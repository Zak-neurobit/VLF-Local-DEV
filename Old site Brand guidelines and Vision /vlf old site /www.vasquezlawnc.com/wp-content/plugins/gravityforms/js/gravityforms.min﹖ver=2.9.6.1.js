...
function gformDeleteUploadedFile(e, t, r) {
  var i,
    ...
    o =
      ...
      n
        .find('input[type="file"],.validation_message,#extensions_message_' + e + '_' + t)
      ...
      jQuery(e)
        ...
        .on('change keyup', function () {
          void 0 === jQuery(this).attr('onChange') &&
            ...
            (t = !0),
            'enable-api' ===
              (jQuery(this).next().data('jsButton') || jQuery(this).data('jsButton')) && (t = null);
        }),
        'gravityformswebapi' === this.getUrlParameter('subview') &&
          gf_webapi_vars.api_enabled !== gf_webapi_vars.enable_api_checkbox_checked &&
          (t = !0),
  ...
  (gform.tools = {
    ...
    mergeObjects: function () {
      for (var e = {}, t = 0; t < arguments.length; t += 1)
        for (var r = arguments[t], i = Object.keys(r), n = 0; n < i.length; n += 1)
          e[i[n]] = r[i[n]];
      return e;
    },
...
function gformIsHidden(e) {
  return (
    (isHidden = 'none' == e.parents('.gfield').not('.gfield_hidden_product').css('display')),
...
function gformUpdateTotalFieldPrice(e, t) {
  ...
  0 < !n.length ||
    ((r = (e = document.querySelector('#gform_wrapper_' + e + '.gform_legacy_markup_wrapper'))
      ? n.next()
      : n),
    (t = {
...
function gformGetShippingPrice(e) {
  ...
  return gformToNumber(
    (t =
      1 != e.length || gformIsHidden(e) ? t : e.attr('readonly') ? e.val() : gformGetPrice(e.val()))
  );
}
...
function gformGetProductQuantity(e, t) {
  ...
  if (gformIsHidden((n = n.length ? n : jQuery('#input_' + e + '_' + t + '_1')))) return 0;
  0 < n.length
    ? (r = n.val())
    : ((r = 1),
...
function gformGetBasePrice(e, t) {
  ...
  return (
    ...
    gformIsHidden(r) && (t = 0),
    !1 === (t = new gform.Currency(gf_global.gf_currency_config).toNumber(t)) ? 0 : t
  );
}
...
function gformFormatPricingField(e) {
  ...
  gf_global.gf_currency_config &&
    ((t = new gform.Currency(gf_global.gf_currency_config).toMoney(jQuery(e).val())),
    jQuery(e).val(t));
}
...
function bindProductChangeEvent() {
  document.addEventListener('gform/products/product_field_changed', function (e) {
    var t = { formId: e.detail.formId, productFieldId: e.detail.productFieldId };
...
function gformShowPasswordStrength(e) {
  var t = gformPasswordStrength(
      ...
      document.getElementById(e + '_2') ? document.getElementById(e + '_2').value : ''
    ),
...
function gformToggleCheckboxes(e) {
  var t,
    ...
    n = i ? r.parent() : r.prev(),
    o = (n.find('label'), n.parent().find('.gchoice:not( .gchoice_select_all )')),
    n = gf_get_form_id_by_html_id(n.parents('.gfield').attr('id')),
    a = rgars(window, 'gf_global/gfcalc/' + n);
  (t = i ? e.checked : 'boolean' == typeof (i = r.data('checked')) ? !i : !(1 === parseInt(i))),
    o.each(function () {
...
function gformToggleSelectAll(e, t) {
  ...
  r ||
    (e.html('deselect' === t ? e.data('label-deselect') : e.data('label-select')),
  ...
  e.find('.delete_list_item').css('visibility', 1 == r ? 'hidden' : 'visible'),
    0 < t && t <= r
      ? (i.data('title', e.find('.add_list_item').attr('title')),
        ...
        n || i.prop('disabled', !0))
      : 0 < t &&
        (i.removeClass('gfield_icon_disabled'), n || i.prop('disabled', !1), i.data('title')) &&
                    ...
                    if (void 0 !== t) {
                      ...
                      if (r) {
                        ...
                        var d = e.attr('id'),
                          ...
                          d =
                            (d &&
                              ...
                              d[2] &&
                              ((s = d[1] + s), f.attr('for', s), e.attr('id', s)),
                            t.replace(r[0], l)),
                        ...
                        e.is(':radio') &&
                          ...
                          t !== d &&
                          f &&
                          (null !== _ && _.prop('checked', !0), e.prop('checked', !1), (_ = e)),
                          e.attr('name', d);
                      }
                    }
                  });
...
jQuery(document).on('click', '.gfield_choice--select_all_enabled *', function () {
  ...
  jQuery(this).is('.gchoice input[type="checkbox"]') &&
    ...
    jQuery(this).is('.gchoice input[type="checkbox"]') &&
      (e = jQuery(this)
        .closest('.gfield_choice--select_all_enabled')
        .find('.gchoice input[type="checkbox"]:not(".gfield_choice_all_toggle")')).length ===
      ...
      var i = parseInt(t, 10),
        n =
          (0 < jQuery('#input_' + e + '_' + i + '_copy_values_activated:checked').length &&
            ((a = jQuery('#input_' + e + '_' + i + '_copy_values_activated').data(
              'source_field_id'
            )),
          ...
          jQuery('#field_' + e + '_' + i)),
        o = n.find(
          (i == t ? 'input[name^="input_' + i + '"]' : 'input[name="input_' + t + '"]') +
            ', select[name^="input_' +
            t +
        ...
        switch (((a = ''), r)) {
          ...
          case 'qty':
            if (n.hasClass('gfield_price'))
              return !1 === (f = gformGetProductQuantity(e, i)) || '' === f ? 0 : f;
        }
        if (
          1 ===
          (o =
            'checkbox' !== o.prop('type') && 'radio' !== o.prop('type') ? o : o.filter(':checked'))
            .length
        ) {
          if (
            (!o.is('select') && 'radio' !== o.prop('type') && 'checkbox' !== o.prop('type')) ||
            '' !== r
          )
            void 0 === f && (f = o.val());
          else if (
            ((f = o.is('select')
              ...
              : ('radio' === o.prop('type') && o.parent().hasClass('gchoice_button')
            ...
            for (var s = [], c = 0; c < f.length; c++) s[c] = jQuery(f[c]).text();
            f = s;
          }
          a = jQuery.isArray(f)
            ? f.join(', ')
    ...
    function (formId, formulaFields) {
      (this.formId = formId),
              ...
              !1 !== formattedResult
                ...
                : field.hasClass('gfield_price') || 'currency' == numberFormat
                  ...
                  : ((decimalSeparator = '.'),
                    ...
                    gformFormatNumber(
                      result,
                      gform.utils.isNumber(formulaField.rounding) ? formulaField.rounding : -1,
                      decimalSeparator,
                      thousandSeparator
                    ))),
              result != previous_val &&
            ...
            s.hasOwnProperty(r) &&
              ...
              'checkbox' ==
                (n = jQuery('#field_' + t + '_' + n).find(
                  'input[name="input_' + i + '"], select[name="input_' + i + '"]'
                )).prop('type') || 'radio' == n.prop('type')
                ? (jQuery(n).click(function () {
                    a.bindCalcEvent(i, e, t, 0);
                  }),
                  0 < (o = n.closest('.gfield--type-image_choice .gchoice')).length &&
              ...
              ((o = parseInt(n, 10)) == r.field_id && o == n) ||
                ...
                d[i][3]
                  ...
                  : ((c = jQuery('.gfield_price input[name=input_' + o + ']').is(
                    ...
                    (l = jQuery('.gfield_price input[name="input_' + n + '"]').is(
                      'input[type=checkbox]'
                    )),
                    (s || c || l) && (a = 'price')),
                (c = (s =
                  !window.gf_check_field_rule || 'show' == gf_check_field_rule(e, o, !0, ''))
        ...
        (this.cleanNumber = function (e, t, r, i) {
          (r = (r = gf_get_field_number_format(r, t)) || gf_get_field_number_format(i.field_id, t)),
...
function gformFormatNumber(e, t, r, i) {
  return (
    void 0 === r &&
      (r = window.gf_global
        ? new gform.Currency(gf_global.gf_currency_config).currency.decimal_separator
        : '.'),
    void 0 === i &&
      (i = window.gf_global
        ? new gform.Currency(gf_global.gf_currency_config).currency.thousand_separator
        : ','),
  ...
  window.FileReader &&
    ...
    ((e = e.files[0]) && e.size > t
      ? (r.text(e.name + ' - ' + gform_gravityforms.strings.file_exceeds_limit),
        wp.a11y.speak(e.name + ' - ' + gform_gravityforms.strings.file_exceeds_limit))
      : r.remove());
}
(gform.recaptcha = {
  renderRecaptcha: function () {
    jQuery('.ginput_recaptcha:not(.gform-initialized)').each(function () {
      var e = jQuery(this),
        t = { sitekey: e.data('sitekey'), theme: e.data('theme'), tabindex: e.data('tabindex') },
        r =
  ...
  maybeExecuteInvisibleRecaptcha: async function (e) {
    ...
    return (
      gform.recaptcha.gformIsRecaptchaPending(jQuery(e.form)) &&
        ...
        await gform.recaptcha.executeRecaptcha(t.getAttribute('data-widget-id'), e.form)),
      e
    );
  },
  ...
  handleAjaxPostValidation: function (e) {
    return (
      gform.recaptcha.saveRecaptchaResponse(e.validationResult.data.recaptcha_response, e.form), e
    );
  },
  handleAjaxPostSubmission: function (e) {
    return (
      gform.recaptcha.saveRecaptchaResponse(e.submissionResult.data.recaptcha_response, e.form), e
    );
  },
  ...
  ((g, m) => {
    ...
    m(document).on('gform_post_render', function (e, t) {
      ...
      m(document).ready(function () {
        ('undefined' != typeof adminpage && 'toplevel_page_gf_edit_forms' === adminpage) ||
    ...
    function i(o) {
      ...
      function f(e, t) {
        m('#' + e).prepend(
          "<li class='gfield_description gfield_validation_message'>" + h(t) + '</li>'
        ),
          setTimeout(function () {
      ...
      (d = t.settings.multipart_params.form_id),
        ...
        (g.toggleDisabled = function (e, t) {
          ('string' == typeof e.browse_button ? m('#' + e.browse_button) : m(e.browse_button)).prop(
            'disabled',
            t
          );
        }),
        ...
        t.bind('FilesAdded', function (o, e) {
          ...
          0 < l && l <= s
            ...
            : (m.each(e, function (e, t) {
                ...
                (a = t.name.split('.').pop()),
                  -1 < m.inArray(a, c)
                    ? (f(o.settings.gf_vars.message_id, t.name + ' - ' + _.illegal_extension),
                      o.removeFile(t))
              ...
              o.refresh(),
              0 ==
                (t = m('form#gform_' + d + ' ' + (e = "input:hidden[name='gform_unique_id']")))
                  .length && (t = m(e)),
              '' === (r = t.val()) &&
              ...
              0 < l &&
                l <= s &&
                (g.toggleDisabled(o.settings, !0), f(o.settings.gf_vars.message_id, _.max_reached)),
        ...
        t.bind('Error', function (e, t) {
          ...
          t.code === plupload.FILE_EXTENSION_ERROR
            ...
            : t.code === plupload.FILE_SIZE_ERROR
              ? f(e.settings.gf_vars.message_id, t.file.name + ' - ' + _.file_exceeds_limit)
              : ((r =
                  'Error: ' +
                  t.code +
                  ', Message: ' +
                ...
                100 == t.percent &&
                  (r.status && 'ok' == r.status
                    ? ((n = i),
                      ...
                      (o[(i = u(i))] = r),
                      n.val(m.toJSON(o)))
                    : f(e.settings.gf_vars.message_id, _.unknown_error + ': ' + t.name))));
        }),
...
function gformInitSpinner(e, t, r = 0) {
  gformIsSpinnerInitialized ||
    ...
    document.addEventListener('gform/submission/submission_aborted', function (e) {
      gformRemoveSpinner(), jQuery('#gform_ajax_spinner_' + e.detail.form.dataset.formid).remove();
    }));
}
    ...
    ? (r = window.tinymce)
      ? (i = r.get('input_' + e + '_' + t))
        ? ((n = jQuery.extend({}, i.settings)),
          ...
          r.init(n),
          gform.console.log(
            'gformReInitTinymceInstance reinitialized TinyMCE on input_' + e + '_' + t + '.'
          ))
        : gform.console.error(
            'gformReInitTinymceInstance did not find an instance for input_' + e + '_' + t + '.'
          )
