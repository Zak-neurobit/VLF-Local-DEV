...
!(function (n) {
        ...
        (s.prototype.displayMessage = function (e) {
          var t = this.options.get('escapeMarkup'),
            n =
              (this.clear(),
              this.hideLoading(),
              u('<li role="alert" aria-live="assertive" class="select2-results__option"></li>')),
          ...
          if (e.children) {
            for (
              var i = u(n),
                ...
                r = ((o.className = 'select2-results__group'), this.template(e, o), []),
                a = 0;
              a < e.children.length;
              a++
            ) {
          ...
          (i.prototype.update = function (e) {
            ...
            0 === e.length
              ...
              : ((e = e[0]),
                ...
                (n = this.display(e, t)),
                t.empty().append(n),
                (n = e.title || e.text) ? t.attr('title', n) : t.removeAttr('title'));
          }),
          i
        );
      }
            ...
            if (0 !== n.length) {
              ...
              if ((this.trigger('clear', o), o.prevented)) this.$element.val(i);
                ...
                for (var r = 0; r < s.length; r++)
                  if (((o = { data: s[r] }), this.trigger('unselect', o), o.prevented))
    ...
    e.define('select2/selection/selectionCss', ['../utils'], function (n) {
      ...
      return (
        (e.prototype.render = function (e) {
          ...
          return (
            -1 !== t.indexOf(':all:') &&
              ((t = t.replace(':all:', '')), n.copyNonInternalCssClasses(e[0], this.$element[0])),
            e.addClass(t),
            e
          );
        }),
        ...
        (n.prototype.item = function (e) {
          ...
          if (null == (t = a.GetData(e[0], 'data'))) {
            ...
            if ('option' === n.tagName.toLowerCase())
              ...
              for (
                var t = { text: e.prop('label'), children: [], title: e.prop('title') },
                  s = e.children('option'),
                  i = [],
                  o = 0;
                o < s.length;
          ...
          for (var o = 0; o < e.length; o++) {
            ...
            0 <= s.indexOf(l.id)
              ? ((r = n.filter(
                ...
                r.replaceWith(a))
              : ((r = this.option(l)),
                l.children && ((a = this.convertToOptions(l.children)), r.append(a)),
                i.push(r));
          }
          return i;
        }),
        ...
        (n.prototype.query = function (t, n) {
          ...
          function e() {
            var e = i.transport(
              ...
              function () {
                (e && 'status' in e && (0 === e.status || '0' === e.status)) ||
    ...
    e.define('select2/dropdown/selectOnClose', ['../utils'], function (n) {
      ...
      return (
        ...
        (e.prototype._handleSelectOnClose = function (e, t) {
          ...
          t.length < 1 ||
            (null != (t = n.GetData(t[0], 'data')).element && t.element.selected) ||
      ...
      return (
        (e.prototype.highlightFirstItem = function (e) {
          ...
          if (0 < t.length) {
            ...
            if (n && n.getAttribute && 'true' === n.getAttribute('data-select2-tag'))
  ...
  function w(t, n) {
    return function () {
      ...
      return (
        'string' != typeof e[0] && 1 === e.length && e.push(null), r.apply(p, e.concat([t, n]))
      );
    };
  }
  function x(e) {
    var t;
    if ((b(m, e) && ((t = m[e]), delete m[e], (v[e] = !0), o.apply(p, t)), b(g, e) || b(v, e)))
      return g[e];
