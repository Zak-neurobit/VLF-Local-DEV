...
!(function (e, t) {
  ...
  var u = {
    ...
    slideToClosest: function (e, t, i, s) {
      ...
      return (
        (a = Math.max(a, 0)), (a = Math.min(a, this.snapGrid.length - 1)), this.slideTo(a, e, t, i)
      );
    },
      ...
      if (s.freeMode) {
        ...
        if (u > s.longSwipesMs) {
          ...
          'next' === t.swipeDirection &&
            (I >= s.longSwipesRatio ? t.slideTo(k + s.slidesPerGroup) : t.slideTo(k)),
            'prev' === t.swipeDirection &&
              (I > 1 - s.longSwipesRatio ? t.slideTo(k + s.slidesPerGroup) : t.slideTo(k));
        } else {
        ...
        if ((a = c[0])) {
          ...
          return (
            ...
            a && a.shadowRoot && a.shadowRoot.querySelector
              ? ((v = s(a.shadowRoot.querySelector('.' + h.params.wrapperClass))).children =
                  function (e) {
                    return c.children(e);
                  })
      ...
      handle: function (e) {
        ...
        if ((s.invert && (a = -a), i.params.freeMode)) {
          ...
          if (
            (w.push(b),
            y
              ? (b.direction !== y.direction || b.delta > y.delta) && i.mousewheel.animateSlider(b)
      ...
      setTranslate: function () {
        for (
          ...
          if ((f.transform(E), (f[0].style.zIndex = 1 - Math.abs(Math.round(g))), n.slideShadows)) {
            ...
            0 === S.length &&
              ((S = s('<div class="swiper-slide-shadow-' + (l ? 'left' : 'top') + '"></div>')),
              f.append(S)),
              0 === C.length &&
                ((C = s(
