        ...
        setup: function () {
          ...
          (r[t] = !0),
            ...
            y &&
              ...
              l.touchstart === 1 &&
                b.on('touchstart', B).on('touchend', I).on('touchmove', F).on('scroll', j));
        },
        teardown: function () {
          --l[t],
            l[t] || b.off(n, H),
            y &&
              (--l.touchstart,
              l.touchstart ||
                b.off('touchstart', B).off('touchmove', F).off('touchend', I).off('scroll', j));
          var r = e(this),
            s = e.data(this, i);
                ...
                (s.move = function (t) {
                  ...
                  (r = e.event.special.swipe.stop(t)),
                    ...
                    Math.abs(o.coords[0] - r.coords[0]) >
                      e.event.special.swipe.scrollSupressionThreshold && t.preventDefault();
                }),
                  (s.stop = function () {
                    (l = !0),
