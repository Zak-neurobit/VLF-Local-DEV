...
class CompetitorMonitoringTester {
  ...
  private async testCompetitiveAnalysis(): Promise<void> {
    ...
    try {
      ...
      this.testResults.push({
        ...
        passed,
        duration,
        details: `Generated analysis for ${analysis.competitors.length} competitors, ` +
  ...
  private async executeScenario(scenario: TestScenario): Promise<void> {
    ...
    try {
      ...
      const hasAutomatedActions = responses.some(r => 
        r.automatedActions && Object.values(r.automatedActions).some(v => v)
      );
      ...
      this.testResults.push({
        ...
        duration,
        responses,
        details: `Processed ${scenario.activities.length} activities, ` +
