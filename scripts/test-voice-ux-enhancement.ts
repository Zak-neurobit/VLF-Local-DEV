    ...
    const scenario: TestScenario = {
      ...
      conversationFlow: [
        ...
        },
        {
          speaker: 'agent',
          message:
            "I understand your concern about your visa expiring. Let's work together to address this urgent matter.",
        },
        {
          speaker: 'user',
        ...
        },
        {
          speaker: 'agent',
          message:
            "I'll explain the documents step by step. First, you'll need your current visa...",
        },
      ],
      expectedOutcomes: {
    ...
    const scenario: TestScenario = {
      ...
      conversationFlow: [
        ...
        },
        {
          speaker: 'agent',
          message:
            'Por supuesto, le puedo ayudar con su proceso de divorcio. ¿Cuánto tiempo lleva separado?',
        },
        {
          speaker: 'user',
        ...
        },
        {
          speaker: 'agent',
          message:
            'No se preocupe, entiendo perfectamente. Seis meses de separación es importante para el proceso.',
        },
      ],
      expectedOutcomes: {
    ...
    const scenario: TestScenario = {
      ...
      conversationFlow: [
        ...
        },
        {
          speaker: 'agent',
          message:
            "I understand you've been injured at work. Let me connect you with our workers compensation specialist.",
        },
        {
          speaker: 'user',
        ...
        },
        {
          speaker: 'agent',
          message:
            "I see you have both workers compensation and criminal defense needs. Let's address the most urgent matter first.",
        },
      ],
      expectedOutcomes: {
    ...
    const scenario: TestScenario = {
      ...
      conversationFlow: [
        ...
        },
        {
          speaker: 'agent',
          message:
            'Of course. Let me slow down. [SLOWER] Your personal injury claim has three main components...',
        },
        {
          speaker: 'user',
    ...
    const scenario: TestScenario = {
      ...
      conversationFlow: [
        ...
        },
        {
          speaker: 'agent',
          message:
            "[CLEAR ARTICULATION] Absolutely. I'll speak more clearly and can repeat any information you need.",
        },
        {
          speaker: 'user',
        ...
        },
        {
          speaker: 'agent',
          message:
            "I'll provide detailed verbal descriptions of all information and processes we discuss.",
        },
      ],
      expectedOutcomes: {
    ...
    const scenario: TestScenario = {
      ...
      conversationFlow: [
        ...
        },
        {
          speaker: 'agent',
          message:
            "That's a great question - license suspension is often the biggest concern. Let me address that first.",
        },
        {
          speaker: 'user',
  ...
  private async testAnalyticsIntegration(): Promise<void> {
    ...
    try {
      ...
      const recommendations =
        await voiceAnalyticsSystem.generateOptimizationRecommendations(analytics);
