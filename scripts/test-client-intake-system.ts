...
import { aiClientIntakeSystem, ClientIntakeRequest } from '../src/lib/crewai/ai-powered-client-intake';
...
class ClientIntakeSystemTester {
  ...
  private async testImmigrationCase(): Promise<void> {
    ...
    const request: ClientIntakeRequest = {
      ...
      legalIssue: {
        ...
        description: 'I need help applying for a green card through my US citizen spouse. We have been married for 2 years and I am currently on a visitor visa that expires soon.',
  ...
  private async testPersonalInjuryCase(): Promise<void> {
    ...
    const request: ClientIntakeRequest = {
      ...
      legalIssue: {
        ...
        description: 'I was hit by a drunk driver last month while stopped at a red light. I suffered a broken arm and whiplash. The other driver was arrested for DUI. I have medical bills of $15,000 so far and cannot work.',
        urgency: 'within_days',
  ...
  private async testWorkersCompCase(): Promise<void> {
    ...
    const request: ClientIntakeRequest = {
      ...
      legalIssue: {
        ...
        description: 'I injured my back lifting heavy boxes at work three weeks ago. I reported it immediately to my supervisor and went to the company doctor. Now they are saying it is not work-related and denying my workers comp claim. I cannot return to work yet.',
        urgency: 'within_days',
        hasDeadlines: true,
  ...
  private async testFamilyLawCase(): Promise<void> {
    ...
    const request: ClientIntakeRequest = {
      ...
      legalIssue: {
        ...
        description: 'My husband and I have been separated for 8 months and I want to file for divorce. We have two children (ages 6 and 9) and disagree on custody arrangements. We also own a house together and have retirement accounts. He has been difficult to work with.',
  ...
  private async testCriminalDefenseCase(): Promise<void> {
    ...
    const request: ClientIntakeRequest = {
      ...
      legalIssue: {
        ...
        description: 'I was arrested for DUI last weekend after a traffic stop. This is my first offense and I blew a 0.10 on the breathalyzer. I have a court date next month and I am worried about losing my job and my license. I need help understanding my options.',
        urgency: 'within_days',
        hasDeadlines: true,
  ...
  private async testUrgentCaseHandling(): Promise<void> {
    ...
    const request: ClientIntakeRequest = {
      ...
      legalIssue: {
        primaryArea: 'immigration',
        description: 'ICE agents came to my house this morning looking for me. My friend told me to call a lawyer immediately. I have been in the US for 10 years and have two US citizen children. I need help right now.',
        urgency: 'immediate',
        hasDeadlines: true,
  ...
  private async testOutOfStateClientRouting(): Promise<void> {
    ...
    const request: ClientIntakeRequest = {
      ...
      legalIssue: {
        primaryArea: 'personal_injury',
        description: 'I was injured in a car accident in Georgia and the insurance company is not being fair. I heard good things about your firm and want to see if you can help.',
        urgency: 'within_weeks',
        hasDeadlines: false,
      },
      priorLegalExperience: {
      ...
      specificQuestions: [
        'Can you handle cases in Georgia?',
      ],
      source: 'referral',
    };
  ...
  private async testMultiLanguageSupport(): Promise<void> {
    ...
    const request: ClientIntakeRequest = {
      ...
      legalIssue: {
        primaryArea: 'family_law',
        description: 'Mi esposo me está amenazando y necesito una orden de protección. También quiero el divorcio y la custodia de mis hijos. Tengo miedo y necesito ayuda inmediatamente.',
        urgency: 'immediate',
        hasDeadlines: true,
      },
      priorLegalExperience: {
  ...
  private async testComplexCaseAssessment(): Promise<void> {
    ...
    const request: ClientIntakeRequest = {
      ...
      legalIssue: {
        primaryArea: 'unknown',
        description: 'I have multiple legal issues. I was injured at work but also involved in a car accident on the way to the hospital. Now I am facing DUI charges because I took pain medication before driving. My wife is also filing for divorce and my immigration status is in question because of the criminal charges.',
        urgency: 'immediate',
        hasDeadlines: true,
  ...
  private async testFinancialViabilityAnalysis(): Promise<void> {
    ...
    const request: ClientIntakeRequest = {
      ...
      legalIssue: {
        primaryArea: 'personal_injury',
        description: 'I was severely injured in a truck accident that was clearly the other driver\'s fault. I have over $200,000 in medical bills, lost my $150,000/year job, and will need ongoing care. The trucking company has insurance and assets.',
        urgency: 'within_weeks',
  ...
  private async testRiskOpportunityAssessment(): Promise<void> {
    ...
    const request: ClientIntakeRequest = {
      ...
      legalIssue: {
        primaryArea: 'immigration',
        description: 'I have been in the US illegally for 15 years but my US citizen daughter just turned 21. I also have a DUI from 5 years ago and was denied a visitor visa twice in the past. My daughter wants to petition for me but I am scared about the risks.',
        urgency: 'within_months',
        hasDeadlines: false,
      },
      priorLegalExperience: {
  ...
  private async testFollowUpStrategyGeneration(): Promise<void> {
    ...
    const request: ClientIntakeRequest = {
      ...
      legalIssue: {
        primaryArea: 'workers_compensation',
        description: 'I hurt my shoulder at work about a month ago. I filed a workers comp claim and it was approved. I am getting medical treatment but I want to make sure I am getting all the benefits I deserve and that my rights are protected.',
        urgency: 'planning',
        hasDeadlines: false,
      },
      priorLegalExperience: {
  ...
  private async executeTest(
    ...
    try {
      ...
      const viabilityMatch = !expectations.expectedViability || 
      ...
      const priorityMatch = !expectations.expectedPriority ||
      ...
      const additionalChecks = hasRecommendations && hasTimeline && hasCostAnalysis && hasFollowUpStrategy;

      this.testResults.push({
        testName,
        passed: passed && additionalChecks,
        duration,
        details: `Practice Area: ${assessment.practiceArea} (expected: ${expectations.expectedPracticeArea}), ` +
