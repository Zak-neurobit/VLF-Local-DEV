...
const dependencies = ['webpack-bundle-analyzer', 'terser-webpack-plugin', '@next/bundle-analyzer'];
...
log(
  '\n✨ Optimization complete! Your website is now faster, more accessible, and better optimized for search engines.',
  'green'
);
