...
const practiceAreasSEO: PracticeAreaSEO[] = [
  {
    ...
    metaTitle: 'Best Immigration Lawyer in North Carolina | 60+ Years Experience | Vasquez Law Firm',
    metaDescription: 'Top-rated immigration attorneys in NC with 60+ years combined experience. Free consultation. Green cards, visas, deportation defense, citizenship. Se habla español. Available 24/7.',
    h1: 'North Carolina\'s #1 Immigration Law Firm - 60+ Years of Excellence',
    keywords: ['immigration lawyer NC', 'immigration attorney North Carolina', 'green card lawyer', 'deportation defense attorney', 'citizenship lawyer NC'],
    localKeywords: ['Raleigh immigration lawyer', 'Charlotte immigration attorney', 'Durham immigration law firm', 'Greensboro visa lawyer', 'Winston Salem deportation defense'],
    structuredData: {
      ...
      hasOfferCatalog: {
        ...
        itemListElement: [
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Green Card Applications' }},
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Deportation Defense' }},
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Citizenship & Naturalization' }},
    ...
    content: {
      intro: 'With 60+ years of combined experience, Vasquez Law Firm is North Carolina\'s most trusted immigration law firm. Our bilingual attorneys have successfully handled thousands of immigration cases across all 100 NC counties.',
      whyChooseUs: 'Why we\'re NC\'s #1 choice: ✓ 98% success rate ✓ 24/7 AI-powered case tracking ✓ Same-day consultations ✓ Fluent Spanish speakers ✓ Former immigration officers on staff',
      services: [
      ...
      callToAction: 'Get your FREE immigration consultation today. Call 1-844-YO-PELEO or chat with our AI assistant 24/7.'
    }
  },
  {
    ...
    metaDescription: 'North Carolina\'s premier personal injury attorneys with 60+ years experience. Maximum compensation for accidents. Free consultation. No upfront fees. Available 24/7.',
    h1: 'NC\'s Most Successful Personal Injury Law Firm - We Fight, You Win',
    keywords: ['personal injury lawyer NC', 'accident attorney North Carolina', 'car accident lawyer', 'slip and fall attorney', 'wrongful death lawyer NC'],
    localKeywords: ['Raleigh personal injury lawyer', 'Charlotte accident attorney', 'Durham injury law firm', 'Greensboro car accident lawyer', 'Winston Salem wrongful death attorney'],
    structuredData: {
      '@context': 'https://schema.org',
      '@type': 'LegalService',
    ...
    content: {
      intro: 'Injured in North Carolina? You deserve maximum compensation. With 60+ years fighting insurance companies and a track record of multi-million dollar settlements, we\'re NC\'s go-to personal injury firm.',
      whyChooseUs: 'Our advantage: ✓ $100M+ recovered for clients ✓ No fees unless we win ✓ 24-hour response time ✓ In-house medical experts ✓ AI-powered case valuation for maximum compensation',
      services: [
      ...
      callToAction: 'Injured? Get your FREE case evaluation now. Call 1-844-YO-PELEO - We fight, you heal.'
    }
  },
  {
    ...
    metaDescription: 'Expert NC workers\' compensation attorneys with 60+ years experience. Get your benefits approved fast. Free consultation. We handle denied claims. Se habla español.',
    h1: 'North Carolina Workers\' Comp Experts - Get the Benefits You Deserve',
    keywords: ['workers comp lawyer NC', 'workers compensation attorney North Carolina', 'workplace injury lawyer', 'denied workers comp claims', 'work accident attorney NC'],
    localKeywords: ['Raleigh workers comp lawyer', 'Charlotte workplace injury attorney', 'Durham workers compensation', 'Greensboro work accident lawyer', 'Winston Salem comp attorney'],
    structuredData: {
      '@context': 'https://schema.org',
      '@type': 'LegalService',
      name: 'Vasquez Law Firm Workers\' Compensation Services',
      description: 'Leading workers\' compensation law firm in North Carolina helping injured workers get benefits',
      provider: {
        '@type': 'Attorney',
        name: 'Vasquez Law Firm, PLLC',
        telephone: '+1-844-967-3536'
    ...
    content: {
      intro: 'Hurt at work in North Carolina? Don\'t let your employer or their insurance company deny your rightful benefits. With 60+ years of experience and thousands of successful claims, we know how to win.',
      whyChooseUs: 'Why injured workers choose us: ✓ 95% approval rate ✓ Expedited claim processing ✓ Maximum benefit calculation ✓ Direct insurance negotiation ✓ No upfront costs',
      services: [
      ...
      callToAction: 'Injured at work? Don\'t wait - NC law has strict deadlines. Call 1-844-YO-PELEO for FREE help now.'
    }
  },
  {
    ...
    metaDescription: 'Aggressive criminal defense lawyers in North Carolina with 60+ years experience. Former prosecutors on your side. 24/7 availability. DWI, drugs, assault, federal crimes.',
    h1: 'NC\'s Most Aggressive Criminal Defense Team - Your Freedom Matters',
    keywords: ['criminal defense lawyer NC', 'criminal attorney North Carolina', 'DWI lawyer NC', 'drug crime attorney', 'assault defense lawyer'],
    localKeywords: ['Raleigh criminal lawyer', 'Charlotte DWI attorney', 'Durham criminal defense', 'Greensboro drug lawyer', 'Winston Salem assault attorney'],
    structuredData: {
      '@context': 'https://schema.org',
      '@type': 'LegalService',
    ...
    content: {
      intro: 'Facing criminal charges in North Carolina? Your future is on the line. With 60+ years of combined experience and former prosecutors on our team, we know how to protect your freedom.',
      whyChooseUs: 'Our edge: ✓ Former prosecutors & judges ✓ 24/7 emergency response ✓ Thousands of cases dismissed ✓ Trial-ready defense ✓ Immigration-safe strategies',
      services: [
        'DWI/DUI Defense',
        'Drug Crime Defense',
      ...
      callToAction: 'Arrested? Time is critical. Call 1-844-YO-PELEO now for 24/7 emergency defense.'
    }
  },
  {
    ...
    metaDescription: 'Expert traffic violation attorneys in North Carolina. Keep your license, avoid points, lower insurance. Speeding, reckless driving, CDL violations. Fast & affordable.',
    h1: 'North Carolina\'s Go-To Traffic Ticket Lawyers - Keep Your License',
    keywords: ['traffic lawyer NC', 'speeding ticket attorney North Carolina', 'traffic violation lawyer', 'CDL ticket attorney', 'license restoration NC'],
    localKeywords: ['Raleigh traffic lawyer', 'Charlotte speeding ticket attorney', 'Durham traffic court', 'Greensboro CDL lawyer', 'Winston Salem license attorney'],
    structuredData: {
      '@context': 'https://schema.org',
      '@type': 'LegalService',
    ...
    content: {
      intro: 'Got a traffic ticket in North Carolina? Don\'t just pay it - fight it! With 60+ years of experience, we\'ve helped thousands keep their licenses and avoid insurance hikes.',
      whyChooseUs: 'Your advantage: ✓ 90% ticket dismissal rate ✓ No court appearance needed ✓ CDL protection specialists ✓ Insurance point prevention ✓ Flat-fee pricing',
      services: [
      ...
      callToAction: 'Don\'t let a ticket ruin your record. Call 1-844-YO-PELEO - Quick, affordable defense.'
    }
  }
];
...
async function generateOptimizedPages() {
  ...
  for (const area of practiceAreasSEO) {
    const pagePath = path.join(__dirname, '..', 'src', 'app', 'practice-areas', area.slug, 'page.tsx');
          ...
          <div className="space-y-12">
            ...
            <section className="bg-gray-50 rounded-lg p-8">
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-8">
                ${area.content.services.map(service => `
