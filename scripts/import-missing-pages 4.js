...
class MissingPageImporter {
  ...
  async importAllPages() {
    console.log('Starting comprehensive page import from vasquezlawnc.com...\n');
...
// Run the importer
async function main() {
  const importer = new MissingPageImporter();
  await importer.importAllPages();
}
...
module.exports = { MissingPageImporter };
