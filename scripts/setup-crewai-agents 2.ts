...
const AGENT_CONFIGS: AgentSetupConfig[] = [
  {
    ...
    backstory: 'You are an expert at analyzing lead quality for law firms. You understand the indicators of high-value clients and can quickly assess urgency, case value, and conversion probability.',
    enabled: true,
    priority: 'high',
  ...
  },
  {
    ...
    backstory: 'You are a friendly and knowledgeable assistant at Vasquez Law Firm. You help clients with initial questions, gather basic information, and guide them toward appropriate next steps.',
    enabled: true,
    priority: 'high',
  ...
  },
  {
    ...
    backstory: 'You are an organized scheduling specialist who manages the complex calendars of multiple attorneys. You understand how to balance urgent cases with routine appointments.',
    enabled: true,
    priority: 'medium',
  ...
  },
  {
    ...
    backstory: 'You are skilled at reading and analyzing legal documents. You can quickly identify key dates, parties, claims, and important details that attorneys need to know.',
    enabled: true,
    priority: 'low',
  ...
  },
  {
    ...
    backstory: 'You are a thorough legal researcher with access to legal databases and knowledge of current laws. You help attorneys build stronger cases through detailed research.',
    enabled: true,
    priority: 'low',
  ...
  },
  {
    ...
    backstory: 'You are a skilled writer who understands legal topics and can communicate complex concepts in accessible language. You create content that builds trust and demonstrates expertise.',
    enabled: true,
    priority: 'low',
  ...
  },
  {
    ...
    backstory: 'You are empathetic and professional, skilled at keeping clients informed about their cases while managing their expectations and concerns.',
    enabled: true,
    priority: 'medium',
  ...
  },
  {
    ...
    backstory: 'You are analytical and detail-oriented, skilled at finding patterns in data that can help the firm make better decisions and serve clients more effectively.',
    enabled: true,
    priority: 'low',
  ...
  },
  {
    ...
    backstory: 'You are experienced at conducting client intake interviews, asking the right questions to understand their legal needs, and determining the best next steps.',
    enabled: true,
    priority: 'high',
  ...
  },
  {
    ...
    backstory: 'You are persistent and organized, skilled at maintaining contact with prospects through multiple touchpoints while respecting their preferences.',
    enabled: true,
    priority: 'medium',
...
async function setupCrewAIAgents() {
  ...
  console.log('\n🔄 Integration Status');
  console.log('─────────────────────');
  console.log(`GoHighLevel: ${process.env.CREWAI_GHL_INTEGRATION === 'true' ? '🟢 ENABLED' : '🔴 DISABLED'}`);
  console.log(`Retell AI: ${process.env.CREWAI_RETELL_INTEGRATION === 'true' ? '🟢 ENABLED' : '🔴 DISABLED'}`);
  console.log(`Database: ${process.env.CREWAI_DATABASE_INTEGRATION === 'true' ? '🟢 ENABLED' : '🔴 DISABLED'}`);
  ...
  console.log(`Parallel Processing: ${process.env.CREWAI_PARALLEL_PROCESSING === 'true' ? '🟢 ENABLED' : '🔴 DISABLED'}`);
