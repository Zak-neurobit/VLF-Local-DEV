  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-[10000] bg-primary text-black p-4 rounded-full shadow-2xl hover:bg-primary-300 transition-all duration-300"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            {/* Header */}
            <div className="bg-primary text-black p-3 flex items-center justify-between">
