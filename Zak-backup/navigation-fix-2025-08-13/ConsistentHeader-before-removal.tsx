...
const navigationData = () => import('@/data/navigation.json');
...
export const ConsistentHeader: React.FC<ConsistentHeaderProps> = ({
  ...
  const [navigation, setNavigation] = useState<{ en: NavigationItem[]; es: NavigationItem[] }>({ en: [], es: [] });
  ...
  // Load navigation data asynchronously
  useEffect(() => {
    navigationData().then(data => {
      ...
      },
      {
        ...
        submenu: [
          ...
          { name: 'Charlotte, NC', href: '/contact/charlotte-nc-office-location' },
          { name: 'Raleigh, NC', href: '/contact/raleigh-nc-office-location' },
          { name: 'Smithfield, NC', href: '/contact/smithfield-office-location' },
          { name: 'Goldsboro, NC', href: '/contact/goldsboro-office-location' },
          { name: 'Orlando, FL', href: '/contact/orlando-fl-office-location' },
        ],
      },
      {
        name: 'About',
    ...
    es: [
      ...
      },
      {
        ...
        submenu: [
          ...
          { name: 'Testimonios', href: '/es/testimonios' },
          { name: 'Resultados de Casos', href: '/es/resultados-de-casos' },
        ],
      },
