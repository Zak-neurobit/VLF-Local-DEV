...
function getNearbyAreas(city: string): string[] {
  const areaMap: Record<string, string[]> = {
    Charlotte: ['Matthews', 'Mint Hill', 'Huntersville', 'Cornelius', 'Davidson', 'Pineville', 'Fort Mill', 'Rock Hill'],
    Raleigh: ['Cary', 'Apex', 'Holly Springs', 'Wake Forest', 'Garner', 'Knightdale', 'Wendell', 'Zebulon'],
    Greensboro: ['High Point', 'Burlington', 'Kernersville', 'Oak Ridge', 'Summerfield', 'Pleasant Garden'],
