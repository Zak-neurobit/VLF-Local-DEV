...
export const LEGAL_PROCESS_GUIDES = {
  greenCardApplication: {
    ...
    description: 'Learn how to apply for a green card (permanent residency) in the United States. This comprehensive guide covers family-based and employment-based green card applications with expert tips from immigration attorneys.',
    ...
    supply: [
      ...
      { name: 'Birth certificate', description: 'Official birth certificate with English translation' },
      { name: 'Marriage certificate (if applicable)', description: 'For family-based applications' },
      { name: 'Police certificates', description: 'From all countries where you lived for 6+ months' },
      { name: 'Medical examination results', description: 'From USCIS-approved physician' },
      { name: 'Financial documents', description: 'Tax returns, bank statements, employment letters' },
      { name: 'Passport photos', description: 'Two passport-style photos meeting USCIS requirements' }
    ],
    steps: [
      {
  ...
  personalInjuryClaim: {
    ...
    description: 'Step-by-step guide to filing a personal injury claim and maximizing your compensation. Learn what to do immediately after an accident and how to build a strong case.',
    ...
    supply: [
      ...
      { name: 'Insurance information', description: 'Your policy and the at-fault party\'s information' },
    ...
    steps: [
      ...
      },
      {
        ...
        warning: 'Insurance companies often offer lowball settlements. Don\'t accept without legal advice.'
      },
      {
  ...
  expungementProcess: {
    ...
    description: 'Complete guide to expunging criminal records in NC. Learn eligibility requirements, required forms, and the step-by-step process to clear your record.',
    ...
    supply: [
      ...
      { name: 'Affidavit of good character', description: 'Two character affidavits from non-relatives' },
  ...
  workersCompClaim: {
    ...
    description: 'Essential guide for injured workers to file a workers comp claim, get medical treatment, and receive benefits. Protect your rights and avoid common mistakes.',
    ...
    supply: [
      ...
      { name: 'Witness statements', description: 'Written statements from coworkers who saw the injury' },
