...
export const attorneys: Attorney[] = [
  ...
  },
  {
    ...
    practiceAreas: ['Immigration Law', 'Family-Based Immigration', 'Deportation Defense', 'VAWA Cases'],
    languages: ['English', 'Spanish'],
    education: [
      {
  ...
  },
  {
    ...
    practiceAreas: ['Criminal Defense', 'DWI/DUI Defense', 'Drug Charges', 'Federal Criminal Defense'],
    languages: ['English'],
    education: [
      {
        institution: 'Law School Name',
  ...
  },
  {
    ...
    practiceAreas: ['Immigration Law', 'Employment-Based Immigration', 'Citizenship', 'Green Cards'],
    languages: ['English', 'Spanish'],
    education: [
      {
        institution: 'Law School Name',
  ...
  },
  {
    ...
    practiceAreas: ['Criminal Defense', 'Family Law', 'Divorce', 'Child Custody', 'Domestic Violence'],
    languages: ['English', 'Spanish'],
    education: [
      {
        institution: 'Law School Name',
  ...
  },
  {
    ...
    practiceAreas: ['Immigration Law', 'Business Immigration', 'H-1B Visas', 'Green Cards', 'Naturalization'],
    languages: ['English', 'Spanish'],
    education: [
      {
        institution: 'Law School Name',
