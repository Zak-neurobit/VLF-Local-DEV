...
className="flex items-center"
      ...
      className="ml-3">
                  <h1
               } className="text-xl font-bold text-[#6B1F2E]">Vasquez Law Firm</h1>
                  <p
               } className="text-xs text-gray-600">YO PELEO POR TI™</p>
                </div>
              </div>
            </Link>
              ...
              <button
                onClick={() => {
                  if (isSpanish) {
                    ...
                    window.location.href = pathname ? `/es${pathname}` : '/es'; className="flex items-center gap-2 text-gray-700 hover:text-[#6B1F2E] transition-colors"
              >
