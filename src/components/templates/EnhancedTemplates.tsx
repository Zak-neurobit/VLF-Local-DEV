    ...
    home: (
      <>
        <motion.div
          ...
          animate={{
            background: [
              'linear-gradient(to bottom right, #000000, rgba(107, 31, 46, 0.2), rgba(201, 151, 77, 0.1))',
              'linear-gradient(to bottom right, #000000, rgba(107, 31, 46, 0.3), rgba(201, 151, 77, 0.2))',
              'linear-gradient(to bottom right, #000000, rgba(107, 31, 46, 0.2), rgba(201, 151, 77, 0.1))',
            ],
          }}
...
export const EnhancedCard: React.FC<{
  ...
  return (
    <motion.div
      whileHover={{ y: variant === 'service' ? -5 : 0 }}
