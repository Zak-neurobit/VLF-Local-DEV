...
export default function ResourceLeadCaptureForm({
  ...
  const translations = {
    en: {
      ...
      successMessage: customThankYouMessage || `We've sent "${resourceTitle}" to your email address. Please check your inbox.`,
    ...
    es: {
      ...
      successMessage: customThankYouMessage || `Hemos enviado "${resourceTitle}" a su correo electrónico. Por favor revise su bandeja de entrada.`,
    ...
    return (
      ...
      >
        ...
        >
          ...
          <span>{language === 'es' ? 'Revise su correo para más detalles' : 'Check your email for more details'}</span>
        </motion.div>
      </motion.div>
    );
  }
