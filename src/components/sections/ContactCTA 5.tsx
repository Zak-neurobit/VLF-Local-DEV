...
export function ContactCTA({
  ...
  return (
    <section className={`relative overflow-hidden bg-gradient-to-br from-[#6B1F2E] via-[#8B2F3E] to-[#C9974D] ${compact ? 'py-12' : 'py-24'}`}>
      {/* Animated Background */}
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4">
        ...
        >
          {/* Main Content */}
          <h2 className={`mb-4 font-black text-white ${compact ? 'text-4xl md:text-5xl' : 'text-5xl md:text-7xl'}`}>
            {title}
          </h2>
          <p className={`mb-2 font-bold text-[#FFF8E7] ${compact ? 'text-2xl' : 'text-3xl'}`}>
            {subtitle}
          </p>
          <p className={`mb-${compact ? '8' : '12'} text-xl text-white/90`}>
            {description}
          </p>
