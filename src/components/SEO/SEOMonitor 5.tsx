        ...
        <div className="absolute bottom-16 right-0 bg-white rounded-lg shadow-2xl p-6 w-96 max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="border-b pb-3">
              <h4 className="font-semibold text-sm text-gray-700 mb-1">Page Title ({metrics.pageTitle.length} chars)</h4>
            ...
            {/* Meta Description */}
            <div className="border-b pb-3">
              <h4 className="font-semibold text-sm text-gray-700 mb-1">Meta Description ({metrics.metaDescription.length} chars)</h4>
            ...
            <div className="border-b pb-3">
              ...
              <div className="space-y-1 text-xs">
                ...
                <div className="flex items-center">
                  <span className={metrics.imageAltMissing === 0 ? 'text-green-600' : 'text-red-600'}>
                    {metrics.imageAltMissing === 0 ? '✓' : '✗'} Image Alt Tags ({metrics.imageAltMissing} missing)
                  </span>
                </div>
              </div>
            </div>
