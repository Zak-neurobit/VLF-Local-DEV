    ...
    '@graph': [
      {
        ...
        description: 'Full-service immigration and personal injury law firm serving North Carolina and Florida. Over 30,000 cases won. Available 24/7 with bilingual services.',
          ...
          itemListElement: [
            {
              ...
              itemOffered: {
                ...
                description: 'Comprehensive immigration services including green cards, citizenship, visas, deportation defense, and asylum applications.',
                provider: {
                  '@id': 'https://www.vasquezlawnc.com/#organization',
                },
                areaServed: {
            ...
            },
            {
              ...
              itemOffered: {
                ...
                description: 'Aggressive representation for accident victims including car accidents, truck accidents, slip and falls, and wrongful death cases.',
                provider: {
                  '@id': 'https://www.vasquezlawnc.com/#organization',
                },
              },
            },
            {
              ...
              itemOffered: {
                ...
                description: '24/7 criminal defense services for DWI, drug charges, assault, theft, and all criminal matters in NC courts.',
                provider: {
                  '@id': 'https://www.vasquezlawnc.com/#organization',
                },
              },
            },
            {
              ...
              itemOffered: {
                ...
                description: 'Fighting for injured workers to get medical care, lost wages, and disability benefits they deserve.',
                provider: {
                  '@id': 'https://www.vasquezlawnc.com/#organization',
                },
              },
        ...
        review: [
          {
            ...
            reviewBody: 'Mr. Vasquez helped me get my green card. Excellent service, always available to answer questions. Highly recommend!',
        ...
        paymentAccepted: ['Cash', 'Check', 'Credit Card', 'PayPal', 'Zelle', 'Payment Plans Available'],
        priceRange: '$$',
