...
export default function CategoryPageTemplate({ categoryId, initialLanguage = 'en' }: CategoryPageTemplateProps) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex justify-center mb-6">
              <div className={`w-24 h-24 ${category.lightColor} rounded-full flex items-center justify-center`}>
