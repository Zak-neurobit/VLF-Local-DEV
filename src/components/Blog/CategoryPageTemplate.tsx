...
className="text-center"
      ...
      onChange={e => setSearchQuery(e.target.value)} className="w-full px-6 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#C9974D] focus:border-transparent"
                  />
                  <svg
      ...
      className="text-gray-600 hover:text-[#C9974D]"
              ...
              <span
               } className={category.textColor}>{category.name[language]}</span>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="space-y-8">
                ...
                href={getCategoryUrl(relatedId, language) className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors group"
                        >
                          <div
      className="flex items-center gap-3">
                            <span
               } className="text-2xl">{relatedCategory.icon}</span>
                    ...
                    <Link href={language === 'es' ? '/es/blog' : '/blog' className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors group border-t pt-6"
                    >
                      <div}
      className="flex items-center gap-3">
                        <span
                        ...
                        <span
               } className="font-medium text-gray-700 group-hover:text-[#C9974D]">
                          {t.viewAllPosts}
                        </span>
                      </div>
                      <ArrowRight className="w-5 h-5 text-gray-400 group-hover:text-[#C9974D]" />
