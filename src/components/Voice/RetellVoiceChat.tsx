...
export const RetellVoiceChat: React.FC<RetellVoiceChatProps> = ({
  ...
  const startVoiceCall = async () => {
    console.log('🚀 Starting voice call process...');
    ...
    try {
      ...
      try {
        ...
        try {
          console.log('Trying simpler audio constraints...');
      ...
      try {
        ...
        console.warn('Could not set up audio monitoring:', audioError);
      }
      ...
      console.log('1. Check if microphone is connected and working');
      console.log('2. Allow microphone permission when prompted');
      console.log('3. Make sure no other apps are using the microphone');
      console.log('4. Try refreshing the page');
      console.log('5. Check browser settings for microphone permissions');
    }
  };
