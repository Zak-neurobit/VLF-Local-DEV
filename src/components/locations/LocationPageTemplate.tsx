          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-6 max-w-4xl mx-auto">
                Top-Rated Legal Representation in {data.county} County, NC • {data.localStats.casesHandled} Cases Won • Available 24/7
              </p>
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-4 text-sm">
                ...
                <span className="bg-white/20 px-4 py-2 rounded-full">✓ Payment Plans Available</span>
                <span className="bg-white/20 px-4 py-2 rounded-full">✓ {data.localStats.responseTime} Response</span>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="mt-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700">
                            Deep knowledge of {data.county} County courts, judges, and legal procedures. 
                            Our attorneys regularly practice in {data.courtInfo.superior} and {data.courtInfo.district}.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700">
                            Full legal services in English and Spanish for {data.city}'s diverse community. 
                            All documents translated, interpreters available for all meetings.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700">
                            {data.localStats.responseTime} average response time for {data.city} clients. 
                            24/7 emergency legal help for arrests, accidents, and urgent immigration matters.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700">
                            Clear flat fees, payment plans available. No hidden costs. 
                            Free consultations for all {data.city} residents.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="mt-6 bg-[#6B1F2E] text-white rounded-lg p-6">
                      ...
                      <p className="mb-4">
                        Arrested? In an accident? Facing deportation? 
                        We're available 24/7 for {data.city} residents.
                      </p>
                      <a
                        href="tel:1-844-967-3536"
              ...
              {activeTab === 'courts' && (
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-gray-50 rounded-lg p-6">
                      <h3 className="text-xl font-bold text-[#6B1F2E] mb-4">Local Courts We Practice In</h3>
                    ...
                    <div className="bg-gray-50 rounded-lg p-6">
                      <h3 className="text-xl font-bold text-[#6B1F2E] mb-4">Common Legal Issues in {data.city}</h3>
              ...
              {activeTab === 'practice-areas' && (
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {data.practiceAreaFocus.map((area, index) => (
                      <div key={index} className="bg-white border-l-4 border-[#C9974D] shadow-lg p-6">
                        <h3 className="text-xl font-bold text-[#6B1F2E] mb-3">{area}</h3>
                        <p className="text-gray-700 mb-4">
                          {getAreaDescription(area, data.city)}
                        </p>
                        <Link
                          href={`/practice-areas/${area.toLowerCase().replace(/\s+/g, '-')}`}
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="prose prose-lg max-w-none">
              <p>
                When you need a lawyer in {data.city}, North Carolina, Vasquez Law Firm stands ready to fight for you. 
                With over {data.localStats.yearsServing} years serving {data.county} County, we've built a reputation as 
                the go-to law firm for immigration, personal injury, workers' compensation, and criminal defense cases.
              </p>
              <p>
                Our {data.city} legal team understands the unique challenges facing our community. Whether you're dealing 
                with immigration issues, recovering from an accident, or facing criminal charges, we provide aggressive 
                representation with a personal touch. We've successfully handled {data.localStats.casesHandled} cases 
                for {data.city} area residents.
              </p>
              ...
              <ul>
                <li>
                  <strong>Local Experience:</strong> Regular practice in {data.courtInfo.superior} and {data.courtInfo.district}
                </li>
                <li>
                ...
                <li>
                  <strong>Proven Results:</strong> {data.localStats.casesHandled} successful cases in {data.county} County
                </li>
                <li>
                  <strong>Community Trust:</strong> {data.localStats.clientRating} star rating from local clients
                </li>
              </ul>
            </div>
          </div>
...
function getAreaDescription(area: string, city: string): string {
  ...
  return descriptions[area] || `Expert ${area.toLowerCase()} services for ${city} and surrounding areas.`;
}
