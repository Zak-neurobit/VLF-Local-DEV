...
export const ChatWidget = dynamic(() => import('./ChatWidget').then(mod => mod.ChatWidget), {
  ssr: false,
  loading: () => null, // Don't show loading state for chat widget
});

export const VirtualAssistant = dynamic(() => import('./VirtualAssistant'), {
  ssr: false,
  loading: () => null,
});
...
export const HeroScene = dynamic(() => import('./hero/HeroScene'), {
  ssr: false,
