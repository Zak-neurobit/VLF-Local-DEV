...
export default function PersonalInjuryPageContent({ language }: PersonalInjuryPageContentProps) {
  const content = {
    en: {
      ...
      description: 'Our experienced personal injury lawyers are committed to fighting for the compensation you deserve. No fees unless we win your case.',
      ...
      areas: [
        {
          icon: Car,
          title: 'Car Accidents',
          description: 'Helping victims of auto accidents get fair compensation for medical bills, lost wages, and pain.',
        },
        {
          icon: Building,
          title: 'Slip & Fall',
    ...
    es: {
      ...
      description: 'Nuestros abogados experimentados en lesiones personales están comprometidos a luchar por la compensación que merece. Sin honorarios a menos que ganemos su caso.',
      ...
      areas: [
        {
          ...
          description: 'Ayudando a víctimas de accidentes automovilísticos a obtener compensación justa por gastos médicos, salarios perdidos y dolor.',
        },
        {
          icon: Building,
          title: 'Resbalones y Caídas',
          description: 'Casos de responsabilidad de locales por lesiones en condiciones inseguras de propiedad.',
        },
        {
          icon: Stethoscope,
