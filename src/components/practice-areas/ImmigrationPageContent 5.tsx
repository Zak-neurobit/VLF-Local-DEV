...
export default function ImmigrationPageContent({ language }: ImmigrationPageContentProps) {
  const content = {
    en: {
      ...
      description: 'Our experienced immigration lawyers are committed to providing high-quality legal representation for all your immigration needs.',
      ...
      areas: [
        {
          ...
          description: 'Helping families reunite through spouse visas, fiancé visas, and family petitions.',
        },
        {
          icon: Shield,
    ...
    es: {
      ...
      description: 'Nuestros abogados experimentados en inmigración están comprometidos a proporcionar representación legal de alta calidad para todas sus necesidades de inmigración.',
      ...
      areas: [
        {
          ...
          description: 'Ayudando a las familias a reunirse a través de visas de cónyuge, visas de prometido y peticiones familiares.',
        },
        {
          icon: Shield,
        ...
        },
        {
          ...
          description: 'Le guiamos a través del proceso de convertirse en ciudadano estadounidense.',
        },
        {
          icon: FileText,
