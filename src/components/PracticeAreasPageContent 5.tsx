...
export default function PracticeAreasPageContent({ language }: PracticeAreasPageContentProps) {
  const practiceAreas = [
    ...
    },
    {
      ...
      href: language === 'es' ? '/es/areas-de-practica/lesiones-personales' : '/practice-areas/personal-injury',
    },
    {
      ...
      href: language === 'es' ? '/es/areas-de-practica/compensacion-laboral' : '/practice-areas/workers-compensation',
    },
    {
      id: 'criminal-defense',
      ...
      href: language === 'es' ? '/es/areas-de-practica/defensa-criminal' : '/practice-areas/criminal-defense',
    },
    {
      id: 'family-law',
      ...
      href: language === 'es' ? '/es/areas-de-practica/derecho-familia' : '/practice-areas/family-law',
    },
    {
      ...
      href: language === 'es' ? '/es/areas-de-practica/infracciones-transito' : '/practice-areas/traffic-violations',
    },
  ];
