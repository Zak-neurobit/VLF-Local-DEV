...
import { Calculator, DollarSign, Users, Home, School, Heart, AlertCircle, Download, FileText } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-[#6B1F2E] to-[#8B2635] p-8 text-white">
          ...
          <p className="text-white/90">
            Estimate child support payments based on North Carolina guidelines. This calculator provides 
            approximate amounts for informational purposes only.
          </p>
        </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6 mb-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">{results.nonCustodialPercentage.toFixed(1)}%</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 rounded-lg p-6 mb-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">{formatCurrency(results.extraordinaryExpenses)}</span>
                  </div>
                  <div className="border-t pt-3 mt-3">
                    <div className="flex justify-between text-lg">
                      <span className="font-semibold text-gray-900">Total Monthly Payment:</span>
                      <span className="font-bold text-[#6B1F2E]">{formatCurrency(results.totalMonthly)}</span>
                    </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  This calculator provides estimates based on simplified North Carolina child support guidelines. 
                  Actual child support orders are determined by the court and may vary significantly based on 
                  factors not included in this calculator, such as:
                </p>
                ...
                <p className="mt-3 text-sm font-semibold text-gray-900">
                  For accurate calculations specific to your case, please consult with a qualified family law attorney.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gray-100 p-8 text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Our experienced family law attorneys can help you understand your rights and obligations, 
            negotiate fair agreements, and represent you in court if necessary.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/contact"
