...
export async function generateMetadata(): Promise<Metadata> {
  return generateLocalMetadata('cary', 'Workers\' Compensation');
}
export default function CaryWorkersCompensationLawyerPage() {
  const cityData = ncCities['cary'];
  if (!cityData) {
    return <div>City data not found</div>;
  }
  const schemas = {
    localBusiness: generateLocalBusinessSchema('cary', 'Workers\' Compensation'),
    breadcrumbs: {
      ...
      'itemListElement': [
        ...
        },
        {
          ...
          'item': `https://www.vasquezlawnc.com/locations/nc/cary/workers-compensation-lawyer`
        }
      ]
    },
    faqs: {
