...
export async function generateMetadata(): Promise<Metadata> {
  return generateLocalMetadata('cary', 'Immigration Lawyer');
}

export default function CaryImmigrationLawyerPage() {
  ...
  const schemas = {
    localBusiness: generateLocalBusinessSchema('cary', 'Immigration Lawyer'),
    breadcrumbs: {
      ...
      'itemListElement': [
        ...
        },
        {
          ...
          'item': `https://www.vasquezlawnc.com/locations/nc/cary/immigration-lawyer`
        }
      ]
    },
    faqs: {
      ...
      'mainEntity': [
        {
          '@type': 'Question',
          'name': `How much does a immigration lawyer cost in ${cityData.city}, NC?`,
          'acceptedAnswer': {
            '@type': 'Answer',
            'text': `At Vasquez Law Firm, we offer transparent pricing for immigration lawyer services in ${cityData.city}. We provide free consultations and flexible payment plans. Many cases are handled on a contingency basis, meaning you pay nothing unless we win.`
          }
        },
        {
          '@type': 'Question',
          'name': `How long does it take to resolve a immigration case in ${cityData.county} County?`,
          'acceptedAnswer': {
            '@type': 'Answer',
