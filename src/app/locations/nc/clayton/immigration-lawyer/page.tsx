...
export async function generateMetadata(): Promise<Metadata> {
  return generateLocalMetadata('clayton', 'Immigration Lawyer');
}
export default function ClaytonImmigrationLawyerPage() {
  const cityData = ncCities['clayton'];
  if (!cityData) {
    return <div>City data not found</div>;
  }
  const schemas = {
    localBusiness: generateLocalBusinessSchema('clayton', 'Immigration Lawyer'),
    breadcrumbs: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: `https://www.vasquezlawnc.com/locations/nc/clayton/immigration-lawyer`,
        },
      ],
    },
    faqs: {
