...
export async function generateMetadata(): Promise<Metadata> {
  return generateLocalMetadata('clayton', 'Personal Injury Attorney');
}

export default function ClaytonPersonalInjuryAttorneyPage() {
  ...
  const schemas = {
    localBusiness: generateLocalBusinessSchema('clayton', 'Personal Injury Attorney'),
    breadcrumbs: {
      ...
      'itemListElement': [
        ...
        },
        {
          ...
          'item': `https://www.vasquezlawnc.com/locations/nc/clayton/personal-injury-attorney`
        }
      ]
    },
    faqs: {
