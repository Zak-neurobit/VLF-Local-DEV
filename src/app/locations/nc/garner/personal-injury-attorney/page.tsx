...
export async function generateMetadata(): Promise<Metadata> {
  return generateLocalMetadata('garner', 'Personal Injury Attorney');
}
export default function GarnerPersonalInjuryAttorneyPage() {
  const cityData = ncCities['garner'];
  if (!cityData) {
    return <div>City data not found</div>;
  }
  const schemas = {
    localBusiness: generateLocalBusinessSchema('garner', 'Personal Injury Attorney'),
    breadcrumbs: {
      ...
      'itemListElement': [
        ...
        },
        {
          ...
          'item': `https://www.vasquezlawnc.com/locations/nc/garner/personal-injury-attorney`
        }
      ]
    },
    faqs: {
