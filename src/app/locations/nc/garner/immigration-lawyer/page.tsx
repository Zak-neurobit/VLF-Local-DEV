...
export async function generateMetadata(): Promise<Metadata> {
  return generateLocalMetadata('garner', 'Immigration Lawyer');
}
export default function GarnerImmigrationLawyerPage() {
  const cityData = ncCities['garner'];
  if (!cityData) {
    return <div>City data not found</div>;
  }
  const schemas = {
    localBusiness: generateLocalBusinessSchema('garner', 'Immigration Lawyer'),
    breadcrumbs: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: `https://www.vasquezlawnc.com/locations/nc/garner/immigration-lawyer`,
        },
      ],
    },
    faqs: {
