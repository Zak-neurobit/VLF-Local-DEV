      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {Object.entries(ncCities).slice(0, 10).map(([slug, city]) => (
              <div key={slug} className="bg-white rounded-lg shadow-lg p-6 border-t-4 border-[#C9974D]">
                ...
                <div className="space-y-1">
                  ...
                  <div className="grid grid-cols-2 gap-1 text-xs">
                    <Link href={`/locations/nc/${slug}/immigration-lawyer`} className="text-[#C9974D] hover:underline">
                      • Immigration Law
                    </Link>
                    <Link href={`/locations/nc/${slug}/personal-injury-attorney`} className="text-[#C9974D] hover:underline">
                      • Personal Injury
                    </Link>
                    <Link href={`/locations/nc/${slug}/criminal-defense-attorney`} className="text-[#C9974D] hover:underline">
                      • Criminal Defense
                    </Link>
                    <Link href={`/locations/nc/${slug}/workers-compensation-lawyer`} className="text-[#C9974D] hover:underline">
                      • Workers Comp
                    </Link>
                  </div>
                </div>
