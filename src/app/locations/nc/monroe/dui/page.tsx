...
export const metadata: Metadata = {
  title: `Dui - Monroe | Vasquez Law Firm`,
  description: `Dui services in Monroe. Experienced attorneys serving the local community.`,
};

export default function MonroeDuiPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Dui in Monroe</h1>
      <p className="text-lg mb-6">
        Welcome to Vasquez Law Firm's Monroe dui. 
