...
export async function generateMetadata(): Promise<Metadata> {
  return generateLocalMetadata('apex', 'Workers\' Compensation');
}
export default function ApexWorkersCompensationLawyerPage() {
  const cityData = ncCities['apex'];
  if (!cityData) {
    return <div>City data not found</div>;
  }
  const schemas = {
    localBusiness: generateLocalBusinessSchema('apex', 'Workers\' Compensation'),
    breadcrumbs: {
      ...
      'itemListElement': [
        ...
        },
        {
          ...
          'item': `https://www.vasquezlawnc.com/locations/nc/apex/workers-compensation-lawyer`
        }
      ]
    },
    faqs: {
