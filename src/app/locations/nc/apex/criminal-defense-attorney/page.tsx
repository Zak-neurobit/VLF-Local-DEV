...
export async function generateMetadata(): Promise<Metadata> {
  return generateLocalMetadata('apex', 'Criminal Defense Attorney');
}
export default function ApexCriminalDefenseAttorneyPage() {
  const cityData = ncCities['apex'];
  if (!cityData) {
    return <div>City data not found</div>;
  }
  const schemas = {
    localBusiness: generateLocalBusinessSchema('apex', 'Criminal Defense Attorney'),
    breadcrumbs: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: `https://www.vasquezlawnc.com/locations/nc/apex/criminal-defense-attorney`,
        },
      ],
    },
    faqs: {
