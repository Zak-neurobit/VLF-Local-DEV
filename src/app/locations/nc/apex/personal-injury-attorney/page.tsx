...
export async function generateMetadata(): Promise<Metadata> {
  return generateLocalMetadata('apex', 'Personal Injury Attorney');
}
export default function ApexPersonalInjuryAttorneyPage() {
  const cityData = ncCities['apex'];
  if (!cityData) {
    return <div>City data not found</div>;
  }
  const schemas = {
    localBusiness: generateLocalBusinessSchema('apex', 'Personal Injury Attorney'),
    breadcrumbs: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: `https://www.vasquezlawnc.com/locations/nc/apex/personal-injury-attorney`,
        },
      ],
    },
    faqs: {
