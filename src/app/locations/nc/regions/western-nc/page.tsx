...
export const metadata: Metadata = {
  ...
  description: 'Leading law firm serving the Western NC region of NC including Buncombe, Henderson, Haywood counties. 60+ years experience. All practice areas.',
  keywords: 'Western NC NC lawyers, Western NC attorneys, Asheville lawyers, Hendersonville lawyers, Waynesville lawyers, Brevard lawyers, Black Mountain lawyers'
};
export default function WesternNCRegionPage() {
  const counties = ["Buncombe","Henderson","Haywood","Jackson","Transylvania","Madison","Yancey","Mitchell","Avery"];
  const cities = ["Asheville","Hendersonville","Waynesville","Brevard","Black Mountain","Boone","Burnsville"];
  return (
        ...
        <div className="space-y-12">
          <section>
            ...
            <p className="text-xl text-gray-700">
              ...
              From Asheville to Burnsville, 
              we&apos;re the law firm the Western NC trusts.
            </p>
          </section>
          <section>
            <h2 className="text-3xl font-bold mb-6 text-[#6B1F2E]">Counties We Serve in Western NC</h2>
          ...
          <section>
            <h2 className="text-3xl font-bold mb-6 text-[#6B1F2E]">Our Western NC Legal Services</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-xl font-semibold text-[#6B1F2E] mb-3">Immigration Lawyer</h3>
                <p className="text-gray-600 mb-4">Serving all of Western NC with expert immigration lawyer services</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">Serving all of Western NC with expert personal injury attorney services</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">Serving all of Western NC with expert workers&apos; compensation lawyer services</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">Serving all of Western NC with expert criminal defense attorney services</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">Serving all of Western NC with expert car accident lawyer services</p>
          ...
          <section className="bg-[#6B1F2E] text-white p-8 rounded-lg text-center">
            ...
            <p className="text-xl mb-6">
              Serving 9 counties • 7+ cities • Available 24/7
            </p>
