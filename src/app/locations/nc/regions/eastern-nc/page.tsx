...
export const metadata: Metadata = {
  ...
  description:
    'Leading law firm serving the Eastern NC region of NC including New Hanover, Brunswick, Pender counties. 60+ years experience. All practice areas.',
  keywords:
    'Eastern NC NC lawyers, Eastern NC attorneys, Wilmington lawyers, Jacksonville lawyers, Greenville lawyers, New Bern lawyers, Kinston lawyers',
};
        ...
        <div className="space-y-12">
          <section>
            <h1 className="text-4xl md:text-5xl font-bold text-[#6B1F2E] mb-4">
              Eastern NC North Carolina&apos;s Premier Law Firm
            </h1>
            <p className="text-xl text-gray-700">
              Serving all 9 counties in the Eastern NC region with comprehensive legal services.
              From Wilmington to Morehead City, we&apos;re the law firm the Eastern NC trusts.
            </p>
          </section>
          <section>
            <h2 className="text-3xl font-bold mb-6 text-[#6B1F2E]">
              Counties We Serve in Eastern NC
            </h2>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">
                  Serving all of Eastern NC with expert personal injury attorney services
                </p>
                <Link
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">
                  Serving all of Eastern NC with expert workers&apos; compensation lawyer services
                </p>
                <Link
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">
                  Serving all of Eastern NC with expert criminal defense attorney services
                </p>
                <Link
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">
                  Serving all of Eastern NC with expert car accident lawyer services
                </p>
                <Link
