...
export const metadata: Metadata = {
  ...
  description:
    'Leading law firm serving the Piedmont region of NC including Cumberland, Harnett, Lee counties. 60+ years experience. All practice areas.',
  keywords:
    'Piedmont NC lawyers, Piedmont attorneys, Fayetteville lawyers, Sanford lawyers, Laurinburg lawyers, Lumberton lawyers, Southern Pines lawyers',
};
        ...
        <div className="space-y-12">
          <section>
            <h1 className="text-4xl md:text-5xl font-bold text-[#6B1F2E] mb-4">
              Piedmont North Carolina&apos;s Premier Law Firm
            </h1>
            <p className="text-xl text-gray-700">
              Serving all 9 counties in the Piedmont region with comprehensive legal services. From
              Fayetteville to Rockingham, we&apos;re the law firm the Piedmont trusts.
            </p>
          </section>
          <section>
            <h2 className="text-3xl font-bold mb-6 text-[#6B1F2E]">
              Counties We Serve in Piedmont
            </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">
                  Serving all of Piedmont with expert immigration lawyer services
                </p>
                <Link
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">
                  Serving all of Piedmont with expert personal injury attorney services
                </p>
                <Link
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">
                  Serving all of Piedmont with expert workers&apos; compensation lawyer services
                </p>
                <Link
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">
                  Serving all of Piedmont with expert criminal defense attorney services
                </p>
                <Link
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">
                  Serving all of Piedmont with expert car accident lawyer services
                </p>
                <Link
