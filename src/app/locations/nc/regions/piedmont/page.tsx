          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">Serving all of Piedmont with expert personal injury attorney services</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">Serving all of Piedmont with expert criminal defense attorney services</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">Serving all of Piedmont with expert car accident lawyer services</p>
