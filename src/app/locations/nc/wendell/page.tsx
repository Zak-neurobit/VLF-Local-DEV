...
export const metadata: Metadata = {
  ...
  alternates: {
    languages: {
      en: `/locations/nc/wendell`,
      es: `/es/locations/nc/wendell`,
    },
  },
};
const localSchema = localBusinessSchema({
  name: 'Wendell',
  address: 'Serving Wendell',
  city: 'Wendell',
  state: 'NC',
  zip: '27591',
...
const breadcrumbs = breadcrumbSchema([
  ...
  { name: 'Wendell', url: `https://www.vasquezlawnc.com/locations/nc/wendell` },
]);
const faqs = faqSchema([
  {
    question: 'Do you have a physical office in Wendell?',
    answer:
      'While our main offices are in Raleigh, Charlotte, and Smithfield, we regularly meet with clients throughout Wendell and Wake County. We offer virtual consultations and can arrange meetings at convenient locations.',
  },
  {
  ...
  {
    question: 'How much do immigration lawyers charge in Wendell?',
    answer:
      'We offer transparent flat fees for most immigration cases and free consultations. Payment plans are available to make quality legal representation affordable for Wendell residents.',
  },
  {
    question: 'Can you help with criminal cases in Wendell?',
    answer:
...
export default function WendellNCPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                Wendell Immigration & Criminal Defense Lawyers
              </h1>
              <p className="text-xl mb-8 max-w-3xl mx-auto">
                Serving Wendell, Wake County, and the Triangle area with experienced legal
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-[#6B1F2E] text-center mb-12">
              Legal Services for Wendell Residents
            </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-bold text-[#6B1F2E] mb-6">
                  Why Wendell Residents Choose Vasquez Law Firm
                </h2>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Full legal services in English and Spanish for Wendell's diverse community
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Payment plans and transparent pricing to serve all Wendell residents
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  ...
                  <h4 className="font-bold text-[#6B1F2E] mb-3 mt-6">
                    Common Legal Issues in Wendell
                  </h4>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-[#6B1F2E] text-center mb-12">
              What Wendell Clients Say About Us
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <p className="font-semibold text-[#6B1F2E]">- Maria G., Wendell</p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-6">
                <div className="text-yellow-400 text-xl mb-3">★★★★★</div>
                <p className="text-gray-700 mb-4">
                ...
                <p className="font-semibold text-[#6B1F2E]">- James T., Wendell</p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-6">
                <div className="text-yellow-400 text-xl mb-3">★★★★★</div>
                <p className="text-gray-700 mb-4">
                ...
                <p className="font-semibold text-[#6B1F2E]">- Sarah L., Wendell</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-[#6B1F2E] text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl font-bold mb-6">Get Legal Help in Wendell Today</h2>
            ...
            <p className="mt-8 text-sm">Serving Wendell, Wake County, and all of Triangle</p>
          </div>
        </section>
      </div>
    </>
