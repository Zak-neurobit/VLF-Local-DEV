...
export const metadata: Metadata = {
  title: 'Best Criminal Defense Attorney in Raleigh, NC | 60+ Years Experience | Free Consultation',
  description: 'Top-rated criminal defense attorney serving Raleigh and Wake County. 60+ years combined experience. Available 24/7. Free consultation. Se habla español. Call 1-844-YO-PELEO.',
  keywords: 'Criminal Defense Attorney Raleigh NC, criminal lawyer Raleigh, DWI attorney Raleigh, drug crime lawyer Raleigh, assault defense attorney Raleigh, Criminal Defense Attorney near Cary, Criminal Defense Attorney near Apex, Criminal Defense Attorney near Garner, Criminal Defense Attorney near Knightdale, Criminal Defense Attorney near Wake Forest',
  openGraph: {
    title: '#1 Criminal Defense Attorney in Raleigh, North Carolina | Vasquez Law Firm',
    description: 'Leading criminal defense attorney in Raleigh. Serving all of Wake County with 60+ years experience. Free consultation. No fees unless we win (PI/WC cases).',
    url: `https://www.vasquezlawfirm.com/locations/nc/raleigh/criminal-defense-attorney`,
    images: [{
  ...
  alternates: {
    canonical: `https://www.vasquezlawfirm.com/locations/nc/raleigh/criminal-defense-attorney`,
    languages: {
      'en-US': `https://www.vasquezlawfirm.com/locations/nc/raleigh/criminal-defense-attorney`,
      'es-ES': `https://www.vasquezlawfirm.com/es/ubicaciones/nc/raleigh/criminal-defense-attorney`
    }
  }
};
export default function RaleighCriminalDefenseAttorneyPage() {
  return (
    <>
          ...
          <div className="space-y-12">
            ...
            <section>
              <h1 className="text-4xl md:text-5xl font-bold text-[#6B1F2E] mb-4">
                Raleigh's Top Criminal Defense Attorney - 60+ Years Winning Cases
              </h1>
              <p className="text-xl text-gray-700">
                When you need the best criminal defense attorney in Raleigh, Wake County, North Carolina, 
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-[#6B1F2E]">
                Criminal Defense Attorney Services in Raleigh
              </h2>
              <p className="text-lg mb-4">
                Our Raleigh criminal defense attorneys handle all types of cases throughout Wake County:
              </p>
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="mt-4 text-gray-600">
                  Our criminal defense attorneys regularly appear in Wake County courts and know the local procedures inside and out.
                </p>
              </div>
            </section>
            {/* CTA Section */}
            <section className="bg-[#6B1F2E] text-white p-8 rounded-lg text-center">
              <h2 className="text-3xl font-bold mb-4">
                Need a Criminal Defense Attorney in Raleigh? Get Help Now!
              </h2>
      ...
      <Script
        id="raleigh-criminal-defense-attorney-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            '@type': 'Attorney',
            name: `Vasquez Law Firm - Raleigh Criminal Defense Attorney`,
            description: `Leading criminal defense attorney serving Raleigh and Wake County, North Carolina`,
            url: `https://www.vasquezlawfirm.com/locations/nc/raleigh/criminal-defense-attorney`,
      ...
      <Script
        id="raleigh-criminal-defense-attorney-faq"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            ...
            mainEntity: [
              {
                '@type': 'Question',
                name: `How much does a criminal defense attorney cost in Raleigh, NC?`,
                acceptedAnswer: {
                  '@type': 'Answer',
