...
export const metadata: Metadata = {
  ...
  description: 'Top-rated car accident lawyer serving Raleigh and Wake County. 60+ years combined experience. Available 24/7. Free consultation. Se habla español. Call 1-844-YO-PELEO.',
  keywords: 'Car Accident Lawyer Raleigh NC, auto accident attorney Raleigh, vehicle accident lawyer Raleigh, crash attorney Raleigh, Car Accident Lawyer near Cary, Car Accident Lawyer near Apex, Car Accident Lawyer near Garner, Car Accident Lawyer near Knightdale, Car Accident Lawyer near Wake Forest',
  openGraph: {
    title: '#1 Car Accident Lawyer in Raleigh, North Carolina | Vasquez Law Firm',
    description: 'Leading car accident lawyer in Raleigh. Serving all of Wake County with 60+ years experience. Free consultation. No fees unless we win (PI/WC cases).',
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="mt-4 text-gray-600">
                  Our car accident lawyers regularly appear in Wake County courts and know the local procedures inside and out.
                </p>
              </div>
            </section>
            {/* CTA Section */}
