...
export default function RockyMountWorkersCompensationPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Workers Compensation in Rocky Mount</h1>
      <p className="text-lg mb-6">
        Welcome to Vasquez Law Firm's Rocky Mount workers compensation. 
