...
export const metadata: Metadata = {
  title: `Dui - Wilson | Vasquez Law Firm`,
  description: `Dui services in Wilson. Experienced attorneys serving the local community.`,
};

export default function WilsonDuiPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Dui in Wilson</h1>
      <p className="text-lg mb-6">
        Welcome to Vasquez Law Firm's Wilson dui. 
