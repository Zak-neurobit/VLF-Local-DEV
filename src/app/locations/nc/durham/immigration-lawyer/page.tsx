...
export const metadata: Metadata = {
  title: 'Best Immigration Lawyer in Durham, NC | 60+ Years Experience | Free Consultation',
  description: 'Top-rated immigration lawyer serving Durham and Durham County. 60+ years combined experience. Available 24/7. Free consultation. Se habla español. Call 1-844-YO-PELEO.',
  keywords: 'Immigration Lawyer Durham NC, immigration attorney Durham, visa lawyer Durham, deportation defense Durham, green card lawyer Durham, Immigration Lawyer near Chapel Hill, Immigration Lawyer near Morrisville, Immigration Lawyer near Research Triangle Park, Immigration Lawyer near Hillsborough',
  openGraph: {
    title: '#1 Immigration Lawyer in Durham, North Carolina | Vasquez Law Firm',
    description: 'Leading immigration lawyer in Durham. Serving all of Durham County with 60+ years experience. Free consultation. No fees unless we win (PI/WC cases).',
    url: `https://www.vasquezlawfirm.com/locations/nc/durham/immigration-lawyer`,
    images: [{
  ...
  alternates: {
    canonical: `https://www.vasquezlawfirm.com/locations/nc/durham/immigration-lawyer`,
    languages: {
      'en-US': `https://www.vasquezlawfirm.com/locations/nc/durham/immigration-lawyer`,
      'es-ES': `https://www.vasquezlawfirm.com/es/ubicaciones/nc/durham/immigration-lawyer`
    }
  }
};

export default function DurhamImmigrationLawyerPage() {
  return (
    <>
          ...
          <div className="space-y-12">
            ...
            <section>
              <h1 className="text-4xl md:text-5xl font-bold text-[#6B1F2E] mb-4">
                Durham's Top Immigration Lawyer - 60+ Years Winning Cases
              </h1>
              <p className="text-xl text-gray-700">
                When you need the best immigration lawyer in Durham, Durham County, North Carolina, 
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-[#6B1F2E]">
                Immigration Lawyer Services in Durham
              </h2>
              <p className="text-lg mb-4">
                Our Durham immigration lawyers handle all types of cases throughout Durham County:
              </p>
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="mt-4 text-gray-600">
                  Our immigration lawyers regularly appear in Durham County courts and know the local procedures inside and out.
                </p>
              </div>
            </section>
            ...
            <section className="bg-[#6B1F2E] text-white p-8 rounded-lg text-center">
              <h2 className="text-3xl font-bold mb-4">
                Need a Immigration Lawyer in Durham? Get Help Now!
              </h2>
      ...
      <Script
        id="durham-immigration-lawyer-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            '@type': 'Attorney',
            name: `Vasquez Law Firm - Durham Immigration Lawyer`,
            description: `Leading immigration lawyer serving Durham and Durham County, North Carolina`,
            url: `https://www.vasquezlawfirm.com/locations/nc/durham/immigration-lawyer`,
      ...
      <Script
        id="durham-immigration-lawyer-faq"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            ...
            mainEntity: [
              {
                '@type': 'Question',
                name: `How much does a immigration lawyer cost in Durham, NC?`,
                acceptedAnswer: {
                  '@type': 'Answer',
