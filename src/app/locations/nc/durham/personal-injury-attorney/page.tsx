...
export const metadata: Metadata = {
  title: 'Best Personal Injury Attorney in Durham, NC | 60+ Years Experience | Free Consultation',
  description: 'Top-rated personal injury attorney serving Durham and Durham County. 60+ years combined experience. Available 24/7. Free consultation. Se habla español. Call 1-844-YO-PELEO.',
  keywords: 'Personal Injury Attorney Durham NC, accident lawyer Durham, injury attorney Durham, car accident lawyer Durham, slip and fall attorney Durham, Personal Injury Attorney near Chapel Hill, Personal Injury Attorney near Morrisville, Personal Injury Attorney near Research Triangle Park, Personal Injury Attorney near Hillsborough',
  openGraph: {
    title: '#1 Personal Injury Attorney in Durham, North Carolina | Vasquez Law Firm',
    description: 'Leading personal injury attorney in Durham. Serving all of Durham County with 60+ years experience. Free consultation. No fees unless we win (PI/WC cases).',
    url: `https://www.vasquezlawfirm.com/locations/nc/durham/personal-injury-attorney`,
    images: [{
  ...
  alternates: {
    canonical: `https://www.vasquezlawfirm.com/locations/nc/durham/personal-injury-attorney`,
    languages: {
      'en-US': `https://www.vasquezlawfirm.com/locations/nc/durham/personal-injury-attorney`,
      'es-ES': `https://www.vasquezlawfirm.com/es/ubicaciones/nc/durham/personal-injury-attorney`
    }
  }
};
export default function DurhamPersonalInjuryAttorneyPage() {
  return (
    <>
          ...
          <div className="space-y-12">
            ...
            <section>
              <h1 className="text-4xl md:text-5xl font-bold text-[#6B1F2E] mb-4">
                Durham&apos;s Top Personal Injury Attorney - 60+ Years Winning Cases
              </h1>
              <p className="text-xl text-gray-700">
                When you need the best personal injury attorney in Durham, Durham County, North Carolina, 
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-[#6B1F2E]">
                Personal Injury Attorney Services in Durham
              </h2>
              <p className="text-lg mb-4">
                Our Durham personal injury attorneys handle all types of cases throughout Durham County:
              </p>
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="mt-4 text-gray-600">
                  Our personal injury attorneys regularly appear in Durham County courts and know the local procedures inside and out.
                </p>
              </div>
            </section>
            {/* CTA Section */}
            <section className="bg-[#6B1F2E] text-white p-8 rounded-lg text-center">
              <h2 className="text-3xl font-bold mb-4">
                Need a Personal Injury Attorney in Durham? Get Help Now!
              </h2>
      ...
      <Script
        id="durham-personal-injury-attorney-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            '@type': 'Attorney',
            name: `Vasquez Law Firm - Durham Personal Injury Attorney`,
            description: `Leading personal injury attorney serving Durham and Durham County, North Carolina`,
            url: `https://www.vasquezlawfirm.com/locations/nc/durham/personal-injury-attorney`,
      ...
      <Script
        id="durham-personal-injury-attorney-faq"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            ...
            mainEntity: [
              {
                '@type': 'Question',
                name: `How much does a personal injury attorney cost in Durham, NC?`,
                acceptedAnswer: {
                  '@type': 'Answer',
