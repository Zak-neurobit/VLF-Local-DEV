...
export const metadata: Metadata = {
  ...
  description: 'Top-rated car accident lawyer serving Durham and Durham County. 60+ years combined experience. Available 24/7. Free consultation. Se habla español. Call 1-844-YO-PELEO.',
  keywords: 'Car Accident Lawyer Durham NC, auto accident attorney Durham, vehicle accident lawyer Durham, crash attorney Durham, Car Accident Lawyer near Chapel Hill, Car Accident Lawyer near Morrisville, Car Accident Lawyer near Research Triangle Park, Car Accident Lawyer near Hillsborough',
  openGraph: {
    title: '#1 Car Accident Lawyer in Durham, North Carolina | Vasquez Law Firm',
    description: 'Leading car accident lawyer in Durham. Serving all of Durham County with 60+ years experience. Free consultation. No fees unless we win (PI/WC cases).',
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="mt-4 text-gray-600">
                  Our car accident lawyers regularly appear in Durham County courts and know the local procedures inside and out.
                </p>
              </div>
            </section>
