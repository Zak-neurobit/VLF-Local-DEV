...
export async function generateMetadata(): Promise<Metadata> {
  return generateLocalMetadata('smithfield', 'Personal Injury Attorney');
}
export default function SmithfieldPersonalInjuryAttorneyPage() {
  const cityData = ncCities['smithfield'];
  if (!cityData) {
    return <div>City data not found</div>;
  }
  const schemas = {
    localBusiness: generateLocalBusinessSchema('smithfield', 'Personal Injury Attorney'),
    breadcrumbs: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: `https://www.vasquezlawnc.com/locations/nc/smithfield/personal-injury-attorney`,
        },
      ],
    },
    faqs: {
