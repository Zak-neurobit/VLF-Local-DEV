...
export async function generateMetadata(): Promise<Metadata> {
  return generateLocalMetadata('smithfield', 'Immigration Lawyer');
}

export default function SmithfieldImmigrationLawyerPage() {
  ...
  const schemas = {
    localBusiness: generateLocalBusinessSchema('smithfield', 'Immigration Lawyer'),
    breadcrumbs: {
      ...
      'itemListElement': [
        ...
        },
        {
          ...
          'item': `https://www.vasquezlawnc.com/locations/nc/smithfield/immigration-lawyer`
        }
      ]
    },
    faqs: {
