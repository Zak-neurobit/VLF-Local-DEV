...
export const metadata: Metadata = {
  title: 'Best Criminal Defense Attorney in Charlotte, NC | 60+ Years Experience | Free Consultation',
  description: 'Top-rated criminal defense attorney serving Charlotte and Mecklenburg County. 60+ years combined experience. Available 24/7. Free consultation. Se habla español. Call 1-844-YO-PELEO.',
  keywords: 'Criminal Defense Attorney Charlotte NC, criminal lawyer Charlotte, DWI attorney Charlotte, drug crime lawyer Charlotte, assault defense attorney Charlotte, Criminal Defense Attorney near Concord, Criminal Defense Attorney near Gastonia, Criminal Defense Attorney near Rock Hill, Criminal Defense Attorney near Matthews, Criminal Defense Attorney near Huntersville',
  openGraph: {
    title: '#1 Criminal Defense Attorney in Charlotte, North Carolina | Vasquez Law Firm',
    description: 'Leading criminal defense attorney in Charlotte. Serving all of Mecklenburg County with 60+ years experience. Free consultation. No fees unless we win (PI/WC cases).',
    url: `https://www.vasquezlawfirm.com/locations/nc/charlotte/criminal-defense-attorney`,
    images: [{
  ...
  alternates: {
    canonical: `https://www.vasquezlawfirm.com/locations/nc/charlotte/criminal-defense-attorney`,
    languages: {
      'en-US': `https://www.vasquezlawfirm.com/locations/nc/charlotte/criminal-defense-attorney`,
      'es-ES': `https://www.vasquezlawfirm.com/es/ubicaciones/nc/charlotte/criminal-defense-attorney`
    }
  }
};
export default function CharlotteCriminalDefenseAttorneyPage() {
  return (
    <>
          ...
          <div className="space-y-12">
            ...
            <section>
              <h1 className="text-4xl md:text-5xl font-bold text-[#6B1F2E] mb-4">
                Charlotte&apos;s Top Criminal Defense Attorney - 60+ Years Winning Cases
              </h1>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-[#6B1F2E]">
                Criminal Defense Attorney Services in Charlotte
              </h2>
              <p className="text-lg mb-4">
                Our Charlotte criminal defense attorneys handle all types of cases throughout Mecklenburg County:
              </p>
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="mt-4 text-gray-600">
                  Our criminal defense attorneys regularly appear in Mecklenburg County courts and know the local procedures inside and out.
                </p>
              </div>
            </section>
            {/* CTA Section */}
            <section className="bg-[#6B1F2E] text-white p-8 rounded-lg text-center">
              <h2 className="text-3xl font-bold mb-4">
                Need a Criminal Defense Attorney in Charlotte? Get Help Now!
              </h2>
      ...
      <Script
        id="charlotte-criminal-defense-attorney-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            '@type': 'Attorney',
            name: `Vasquez Law Firm - Charlotte Criminal Defense Attorney`,
            description: `Leading criminal defense attorney serving Charlotte and Mecklenburg County, North Carolina`,
            url: `https://www.vasquezlawfirm.com/locations/nc/charlotte/criminal-defense-attorney`,
      ...
      <Script
        id="charlotte-criminal-defense-attorney-faq"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            ...
            mainEntity: [
              {
                '@type': 'Question',
                name: `How much does a criminal defense attorney cost in Charlotte, NC?`,
                acceptedAnswer: {
                  '@type': 'Answer',
