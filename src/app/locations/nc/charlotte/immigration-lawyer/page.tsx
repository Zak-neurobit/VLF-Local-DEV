...
export const metadata: Metadata = {
  title: 'Best Immigration Lawyer in Charlotte, NC | 60+ Years Experience | Free Consultation',
  description: 'Top-rated immigration lawyer serving Charlotte and Mecklenburg County. 60+ years combined experience. Available 24/7. Free consultation. Se habla español. Call 1-844-YO-PELEO.',
  keywords: 'Immigration Lawyer Charlotte NC, immigration attorney Charlotte, visa lawyer Charlotte, deportation defense Charlotte, green card lawyer Charlotte, Immigration Lawyer near Concord, Immigration Lawyer near Gastonia, Immigration Lawyer near Rock Hill, Immigration Lawyer near Matthews, Immigration Lawyer near Huntersville',
  openGraph: {
    title: '#1 Immigration Lawyer in Charlotte, North Carolina | Vasquez Law Firm',
    description: 'Leading immigration lawyer in Charlotte. Serving all of Mecklenburg County with 60+ years experience. Free consultation. No fees unless we win (PI/WC cases).',
    url: `https://www.vasquezlawfirm.com/locations/nc/charlotte/immigration-lawyer`,
    images: [{
  ...
  alternates: {
    canonical: `https://www.vasquezlawfirm.com/locations/nc/charlotte/immigration-lawyer`,
    languages: {
      'en-US': `https://www.vasquezlawfirm.com/locations/nc/charlotte/immigration-lawyer`,
      'es-ES': `https://www.vasquezlawfirm.com/es/ubicaciones/nc/charlotte/immigration-lawyer`
    }
  }
};

export default function CharlotteImmigrationLawyerPage() {
  return (
    <>
      <LocationPageTemplate
        ...
        content={
          <div className="space-y-12">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-[#6B1F2E]">
                Immigration Lawyer Services in Charlotte
              </h2>
              <p className="text-lg mb-4">
                Our Charlotte immigration lawyers handle all types of cases throughout Mecklenburg County:
              </p>
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="mt-4 text-gray-600">
                  Our immigration lawyers regularly appear in Mecklenburg County courts and know the local procedures inside and out.
                </p>
              </div>
            </section>
            ...
            <section className="bg-[#6B1F2E] text-white p-8 rounded-lg text-center">
              <h2 className="text-3xl font-bold mb-4">
                Need a Immigration Lawyer in Charlotte? Get Help Now!
              </h2>
      ...
      <Script
        id="charlotte-immigration-lawyer-schema"
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: `Leading immigration lawyer serving Charlotte and Mecklenburg County, North Carolina`,
            url: `https://www.vasquezlawfirm.com/locations/nc/charlotte/immigration-lawyer`,
      ...
      <Script
        id="charlotte-immigration-lawyer-faq"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            ...
            mainEntity: [
              {
                '@type': 'Question',
                name: `How much does a immigration lawyer cost in Charlotte, NC?`,
                acceptedAnswer: {
                  '@type': 'Answer',
