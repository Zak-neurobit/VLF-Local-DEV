...
export const metadata: Metadata = {
  title: 'Best Workers\' Compensation Lawyer in Charlotte, NC | 60+ Years Experience | Free Consultation',
  description: 'Top-rated workers\' compensation lawyer serving Charlotte and Mecklenburg County. 60+ years combined experience. Available 24/7. Free consultation. Se habla español. Call 1-844-YO-PELEO.',
  keywords: 'Workers\' Compensation Lawyer Charlotte NC, work injury lawyer Charlotte, workers comp attorney Charlotte, workplace accident lawyer Charlotte, Workers\' Compensation Lawyer near Concord, Workers\' Compensation Lawyer near Gastonia, Workers\' Compensation Lawyer near Rock Hill, Workers\' Compensation Lawyer near Matthews, Workers\' Compensation Lawyer near Huntersville',
  openGraph: {
    title: '#1 Workers\' Compensation Lawyer in Charlotte, North Carolina | Vasquez Law Firm',
    description: 'Leading workers\' compensation lawyer in Charlotte. Serving all of Mecklenburg County with 60+ years experience. Free consultation. No fees unless we win (PI/WC cases).',
  ...
  alternates: {
    canonical: `https://www.vasquezlawfirm.com/locations/nc/charlotte/workers-compensation-lawyer`,
    languages: {
      'en-US': `https://www.vasquezlawfirm.com/locations/nc/charlotte/workers-compensation-lawyer`,
      'es-ES': `https://www.vasquezlawfirm.com/es/ubicaciones/nc/charlotte/workers-compensation-lawyer`
    }
  }
};
export default function CharlotteWorkersCompensationLawyerPage() {
  return (
    <>
      ...
      <Script
        id="charlotte-workers-compensation-lawyer-schema"
      ...
      <Script
        id="charlotte-workers-compensation-lawyer-faq"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
