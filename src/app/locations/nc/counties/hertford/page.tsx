...
export const metadata: Metadata = {
  ...
  description: 'Top-rated attorneys serving Hertford County, North Carolina. Immigration, personal injury, workers comp, criminal defense. 60+ years experience. Free consultation.',
  keywords: 'Hertford County lawyers, Hertford County attorneys, Hertford County law firm, abogados Hertford County NC',
  openGraph: {
    title: '#1 Law Firm in Hertford County, North Carolina | Vasquez Law',
    description: 'Leading law firm serving all of Hertford County with 60+ years combined experience. Free consultation. Se habla español.',
...
export default function HertfordCountyPage() {
  ...
  const region = Object.entries(regionData).find(([_, data]) => 
    data.counties.includes(&apos;Hertford&apos;)
  )?.[0] || &apos;North Carolina&apos;;
  return (
    <>
          ...
          <div className="space-y-12">
            <section>
              ...
              <p className="text-xl text-gray-700">
                When legal issues arise in Hertford County, North Carolina residents trust Vasquez Law Firm. 
