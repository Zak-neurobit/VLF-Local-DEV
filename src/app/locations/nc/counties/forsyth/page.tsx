...
export const metadata: Metadata = {
  title: 'Best Lawyers in Forsyth County, NC | All Legal Services | Vasquez Law Firm',
  description: 'Top-rated attorneys serving Forsyth County, North Carolina. Immigration, personal injury, workers comp, criminal defense. 60+ years experience. Free consultation.',
  keywords: 'Forsyth County lawyers, Forsyth County attorneys, Forsyth County law firm, abogados Forsyth County NC',
  openGraph: {
    title: '#1 Law Firm in Forsyth County, North Carolina | Vasquez Law',
    description: 'Leading law firm serving all of Forsyth County with 60+ years combined experience. Free consultation. Se habla español.',
    url: `https://www.vasquezlawfirm.com/locations/nc/counties/forsyth`
  }
};
export default function ForsythCountyPage() {
  ...
  const region = Object.entries(regionData).find(([_, data]) => 
    data.counties.includes('Forsyth')
  )?.[0] || 'North Carolina';
  return (
    <>
          ...
          <div className="space-y-12">
            <section>
              <h1 className="text-4xl md:text-5xl font-bold text-[#6B1F2E] mb-4">
                Forsyth County's Trusted Law Firm - 60+ Years of Excellence
              </h1>
              <p className="text-xl text-gray-700">
                When legal issues arise in Forsyth County, North Carolina residents trust Vasquez Law Firm. 
            ...
            <section className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert immigration lawyer services for Forsyth County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert personal injury attorney services for Forsyth County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert workers' compensation lawyer services for Forsyth County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert criminal defense attorney services for Forsyth County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert car accident lawyer services for Forsyth County residents</p>
            ...
            <section className="bg-[#6B1F2E] text-white p-8 rounded-lg">
              <h2 className="text-3xl font-bold mb-4">Why Forsyth County Chooses Vasquez Law</h2>
            ...
            <section className="text-center bg-gray-50 p-8 rounded-lg">
              <h2 className="text-3xl font-bold mb-4 text-[#6B1F2E]">
                Get Help Now - Serving All of Forsyth County
              </h2>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LegalService',
            name: `Vasquez Law Firm - Forsyth County`,
            description: `Comprehensive legal services for Forsyth County, North Carolina residents`,
            areaServed: {
