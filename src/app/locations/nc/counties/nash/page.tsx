...
export const metadata: Metadata = {
  ...
  description: 'Top-rated attorneys serving Nash County, North Carolina. Immigration, personal injury, workers comp, criminal defense. 60+ years experience. Free consultation.',
  keywords: 'Nash County lawyers, Nash County attorneys, Nash County law firm, abogados Nash County NC',
  openGraph: {
    title: '#1 Law Firm in Nash County, North Carolina | Vasquez Law',
    description: 'Leading law firm serving all of Nash County with 60+ years combined experience. Free consultation. Se habla español.',
          ...
          <div className="space-y-12">
            ...
            <section className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert immigration lawyer services for Nash County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert personal injury attorney services for Nash County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert criminal defense attorney services for Nash County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert car accident lawyer services for Nash County residents</p>
