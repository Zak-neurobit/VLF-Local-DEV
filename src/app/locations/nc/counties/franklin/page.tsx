...
export const metadata: Metadata = {
  title: 'Best Lawyers in Franklin County, NC | All Legal Services | Vasquez Law Firm',
  description: 'Top-rated attorneys serving Franklin County, North Carolina. Immigration, personal injury, workers comp, criminal defense. 60+ years experience. Free consultation.',
  keywords: 'Franklin County lawyers, Franklin County attorneys, Franklin County law firm, abogados Franklin County NC',
  openGraph: {
    title: '#1 Law Firm in Franklin County, North Carolina | Vasquez Law',
    description: 'Leading law firm serving all of Franklin County with 60+ years combined experience. Free consultation. Se habla español.',
    url: `https://www.vasquezlawfirm.com/locations/nc/counties/franklin`
  }
};
export default function FranklinCountyPage() {
  ...
  const region = Object.entries(regionData).find(([_, data]) => 
    data.counties.includes('Franklin')
  )?.[0] || 'North Carolina';
  return (
    <>
          ...
          <div className="space-y-12">
            <section>
              <h1 className="text-4xl md:text-5xl font-bold text-[#6B1F2E] mb-4">
                Franklin County&apos;s Trusted Law Firm - 60+ Years of Excellence
              </h1>
              <p className="text-xl text-gray-700">
                When legal issues arise in Franklin County, North Carolina residents trust Vasquez Law Firm. 
            ...
            <section className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert immigration lawyer services for Franklin County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert personal injury attorney services for Franklin County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert workers&apos; compensation lawyer services for Franklin County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert criminal defense attorney services for Franklin County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert car accident lawyer services for Franklin County residents</p>
            ...
            <section className="bg-[#6B1F2E] text-white p-8 rounded-lg">
              <h2 className="text-3xl font-bold mb-4">Why Franklin County Chooses Vasquez Law</h2>
            ...
            <section className="text-center bg-gray-50 p-8 rounded-lg">
              <h2 className="text-3xl font-bold mb-4 text-[#6B1F2E]">
                Get Help Now - Serving All of Franklin County
              </h2>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LegalService',
            name: `Vasquez Law Firm - Franklin County`,
            description: `Comprehensive legal services for Franklin County, North Carolina residents`,
            areaServed: {
