...
export const metadata: Metadata = {
  title: 'Best Lawyers in Columbus County, NC | All Legal Services | Vasquez Law Firm',
  description: 'Top-rated attorneys serving Columbus County, North Carolina. Immigration, personal injury, workers comp, criminal defense. 60+ years experience. Free consultation.',
  keywords: 'Columbus County lawyers, Columbus County attorneys, Columbus County law firm, abogados Columbus County NC',
  openGraph: {
    title: '#1 Law Firm in Columbus County, North Carolina | Vasquez Law',
    description: 'Leading law firm serving all of Columbus County with 60+ years combined experience. Free consultation. Se habla español.',
    url: `https://www.vasquezlawfirm.com/locations/nc/counties/columbus`
  }
};
export default function ColumbusCountyPage() {
  ...
  const region = Object.entries(regionData).find(([_, data]) => 
    data.counties.includes('Columbus')
  )?.[0] || 'North Carolina';
  return (
    <>
          ...
          <div className="space-y-12">
            <section>
              <h1 className="text-4xl md:text-5xl font-bold text-[#6B1F2E] mb-4">
                Columbus County's Trusted Law Firm - 60+ Years of Excellence
              </h1>
              <p className="text-xl text-gray-700">
                When legal issues arise in Columbus County, North Carolina residents trust Vasquez Law Firm. 
            ...
            <section className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert immigration lawyer services for Columbus County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert personal injury attorney services for Columbus County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert workers' compensation lawyer services for Columbus County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert criminal defense attorney services for Columbus County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert car accident lawyer services for Columbus County residents</p>
            ...
            <section className="bg-[#6B1F2E] text-white p-8 rounded-lg">
              <h2 className="text-3xl font-bold mb-4">Why Columbus County Chooses Vasquez Law</h2>
            ...
            <section className="text-center bg-gray-50 p-8 rounded-lg">
              <h2 className="text-3xl font-bold mb-4 text-[#6B1F2E]">
                Get Help Now - Serving All of Columbus County
              </h2>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LegalService',
            name: `Vasquez Law Firm - Columbus County`,
            description: `Comprehensive legal services for Columbus County, North Carolina residents`,
            areaServed: {
