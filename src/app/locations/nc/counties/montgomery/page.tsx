...
export const metadata: Metadata = {
  ...
  description: 'Top-rated attorneys serving Montgomery County, North Carolina. Immigration, personal injury, workers comp, criminal defense. 60+ years experience. Free consultation.',
  keywords: 'Montgomery County lawyers, Montgomery County attorneys, Montgomery County law firm, abogados Montgomery County NC',
  openGraph: {
    title: '#1 Law Firm in Montgomery County, North Carolina | Vasquez Law',
    description: 'Leading law firm serving all of Montgomery County with 60+ years combined experience. Free consultation. Se habla español.',
...
export default function MontgomeryCountyPage() {
  ...
  const region = Object.entries(regionData).find(([_, data]) => 
    data.counties.includes('Montgomery')
  )?.[0] || 'North Carolina';
  return (
    <>
          ...
          <div className="space-y-12">
            <section>
              ...
              <p className="text-xl text-gray-700">
                When legal issues arise in Montgomery County, North Carolina residents trust Vasquez Law Firm. 
