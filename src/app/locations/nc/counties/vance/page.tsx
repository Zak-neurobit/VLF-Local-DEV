...
export const metadata: Metadata = {
  ...
  description:
    'Top-rated attorneys serving Vance County, North Carolina. Immigration, personal injury, workers comp, criminal defense. 60+ years experience. Free consultation.',
  keywords:
    'Vance County lawyers, Vance County attorneys, Vance County law firm, abogados Vance County NC',
  openGraph: {
    title: '#1 Law Firm in Vance County, North Carolina | Vasquez Law',
    description:
      'Leading law firm serving all of Vance County with 60+ years combined experience. Free consultation. Se habla español.',
...
export default function VanceCountyPage() {
  ...
  const region =
    Object.entries(regionData).find(([_, data]) => data.counties.includes('Vance'))?.[0] ||
    'North Carolina';
  return (
    <>
          ...
          <div className="space-y-12">
            <section>
              <h1 className="text-4xl md:text-5xl font-bold text-[#6B1F2E] mb-4">
                Vance County&apos;s Trusted Law Firm - 60+ Years of Excellence
              </h1>
              <p className="text-xl text-gray-700">
                When legal issues arise in Vance County, North Carolina residents trust Vasquez Law
            ...
            <section className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">
                  Expert immigration lawyer services for Vance County residents
                </p>
                <Link
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">
                  Expert personal injury attorney services for Vance County residents
                </p>
                <Link
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">
                  Expert workers&apos; compensation lawyer services for Vance County residents
                </p>
                <Link
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">
                  Expert criminal defense attorney services for Vance County residents
                </p>
                <Link
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">
                  Expert car accident lawyer services for Vance County residents
                </p>
                <Link
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LegalService',
            name: `Vasquez Law Firm - Vance County`,
            description: `Comprehensive legal services for Vance County, North Carolina residents`,
            areaServed: {
