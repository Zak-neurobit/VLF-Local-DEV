...
export const metadata: Metadata = {
  ...
  keywords: 'Vance County lawyers, Vance County attorneys, Vance County law firm, abogados Vance County NC',
  openGraph: {
    title: '#1 Law Firm in Vance County, North Carolina | Vasquez Law',
    description: 'Leading law firm serving all of Vance County with 60+ years combined experience. Free consultation. Se habla español.',
          ...
          <div className="space-y-12">
            <section>
              ...
              <p className="text-xl text-gray-700">
                When legal issues arise in Vance County, North Carolina residents trust Vasquez Law Firm. 
            ...
            <section className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert personal injury attorney services for Vance County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert workers' compensation lawyer services for Vance County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert criminal defense attorney services for Vance County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert car accident lawyer services for Vance County residents</p>
