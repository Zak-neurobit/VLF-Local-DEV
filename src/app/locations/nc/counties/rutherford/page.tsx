...
export const metadata: Metadata = {
  title: 'Best Lawyers in Rutherford County, NC | All Legal Services | Vasquez Law Firm',
  description: 'Top-rated attorneys serving Rutherford County, North Carolina. Immigration, personal injury, workers comp, criminal defense. 60+ years experience. Free consultation.',
  keywords: 'Rutherford County lawyers, Rutherford County attorneys, Rutherford County law firm, abogados Rutherford County NC',
  openGraph: {
    title: '#1 Law Firm in Rutherford County, North Carolina | Vasquez Law',
    description: 'Leading law firm serving all of Rutherford County with 60+ years combined experience. Free consultation. Se habla español.',
    url: `https://www.vasquezlawfirm.com/locations/nc/counties/rutherford`
  }
};
export default function RutherfordCountyPage() {
  ...
  const region = Object.entries(regionData).find(([_, data]) => 
    data.counties.includes('Rutherford')
  )?.[0] || 'North Carolina';
  return (
    <>
          ...
          <div className="space-y-12">
            <section>
              <h1 className="text-4xl md:text-5xl font-bold text-[#6B1F2E] mb-4">
                Rutherford County's Trusted Law Firm - 60+ Years of Excellence
              </h1>
              <p className="text-xl text-gray-700">
                When legal issues arise in Rutherford County, North Carolina residents trust Vasquez Law Firm. 
            ...
            <section className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert immigration lawyer services for Rutherford County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert personal injury attorney services for Rutherford County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert workers' compensation lawyer services for Rutherford County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert criminal defense attorney services for Rutherford County residents</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Expert car accident lawyer services for Rutherford County residents</p>
            ...
            <section className="bg-[#6B1F2E] text-white p-8 rounded-lg">
              <h2 className="text-3xl font-bold mb-4">Why Rutherford County Chooses Vasquez Law</h2>
            ...
            <section className="text-center bg-gray-50 p-8 rounded-lg">
              <h2 className="text-3xl font-bold mb-4 text-[#6B1F2E]">
                Get Help Now - Serving All of Rutherford County
              </h2>
      ...
      />
      <Script
        id="rutherford-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            '@type': 'LegalService',
            name: `Vasquez Law Firm - Rutherford County`,
            description: `Comprehensive legal services for Rutherford County, North Carolina residents`,
            areaServed: {
