...
export const metadata: Metadata = {
  ...
  alternates: {
    languages: {
      en: `/locations/nc/henderson`,
      es: `/es/locations/nc/henderson`,
    },
  },
};
const localSchema = localBusinessSchema({
  name: 'Henderson',
  address: 'Serving Henderson',
  city: 'Henderson',
  state: 'NC',
  zip: '27536',
...
const breadcrumbs = breadcrumbSchema([
  ...
  { name: 'Henderson', url: `https://www.vasquezlawnc.com/locations/nc/henderson` },
]);
const faqs = faqSchema([
  {
    question: 'Do you have a physical office in Henderson?',
    answer:
      'While our main offices are in Raleigh, Charlotte, and Smithfield, we regularly meet with clients throughout Henderson and Vance County. We offer virtual consultations and can arrange meetings at convenient locations.',
  },
  {
    question: 'What courts do you handle cases in Vance County?',
    answer:
      'We represent clients in all Vance County courts, including the 10th Judicial District Court and Eastern District of NC federal court. Our attorneys are licensed to practice in all North Carolina state and federal courts.',
  },
  {
    question: 'How much do immigration lawyers charge in Henderson?',
    answer:
      'We offer transparent flat fees for most immigration cases and free consultations. Payment plans are available to make quality legal representation affordable for Henderson residents.',
  },
  {
    question: 'Can you help with criminal cases in Henderson?',
    answer:
      'Yes, we handle all types of criminal charges in Vance County, including DWI, drug charges, assault, and traffic violations. We offer 24/7 availability for emergencies.',
  },
]);
export default function HendersonNCPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                Henderson Immigration & Criminal Defense Lawyers
              </h1>
              <p className="text-xl mb-8 max-w-3xl mx-auto">
                Serving Henderson, Vance County, and the Northern NC area with experienced legal
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              ...
              <div>
                ...
                <p className="text-sm">Cases in Vance County</p>
              </div>
              <div>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-[#6B1F2E] text-center mb-12">
              Legal Services for Henderson Residents
            </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-bold text-[#6B1F2E] mb-6">
                  Why Henderson Residents Choose Vasquez Law Firm
                </h2>
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Deep understanding of Vance County courts, judges, and legal procedures
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Full legal services in English and Spanish for Henderson&apos;s diverse community
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Payment plans and transparent pricing to serve all Henderson residents
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div>
                <h3 className="text-2xl font-bold text-[#6B1F2E] mb-6">
                  Vance County Legal Information
                </h3>
                <div className="bg-white rounded-lg shadow-md p-6">
                  ...
                  <h4 className="font-bold text-[#6B1F2E] mb-3 mt-6">
                    Common Legal Issues in Henderson
                  </h4>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-[#6B1F2E] text-center mb-12">
              What Henderson Clients Say About Us
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <p className="font-semibold text-[#6B1F2E]">- Maria G., Henderson</p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-6">
                <div className="text-yellow-400 text-xl mb-3">★★★★★</div>
                <p className="text-gray-700 mb-4">
                  &quot;Got arrested for DWI in Vance County. Vasquez Law Firm got my charges reduced and
                  saved my license. Worth every penny!&quot;
                </p>
                <p className="font-semibold text-[#6B1F2E]">- James T., Henderson</p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-6">
                <div className="text-yellow-400 text-xl mb-3">★★★★★</div>
                <p className="text-gray-700 mb-4">
                ...
                <p className="font-semibold text-[#6B1F2E]">- Sarah L., Henderson</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-[#6B1F2E] text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl font-bold mb-6">Get Legal Help in Henderson Today</h2>
            ...
            <p className="mt-8 text-sm">Serving Henderson, Vance County, and all of Northern NC</p>
          </div>
        </section>
      </div>
    </>
