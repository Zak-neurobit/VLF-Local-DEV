...
export default function MooresvilleLesionesPersonalesPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4"> in Mooresville Lesiones Personales</h1>
      <p className="text-lg mb-6">
        Welcome to Vasquez Law Firm's Mooresville Lesiones Personales office. We provide expert  services to the local community.
      </p>
      <div className="space-y-4">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Local expertise in Mooresville Lesiones Personales</li>
            <li>Experienced </li>
        ...
        <section>
          ...
          <p>Don't wait - reach out to our Mooresville Lesiones Personales office for immediate assistance.</p>
        </section>
      </div>
    </div>
  );
