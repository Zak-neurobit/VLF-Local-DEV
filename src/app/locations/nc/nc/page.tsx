...
export const metadata: Metadata = {
  title: ` in Nc | Vasquez Law Firm`,
  description: `Expert  in Nc. Experienced legal representation.`,
};

export default function NcPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4"> in Nc</h1>
      <p className="text-lg mb-6">
        Welcome to Vasquez Law Firm's Nc office. We provide expert  services to the local community.
      </p>
