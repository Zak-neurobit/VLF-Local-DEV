...
export const metadata: Metadata = {
  ...
  keywords: 'Workers\' Compensation Lawyer Greensboro NC, work injury lawyer Greensboro, workers comp attorney Greensboro, workplace accident lawyer Greensboro, Workers\' Compensation Lawyer near High Point, Workers\' Compensation Lawyer near Burlington, Workers\' Compensation Lawyer near Jamestown, Workers\' Compensation Lawyer near Summerfield',
  openGraph: {
    title: '#1 Workers\' Compensation Lawyer in Greensboro, North Carolina | Vasquez Law Firm',
    description: 'Leading workers\' compensation lawyer in Greensboro. Serving all of Guilford County with 60+ years experience. Free consultation. No fees unless we win (PI/WC cases).',
    url: `https://www.vasquezlawfirm.com/locations/nc/greensboro/workers-compensation-lawyer`,
    images: [{
  ...
  alternates: {
    canonical: `https://www.vasquezlawfirm.com/locations/nc/greensboro/workers-compensation-lawyer`,
    languages: {
      'en-US': `https://www.vasquezlawfirm.com/locations/nc/greensboro/workers-compensation-lawyer`,
      'es-ES': `https://www.vasquezlawfirm.com/es/ubicaciones/nc/greensboro/workers-compensation-lawyer`
    }
  }
};
          ...
          <div className="space-y-12">
            ...
            <section>
              <h1 className="text-4xl md:text-5xl font-bold text-[#6B1F2E] mb-4">
                Greensboro\'s Top Workers\' Compensation Lawyer - 60+ Years Winning Cases
              </h1>
              <p className="text-xl text-gray-700">
                When you need the best workers\' compensation lawyer in Greensboro, Guilford County, North Carolina, 
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-[#6B1F2E]">
                Workers\' Compensation Lawyer Services in Greensboro
              </h2>
              <p className="text-lg mb-4">
                Our Greensboro workers\' compensation lawyers handle all types of cases throughout Guilford County:
              </p>
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="mt-4 text-gray-600">
                  Our workers\' compensation lawyers regularly appear in Guilford County courts and know the local procedures inside and out.
                </p>
              </div>
            </section>
            {/* CTA Section */}
            <section className="bg-[#6B1F2E] text-white p-8 rounded-lg text-center">
              <h2 className="text-3xl font-bold mb-4">
                Need a Workers\' Compensation Lawyer in Greensboro? Get Help Now!
              </h2>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Attorney',
            name: `Vasquez Law Firm - Greensboro Workers\' Compensation Lawyer`,
            description: `Leading workers\' compensation lawyer serving Greensboro and Guilford County, North Carolina`,
            url: `https://www.vasquezlawfirm.com/locations/nc/greensboro/workers-compensation-lawyer`,
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                '@type': 'Question',
                name: `How much does a workers\' compensation lawyer cost in Greensboro, NC?`,
                acceptedAnswer: {
                  '@type': 'Answer',
