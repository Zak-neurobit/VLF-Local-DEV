...
export const metadata: Metadata = {
  ...
  description:
    'Top-rated law firm in Greensboro, North Carolina. Immigration, personal injury, workers comp, criminal defense. 60+ years experience. Free consultation. Se habla español.',
  keywords:
    'lawyers Greensboro NC, attorneys Greensboro, law firm Greensboro North Carolina, abogados Greensboro',
};
        ...
        <div className="space-y-12">
              ...
              {practiceAreas.map(area => (
                ...
                >
                  ...
                  <p className="text-gray-600">
                    Expert {area.name.toLowerCase()} services in Greensboro
                  </p>
          ...
          <section className="bg-gray-50 p-8 rounded-lg">
            <h2 className="text-3xl font-bold mb-6 text-[#6B1F2E]">
              Why Greensboro Trusts Vasquez Law Firm
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold mb-4 text-[#C9974D]">
                  Local Greensboro Presence
                </h3>
