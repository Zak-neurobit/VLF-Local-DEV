...
export default function HighPointFamilyLawPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Family Law in High Point</h1>
      <p className="text-lg mb-6">
        Welcome to Vasquez Law Firm's High Point family law. 
