...
export const metadata: Metadata = {
  ...
  alternates: {
    languages: {
      en: `/locations/nc/pineville`,
      es: `/es/locations/nc/pineville`,
    },
  },
};
const localSchema = localBusinessSchema({
  name: 'Pineville',
  address: 'Serving Pineville',
  city: 'Pineville',
  state: 'NC',
  zip: '28134',
...
const breadcrumbs = breadcrumbSchema([
  ...
  { name: 'Pineville', url: `https://www.vasquezlawnc.com/locations/nc/pineville` },
]);
const faqs = faqSchema([
  {
    question: 'Do you have a physical office in Pineville?',
    answer:
      'While our main offices are in Raleigh, Charlotte, and Smithfield, we regularly meet with clients throughout Pineville and Mecklenburg County. We offer virtual consultations and can arrange meetings at convenient locations.',
  },
  {
  ...
  {
    question: 'How much do immigration lawyers charge in Pineville?',
    answer:
      'We offer transparent flat fees for most immigration cases and free consultations. Payment plans are available to make quality legal representation affordable for Pineville residents.',
  },
  {
    question: 'Can you help with criminal cases in Pineville?',
    answer:
...
export default function PinevilleNCPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                Pineville Immigration & Criminal Defense Lawyers
              </h1>
              <p className="text-xl mb-8 max-w-3xl mx-auto">
                Serving Pineville, Mecklenburg County, and the Charlotte Metro area with experienced
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-[#6B1F2E] text-center mb-12">
              Legal Services for Pineville Residents
            </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-bold text-[#6B1F2E] mb-6">
                  Why Pineville Residents Choose Vasquez Law Firm
                </h2>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Full legal services in English and Spanish for Pineville&apos;s diverse community
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Payment plans and transparent pricing to serve all Pineville residents
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  ...
                  <h4 className="font-bold text-[#6B1F2E] mb-3 mt-6">
                    Common Legal Issues in Pineville
                  </h4>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-[#6B1F2E] text-center mb-12">
              What Pineville Clients Say About Us
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <p className="font-semibold text-[#6B1F2E]">- Maria G., Pineville</p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-6">
                <div className="text-yellow-400 text-xl mb-3">★★★★★</div>
                <p className="text-gray-700 mb-4">
                ...
                <p className="font-semibold text-[#6B1F2E]">- James T., Pineville</p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-6">
                <div className="text-yellow-400 text-xl mb-3">★★★★★</div>
                <p className="text-gray-700 mb-4">
                ...
                <p className="font-semibold text-[#6B1F2E]">- Sarah L., Pineville</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-[#6B1F2E] text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl font-bold mb-6">Get Legal Help in Pineville Today</h2>
            ...
            <p className="mt-8 text-sm">
              Serving Pineville, Mecklenburg County, and all of Charlotte Metro
            </p>
          </div>
        </section>
      </div>
