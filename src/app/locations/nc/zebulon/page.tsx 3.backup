...
export const metadata: Metadata = {
  ...
  alternates: {
    languages: {
      en: `/locations/nc/zebulon`,
      es: `/es/locations/nc/zebulon`,
    },
  },
};
const localSchema = localBusinessSchema({
  name: 'Zebulon',
  address: 'Serving Zebulon',
  city: 'Zebulon',
  state: 'NC',
  zip: '27597',
...
const breadcrumbs = breadcrumbSchema([
  ...
  { name: 'Zebulon', url: `https://www.vasquezlawnc.com/locations/nc/zebulon` },
]);
const faqs = faqSchema([
  {
    question: 'Do you have a physical office in Zebulon?',
    answer:
      'While our main offices are in Raleigh, Charlotte, and Smithfield, we regularly meet with clients throughout Zebulon and Wake County. We offer virtual consultations and can arrange meetings at convenient locations.',
  },
  {
  ...
  {
    question: 'How much do immigration lawyers charge in Zebulon?',
    answer:
      'We offer transparent flat fees for most immigration cases and free consultations. Payment plans are available to make quality legal representation affordable for Zebulon residents.',
  },
  {
    question: 'Can you help with criminal cases in Zebulon?',
    answer:
...
export default function ZebulonNCPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                Zebulon Immigration & Criminal Defense Lawyers
              </h1>
              <p className="text-xl mb-8 max-w-3xl mx-auto">
                Serving Zebulon, Wake County, and the Triangle area with experienced legal
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-[#6B1F2E] text-center mb-12">
              Legal Services for Zebulon Residents
            </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-bold text-[#6B1F2E] mb-6">
                  Why Zebulon Residents Choose Vasquez Law Firm
                </h2>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Full legal services in English and Spanish for Zebulon&apos;s diverse community
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Payment plans and transparent pricing to serve all Zebulon residents
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  ...
                  <h4 className="font-bold text-[#6B1F2E] mb-3 mt-6">
                    Common Legal Issues in Zebulon
                  </h4>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-[#6B1F2E] text-center mb-12">
              What Zebulon Clients Say About Us
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <p className="font-semibold text-[#6B1F2E]">- Maria G., Zebulon</p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-6">
                <div className="text-yellow-400 text-xl mb-3">★★★★★</div>
                <p className="text-gray-700 mb-4">
                ...
                <p className="font-semibold text-[#6B1F2E]">- James T., Zebulon</p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-6">
                <div className="text-yellow-400 text-xl mb-3">★★★★★</div>
                <p className="text-gray-700 mb-4">
                ...
                <p className="font-semibold text-[#6B1F2E]">- Sarah L., Zebulon</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-[#6B1F2E] text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl font-bold mb-6">Get Legal Help in Zebulon Today</h2>
            ...
            <p className="mt-8 text-sm">Serving Zebulon, Wake County, and all of Triangle</p>
          </div>
        </section>
      </div>
    </>
