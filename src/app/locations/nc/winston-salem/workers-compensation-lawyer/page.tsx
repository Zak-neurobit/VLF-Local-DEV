...
export const metadata: Metadata = {
  ...
  keywords: 'Workers\' Compensation Lawyer Winston-Salem NC, work injury lawyer Winston-Salem, workers comp attorney Winston-Salem, workplace accident lawyer Winston-Salem, Workers\' Compensation Lawyer near Kernersville, Workers\' Compensation Lawyer near Clemmons, Workers\' Compensation Lawyer near Lewisville, Workers\' Compensation Lawyer near Walkertown',
  openGraph: {
    title: '#1 Workers\' Compensation Lawyer in Winston-Salem, North Carolina | Vasquez Law Firm',
    description: 'Leading workers\' compensation lawyer in Winston-Salem. Serving all of Forsyth County with 60+ years experience. Free consultation. No fees unless we win (PI/WC cases).',
    url: `https://www.vasquezlawfirm.com/locations/nc/winston-salem/workers-compensation-lawyer`,
    images: [{
  ...
  alternates: {
    canonical: `https://www.vasquezlawfirm.com/locations/nc/winston-salem/workers-compensation-lawyer`,
    languages: {
      'en-US': `https://www.vasquezlawfirm.com/locations/nc/winston-salem/workers-compensation-lawyer`,
      'es-ES': `https://www.vasquezlawfirm.com/es/ubicaciones/nc/winston-salem/workers-compensation-lawyer`
    }
  }
};
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Attorney',
            name: `Vasquez Law Firm - Winston-Salem Workers\' Compensation Lawyer`,
            description: `Leading workers\' compensation lawyer serving Winston-Salem and Forsyth County, North Carolina`,
            url: `https://www.vasquezlawfirm.com/locations/nc/winston-salem/workers-compensation-lawyer`,
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                '@type': 'Question',
                name: `How much does a workers\' compensation lawyer cost in Winston-Salem, NC?`,
                acceptedAnswer: {
                  '@type': 'Answer',
