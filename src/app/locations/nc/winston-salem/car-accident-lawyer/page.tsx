...
export const metadata: Metadata = {
  ...
  description: 'Top-rated car accident lawyer serving Winston-Salem and Forsyth County. 60+ years combined experience. Available 24/7. Free consultation. Se habla español. Call 1-844-YO-PELEO.',
  keywords: 'Car Accident Lawyer Winston-Salem NC, auto accident attorney Winston-Salem, vehicle accident lawyer Winston-Salem, crash attorney Winston-Salem, Car Accident Lawyer near Kernersville, Car Accident Lawyer near Clemmons, Car Accident Lawyer near Lewisville, Car Accident Lawyer near Walkertown',
  openGraph: {
    title: '#1 Car Accident Lawyer in Winston-Salem, North Carolina | Vasquez Law Firm',
    description: 'Leading car accident lawyer in Winston-Salem. Serving all of Forsyth County with 60+ years experience. Free consultation. No fees unless we win (PI/WC cases).',
          ...
          <div className="space-y-12">
            ...
            <section>
              ...
              <p className="text-lg mb-4">
                Our Winston-Salem car accident lawyers handle all types of cases throughout Forsyth County:
              </p>
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="mt-4 text-gray-600">
                  Our car accident lawyers regularly appear in Forsyth County courts and know the local procedures inside and out.
                </p>
              </div>
            </section>
            {/* CTA Section */}
