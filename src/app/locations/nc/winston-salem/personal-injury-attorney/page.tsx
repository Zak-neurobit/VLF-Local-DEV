...
export const metadata: Metadata = {
  title: 'Best Personal Injury Attorney in Winston-Salem, NC | 60+ Years Experience | Free Consultation',
  description: 'Top-rated personal injury attorney serving Winston-Salem and Forsyth County. 60+ years combined experience. Available 24/7. Free consultation. Se habla español. Call 1-844-YO-PELEO.',
  keywords: 'Personal Injury Attorney Winston-Salem NC, accident lawyer Winston-Salem, injury attorney Winston-Salem, car accident lawyer Winston-Salem, slip and fall attorney Winston-Salem, Personal Injury Attorney near Kernersville, Personal Injury Attorney near Clemmons, Personal Injury Attorney near Lewisville, Personal Injury Attorney near Walkertown',
  openGraph: {
    title: '#1 Personal Injury Attorney in Winston-Salem, North Carolina | Vasquez Law Firm',
    description: 'Leading personal injury attorney in Winston-Salem. Serving all of Forsyth County with 60+ years experience. Free consultation. No fees unless we win (PI/WC cases).',
    url: `https://www.vasquezlawfirm.com/locations/nc/winston-salem/personal-injury-attorney`,
    images: [{
  ...
  alternates: {
    canonical: `https://www.vasquezlawfirm.com/locations/nc/winston-salem/personal-injury-attorney`,
    languages: {
      'en-US': `https://www.vasquezlawfirm.com/locations/nc/winston-salem/personal-injury-attorney`,
      'es-ES': `https://www.vasquezlawfirm.com/es/ubicaciones/nc/winston-salem/personal-injury-attorney`
    }
  }
};
export default function WinstonSalemPersonalInjuryAttorneyPage() {
  return (
    <>
          ...
          <div className="space-y-12">
            ...
            <section>
              <h1 className="text-4xl md:text-5xl font-bold text-[#6B1F2E] mb-4">
                Winston-Salem's Top Personal Injury Attorney - 60+ Years Winning Cases
              </h1>
              <p className="text-xl text-gray-700">
                When you need the best personal injury attorney in Winston-Salem, Forsyth County, North Carolina, 
            ...
            <section className="bg-gray-50 p-8 rounded-lg">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="font-semibold text-xl mb-3 text-[#C9974D]">Local Winston-Salem Expertise</h3>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-[#6B1F2E]">
                Personal Injury Attorney Services in Winston-Salem
              </h2>
              <p className="text-lg mb-4">
                Our Winston-Salem personal injury attorneys handle all types of cases throughout Forsyth County:
              </p>
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="mt-4 text-gray-600">
                  Our personal injury attorneys regularly appear in Forsyth County courts and know the local procedures inside and out.
                </p>
              </div>
            </section>
            {/* CTA Section */}
            <section className="bg-[#6B1F2E] text-white p-8 rounded-lg text-center">
              <h2 className="text-3xl font-bold mb-4">
                Need a Personal Injury Attorney in Winston-Salem? Get Help Now!
              </h2>
      ...
      <Script
        id="winston-salem-personal-injury-attorney-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            '@type': 'Attorney',
            name: `Vasquez Law Firm - Winston-Salem Personal Injury Attorney`,
            description: `Leading personal injury attorney serving Winston-Salem and Forsyth County, North Carolina`,
            url: `https://www.vasquezlawfirm.com/locations/nc/winston-salem/personal-injury-attorney`,
      ...
      <Script
        id="winston-salem-personal-injury-attorney-faq"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            ...
            mainEntity: [
              {
                '@type': 'Question',
                name: `How much does a personal injury attorney cost in Winston-Salem, NC?`,
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: `At Vasquez Law Firm, we offer free consultations for all Winston-Salem residents. We work on contingency - no fees unless we win your case.`
                }
              },
              {
                '@type': 'Question',
