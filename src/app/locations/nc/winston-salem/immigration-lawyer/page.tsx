...
export const metadata: Metadata = {
  title: 'Best Immigration Lawyer in Winston-Salem, NC | 60+ Years Experience | Free Consultation',
  description: 'Top-rated immigration lawyer serving Winston-Salem and Forsyth County. 60+ years combined experience. Available 24/7. Free consultation. Se habla español. Call 1-844-YO-PELEO.',
  keywords: 'Immigration Lawyer Winston-Salem NC, immigration attorney Winston-Salem, visa lawyer Winston-Salem, deportation defense Winston-Salem, green card lawyer Winston-Salem, Immigration Lawyer near Kernersville, Immigration Lawyer near Clemmons, Immigration Lawyer near Lewisville, Immigration Lawyer near Walkertown',
  openGraph: {
    title: '#1 Immigration Lawyer in Winston-Salem, North Carolina | Vasquez Law Firm',
    description: 'Leading immigration lawyer in Winston-Salem. Serving all of Forsyth County with 60+ years experience. Free consultation. No fees unless we win (PI/WC cases).',
    url: `https://www.vasquezlawfirm.com/locations/nc/winston-salem/immigration-lawyer`,
    images: [{
  ...
  alternates: {
    canonical: `https://www.vasquezlawfirm.com/locations/nc/winston-salem/immigration-lawyer`,
    languages: {
      'en-US': `https://www.vasquezlawfirm.com/locations/nc/winston-salem/immigration-lawyer`,
      'es-ES': `https://www.vasquezlawfirm.com/es/ubicaciones/nc/winston-salem/immigration-lawyer`
    }
  }
};

export default function WinstonSalemImmigrationLawyerPage() {
  return (
    <>
      <LocationPageTemplate
        location="Winston-Salem"
        practiceArea="Immigration Lawyer"
        content={
          <div className="space-y-12">
            {/* Hero Section */}
            <section>
              <h1 className="text-4xl md:text-5xl font-bold text-[#6B1F2E] mb-4">
                Winston-Salem's Top Immigration Lawyer - 60+ Years Winning Cases
              </h1>
              <p className="text-xl text-gray-700">
                When you need the best immigration lawyer in Winston-Salem, Forsyth County, North Carolina, 
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-[#6B1F2E]">
                Immigration Lawyer Services in Winston-Salem
              </h2>
              <p className="text-lg mb-4">
                Our Winston-Salem immigration lawyers handle all types of cases throughout Forsyth County:
              </p>
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="mt-4 text-gray-600">
                  Our immigration lawyers regularly appear in Forsyth County courts and know the local procedures inside and out.
                </p>
              </div>
            </section>
            ...
            <section className="bg-[#6B1F2E] text-white p-8 rounded-lg text-center">
              <h2 className="text-3xl font-bold mb-4">
                Need a Immigration Lawyer in Winston-Salem? Get Help Now!
              </h2>
      ...
      <Script
        id="winston-salem-immigration-lawyer-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            '@type': 'Attorney',
            name: `Vasquez Law Firm - Winston-Salem Immigration Lawyer`,
            description: `Leading immigration lawyer serving Winston-Salem and Forsyth County, North Carolina`,
            url: `https://www.vasquezlawfirm.com/locations/nc/winston-salem/immigration-lawyer`,
      ...
      <Script
        id="winston-salem-immigration-lawyer-faq"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            ...
            mainEntity: [
              {
                '@type': 'Question',
                name: `How much does a immigration lawyer cost in Winston-Salem, NC?`,
                acceptedAnswer: {
                  '@type': 'Answer',
