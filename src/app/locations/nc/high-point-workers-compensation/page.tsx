...
export default function HighPointCompensacionLaboralPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4"> in High Point Compensacion Laboral</h1>
      <p className="text-lg mb-6">
        Welcome to Vasquez Law Firm's High Point Compensacion Laboral office. We provide expert  services to the local community.
      </p>
      <div className="space-y-4">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Local expertise in High Point Compensacion Laboral</li>
            <li>Experienced </li>
        ...
        <section>
          ...
          <p>Don't wait - reach out to our High Point Compensacion Laboral office for immediate assistance.</p>
        </section>
      </div>
    </div>
  );
