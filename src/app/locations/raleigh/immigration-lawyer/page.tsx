...
export default function RaleighImmigrationLawyerPage() {
  const serviceLocationData = {
    ...
    courtInfo: {
      title: 'Immigration Court Information for Raleigh',
      name: 'Charlotte Immigration Court (Serving Raleigh)',
    ...
    whyHireUs: {
      title: 'Why Hire a Raleigh Immigration Lawyer?',
