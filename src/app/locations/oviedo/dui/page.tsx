...
export const metadata: Metadata = {
  title: `Dui - Oviedo | Vasquez Law Firm`,
  description: `Dui services in Oviedo. Experienced attorneys serving the local community.`,
};

export default function OviedoDuiPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Dui in Oviedo</h1>
      <p className="text-lg mb-6">
        Welcome to Vasquez Law Firm's Oviedo dui. 
