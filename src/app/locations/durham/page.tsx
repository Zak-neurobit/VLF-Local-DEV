...
export const metadata: Metadata = {
  title: 'Durham Office - Vasquez Law Firm, PLLC - Vasquez Law Firm, PLLC',
  description: '',
};
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Durham Office - Vasquez Law Firm, PLLC
            </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none">
              <div className="mb-8">
                <h2 className="text-3xl font-bold text-burgundy-900 mb-4">Durham Office</h2>
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      ...
                      <p>
                        <a href="tel:(919) 401-9977" className="text-burgundy-700 hover:underline">
                          (919) 401-9977
                        </a>
                      </p>
                    </div>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: 'https://www.vasquezlawfirm.com/locations/durham/page',
            priceRange: '$$',
