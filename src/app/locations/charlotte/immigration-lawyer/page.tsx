...
export default function CharlotteImmigrationLawyerPage() {
  const serviceLocationData = {
    ...
    courtInfo: {
      title: 'Charlotte Immigration Court Information',
              ...
              itemListElement: [
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Deportation Defense',
                    description: 'Emergency deportation defense at Charlotte Immigration Court',
                  },
                },
                {
                  '@type': 'Offer',
