...
export const metadata: Metadata = {
  ...
  description: 'Injured at work in Charlotte? Get the benefits you deserve. Workers compensation lawyers fighting insurance companies. Free consultation. No fee unless we win.',
  keywords: 'Charlotte workers comp attorney, Charlotte workers compensation lawyer, workplace injury lawyer Charlotte NC, work accident attorney Charlotte, workers comp benefits Charlotte, construction accident lawyer Charlotte, Charlotte work injury law firm',
  openGraph: {
    title: 'Charlotte Workers Comp Attorney - YO PELEO POR TI™ | Vasquez Law',
    description: 'Hurt at work in Charlotte? We fight for your medical care, lost wages, and disability benefits. Don\'t let insurance companies deny your claim.',
  ...
  twitter: {
    ...
    description: 'Injured at work? We fight for your benefits. Free consultation. Se habla español.',
  },
  alternates: {
...
export default function CharlotteWorkersCompAttorneyPage() {
  const serviceLocationData = {
    ...
    heroDescription: 'Injured at work in Charlotte? Don\'t let insurance companies deny your rightful benefits. We fight for your medical care, lost wages, and future. No upfront fees.',
    ...
    serviceDetails: {
      ...
      description: 'Complete representation for workplace injuries throughout Charlotte\'s diverse industries',
      services: [
        {
          name: 'Construction Injuries',
          description: 'Falls, equipment accidents, electrocutions. We understand OSHA violations and third-party claims.',
          localInfo: 'Representing workers at major Charlotte construction sites and developments',
        },
        {
          name: 'Manufacturing & Warehouse',
          description: 'Machine injuries, repetitive stress, back injuries from Charlotte\'s distribution centers.',
          localInfo: 'Experience with Amazon, FedEx, UPS, and Charlotte manufacturing facilities',
        },
        {
          name: 'Healthcare Worker Injuries',
          description: 'Back injuries, needle sticks, workplace violence in hospitals and care facilities.',
        ...
        },
        {
          ...
          description: 'Carpal tunnel, back problems, slip and falls in Charlotte\'s corporate offices.',
          localInfo: 'Representing workers from Bank of America, Wells Fargo, and other employers',
        },
        {
          name: 'Denied Claims Appeals',
          description: 'Fighting wrongful denials, getting second opinions, appealing to the Industrial Commission.',
    ...
    courtInfo: {
      ...
      additionalInfo: 'We regularly appear before Deputy Commissioners in Charlotte and know the local procedures that can make or break your case. Our office handles mediations and hearings throughout the region.',
    },
    ...
    faqs: [
      {
        ...
        answer: 'Report it immediately to your supervisor IN WRITING. Seek medical treatment right away - you have the right to see your own doctor after the first visit. Document everything: take photos, get witness info, keep all paperwork. Then call us for free guidance on protecting your rights.',
      },
      {
        question: 'Can I be fired for filing workers\' comp in Charlotte?',
        answer: 'It\'s illegal for employers to retaliate against you for filing a legitimate workers\' comp claim. However, they may try other tactics. We protect you from retaliation and can file additional claims if your employer violates the law. Don\'t let fear stop you from getting benefits you\'ve earned.',
      },
      {
        question: 'What benefits can I get through NC workers\' comp?',
        answer: 'You\'re entitled to: (1) All medical treatment related to your injury, (2) Two-thirds of your average weekly wage while unable to work, (3) Permanent disability benefits if applicable, (4) Vocational rehabilitation if you can\'t return to your job. We fight for maximum benefits in each category.',
      },
      {
        question: 'How long do I have to file a workers\' comp claim in Charlotte?',
        answer: 'You must report the injury within 30 days and file a claim within 2 years. However, some exceptions apply. The sooner you act, the stronger your case. Insurance companies use delays against you. Call us immediately for free advice on deadlines specific to your situation.',
      },
    ],
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'Charlotte workers compensation lawyers fighting for injured workers. Construction, warehouse, healthcare injuries. No fee unless we win.',
            url: 'https://www.vasquezlawfirm.com/locations/charlotte/workers-comp-attorney',
