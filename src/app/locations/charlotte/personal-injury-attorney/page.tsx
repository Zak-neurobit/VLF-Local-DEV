...
export const metadata: Metadata = {
  ...
  description: 'Experienced Charlotte personal injury lawyers. Car accidents, truck crashes, slip & fall, wrongful death. No fee unless we win. Free consultation. Se habla español.',
  keywords: 'Charlotte personal injury attorney, Charlotte personal injury lawyer, car accident lawyer Charlotte NC, truck accident attorney Charlotte, slip and fall lawyer Charlotte, wrongful death attorney Charlotte, Charlotte injury law firm, best personal injury lawyer Charlotte',
  openGraph: {
    title: 'Charlotte Personal Injury Attorney - YO PELEO POR TI™ | Vasquez Law',
    description: 'Charlotte\'s trusted personal injury law firm. We fight insurance companies to get you maximum compensation. No fee unless we win your case.',
...
export default function CharlottePersonalInjuryAttorneyPage() {
  const serviceLocationData = {
    ...
    heroDescription: 'Injured in Charlotte? We fight insurance companies to get you the compensation you deserve. No fee unless we win. Over $100 million recovered for clients.',
    ...
    serviceDetails: {
      ...
      description: 'Comprehensive injury representation for accidents throughout Charlotte and Mecklenburg County',
      services: [
        {
          name: 'Car & Truck Accidents',
          description: 'Serious injuries from crashes on I-77, I-85, I-485, and Charlotte streets. We handle all insurance negotiations.',
        ...
        },
        {
          ...
          description: 'Premises liability cases at stores, restaurants, apartments, and public property throughout Charlotte.',
          localInfo: 'Familiar with property codes and safety standards in Mecklenburg County',
        },
        {
          name: 'Medical Malpractice',
          description: 'Holding Charlotte hospitals and doctors accountable for medical errors and negligence.',
          localInfo: 'Experience with Atrium Health, Novant, and other Charlotte medical facilities',
        },
        {
          name: 'Wrongful Death',
          description: 'Compassionate representation for families who\'ve lost loved ones due to negligence.',
          localInfo: 'Understanding of North Carolina wrongful death laws and local court procedures',
        },
        {
    ...
    courtInfo: {
      ...
      additionalInfo: 'We regularly appear in Mecklenburg County courts and know the judges, procedures, and local rules that can impact your case outcome.',
    },
    ...
    faqs: [
      {
        ...
        answer: 'Case value depends on injury severity, medical costs, lost wages, and pain and suffering. We offer free case evaluations to assess your claim\'s potential value. Our Charlotte personal injury lawyers have recovered millions for clients with similar injuries.',
      },
      {
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'Experienced Charlotte personal injury lawyers. Car accidents, truck crashes, slip & fall, wrongful death. No fee unless we win.',
            url: 'https://www.vasquezlawfirm.com/locations/charlotte/personal-injury-attorney',
