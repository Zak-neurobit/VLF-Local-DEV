...
export default function CharlotteCriminalDefenseLawyerPage() {
  const serviceLocationData = {
    ...
    serviceDetails: {
      title: 'Charlotte Criminal Defense Services',
    ...
    localExpertise: {
      title: 'Why Charlotte Chooses Our Criminal Defense Team',
      points: [
    ...
    officeInfo: {
      name: 'Charlotte Criminal Defense Office',
    ...
    whyHireUs: {
      title: 'Why You Need a Charlotte Criminal Defense Lawyer',
      content: `Facing criminal charges in Charlotte is terrifying. Your freedom, career, and reputation are at stake. The Mecklenburg County District Attorney\'s office has unlimited resources to prosecute you. You need an equally aggressive defense. Our Charlotte criminal defense lawyers are former prosecutors who know their playbook. We\'ve defended over 2,000 Charlotte residents, achieving dismissals, acquittals, and reduced charges. Don\'t gamble with your future - get proven defenders who know Charlotte\'s courts inside and out.`,
    },
