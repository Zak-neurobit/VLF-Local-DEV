        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Guide to Permanent Residency Through Employment | Vasquez Law Firm
            </h1>
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/guide-to-permanent-residency-through-employment-what-you-need-to-know/',
                  url: 'https://www.vasquezlawnc.com/guide-to-permanent-residency-through-employment-what-you-need-to-know/',
                  name: 'Guide to Permanent Residency Through Employment | Vasquez Law Firm',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/guide-to-permanent-residency-through-employment-what-you-need-to-know/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/guide-to-permanent-residency-through-employment-what-you-need-to-know/#primaryimage',
                  ...
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/11/guide-to-permanent-residency-through-employment-scaled.jpg',
                  datePublished: '2024-11-27T14:47:17+00:00',
                  author: {
                    '@id':
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/guide-to-permanent-residency-through-employment-what-you-need-to-know/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  width: 2560,
                  height: 1282,
                  caption: 'Guide to Permanent Residency Through Employment: What You Need to Know',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'Guide to Permanent Residency Through Employment: What You Need to Know',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Guide to permanent residency through employment what you need to know',
                  item: 'https://vasquezlawnc.com/guide-to-permanent-residency-through-employment-what-you-need-to-know',
                },
              ],
            },
            {
