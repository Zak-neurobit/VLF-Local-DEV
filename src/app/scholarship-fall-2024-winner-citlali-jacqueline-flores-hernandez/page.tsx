...
export const metadata: Metadata = {
  title: 'Fall 2024 Winner Citlali Jacqueline Flores Hernandez - Vasquez Law Firm, PLLC',
  description:
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/scholarship-fall-2024-winner-citlali-jacqueline-flores-hernandez/',
                  url: 'https://www.vasquezlawnc.com/scholarship-fall-2024-winner-citlali-jacqueline-flores-hernandez/',
                  name: 'Fall 2024 Winner Citlali Jacqueline Flores Hernandez - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-09-20T17:25:19+00:00',
                  dateModified: '2024-09-20T17:27:46+00:00',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/scholarship-fall-2024-winner-citlali-jacqueline-flores-hernandez/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'Fall 2024 Winner Citlali Jacqueline Flores Hernandez',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 2,
                  name: 'Scholarship fall 2024 winner citlali jacqueline flores hernandez',
                  item: 'https://vasquezlawnc.com/scholarship-fall-2024-winner-citlali-jacqueline-flores-hernandez',
                },
              ],
            },
            {
