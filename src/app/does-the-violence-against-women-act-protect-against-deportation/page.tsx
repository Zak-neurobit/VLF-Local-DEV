        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Does the Violence Against Women Act Protect Against Deportation? - Vasquez Law Firm,
              PLLC
            </h1>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                  Does the Violence Against Women Act Protect Against Deportation? - Vasquez Law
                  Firm, PLLC
                </h2>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/does-the-violence-against-women-act-protect-against-deportation/',
                  url: 'https://www.vasquezlawnc.com/does-the-violence-against-women-act-protect-against-deportation/',
                  name: 'Does the Violence Against Women Act Protect Against Deportation? - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/does-the-violence-against-women-act-protect-against-deportation/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/does-the-violence-against-women-act-protect-against-deportation/#primaryimage',
                  ...
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/09/Untitled-2023-10-17T105430.440.jpg',
                  datePublished: '2023-10-17T16:19:37+00:00',
                  dateModified: '2024-09-18T16:19:58+00:00',
                  author: {
                    '@id':
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/does-the-violence-against-women-act-protect-against-deportation/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'Does the Violence Against Women Act Protect Against Deportation?',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              availableLanguage: ['English', 'Spanish'],
              url: 'https://vasquezlawnc.com/does-the-violence-against-women-act-protect-against-deportation/index',
            },
            {
              '@context': 'https://schema.org',
              '@type': 'BreadcrumbList',
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Does the violence against women act protect against deportation',
                  item: 'https://vasquezlawnc.com/does-the-violence-against-women-act-protect-against-deportation',
                },
              ],
            },
            {
