...
export const metadata: Metadata = {
  title: `Attorney immigration Near Me in Durham | Vasquez Law Firm`,
  description: `Find the best abogado immigration near you in Durham. Experienced legal representation.`,
};

export default function DurhamAttorneyimmigrationPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Attorney immigration Near Me in Durham</h1>
      <p className="text-lg mb-6">
        Looking for a abogado immigration near you in Durham? Vasquez Law Firm provides experienced
