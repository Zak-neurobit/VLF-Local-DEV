...
export const metadata: Metadata = {
  title: `Attorney workers compensation Near Me in Wilmington | Vasquez Law Firm`,
  description: `Find the best abogado workers compensation near you in Wilmington. Experienced legal representation.`,
};

export default function WilmingtonAttorneyworkerscompensationPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">
        Attorney workers compensation Near Me in Wilmington
      </h1>
      <p className="text-lg mb-6">
        Looking for a abogado workers compensation near you in Wilmington? Vasquez Law Firm provides
