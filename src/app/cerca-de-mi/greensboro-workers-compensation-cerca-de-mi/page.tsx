...
export const metadata: Metadata = {
  ...
  description: 'Page content for Greensboro Workers Compensation Cerca De Mi',
};
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold mb-6">Greensboro Workers Compensation Cerca De Mi</h1>
