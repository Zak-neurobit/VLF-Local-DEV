...
export const metadata: Metadata = {
  title: `Attorney criminal defense Near Me in Cary | Vasquez Law Firm`,
  description: `Find the best abogado criminal defense near you in Cary. Experienced legal representation.`,
};

export default function CaryAttorneycriminaldefensePage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Attorney criminal defense Near Me in Cary</h1>
