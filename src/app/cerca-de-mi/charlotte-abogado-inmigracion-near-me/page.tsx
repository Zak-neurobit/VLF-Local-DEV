...
export const metadata: Metadata = {
  title: `Attorney immigration Near Me in Charlotte | Vasquez Law Firm`,
  description: `Find the best abogado immigration near you in Charlotte. Experienced legal representation.`,
};

export default function CharlotteAttorneyimmigrationPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Attorney immigration Near Me in Charlotte</h1>
      <p className="text-lg mb-6">
        Looking for a abogado immigration near you in Charlotte? Vasquez Law Firm provides
