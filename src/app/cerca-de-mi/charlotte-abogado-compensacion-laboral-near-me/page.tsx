...
export const metadata: Metadata = {
  title: `Attorney workers compensation Near Me in Charlotte | Vasquez Law Firm`,
  description: `Find the best abogado workers compensation near you in Charlotte. Experienced legal representation.`,
};

export default function CharlotteAttorneyworkerscompensationPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">
        Attorney workers compensation Near Me in Charlotte
      </h1>
