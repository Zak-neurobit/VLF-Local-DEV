...
export const metadata: Metadata = {
  title: `Attorney criminal defense Near Me in Charlotte | Vasquez Law Firm`,
  description: `Find the best abogado criminal defense near you in Charlotte. Experienced legal representation.`,
};

export default function CharlotteAttorneycriminaldefensePage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Attorney criminal defense Near Me in Charlotte</h1>
      <p className="text-lg mb-6">
        Looking for a abogado criminal defense near you in Charlotte? Vasquez Law Firm provides
