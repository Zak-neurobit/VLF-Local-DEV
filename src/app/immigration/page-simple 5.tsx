          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <Text size="xl" className="mx-auto mb-8 max-w-3xl">
                Need a trusted immigration lawyer in North Carolina? Our experienced attorneys 
                help families navigate the complex immigration system with confidence.
              </Text>
        ...
        <section className="py-16">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="prose prose-invert max-w-none">
              ...
              <Heading level={2} className="mt-12 text-white">Our Immigration Services</Heading>
              ...
              <Heading level={2} className="mt-12 text-white">Why Choose Vasquez Law Firm?</Heading>
              ...
              <Heading level={3} className="mt-8 text-white">Our Approach</Heading>
              <p className="text-gray-300">
              ...
              <Heading level={3} className="mt-8 text-white">Free Consultation</Heading>
              <p className="text-gray-300">
