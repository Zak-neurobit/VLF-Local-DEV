        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Raleigh, NC Immigrant Visa Attorneys
            </h1>
              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Raleigh, NC Immigrant Visa Attorneys - Vasquez Law Firm, PLLC
                  </h2>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/immigration/visa-process/',
                  url: 'https://www.vasquezlawnc.com/immigration/visa-process/',
                  name: 'Raleigh, NC Immigrant Visa Attorneys - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id': 'https://www.vasquezlawnc.com/immigration/visa-process/#primaryimage',
                  },
                  image: {
                    '@id': 'https://www.vasquezlawnc.com/immigration/visa-process/#primaryimage',
                  },
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/04/charlotte-immigrant-visa-application-attorneys.jpg',
                  datePublished: '2024-04-04T17:42:44+00:00',
                  dateModified: '2025-02-19T12:29:24+00:00',
                  description:
                    'Need a visa? Raleigh, NC immigrant visa attorneys provide expert legal guidance for work, family, and investor visas. Get trusted representation today.',
                  breadcrumb: {
                    '@id': 'https://www.vasquezlawnc.com/immigration/visa-process/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/immigration/visa-process/'],
                    },
                  ],
                },
                {
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'Charlotte Immigrant Visa Application Attorneys',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id': 'https://www.vasquezlawnc.com/immigration/visa-process/#breadcrumb',
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'Raleigh, NC Family-Based Immigration Lawyers',
                    },
                  ],
                },
                {
            ...
            },
            {
              '@context': 'https://schema.org',
              '@type': 'Attorney',
              name: 'Raleigh, NC Immigrant Visa Attorneys',
              image: '',
              jobTitle: 'Attorney',
              worksFor: {
                '@type': 'LegalService',
              ...
              url: 'https://vasquezlawnc.com/immigration/visa-process/page/9/index﹖et_blog',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: 'Visa process',
                  item: 'https://vasquezlawnc.com/immigration/visa-process',
                },
                {
                  '@type': 'ListItem',
                  position: 4,
                  name: 'Page',
                  item: 'https://vasquezlawnc.com/immigration/visa-process/page',
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: '9',
                  item: 'https://vasquezlawnc.com/immigration/visa-process/page/9',
                },
                {
                  '@type': 'ListItem',
                  position: 6,
                  name: 'Index﹖et_blog',
                  item: 'https://vasquezlawnc.com/immigration/visa-process/page/9/index﹖et_blog',
                },
              ],
            },
            {
