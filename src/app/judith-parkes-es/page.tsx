      ...
      <section className="bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Judith Parkes</h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/judith-parkes-es/',
                  url: 'https://www.vasquezlawnc.com/judith-parkes-es/',
                  name: 'Judith parkes - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2025-04-22T14:01:57+00:00',
                  dateModified: '2025-04-22T14:15:04+00:00',
                  breadcrumb: {
                    '@id': 'https://www.vasquezlawnc.com/judith-parkes-es/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/judith-parkes-es/'],
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 2,
                  name: 'Judith parkes es',
                  item: 'https://vasquezlawnc.com/judith-parkes-es',
                },
              ],
            },
            {
