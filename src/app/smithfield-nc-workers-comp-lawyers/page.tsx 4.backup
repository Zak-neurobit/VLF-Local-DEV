...
export default function SmithfieldNcWorkersCompLawyersPage() {
  return (
              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Smithfield, NC Workers&apos; Comp Lawyers | Vasquez Law Firm, PLLC
                  </h2>
                  <p className="text-gray-700">
                    Smithfield, NC Workers&apos; Comp Lawyers brings extensive legal experience to
                    every case. Licensed to practice in North Carolina and Florida, they has
                    successfully represented hundreds of clients in immigration, personal injury,
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-700">
                    Smithfield, NC Workers&apos; Comp Lawyers focuses on immigration, personal
                    injury, and criminal defense, providing dedicated representation to clients
                    throughout North Carolina and Florida.
                  </p>
                </div>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/smithfield-nc-workers-comp-lawyers/',
                  url: 'https://www.vasquezlawnc.com/smithfield-nc-workers-comp-lawyers/',
                  name: "Smithfield, NC Workers' Comp Lawyers | Vasquez Law Firm, PLLC",
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-11-27T14:43:22+00:00',
                  dateModified: '2025-02-28T15:27:22+00:00',
                  description:
                    "Trusted workers' comp lawyers in Smithfield, NC. Vasquez Law Firm, PLLC provides legal guidance for workers seeking compensation for workplace injuries.",
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/smithfield-nc-workers-comp-lawyers/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/smithfield-nc-workers-comp-lawyers/'],
                    },
                  ],
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id': 'https://www.vasquezlawnc.com/smithfield-nc-workers-comp-lawyers/#breadcrumb',
                  itemListElement: [
                    {
                      '@type': 'ListItem',
                      position: 1,
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: "Smithfield, NC Workers' Comp Lawyers",
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              address: {
                '@type': 'PostalAddress',
                streetAddress: '901 N. Equity Dr. Suite 900',
            ...
            },
            {
              ...
              url: 'https://vasquezlawnc.com/smithfield-nc-workers-comp-lawyers/index',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Smithfield nc workers comp lawyers',
                  item: 'https://vasquezlawnc.com/smithfield-nc-workers-comp-lawyers',
                },
              ],
            },
            {
