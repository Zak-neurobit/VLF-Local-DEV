        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-gray-800 p-4 rounded">
                ...
                <ul className="space-y-2">
                  <li>
                    <a href="/locations/nc/charlotte" className="text-blue-600 hover:underline">
                      /locations/nc/charlotte
                    </a>
                  </li>
                  <li>
                    <a href="/locations/nc/raleigh" className="text-blue-600 hover:underline">
                      /locations/nc/raleigh
                    </a>
                  </li>
                  <li>
                    <a href="/locations/nc/durham" className="text-blue-600 hover:underline">
                      /locations/nc/durham
                    </a>
                  </li>
                  <li>
                    <a href="/locations/nc/greensboro" className="text-blue-600 hover:underline">
              ...
              <div className="bg-gray-800 p-4 rounded">
                ...
                <ul className="space-y-2">
                  <li>
                    <a href="/locations/fl/orlando" className="text-blue-600 hover:underline">
                      /locations/fl/orlando
                    </a>
                  </li>
                  <li>
                    <a href="/locations/fl/tampa" className="text-blue-600 hover:underline">
                      /locations/fl/tampa
                    </a>
                  </li>
                  <li>
                    <a href="/locations/fl/miami" className="text-blue-600 hover:underline">
                      /locations/fl/miami
                    </a>
                  </li>
                </ul>
          ...
          <section>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="/locations/nc/charlotte/immigration-lawyer"
              ...
              <li>
                <a
                  href="/locations/nc/charlotte/personal-injury-attorney"
                  className="text-blue-600 hover:underline"
                >
              ...
              <li>
                <a
                  href="/locations/fl/orlando/workers-compensation"
                  className="text-blue-600 hover:underline"
                >
