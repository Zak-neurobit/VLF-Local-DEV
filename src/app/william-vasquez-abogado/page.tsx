          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/william-vasquez-abogado/',
                  url: 'https://www.vasquezlawnc.com/william-vasquez-abogado/',
                  name: 'William Vasquez Abogado - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-09-13T13:35:40+00:00',
                  dateModified: '2025-02-20T11:04:08+00:00',
                  description:
                    'William Vasquez, abogado y fundador, brinda representación legal experta en inmigración. ¡Contáctenos hoy para una consulta y asesoría profesional!',
                  breadcrumb: {
                    '@id': 'https://www.vasquezlawnc.com/william-vasquez-abogado/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/william-vasquez-abogado/'],
                    },
                  ],
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'William Vasquez Abogado' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 2,
                  name: 'William vasquez abogado',
                  item: 'https://vasquezlawnc.com/william-vasquez-abogado',
                },
              ],
            },
            {
