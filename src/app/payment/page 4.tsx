...
import { Lock, DollarSign, ExternalLink, Building } from 'lucide-react';
...
export default function PaymentPage() {
  ...
  const content = {
    en: {
      ...
      description:
        'Make secure payments to Vasquez Law Firm through our trusted payment partner, LawPay.',
      ...
      security: {
        ...
        description:
          'Your payment information is encrypted and processed securely through LawPay, a trusted payment solution specifically designed for law firms.',
      },
      alternative: {
    ...
    es: {
      ...
      description:
        'Realice pagos seguros a Vasquez Law Firm a través de nuestro socio de pago de confianza, LawPay.',
      ...
      security: {
        ...
        description:
          'Su información de pago está encriptada y procesada de forma segura a través de LawPay, una solución de pago confiable diseñada específicamente para bufetes de abogados.',
      },
      alternative: {
      ...
      <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex items-center gap-2 bg-white rounded-lg shadow-sm p-1">
            <button
              ...
              className={`px-3 py-1 text-sm rounded ${
                language === 'en' ? 'bg-[#6B1F2E] text-white' : 'text-gray-600 hover:bg-gray-100'
              }`}
            >
              EN
            </button>
            <button
              ...
              className={`px-3 py-1 text-sm rounded ${
                language === 'es' ? 'bg-[#6B1F2E] text-white' : 'text-gray-600 hover:bg-gray-100'
              }`}
            >
              ES
            </button>
        ...
        <div className="bg-white rounded-lg shadow-lg">
          ...
          <div className="bg-[#6B1F2E] text-white p-6 rounded-t-lg">
            ...
            <p className="text-sm mt-2 opacity-90">{t.subtitle}</p>
          </div>
