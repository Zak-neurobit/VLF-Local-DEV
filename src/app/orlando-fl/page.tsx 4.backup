...
export const metadata: Metadata = {
  ...
  description:
    'Vasquez Law Firm in Orlando, FL - Immigration, personal injury, criminal defense & family law. Local attorneys who understand your needs. Walk-ins welcome.',
  openGraph: {
    title: 'Orlando, FL Lawyer Vasquez Law Firm, PLLC',
    description:
      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Orlando, FL</h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium">4426 Louisburg Road</p>
                      <p className="text-gray-600">Orlando, NC 27616</p>
                    </div>
                  </div>
                  <a
                    href="tel:(844) 967-3536"
              ...
              <div className="grid grid-cols-2 gap-4">
                <a
                  href="https://maps.google.com/?q=4426 Louisburg Road+Orlando+NC"
                  target="_blank"
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/orlando-fl/',
                  url: 'https://www.vasquezlawnc.com/orlando-fl/',
                  name: 'Orlando, FL Lawyer Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-11-27T14:35:03+00:00',
                  dateModified: '2024-11-27T14:36:20+00:00',
                  description:
                    'Trusted lawyers in Orlando, FL. Vasquez Law Firm provides skilled legal assistance for personal injury and immigration.',
                  breadcrumb: { '@id': 'https://www.vasquezlawnc.com/orlando-fl/#breadcrumb' },
                  inLanguage: 'en-US',
                  potentialAction: [
                    { '@type': 'ReadAction', target: ['https://www.vasquezlawnc.com/orlando-fl/'] },
                  ],
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id': 'https://www.vasquezlawnc.com/orlando-fl/#breadcrumb',
                  itemListElement: [
                    {
                      '@type': 'ListItem',
                      position: 1,
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Orlando, FL' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Orlando fl',
                  item: 'https://vasquezlawnc.com/orlando-fl',
                },
              ],
            },
            {
