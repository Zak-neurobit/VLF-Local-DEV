      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Orlando, FL Immigration Lawyers</h1>
              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Orlando, FL Immigration Lawyers | Vasquez Law Firm, PLLC
                  </h2>
                  <p className="text-gray-700">
                    Orlando, FL Immigration Lawyers brings extensive legal experience to every case.
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-700">
                    Orlando, FL Immigration Lawyers focuses on immigration, personal injury, and
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/orlando-fl-immigration-lawyers/',
                  url: 'https://www.vasquezlawnc.com/orlando-fl-immigration-lawyers/',
                  name: 'Orlando, FL Immigration Lawyers | Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-12-27T16:17:50+00:00',
                  dateModified: '2024-12-27T16:17:56+00:00',
                  description:
                    'Experienced immigration lawyers in Orlando, FL. Providing legal assistance for visas, green cards, citizenship, deportation defense, and more.',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/orlando-fl-immigration-lawyers/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/orlando-fl-immigration-lawyers/'],
                    },
                  ],
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id': 'https://www.vasquezlawnc.com/orlando-fl-immigration-lawyers/#breadcrumb',
                  itemListElement: [
                    {
                      '@type': 'ListItem',
                      position: 1,
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Orlando, FL Immigration Lawyers' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              '@context': 'https://schema.org',
              '@type': 'Attorney',
              name: 'Orlando, FL Immigration Lawyers',
              image: '',
              jobTitle: 'Attorney',
              worksFor: {
                '@type': 'LegalService',
              ...
              url: 'https://vasquezlawnc.com/orlando-fl-immigration-lawyers/index',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Orlando fl immigration lawyers',
                  item: 'https://vasquezlawnc.com/orlando-fl-immigration-lawyers',
                },
              ],
            },
            {
