        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Job-Related Risks for Agricultural Workers - Vasquez Law Firm, PLLC
            </h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/job-related-risks-for-agricultural-workers/',
                  url: 'https://www.vasquezlawnc.com/job-related-risks-for-agricultural-workers/',
                  name: 'Job-Related Risks for Agricultural Workers - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/job-related-risks-for-agricultural-workers/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/job-related-risks-for-agricultural-workers/#primaryimage',
                  ...
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/09/shutterstock-2259921419-min.jpg',
                  datePublished: '2024-06-21T16:11:43+00:00',
                  dateModified: '2024-09-18T16:12:02+00:00',
                  author: {
                    '@id':
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/job-related-risks-for-agricultural-workers/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: [
                        'https://www.vasquezlawnc.com/job-related-risks-for-agricultural-workers/',
                      ],
                    },
                  ],
                },
                ...
                },
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'Job-Related Risks for Agricultural Workers',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              availableLanguage: ['English', 'Spanish'],
              url: 'https://vasquezlawnc.com/job-related-risks-for-agricultural-workers/index',
            },
            {
              '@context': 'https://schema.org',
              '@type': 'BreadcrumbList',
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Job related risks for agricultural workers',
                  item: 'https://vasquezlawnc.com/job-related-risks-for-agricultural-workers',
                },
              ],
            },
            {
