              ...
              <div className="mt-12">
                ...
                <MomentumScroll>
                  <div className="space-y-4">
                    <h4 className="text-xl font-bold text-[#6B1F2E]">Experience Smooth Scrolling</h4>
                    <p className="text-gray-600">
                      This container has momentum-based scrolling with spring physics.
                      Try scrolling or dragging to feel the smooth motion!
                    </p>
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="mx-auto max-w-4xl space-y-6 text-gray-600">
                <div className="rounded-lg bg-white p-6 shadow-lg">
                  <h3 className="mb-3 text-xl font-semibold text-[#6B1F2E]">1. Import Animations</h3>
                ...
                <div className="rounded-lg bg-white p-6 shadow-lg">
                  <h3 className="mb-3 text-xl font-semibold text-[#6B1F2E]">2. Use Animation Hooks</h3>
                  <pre className="rounded bg-gray-100 p-4">
...
const { ref, y, scale } = useParallax();`}</code>
                ...
                <div className="rounded-lg bg-white p-6 shadow-lg">
                  <h3 className="mb-3 text-xl font-semibold text-[#6B1F2E]">3. Apply to Components</h3>
                  <pre className="rounded bg-gray-100 p-4">
