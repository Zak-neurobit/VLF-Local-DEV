...
export const metadata: Metadata = {
  title: 'Charlotte, NC - Vasquez Law Firm, PLLC',
  description:
      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Charlotte, NC</h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium">Charlotte Office</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <a
                  href="https://maps.google.com/?q=Charlotte Office+Charlotte+NC"
                  target="_blank"
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/charlotte-nc/',
                  url: 'https://www.vasquezlawnc.com/charlotte-nc/',
                  name: 'Charlotte, NC - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id': 'https://www.vasquezlawnc.com/charlotte-nc/#primaryimage',
                  },
                  image: { '@id': 'https://www.vasquezlawnc.com/charlotte-nc/#primaryimage' },
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/04/wake-county-family-based-immigration-lawyers.jpg',
                  datePublished: '2024-06-03T18:24:52+00:00',
                  dateModified: '2025-02-20T10:33:47+00:00',
                  description:
                    'Charlotte, NC, is a vibrant city known for its booming economy, rich history, and exciting attractions. Explore top dining, entertainment, and business opportunities!',
                  breadcrumb: { '@id': 'https://www.vasquezlawnc.com/charlotte-nc/#breadcrumb' },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/charlotte-nc/'],
                    },
                  ],
                },
                {
                ...
                {
                  '@type': 'BreadcrumbList',
                  '@id': 'https://www.vasquezlawnc.com/charlotte-nc/#breadcrumb',
                  itemListElement: [
                    {
                      '@type': 'ListItem',
                      position: 1,
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Charlotte, NC' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Charlotte nc',
                  item: 'https://vasquezlawnc.com/charlotte-nc',
                },
              ],
            },
            {
