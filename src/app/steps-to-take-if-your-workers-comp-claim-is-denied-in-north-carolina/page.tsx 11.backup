        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Steps To Take If Your Workers’ Comp Claim Is Denied In North Carolina | Vasquez Law
              Firm, PLLC
            </h1>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                  Steps To Take If Your Workers’ Comp Claim Is Denied In North Carolina | Vasquez
                  Law Firm, PLLC
                </h2>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/steps-to-take-if-your-workers-comp-claim-is-denied-in-north-carolina/',
                  url: 'https://www.vasquezlawnc.com/steps-to-take-if-your-workers-comp-claim-is-denied-in-north-carolina/',
                  name: 'Steps To Take If Your Workers’ Comp Claim Is Denied In North Carolina | Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/steps-to-take-if-your-workers-comp-claim-is-denied-in-north-carolina/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/steps-to-take-if-your-workers-comp-claim-is-denied-in-north-carolina/#primaryimage',
                  },
                  thumbnailUrl: '../wp-content/uploads/2024/10/steps-to-take-scaled.jpg',
                  datePublished: '2024-10-30T18:33:19+00:00',
                  author: {
                    '@id':
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/steps-to-take-if-your-workers-comp-claim-is-denied-in-north-carolina/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  '@id':
                    'https://www.vasquezlawnc.com/steps-to-take-if-your-workers-comp-claim-is-denied-in-north-carolina/#primaryimage',
                  url: '../wp-content/uploads/2024/10/steps-to-take-scaled.jpg',
                  contentUrl: '../wp-content/uploads/2024/10/steps-to-take-scaled.jpg',
                  width: 2560,
                  height: 1706,
                  caption: 'Steps To Take If Your Workers’ Comp Claim Is Denied In North Carolina',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'Steps To Take If Your Workers’ Comp Claim Is Denied In North Carolina',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              availableLanguage: ['English', 'Spanish'],
              url: 'https://vasquezlawnc.com/steps-to-take-if-your-workers-comp-claim-is-denied-in-north-carolina/index',
            },
            {
              '@context': 'https://schema.org',
              '@type': 'BreadcrumbList',
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Steps to take if your workers comp claim is denied in north carolina',
                  item: 'https://vasquezlawnc.com/steps-to-take-if-your-workers-comp-claim-is-denied-in-north-carolina',
                },
              ],
            },
            {
