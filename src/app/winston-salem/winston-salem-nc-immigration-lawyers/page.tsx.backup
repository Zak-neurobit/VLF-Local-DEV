...
export const metadata: Metadata = {
  title: 'Winston-Salem, NC Immigration Lawyers - Vasquez Law Firm, PLLC',
  description:
    'Experienced Winston-Salem, NC immigration lawyers helping with visas, green cards, and citizenship. Get trusted legal support for your immigration needs.',
  openGraph: {
    title: 'Winston-Salem, NC Immigration Lawyers - Vasquez Law Firm, PLLC',
    description:
      'Experienced Winston-Salem, NC immigration lawyers helping with visas, green cards, and citizenship. Get trusted legal support for your immigration needs.',
...
export default function WinstonSalemNcImmigrationLawyersPage() {
  return (
              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Winston-Salem, NC Immigration Lawyers - Vasquez Law Firm, PLLC
                  </h2>
                  <p className="text-gray-700">
                    Winston-Salem, NC Immigration Lawyers brings extensive legal experience to every
                    case. Licensed to practice in North Carolina and Florida, they has successfully
                    represented hundreds of clients in immigration, personal injury, and criminal
                    defense.
                  </p>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-700">
                    Winston-Salem, NC Immigration Lawyers focuses on immigration, personal injury,
                    and criminal defense, providing dedicated representation to clients throughout
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/winston-salem/winston-salem-nc-immigration-lawyers/',
                  url: 'https://www.vasquezlawnc.com/winston-salem/winston-salem-nc-immigration-lawyers/',
                  name: 'Winston-Salem, NC Immigration Lawyers - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/winston-salem/winston-salem-nc-immigration-lawyers/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/winston-salem/winston-salem-nc-immigration-lawyers/#primaryimage',
                  ...
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/04/wake-county-family-based-immigration-lawyers.jpg',
                  datePublished: '2024-09-09T19:28:12+00:00',
                  dateModified: '2025-02-19T12:30:11+00:00',
                  description:
                    'Experienced Winston-Salem, NC immigration lawyers helping with visas, green cards, and citizenship. Get trusted legal support for your immigration needs.',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/winston-salem/winston-salem-nc-immigration-lawyers/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'Wake County Family-Based Immigration Lawyers',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      ...
                      item: 'https://www.vasquezlawnc.com/winston-salem/',
                    },
                    {
                      '@type': 'ListItem',
                      position: 3,
                      name: 'Winston-Salem, NC Immigration Lawyers',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              url: 'https://vasquezlawnc.com/winston-salem/winston-salem-nc-immigration-lawyers/index',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Winston salem',
                  item: 'https://vasquezlawnc.com/winston-salem',
                },
                {
                  '@type': 'ListItem',
                  position: 3,
                  name: 'Winston salem nc immigration lawyers',
                  item: 'https://vasquezlawnc.com/winston-salem/winston-salem-nc-immigration-lawyers',
                },
              ],
            },
            {
