              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Winston-Salem, NC Auto Accident Lawyers - Vasquez Law Firm, PLLC
                  </h2>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/winston-salem/winston-salem-nc-auto-accident-lawyers/',
                  url: 'https://www.vasquezlawnc.com/winston-salem/winston-salem-nc-auto-accident-lawyers/',
                  name: 'Winston-Salem, NC Auto Accident Lawyers - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/winston-salem/winston-salem-nc-auto-accident-lawyers/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/winston-salem/winston-salem-nc-auto-accident-lawyers/#primaryimage',
                  ...
                  datePublished: '2024-09-09T19:29:33+00:00',
                  dateModified: '2025-02-19T12:18:38+00:00',
                  description:
                    'Injured in a crash? Winston-Salem, NC auto accident lawyers help you get the compensation you deserve. Expert legal representation. Free consultation.',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/winston-salem/winston-salem-nc-auto-accident-lawyers/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 3,
                      name: 'Winston-Salem, NC Auto Accident Lawyers',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              url: 'https://vasquezlawnc.com/winston-salem/winston-salem-nc-auto-accident-lawyers/index',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: 'Winston salem nc auto accident lawyers',
                  item: 'https://vasquezlawnc.com/winston-salem/winston-salem-nc-auto-accident-lawyers',
                },
              ],
            },
            {
