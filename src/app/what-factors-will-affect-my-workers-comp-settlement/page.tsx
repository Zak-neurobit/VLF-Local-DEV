        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              What Factors Will Affect My Worker’s Comp Settlement? | Vasquez Law Firm, PLLC
            </h1>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/what-factors-will-affect-my-workers-comp-settlement/',
                  url: 'https://www.vasquezlawnc.com/what-factors-will-affect-my-workers-comp-settlement/',
                  name: 'What Factors Will Affect My Worker’s Comp Settlement? | Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/what-factors-will-affect-my-workers-comp-settlement/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/what-factors-will-affect-my-workers-comp-settlement/#primaryimage',
                  ...
                  thumbnailUrl:
                    '../wp-content/uploads/2024/12/what-factors-will-affect-my-workers-comp-settlement-scaled.jpg',
                  datePublished: '2024-12-27T16:13:42+00:00',
                  dateModified: '2025-01-03T12:19:20+00:00',
                  author: {
                    '@id':
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/what-factors-will-affect-my-workers-comp-settlement/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  width: 2560,
                  height: 1159,
                  caption: 'What Factors Will Affect My Worker’s Comp Settlement?',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'What Factors Will Affect My Worker’s Comp Settlement?',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              availableLanguage: ['English', 'Spanish'],
              url: 'https://vasquezlawnc.com/what-factors-will-affect-my-workers-comp-settlement/index',
            },
            {
              '@context': 'https://schema.org',
              '@type': 'BreadcrumbList',
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 2,
                  name: 'What factors will affect my workers comp settlement',
                  item: 'https://vasquezlawnc.com/what-factors-will-affect-my-workers-comp-settlement',
                },
              ],
            },
            {
