    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Free Downloadable Resources</h2>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">External Resources & Links</h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Helpful external resources, government websites, and official forms organized by
                legal practice area. These links are provided for informational purposes only.
              </p>
            </div>
                        ...
                        {item.type === 'external' ? (
                          ...
                          >
                            <div className="flex items-start justify-between">
                              ...
                              <svg
                                className="w-5 h-5 text-gray-400 group-hover:text-primary-600 flex-shrink-0 ml-4 mt-1"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                              >
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-xl font-semibold text-red-600 mb-4">24/7 Crisis Hotlines</h3>
                <ul className="space-y-3 text-left">
                  <li className="flex items-center">
                    <span className="font-medium mr-2">National Domestic Violence Hotline:</span>
                    <a href="tel:1-800-799-7233" className="text-primary-600 hover:underline">
                      1-800-799-7233
                    </a>
                  </li>
                  <li className="flex items-center">
                    <span className="font-medium mr-2">National Suicide Prevention Lifeline:</span>
                    <a href="tel:988" className="text-primary-600 hover:underline">
                      988
                    </a>
                  </li>
                  <li className="flex items-center">
                    <span className="font-medium mr-2">RAINN National Sexual Assault Hotline:</span>
                    <a href="tel:1-800-656-4673" className="text-primary-600 hover:underline">
                      1-800-656-4673
                    </a>
                  </li>
                </ul>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-xl font-semibold text-red-600 mb-4">Immediate Legal Help</h3>
      ...
      <section className="py-16 bg-primary-600">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Need Legal Guidance?</h2>
            <p className="text-xl text-white/90 mb-8">
              These resources are helpful, but nothing replaces personalized legal advice. Schedule
              a free consultation with our experienced attorneys.
            </p>
