...
export const metadata: Metadata = {
  title: 'When Can Criminal Cases Affect a Person’s Immigration Status? - Vasquez Law Firm, PLLC',
  description:
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              When Can Criminal Cases Affect a Person’s Immigration Status? - Vasquez Law Firm, PLLC
            </h1>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                  When Can Criminal Cases Affect a Person’s Immigration Status? - Vasquez Law Firm,
                  PLLC
                </h2>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/when-can-criminal-cases-affect-a-persons-immigration-status/',
                  url: 'https://www.vasquezlawnc.com/when-can-criminal-cases-affect-a-persons-immigration-status/',
                  name: 'When Can Criminal Cases Affect a Person’s Immigration Status? - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/when-can-criminal-cases-affect-a-persons-immigration-status/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/when-can-criminal-cases-affect-a-persons-immigration-status/#primaryimage',
                  ...
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/09/shutterstock_1005706576-min.jpg',
                  datePublished: '2023-07-11T16:23:40+00:00',
                  dateModified: '2024-09-18T16:24:30+00:00',
                  author: {
                    '@id':
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/when-can-criminal-cases-affect-a-persons-immigration-status/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'When Can Criminal Cases Affect a Person’s Immigration Status?',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              availableLanguage: ['English', 'Spanish'],
              url: 'https://vasquezlawnc.com/when-can-criminal-cases-affect-a-persons-immigration-status/index',
            },
            {
              '@context': 'https://schema.org',
              '@type': 'BreadcrumbList',
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 2,
                  name: 'When can criminal cases affect a persons immigration status',
                  item: 'https://vasquezlawnc.com/when-can-criminal-cases-affect-a-persons-immigration-status',
                },
              ],
            },
            {
