      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">William Vasquez</h1>
              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    William Vasquez - Vasquez Law Firm, PLLC
                  </h2>
                  <p className="text-gray-700">
                    William Vasquez brings extensive legal experience to every case. Licensed to
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-700">
                    William Vasquez focuses on immigration, personal injury, and criminal defense,
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/attorneys/william-vasquez-attorney/',
                  url: 'https://www.vasquezlawnc.com/attorneys/william-vasquez-attorney/',
                  name: 'William Vasquez - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-03-08T15:11:52+00:00',
                  dateModified: '2025-02-19T11:57:12+00:00',
                  description:
                    'William Vasquez, attorney & founder, is a U.S. Air Force veteran and immigration lawyer in NC, providing expert legal counsel in immigration and criminal defense.',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/attorneys/william-vasquez-attorney/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/attorneys/william-vasquez-attorney/'],
                    },
                  ],
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 3, name: 'William Vasquez' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              url: 'https://vasquezlawnc.com/attorneys/william-vasquez-attorney/index',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 3,
                  name: 'William vasquez attorney',
                  item: 'https://vasquezlawnc.com/attorneys/william-vasquez-attorney',
                },
              ],
            },
            {
