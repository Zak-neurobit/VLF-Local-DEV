...
export const metadata: Metadata = {
  title: 'Struggles of Undocumented Immigrants? - Vasquez Law Firm, PLLC',
  description:
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              What’s Really Behind the Mental Health Struggles of Undocumented Immigrants?
            </h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/struggles-of-undocumented-immigrants/',
                  url: 'https://www.vasquezlawnc.com/struggles-of-undocumented-immigrants/',
                  name: 'Struggles of Undocumented Immigrants? - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/struggles-of-undocumented-immigrants/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/struggles-of-undocumented-immigrants/#primaryimage',
                  ...
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2025/01/Whats-Really-Behind-the-Mental-Health-Struggles.jpg',
                  datePublished: '2025-01-30T15:09:33+00:00',
                  author: {
                    '@id':
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/struggles-of-undocumented-immigrants/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: [
                        'https://www.vasquezlawnc.com/struggles-of-undocumented-immigrants/',
                      ],
                    },
                  ],
                },
                {
                  ...
                  height: 400,
                  caption:
                    'Image of an undocumented immigrant facing mental health struggles, highlighting the emotional and legal challenges they endure.',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'Struggles of Undocumented Immigrants?',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Struggles of undocumented immigrants',
                  item: 'https://vasquezlawnc.com/struggles-of-undocumented-immigrants',
                },
              ],
            },
            {
