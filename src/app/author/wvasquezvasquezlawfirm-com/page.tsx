        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              wvasquez@vasquezlawfirm.com, Author at Vasquez Law Firm, PLLC - Page 9 of 10
            </h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'ProfilePage',
                  '@id': 'https://www.vasquezlawnc.com/author/wvasquezvasquezlawfirm-com/',
                  url: 'https://www.vasquezlawnc.com/author/wvasquezvasquezlawfirm-com/page/9/',
                  name: 'wvasquez@vasquezlawfirm.com, Author at Vasquez Law Firm, PLLC - Page 9 of 10',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/author/wvasquezvasquezlawfirm-com/page/9/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/author/wvasquezvasquezlawfirm-com/page/9/#primaryimage',
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/author/wvasquezvasquezlawfirm-com/page/9/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: [
                        'https://www.vasquezlawnc.com/author/wvasquezvasquezlawfirm-com/page/9/',
                      ],
                    },
                  ],
                },
                ...
                },
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'Archives for wvasquez@vasquezlawfirm.com',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Author',
                  item: 'https://vasquezlawnc.com/author',
                },
                {
                  '@type': 'ListItem',
                  position: 3,
                  name: 'Wvasquezvasquezlawfirm com',
                  item: 'https://vasquezlawnc.com/author/wvasquezvasquezlawfirm-com',
                },
                {
                  '@type': 'ListItem',
                  position: 4,
                  name: 'Page',
                  item: 'https://vasquezlawnc.com/author/wvasquezvasquezlawfirm-com/page',
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: '9',
                  item: 'https://vasquezlawnc.com/author/wvasquezvasquezlawfirm-com/page/9',
                },
              ],
            },
            {
