          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/',
                  url: 'https://www.vasquezlawnc.com/',
                  name: 'Home - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-02-12T19:23:31+00:00',
                  dateModified: '2025-04-11T13:47:11+00:00',
                  description:
                    'Find experienced Raleigh, NC immigration lawyers to help with visas, green cards, citizenship, and more. Get expert legal guidance for your immigration needs today.',
                  breadcrumb: { '@id': 'https://www.vasquezlawnc.com/#breadcrumb' },
                  inLanguage: 'en-US',
                  potentialAction: [
                    { '@type': 'ReadAction', target: ['https://www.vasquezlawnc.com/'] },
                  ],
                },
                {
                  '@type': 'BreadcrumbList',
