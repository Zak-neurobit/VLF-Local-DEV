...
import { ModernSelect as Select, ModernSelectContent as SelectContent, ModernSelectItem as SelectItem, ModernSelectTrigger as SelectTrigger, ModernSelectValue as SelectValue } from '@/components/ui/modern-select';
...
export default function AnalyticsPage() {
  ...
  const { isConnected, realtimeMetrics, emitPageView } = useAnalyticsSocket();

  useEffect(() => {
    fetchMetrics();
    emitPageView('/admin/analytics');
  }, [timeRange, emitPageView]);
            ...
            <TabsContent value="overview" className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <AreaChart
                  ...
                  data={trendData}
                  areas={[
                    { key: 'responseTime', color: '#F59E0B', name: 'Response Time (ms)' },
                  ]}
                />
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <BarChart
                  ...
                  bars={[
                    { key: 'value', color: '#3B82F6', name: 'Count' },
                  ]}
                />
              </div>
            </TabsContent>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold">{metrics.seo.organicTraffic.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold">{metrics.content.totalViews.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold text-red-600">{metrics.security.threatsDetected}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Threats Blocked</span>
                      <span className="font-bold text-green-600">{metrics.security.threatsBlocked}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Success Rate</span>
                      <span className="font-bold">
                        {((metrics.security.threatsBlocked / metrics.security.threatsDetected) * 100).toFixed(1)}%
                      </span>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <div className="text-center space-y-2">
                      <div className={`text-3xl font-bold ${
                        metrics.security.riskScore <= 30 ? 'text-green-600' : 
                        metrics.security.riskScore <= 60 ? 'text-yellow-600' : 'text-red-600'
                      }`}>
                        {metrics.security.riskScore}/100
                      </div>
                      <div className="text-sm text-gray-600">Current Risk Score</div>
                      <Badge variant={
                        metrics.security.riskScore <= 30 ? 'default' : 
                        metrics.security.riskScore <= 60 ? 'secondary' : 'destructive'
                      }>
                        {metrics.security.riskScore <= 30 ? 'Low Risk' : 
                         metrics.security.riskScore <= 60 ? 'Medium Risk' : 'High Risk'}
                      </Badge>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <div className="text-center space-y-2">
                      ...
                      <Badge variant="default">
                        {metrics.security.complianceScore >= 90 ? 'Excellent' : 
                         metrics.security.complianceScore >= 80 ? 'Good' : 'Needs Improvement'}
                      </Badge>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold text-green-600">{metrics.performance.uptime}%</span>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold text-yellow-600">{metrics.gmb.averageRating}/5</span>
                    </div>
                    <div className="flex justify-between">
