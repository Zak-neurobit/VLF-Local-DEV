        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Raleigh, NC Third-Party Work Injury Claims Attorneys
            </h1>
              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Raleigh, NC Third-Party Work Injury Claims Attorneys - Vasquez Law Firm, PLLC
                  </h2>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/workers-compensation-job-injury/third-party-injury-claims/',
                  url: 'https://www.vasquezlawnc.com/workers-compensation-job-injury/third-party-injury-claims/',
                  name: 'Raleigh, NC Third-Party Work Injury Claims Attorneys - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/workers-compensation-job-injury/third-party-injury-claims/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/workers-compensation-job-injury/third-party-injury-claims/#primaryimage',
                  ...
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/04/charlotte-nc-third-party-lawsuit-attorneys.jpg',
                  datePublished: '2024-04-04T19:53:36+00:00',
                  dateModified: '2024-04-04T19:54:10+00:00',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/workers-compensation-job-injury/third-party-injury-claims/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'Charlotte NC Third-Party Lawsuit Attorneys',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
            ...
            },
            {
              '@context': 'https://schema.org',
              '@type': 'Attorney',
              name: 'Raleigh, NC Third-Party Work Injury Claims Attorneys',
              image: '',
              jobTitle: 'Attorney',
              worksFor: {
                '@type': 'LegalService',
              ...
              url: 'https://vasquezlawnc.com/workers-compensation-job-injury/third-party-injury-claims/page/9/index﹖et_blog',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 2,
                  name: 'Workers compensation job injury',
                  item: 'https://vasquezlawnc.com/workers-compensation-job-injury',
                },
                {
                  '@type': 'ListItem',
                  position: 3,
                  name: 'Third party injury claims',
                  item: 'https://vasquezlawnc.com/workers-compensation-job-injury/third-party-injury-claims',
                },
                {
                  '@type': 'ListItem',
                  position: 4,
                  name: 'Page',
                  item: 'https://vasquezlawnc.com/workers-compensation-job-injury/third-party-injury-claims/page',
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: '9',
                  item: 'https://vasquezlawnc.com/workers-compensation-job-injury/third-party-injury-claims/page/9',
                },
                {
                  '@type': 'ListItem',
                  position: 6,
                  name: 'Index﹖et_blog',
                  item: 'https://vasquezlawnc.com/workers-compensation-job-injury/third-party-injury-claims/page/9/index﹖et_blog',
                },
              ],
            },
            {
