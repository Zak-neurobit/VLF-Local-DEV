              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Raleigh, NC Workers&apos; Compensation Attorneys - Vasquez Law Firm, PLLC
                  </h2>
              ...
              '@graph': [
                {
                  ...
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/workers-compensation-job-injury/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/workers-compensation-job-injury/#primaryimage',
                  ...
                  datePublished: '2024-02-19T21:04:12+00:00',
                  dateModified: '2024-12-10T13:10:50+00:00',
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/workers-compensation-job-injury/'],
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: 'Page',
                  item: 'https://vasquezlawnc.com/workers-compensation-job-injury/page',
                },
                {
                  '@type': 'ListItem',
                  position: 4,
                  name: '9',
                  item: 'https://vasquezlawnc.com/workers-compensation-job-injury/page/9',
                },
                {
                  '@type': 'ListItem',
                  position: 5,
