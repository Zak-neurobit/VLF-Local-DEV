              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Orlando, FL Auto Accident Lawyers | Vasquez Law Firm, PLLC
                  </h2>
                  <p className="text-gray-700">
                    Orlando, FL Auto Accident Lawyers brings extensive legal experience to every
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-700">
                    Orlando, FL Auto Accident Lawyers focuses on immigration, personal injury, and
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/orlando-fl-auto-accident-lawyers/',
                  url: 'https://www.vasquezlawnc.com/orlando-fl-auto-accident-lawyers/',
                  name: 'Orlando, FL Auto Accident Lawyers | Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-11-27T14:38:45+00:00',
                  dateModified: '2024-12-27T16:22:15+00:00',
                  description:
                    'Experienced auto accident lawyers in Orlando, providing legal assistance for injury claims, compensation, and navigating the aftermath of a car accident.',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/orlando-fl-auto-accident-lawyers/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/orlando-fl-auto-accident-lawyers/'],
                    },
                  ],
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Orlando, FL Auto Accident Lawyers' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              '@context': 'https://schema.org',
              '@type': 'Attorney',
              name: 'Orlando, FL Auto Accident Lawyers',
              image: '',
              jobTitle: 'Attorney',
              worksFor: {
                '@type': 'LegalService',
              ...
              url: 'https://vasquezlawnc.com/orlando-fl-auto-accident-lawyers/index',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Orlando fl auto accident lawyers',
                  item: 'https://vasquezlawnc.com/orlando-fl-auto-accident-lawyers',
                },
              ],
            },
            {
