...
export const metadata: Metadata = {
  ...
  description: 'Read what our clients say about us. Over 30,000 cases won. Immigration, personal injury, and criminal defense attorneys.',
};

export default function TestimonialsPage() {
  return (
    <div className="min-h-screen bg-white">
      <section className="py-20 bg-gradient-to-br from-[#1B3B5A] to-[#2C5282] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex items-center gap-4">
            ...
            <span className="text-lg">4.5 out of 5.0 based on 363 reviews</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg mb-2">30,000+ Cases Won</h3>
              <p className="text-gray-600">Proven experience in immigration, personal injury, and criminal defense</p>
            </div>
            <div className="text-center">
              <div className="bg-[#1B3B5A] text-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg mb-2">Bilingual Team</h3>
              <p className="text-gray-600">Our entire team speaks both English and Spanish fluently</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="bg-white text-[#1B3B5A] border-2 border-[#1B3B5A] px-8 py-4 rounded-lg font-semibold text-lg hover:bg-[#1B3B5A] hover:text-white transition-colors inline-flex items-center justify-center gap-2"
            >
