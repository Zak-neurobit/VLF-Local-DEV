...
export const metadata: Metadata = {
  title:
    "Workplace Accident Attorneys NC & FL | Workers' Compensation Attorneys | Vasquez Law Firm",
  description:
  ...
  openGraph: {
    title: 'Workplace Accident Attorneys | Work Injury Legal Experts - Vasquez Law Firm',
    description:
...
export default function WorkplaceAccidentsPage() {
  ...
  return (
    <StandardizedPracticeAreaTemplate
      title="Workplace Accident Attorneys"
