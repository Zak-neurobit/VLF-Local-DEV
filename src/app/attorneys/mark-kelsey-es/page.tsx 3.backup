      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Mark Kelsey</h1>
              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Mark kelsey - Vasquez Law Firm, PLLC
                  </h2>
                  <p className="text-gray-700">
                    Mark Kelsey brings extensive legal experience to every case. Licensed to
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-700">
                    Mark Kelsey focuses on immigration, personal injury, and criminal defense,
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/attorneys/mark-kelsey-es/',
                  url: 'https://www.vasquezlawnc.com/attorneys/mark-kelsey-es/',
                  name: 'Mark kelsey - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2025-04-22T13:05:00+00:00',
                  dateModified: '2025-04-22T13:06:15+00:00',
                  description:
                    'Mark Kelsey is a dedicated professional providing expert services with a focus on quality and client satisfaction. Learn more about his expertise today.',
                  breadcrumb: {
                    '@id': 'https://www.vasquezlawnc.com/attorneys/mark-kelsey-es/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/attorneys/mark-kelsey-es/'],
                    },
                  ],
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 3, name: 'Mark kelsey' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              url: 'https://vasquezlawnc.com/attorneys/mark-kelsey-es/index',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: 'Mark kelsey es',
                  item: 'https://vasquezlawnc.com/attorneys/mark-kelsey-es',
                },
              ],
            },
            {
