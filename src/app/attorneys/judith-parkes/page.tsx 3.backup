...
export const metadata: Metadata = {
  title: 'Judith Parkes - Attorney - Vasquez Law Firm, PLLC',
  description: '',
};
      ...
      <section className="relative bg-gradient-to-r from-burgundy-700 to-burgundy-900 text-white py-20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Judith Parkes - Attorney</h1>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="mb-8">
                ...
                <p className="text-gray-700">
                  Judith Parkes brings decades of experience in complex litigation and appeals to
                  the firm.
                </p>
              </div>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: 'https://www.vasquezlawfirm.com/attorneys/judith-parkes/page',
            sameAs: [
