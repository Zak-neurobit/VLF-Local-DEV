      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Roselyn V. Torrellas</h1>
              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Roselyn v. Torrellas - Vasquez Law Firm, PLLC
                  </h2>
                  <p className="text-gray-700">
                    Roselyn V. Torrellas brings extensive legal experience to every case. Licensed
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-700">
                    Roselyn V. Torrellas focuses on immigration, personal injury, and criminal
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/attorneys/roselyn-v-torrellas/',
                  url: 'https://www.vasquezlawnc.com/attorneys/roselyn-v-torrellas/',
                  name: 'Roselyn v. Torrellas - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/attorneys/roselyn-v-torrellas/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/attorneys/roselyn-v-torrellas/#primaryimage',
                  ...
                  thumbnailUrl:
                    'https://vasquezlawnc.com/wp-content/uploads/2024/03/attn-torrellas-249x300.jpg',
                  datePublished: '2025-04-22T13:11:25+00:00',
                  dateModified: '2025-04-22T13:19:32+00:00',
                  description:
                    'Roselyn V. Torrellas is a dedicated attorney providing expert legal counsel in immigration and personal injury law. Trusted representation you can count on.',
                  breadcrumb: {
                    '@id': 'https://www.vasquezlawnc.com/attorneys/roselyn-v-torrellas/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/attorneys/roselyn-v-torrellas/'],
                    },
                  ],
                },
                {
                  '@type': 'ImageObject',
                  inLanguage: 'en-US',
                  '@id': 'https://www.vasquezlawnc.com/attorneys/roselyn-v-torrellas/#primaryimage',
                  url: 'https://vasquezlawnc.com/wp-content/uploads/2024/03/attn-torrellas-249x300.jpg',
                  contentUrl:
                    'https://vasquezlawnc.com/wp-content/uploads/2024/03/attn-torrellas-249x300.jpg',
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 3, name: 'Roselyn v. Torrellas' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              url: 'https://vasquezlawnc.com/attorneys/roselyn-v-torrellas/index',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: 'Roselyn v torrellas',
                  item: 'https://vasquezlawnc.com/attorneys/roselyn-v-torrellas',
                },
              ],
            },
            {
