        ...
        <section className="relative overflow-hidden bg-black py-24">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                <h1 className="text-5xl md:text-7xl font-black mb-6 text-white">Jillian Baucom</h1>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="bg-neutral-900/50 p-4 rounded-xl border border-primary/20">
                      ...
                      <p className="text-gray-400">Removal Defense</p>
                    </div>
                  </div>
                </motion.div>
              </div>
                  ...
                  <ul className="space-y-4">
                    <li className="border-l-2 border-primary pl-4">
                      ...
                      <p className="text-gray-400 text-sm">
                        University of North Carolina School of Law, 2016
                      </p>
                    </li>
                    <li className="border-l-2 border-primary pl-4">
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {[
                    ...
                    'Post-Conviction Relief for Immigration',
                  ].map((service, index) => (
                    <motion.div
                      key={index}
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <p className="text-xl mb-8 text-gray-300">
                  Contact Jillian Baucom today for experienced removal defense representation.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <motion.a
                    href="/contact"
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: 'https://www.vasquezlawfirm.com/attorneys/jillian-baucom',
              sameAs: [
