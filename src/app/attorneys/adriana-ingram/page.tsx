...
const VoiceAssistant = dynamic(
  () => import('@/components/VirtualAssistant').then(mod => mod.VirtualAssistant),
  {
    ssr: false,
  }
);
...
export default function AdrianaIngramPage() {
  return (
      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Adrianna Ingram</h1>
              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Adriana ingram - Vasquez Law Firm, PLLC
                  </h2>
                  <p className="text-gray-700">
                    Adrianna Ingram brings extensive legal experience to every case. Licensed to
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-700">
                    Adrianna Ingram focuses on immigration, personal injury, and criminal defense,
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/attorneys/adriana-ingram/',
                  url: 'https://www.vasquezlawnc.com/attorneys/adriana-ingram/',
                  name: 'Adriana ingram - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id': 'https://www.vasquezlawnc.com/attorneys/adriana-ingram/#primaryimage',
                  },
                  image: {
                    '@id': 'https://www.vasquezlawnc.com/attorneys/adriana-ingram/#primaryimage',
                  },
                  thumbnailUrl:
                    'https://vasquezlawnc.com/wp-content/uploads/2024/03/att-adrianna.webp',
                  datePublished: '2024-03-08T15:40:44+00:00',
                  dateModified: '2025-04-16T09:25:07+00:00',
                  description:
                    'Adrianna Ingram, experienced family and criminal attorney, provides dedicated legal representation to protect your rights and family in every case. Contact now!',
                  breadcrumb: {
                    '@id': 'https://www.vasquezlawnc.com/attorneys/adriana-ingram/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/attorneys/adriana-ingram/'],
                    },
                  ],
                },
                {
                  ...
                  inLanguage: 'en-US',
                  '@id': 'https://www.vasquezlawnc.com/attorneys/adriana-ingram/#primaryimage',
                  url: 'https://vasquezlawnc.com/wp-content/uploads/2024/03/att-adrianna.webp',
                  contentUrl:
                    'https://vasquezlawnc.com/wp-content/uploads/2024/03/att-adrianna.webp',
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Attorneys', item: '../index.html' },
                    { '@type': 'ListItem', position: 3, name: 'Adriana ingram' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              url: 'https://vasquezlawnc.com/attorneys/adriana-ingram/index',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: 'Adriana ingram',
                  item: 'https://vasquezlawnc.com/attorneys/adriana-ingram',
                },
              ],
            },
            {
