...
export const metadata: Metadata = {
  title: 'Adrianna Ingram - Attorney - Vasquez Law Firm, PLLC',
  description: '',
};
      ...
      <section className="relative bg-gradient-to-r from-burgundy-700 to-burgundy-900 text-white py-20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Adrianna Ingram - Attorney</h1>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="mb-8">
                ...
                <p className="text-gray-700">
                  Adrianna Ingram specializes in all aspects of immigration law, including
                  family-based petitions, employment visas, and deportation defense.
                </p>
              </div>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: 'https://www.vasquezlawfirm.com/attorneys/adrianna-ingram/page',
            sameAs: [
