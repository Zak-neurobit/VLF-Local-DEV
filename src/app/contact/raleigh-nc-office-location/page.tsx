      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Map & Directions – Raleigh</h1>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Raleigh, NC 27616</p>
                    </div>
                  </div>
                  <a
                    href="tel:+1-919-755-9425"
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/contact/raleigh-nc-office-location/',
                  url: 'https://www.vasquezlawnc.com/contact/raleigh-nc-office-location/',
                  name: 'Raleigh, NC Office Location - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-09-13T14:25:58+00:00',
                  dateModified: '2025-02-20T10:58:27+00:00',
                  description:
                    'Find the best route to our Raleigh, NC office. Get accurate maps and directions to visit our workers’ comp lawyers. Contact us for assistance today!',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/contact/raleigh-nc-office-location/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/contact/raleigh-nc-office-location/'],
                    },
                  ],
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 3, name: 'Raleigh, NC Office Location' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              geo: { '@type': 'GeoCoordinates', latitude: '35.843768', longitude: '-78.720567' },
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 3,
                  name: 'Raleigh nc office location',
                  item: 'https://vasquezlawnc.com/contact/raleigh-nc-office-location',
                },
              ],
            },
            {
