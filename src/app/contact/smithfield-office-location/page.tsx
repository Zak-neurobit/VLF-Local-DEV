  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Map & Directions – Smithfield</h1>
            <p className="text-xl mb-8">Serving Smithfield and Surrounding Areas</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium">Smithfield Office</p>
                      <p className="text-gray-600">Smithfield, NC 27577</p>
                    </div>
                  </div>
                  <a
                    href="tel:+1-919-755-9425"
              ...
              <div className="grid grid-cols-2 gap-4">
                <a
                  href="https://maps.google.com/?q=Smithfield Office+Smithfield+NC"
                  target="_blank"
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-burgundy-900 text-center mb-12">
            Why Choose Vasquez Law Firm in Smithfield?
          </h2>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/contact/smithfield-office-location/',
                  url: 'https://www.vasquezlawnc.com/contact/smithfield-office-location/',
                  name: 'Smithfield Office Location - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-09-13T14:17:11+00:00',
                  dateModified: '2025-02-20T10:29:31+00:00',
                  description:
                    'Find our Smithfield office with our easy-to-follow map and directions. Get convenient access to expert legal assistance. Visit us or call for more details!',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/contact/smithfield-office-location/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/contact/smithfield-office-location/'],
                    },
                  ],
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 3, name: 'Smithfield Office Location' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              address: {
                '@type': 'PostalAddress',
                streetAddress: 'Smithfield Office',
                addressLocality: 'Smithfield',
                addressRegion: 'NC',
                postalCode: '27577',
              },
              geo: { '@type': 'GeoCoordinates', latitude: '35.508456', longitude: '-78.339416' },
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 3,
                  name: 'Smithfield office location',
                  item: 'https://vasquezlawnc.com/contact/smithfield-office-location',
                },
              ],
            },
            {
