...
export default function GoldsboroOfficeLocationPage() {
  return (
      ...
      <section className="bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Goldsboro, NC Office Location</h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/contact/goldsboro-office-location/',
                  url: 'https://www.vasquezlawnc.com/contact/goldsboro-office-location/',
                  name: 'Goldsboro, NC Office Location - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-09-13T14:34:54+00:00',
                  dateModified: '2025-02-20T10:35:07+00:00',
                  description:
                    'Find our Goldsboro, NC office location for expert services. Conveniently located with easy access, we offer top solutions to meet your needs. Visit us today!',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/contact/goldsboro-office-location/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/contact/goldsboro-office-location/'],
                    },
                  ],
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 3, name: 'Goldsboro, NC Office Location' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 3,
                  name: 'Goldsboro office location',
                  item: 'https://vasquezlawnc.com/contact/goldsboro-office-location',
                },
              ],
            },
            {
