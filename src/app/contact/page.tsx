...
export const metadata: Metadata = {
  ...
  description: 'Contact Vasquez Law Firm for a free consultation. Available 24/7 with AI assistant. Offices in NC & FL. Call 1-844-YO-PELEO or chat now. Se habla español.',
