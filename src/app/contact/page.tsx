...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Top Bar */}
      <div className="bg-[#C9974D] text-white py-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <Link href="/" className="flex items-center">
              <div>
                <h1 className="text-2xl font-bold text-[#C9974D]">Vasquez Law Firm, PLLC</h1>
                <p className="text-xs text-[#6B1F2E] font-semibold">YO PELEO POR TI™</p>
              </div>
            </Link>
            <div className="hidden md:flex items-center space-x-6">
              ...
              <Link href="/contact" className="text-[#C9974D] font-medium">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="bg-gradient-to-r from-[#C9974D] to-[#B8843D] rounded-lg p-8 text-white">
                <h3 className="text-2xl font-bold mb-6">{t.instantHelp}</h3>
                <button className="w-full px-6 py-3 bg-white text-[#C9974D] rounded-md font-semibold hover:shadow-lg transition-all mb-4">
                  🤖 {t.chatNow}
                </button>
              ...
              <div className="bg-[#6B1F2E]/10 rounded-lg p-6">
                <h3 className="text-xl font-bold text-[#6B1F2E] mb-3">{t.emergency}</h3>
                <p className="text-gray-700 mb-4">{t.emergencyText}</p>
                <button className="px-6 py-2 bg-[#6B1F2E] text-white rounded-md font-medium hover:bg-[#8B2635] transition-colors">
                  {t.startChat}
                </button>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <div className="flex gap-3">
                  <span className="px-3 py-1 bg-[#C9974D]/10 text-[#C9974D] rounded-full text-sm font-medium">
                    English
                  </span>
                  <span className="px-3 py-1 bg-[#C9974D]/10 text-[#C9974D] rounded-full text-sm font-medium">
                    Español
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-sm text-[#C9974D] font-medium mb-2">{location.phone}</p>
                    <p className="text-xs text-gray-500 mb-4">{location.hours}</p>
                    <a
                      href={location.mapUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-sm text-[#6B1F2E] font-medium hover:underline"
                    >
                      {t.getDirections} →
                    </a>
                  </div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-[#C9974D] to-[#B8843D] rounded-2xl p-8 text-white">
