  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Charlotte, NC Office Location</h1>
            <p className="text-xl mb-8">Serving Charlotte and Surrounding Areas</p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={`tel:${office?.phone?.replace(/[^0-9]/g, '') || '7042662998'}`}
              ...
              >
                Call {office?.phone || '(704) 266-2998'}
              </a>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium">
                        {office?.address || '5701 Executive Center Dr, Ste 103'}
                      </p>
                      <p className="text-gray-600">
                        {office?.city || 'Charlotte'}, {office?.state || 'NC'}{' '}
                        {office?.fullAddress?.split(', ').pop()?.split(' ').pop() || '28212'}
                      </p>
                    </div>
                  </div>
                  <a
                  ...
                  >
                    ...
                    <span>{office?.phone || '(704) 266-2998'}</span>
                  </a>
                  <a
              ...
              <div className="grid grid-cols-2 gap-4">
                <a
                  href={
                    office?.mapUrl ||
                    'https://maps.google.com/?q=5701+Executive+Center+Dr+Charlotte+NC+28212'
                  }
                  target="_blank"
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-burgundy-900 text-center mb-12">
            Why Choose Vasquez Law Firm in Charlotte?
          </h2>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/contact/charlotte-nc-office-location/',
                  url: 'https://www.vasquezlawnc.com/contact/charlotte-nc-office-location/',
                  name: 'Charlotte, NC Office Location - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-09-13T14:31:08+00:00',
                  dateModified: '2025-02-20T10:39:30+00:00',
                  description:
                    'Visit our Charlotte, NC office for expert legal services in family and criminal law. Convenient location, dedicated support—schedule a consultation today!',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/contact/charlotte-nc-office-location/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: [
                        'https://www.vasquezlawnc.com/contact/charlotte-nc-office-location/',
                      ],
                    },
                  ],
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 3, name: 'Charlotte, NC Office Location' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              address: {
                '@type': 'PostalAddress',
                streetAddress: 'Charlotte Office',
                addressLocality: 'Charlotte',
                addressRegion: 'NC',
                postalCode: '28202',
              },
              geo: { '@type': 'GeoCoordinates', latitude: '35.227085', longitude: '-80.843124' },
              telephone: '+1-980-754-9667',
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 3,
                  name: 'Charlotte nc office location',
                  item: 'https://vasquezlawnc.com/contact/charlotte-nc-office-location',
                },
              ],
            },
            {
