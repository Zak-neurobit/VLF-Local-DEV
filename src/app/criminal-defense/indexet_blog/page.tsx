              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Raleigh Criminal Defense Attorneys - Vasquez Law Firm, PLLC
                  </h2>
                  <p className="text-gray-700">
                    Raleigh Criminal Defense Attorneys brings extensive legal experience to every
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-700">
                    Raleigh Criminal Defense Attorneys focuses on immigration, personal injury, and
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/criminal-defense/',
                  url: 'https://www.vasquezlawnc.com/criminal-defense/',
                  name: 'Raleigh Criminal Defense Attorneys - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id': 'https://www.vasquezlawnc.com/criminal-defense/#primaryimage',
                  },
                  image: { '@id': 'https://www.vasquezlawnc.com/criminal-defense/#primaryimage' },
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/04/smithfield-criminal-defense-law-firm.jpg',
                  datePublished: '2024-02-19T21:04:34+00:00',
                  dateModified: '2025-02-19T11:58:15+00:00',
                  description:
                    'Experienced Raleigh criminal defense attorneys protecting your rights. Get skilled legal representation for DUI, drug charges, assault, and more. Call today.',
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/criminal-defense/'],
                    },
                  ],
                },
                {
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'Smithfield Criminal Defense Law Firm',
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              '@context': 'https://schema.org',
              '@type': 'Attorney',
              name: 'Raleigh Criminal Defense Attorneys',
              image: '',
              jobTitle: 'Attorney',
              worksFor: {
                '@type': 'LegalService',
              ...
              url: 'https://vasquezlawnc.com/criminal-defense/page/9/index﹖et_blog',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  item: 'https://vasquezlawnc.com/criminal-defense',
                },
                {
                  '@type': 'ListItem',
                  position: 3,
                  name: 'Page',
                  item: 'https://vasquezlawnc.com/criminal-defense/page',
                },
                {
                  '@type': 'ListItem',
                  position: 4,
                  name: '9',
                  item: 'https://vasquezlawnc.com/criminal-defense/page/9',
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: 'Index﹖et_blog',
                  item: 'https://vasquezlawnc.com/criminal-defense/page/9/index﹖et_blog',
                },
              ],
            },
            {
