...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://vasquezlawnc.com/criminal-defense',
  },
};
      ...
      <section className="relative bg-gradient-to-br from-[#6B1F2E] to-[#8B2635] text-white py-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl md:text-2xl max-w-3xl">
            Experienced Raleigh criminal defense attorneys protecting your rights. Get skilled legal
            representation for DUI, drug charges, assault, and more. Call today.
          </p>
        </div>
      </section>
