        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Understanding the Different Kinds of Family Visas in North Carolina - Vasquez Law
              Firm, PLLC
            </h1>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/understanding-the-different-kinds-of-family-visas-in-north-carolina/',
                  url: 'https://www.vasquezlawnc.com/understanding-the-different-kinds-of-family-visas-in-north-carolina/',
                  name: 'Understanding the Different Kinds of Family Visas in North Carolina - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/understanding-the-different-kinds-of-family-visas-in-north-carolina/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/understanding-the-different-kinds-of-family-visas-in-north-carolina/#primaryimage',
                  ...
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/09/shutterstock-1487364161-1.jpg',
                  datePublished: '2024-05-21T16:14:44+00:00',
                  dateModified: '2024-09-18T16:15:01+00:00',
                  author: {
                    '@id':
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/understanding-the-different-kinds-of-family-visas-in-north-carolina/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'Understanding the Different Kinds of Family Visas in North Carolina',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              availableLanguage: ['English', 'Spanish'],
              url: 'https://vasquezlawnc.com/understanding-the-different-kinds-of-family-visas-in-north-carolina/index',
            },
            {
              '@context': 'https://schema.org',
              '@type': 'BreadcrumbList',
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Understanding the different kinds of family visas in north carolina',
                  item: 'https://vasquezlawnc.com/understanding-the-different-kinds-of-family-visas-in-north-carolina',
                },
              ],
            },
            {
