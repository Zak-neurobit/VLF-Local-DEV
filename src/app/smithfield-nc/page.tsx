      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Smithfield, NC</h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/smithfield-nc/',
                  url: 'https://www.vasquezlawnc.com/smithfield-nc/',
                  name: 'Smithfield, NC - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-09-30T20:25:53+00:00',
                  dateModified: '2025-02-19T12:36:53+00:00',
                  description:
                    'Discover Smithfield, NC – a charming town with rich history, great dining, and a welcoming community. Explore local attractions and small-town charm today!',
                  breadcrumb: { '@id': 'https://www.vasquezlawnc.com/smithfield-nc/#breadcrumb' },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/smithfield-nc/'],
                    },
                  ],
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id': 'https://www.vasquezlawnc.com/smithfield-nc/#breadcrumb',
                  itemListElement: [
                    {
                      '@type': 'ListItem',
                      position: 1,
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Smithfield, NC' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Smithfield nc',
                  item: 'https://vasquezlawnc.com/smithfield-nc',
                },
              ],
            },
            {
