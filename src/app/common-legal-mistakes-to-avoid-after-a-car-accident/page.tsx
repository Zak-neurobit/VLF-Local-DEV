        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Common Legal Mistakes to Avoid After a Car Accident - Vasquez Law Firm, PLLC
            </h1>
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/common-legal-mistakes-to-avoid-after-a-car-accident/',
                  url: 'https://www.vasquezlawnc.com/common-legal-mistakes-to-avoid-after-a-car-accident/',
                  name: 'Common Legal Mistakes to Avoid After a Car Accident - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/common-legal-mistakes-to-avoid-after-a-car-accident/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/common-legal-mistakes-to-avoid-after-a-car-accident/#primaryimage',
                  },
                  thumbnailUrl: '../wp-content/uploads/2024/09/vasquez-blog-sept2024.webp',
                  datePublished: '2024-09-30T20:39:12+00:00',
                  author: {
                    '@id':
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/common-legal-mistakes-to-avoid-after-a-car-accident/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  '@id':
                    'https://www.vasquezlawnc.com/common-legal-mistakes-to-avoid-after-a-car-accident/#primaryimage',
                  url: '../wp-content/uploads/2024/09/vasquez-blog-sept2024.webp',
                  contentUrl: '../wp-content/uploads/2024/09/vasquez-blog-sept2024.webp',
                  width: 1000,
                  height: 400,
                },
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'Common Legal Mistakes to Avoid After a Car Accident',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Common legal mistakes to avoid after a car accident',
                  item: 'https://vasquezlawnc.com/common-legal-mistakes-to-avoid-after-a-car-accident',
                },
              ],
            },
            {
