...
export const metadata: Metadata = {
  title: 'Abogado de Divorcio Cerca De Mí Raleigh NC | Disponible 24/7 | Consulta Gratuita',
  description:
    '¿Busca un abogado de divorcio cerca de usted en Raleigh? ⭐ Calificación 5 Estrellas • 60+ Años de Experiencia • Se Habla Español • Citas el Mismo Día • Llame 1-844-YO-PELEO',
  keywords:
    'abogado de divorcio cerca de mi, abogado de derecho familiar cerca de mi, abogado de custodia cerca de mi, abogado de divorcio raleigh nc cerca de mi, mejor abogado de divorcio cerca de mi, abogado de divorcio que habla español cerca de mi, abogado de divorcio de emergencia cerca de mi',
  openGraph: {
    title: 'Abogado de Divorcio Cerca De Mí en Raleigh | Vasquez Law Firm',
    description:
      'Ayuda Legal de Emergencia 24/7 en Raleigh. Consulta Gratuita. 30,000+ Casos Ganados. Se Habla Español.',
    url: 'https://www.vasquezlawnc.com/es/cerca-de-mi/raleigh-abogado-divorcio-cerca-de-mi',
    images: [
      {
        url: '/images/raleigh-office-hero.jpg',
        width: 1200,
        height: 630,
        alt: 'Vasquez Law Firm Raleigh - Abogado de Divorcio Cerca de Usted',
      },
    ],
  },
};
...
export default function RaleighAbogadodivorcioCercaDeMiPage() {
  const post = {
    id: 'raleigh-abogado-divorcio-cerca-de-mi',
    title: 'Abogado de Divorcio Cerca De Mí en Raleigh',
    slug: 'raleigh-abogado-divorcio-cerca-de-mi',
    excerpt: 'Abogado de Divorcio experimentado en Raleigh, NC. Consulta gratuita disponible 24/7.',
    content: `
      <div class="prose prose-lg max-w-none">
        <h1>Abogado de Divorcio Cerca De Mí en Raleigh, NC</h1>
        
        <p>¿Necesita un abogado de divorcio cerca de usted en Raleigh? Vasquez Law Firm es su mejor opción. Con más de 60 años de experiencia combinada, nuestro equipo bilingüe está listo para luchar por sus derechos.</p>

        <h2>👨‍👩‍👧‍👦 Servicios de Abogado de Divorcio en Raleigh</h2>
        ...
        <h2>📞 Contacte a Su Abogado de Divorcio en Raleigh Hoy</h2>
    ...
    tags: ['divorcio', 'raleigh', 'abogado', 'cerca-de-mi'],
  };
