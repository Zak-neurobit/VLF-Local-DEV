...
export const metadata: Metadata = {
  title: 'Abogado de Divorcio Cerca De Mí High Point NC | Disponible 24/7 | Consulta Gratuita',
  description:
    '¿Busca un abogado de divorcio cerca de usted en High Point? ⭐ Calificación 5 Estrellas • 60+ Años de Experiencia • Se Habla Español • Citas el Mismo Día • Llame 1-844-YO-PELEO',
  keywords:
    'abogado de divorcio cerca de mi, abogado de derecho familiar cerca de mi, abogado de custodia cerca de mi, abogado de divorcio high point nc cerca de mi, mejor abogado de divorcio cerca de mi, abogado de divorcio que habla español cerca de mi, abogado de divorcio de emergencia cerca de mi',
  openGraph: {
    title: 'Abogado de Divorcio Cerca De Mí en High Point | Vasquez Law Firm',
    description:
      'Ayuda Legal de Emergencia 24/7 en High Point. Consulta Gratuita. 30,000+ Casos Ganados. Se Habla Español.',
    url: 'https://www.vasquezlawnc.com/es/cerca-de-mi/high-point-abogado-divorcio-cerca-de-mi',
    images: [
      {
        url: '/images/high-point-office-hero.jpg',
        width: 1200,
        height: 630,
        alt: 'Vasquez Law Firm High Point - Abogado de Divorcio Cerca de Usted',
      },
    ],
  },
};
  ...
  const post = {
    ...
    content: `
      <div class="prose prose-lg max-w-none">
        ...
        <h2>👨‍👩‍👧‍👦 Servicios de Abogado de Divorcio en High Point</h2>
    ...
    tags: ['divorcio', 'high-point', 'abogado', 'cerca-de-mi'],
  };
