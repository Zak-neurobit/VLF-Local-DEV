...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado de dui cerca de usted en Greensboro, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
  keywords: 'abogado de dui cerca de mi, abogado de dui Greensboro, abogado Greensboro, abogado de dui NC, abogado español Greensboro',
  openGraph: {
    title: 'Abogado de DUI Cerca de Mi en Greensboro, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado de dui cerca de usted en Greensboro, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
