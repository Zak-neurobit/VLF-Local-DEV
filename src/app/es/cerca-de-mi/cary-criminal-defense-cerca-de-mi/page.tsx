...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado de defensa criminal cerca de usted en Cary, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
  keywords: 'abogado de defensa criminal cerca de mi, abogado de defensa criminal Cary, abogado Cary, abogado de defensa criminal NC, abogado español Cary',
  openGraph: {
    title: 'Abogado de Defensa Criminal Cerca de Mi en Cary, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado de defensa criminal cerca de usted en Cary, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
