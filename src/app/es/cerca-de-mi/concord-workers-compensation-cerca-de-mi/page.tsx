...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado de compensación laboral cerca de usted en Concord, NC. Consultas gratuitas 24/7. Llame (704) 533-7000.',
  keywords: 'abogado de compensación laboral cerca de mi, abogado de compensación laboral Concord, abogado Concord, abogado de compensación laboral NC, abogado español Concord',
  openGraph: {
    title: 'Abogado de Compensación Laboral Cerca de Mi en Concord, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado de compensación laboral cerca de usted en Concord, NC. Consultas gratuitas 24/7. Llame (704) 533-7000.',
  ...
  alternates: {
    canonical: 'https://www.vasquezlawnc.com/es/cerca-de-mi/concord-workers-compensation-cerca-de-mi',
    languages: {
      'en-US': 'https://www.vasquezlawnc.com/near-me/concord-workers-compensation-near-me',
      'es-ES': 'https://www.vasquezlawnc.com/es/cerca-de-mi/concord-workers-compensation-cerca-de-mi'
    }
  }
};