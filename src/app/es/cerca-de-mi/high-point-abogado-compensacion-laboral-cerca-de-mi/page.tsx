...
export const metadata: Metadata = {
  title:
    'Abogado de Compensación Laboral Cerca De Mí High Point NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function HighPointAbogadocompensacionlaboralCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado de Compensación Laboral experimentado en High Point, NC. Consulta gratuita disponible 24/7.',
    content: `
