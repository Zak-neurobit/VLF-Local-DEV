...
export const metadata: Metadata = {
  title: 'Abogado de Compensación Laboral Cerca De Mí High Point NC | Disponible 24/7 | Consulta Gratuita',
  description:
    '¿Busca un abogado de compensación laboral cerca de usted en High Point? ⭐ Calificación 5 Estrellas • 60+ Años de Experiencia • Se Habla Español • Citas el Mismo Día • Llame 1-844-YO-PELEO',
  keywords:
    'abogado de compensacion laboral cerca de mi, abogado de lesiones en el trabajo cerca de mi, workers comp cerca de mi, abogado de compensación laboral high point nc cerca de mi, mejor abogado de compensación laboral cerca de mi, abogado de compensación laboral que habla español cerca de mi, abogado de compensación laboral de emergencia cerca de mi',
  openGraph: {
    title: 'Abogado de Compensación Laboral Cerca De Mí en High Point | Vasquez Law Firm',
    description:
      'Ayuda Legal de Emergencia 24/7 en High Point. Consulta Gratuita. 30,000+ Casos Ganados. Se Habla Español.',
    url: 'https://www.vasquezlawnc.com/es/cerca-de-mi/high-point-abogado-compensacion-laboral-cerca-de-mi',
    images: [
      {
        url: '/images/high-point-office-hero.jpg',
        width: 1200,
        height: 630,
        alt: 'Vasquez Law Firm High Point - Abogado de Compensación Laboral Cerca de Usted',
      },
    ],
  },
};
...
export default function HighPointAbogadocompensacionlaboralCercaDeMiPage() {
  const post = {
    id: 'high-point-abogado-compensacion-laboral-cerca-de-mi',
    title: 'Abogado de Compensación Laboral Cerca De Mí en High Point',
    slug: 'high-point-abogado-compensacion-laboral-cerca-de-mi',
    excerpt: 'Abogado de Compensación Laboral experimentado en High Point, NC. Consulta gratuita disponible 24/7.',
    content: `
      <div class="prose prose-lg max-w-none">
        <h1>Abogado de Compensación Laboral Cerca De Mí en High Point, NC</h1>
        
        <p>¿Necesita un abogado de compensación laboral cerca de usted en High Point? Vasquez Law Firm es su mejor opción. Con más de 60 años de experiencia combinada, nuestro equipo bilingüe está listo para luchar por sus derechos.</p>

        <h2>💼 Servicios de Abogado de Compensación Laboral en High Point</h2>
        ...
        <h2>📞 Contacte a Su Abogado de Compensación Laboral en High Point Hoy</h2>
    ...
    tags: ['compensacion', 'high-point', 'abogado', 'cerca-de-mi'],
  };
