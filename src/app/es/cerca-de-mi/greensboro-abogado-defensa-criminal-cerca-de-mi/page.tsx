...
export const metadata: Metadata = {
  ...
  keywords:
    'abogado de defensa criminal cerca de mi, abogado criminalista cerca de mi, defensa penal cerca de mi, abogado de defensa criminal greensboro nc cerca de mi, mejor abogado de defensa criminal cerca de mi, abogado de defensa criminal que habla español cerca de mi, abogado de defensa criminal de emergencia cerca de mi',
  openGraph: {
    title: 'Abogado de Defensa Criminal Cerca De Mí en Greensboro | Vasquez Law Firm',
    description:
      'Ayuda Legal de Emergencia 24/7 en Greensboro. Consulta Gratuita. 30,000+ Casos Ganados. Se Habla Español.',
    url: 'https://www.vasquezlawnc.com/es/cerca-de-mi/greensboro-abogado-defensa-criminal-cerca-de-mi',
    images: [
      {
        url: '/images/greensboro-office-hero.jpg',
        width: 1200,
        height: 630,
        alt: 'Vasquez Law Firm Greensboro - Abogado de Defensa Criminal Cerca de Usted',
      },
    ],
  },
};
  ...
  const post = {
    ...
    content: `
      <div class="prose prose-lg max-w-none">
        ...
        <h2>⚖️ Servicios de Abogado de Defensa Criminal en Greensboro</h2>
    ...
    tags: ['defensa', 'greensboro', 'abogado', 'cerca-de-mi'],
  };
