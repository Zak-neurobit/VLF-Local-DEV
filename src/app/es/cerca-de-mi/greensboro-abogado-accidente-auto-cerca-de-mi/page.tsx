...
export const metadata: Metadata = {
  title: 'Abogado de Accidente de Auto Cerca De Mí Greensboro NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function GreensboroAbogadoaccidenteautoCercaDeMiPage() {
  const post = {
    ...
    excerpt: 'Abogado de Accidente de Auto experimentado en Greensboro, NC. Consulta gratuita disponible 24/7.',
    content: `
