...
export const metadata: Metadata = {
  title:
    'Abogado de Lesiones Personales Cerca De Mí Greensboro NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function GreensboroAbogadolesionespersonalesCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado de Lesiones Personales experimentado en Greensboro, NC. Consulta gratuita disponible 24/7.',
    content: `
