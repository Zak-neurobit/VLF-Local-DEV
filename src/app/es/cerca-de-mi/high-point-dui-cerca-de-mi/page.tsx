...
export const metadata = {
  ...
  description:
    'Encuentre el mejor abogado de dui cerca de usted en High Point, NC. Consultas gratuitas 24/7. Llame (704) 533-7000.',
  keywords:
    'abogado de dui cerca de mi, abogado de dui High Point, abogado High Point, abogado de dui NC, abogado español High Point',
  openGraph: {
    title: 'Abogado de DUI Cerca de Mi en High Point, NC | Vasquez Law Firm',
    description:
      'Encuentre el mejor abogado de dui cerca de usted en High Point, NC. Consultas gratuitas 24/7. Llame (704) 533-7000.',
