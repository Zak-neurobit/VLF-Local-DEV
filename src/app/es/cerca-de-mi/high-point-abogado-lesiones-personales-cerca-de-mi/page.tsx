...
export const metadata: Metadata = {
  title:
    'Abogado de Lesiones Personales Cerca De Mí High Point NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function HighPointAbogadolesionespersonalesCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado de Lesiones Personales experimentado en High Point, NC. Consulta gratuita disponible 24/7.',
    content: `
