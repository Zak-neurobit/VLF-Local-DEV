...
export const metadata: Metadata = {
  title:
    'Abogado de Accidente de Auto Cerca De Mí Raleigh NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function RaleighAbogadoaccidenteautoCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado de Accidente de Auto experimentado en Raleigh, NC. Consulta gratuita disponible 24/7.',
    content: `
