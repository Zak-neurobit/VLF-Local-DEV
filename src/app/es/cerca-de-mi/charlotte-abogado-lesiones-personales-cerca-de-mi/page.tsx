...
export const metadata: Metadata = {
  title: 'Abogado de Lesiones Personales Cerca De Mí Charlotte NC | Disponible 24/7 | Consulta Gratuita',
  description:
    '¿Busca un abogado de lesiones personales cerca de usted en Charlotte? ⭐ Calificación 5 Estrellas • 60+ Años de Experiencia • Se Habla Español • Citas el Mismo Día • Llame 1-844-YO-PELEO',
  keywords:
    'abogado de lesiones personales cerca de mi, abogado de accidentes cerca de mi, abogado de daños cerca de mi, abogado de lesiones personales charlotte nc cerca de mi, mejor abogado de lesiones personales cerca de mi, abogado de lesiones personales que habla español cerca de mi, abogado de lesiones personales de emergencia cerca de mi',
  openGraph: {
    title: 'Abogado de Lesiones Personales Cerca De Mí en Charlotte | Vasquez Law Firm',
    description:
      'Ayuda Legal de Emergencia 24/7 en Charlotte. Consulta Gratuita. 30,000+ Casos Ganados. Se Habla Español.',
    url: 'https://www.vasquezlawnc.com/es/cerca-de-mi/charlotte-abogado-lesiones-personales-cerca-de-mi',
    images: [
      {
        url: '/images/charlotte-office-hero.jpg',
        width: 1200,
        height: 630,
        alt: 'Vasquez Law Firm Charlotte - Abogado de Lesiones Personales Cerca de Usted',
      },
    ],
  },
};
...
export default function CharlotteAbogadolesionespersonalesCercaDeMiPage() {
  const post = {
    id: 'charlotte-abogado-lesiones-personales-cerca-de-mi',
    title: 'Abogado de Lesiones Personales Cerca De Mí en Charlotte',
    slug: 'charlotte-abogado-lesiones-personales-cerca-de-mi',
    excerpt: 'Abogado de Lesiones Personales experimentado en Charlotte, NC. Consulta gratuita disponible 24/7.',
    content: `
      <div class="prose prose-lg max-w-none">
        <h1>Abogado de Lesiones Personales Cerca De Mí en Charlotte, NC</h1>
        
        <p>¿Necesita un abogado de lesiones personales cerca de usted en Charlotte? Vasquez Law Firm es su mejor opción. Con más de 60 años de experiencia combinada, nuestro equipo bilingüe está listo para luchar por sus derechos.</p>

        <h2>🏥 Servicios de Abogado de Lesiones Personales en Charlotte</h2>
        ...
        <h2>📞 Contacte a Su Abogado de Lesiones Personales en Charlotte Hoy</h2>
    ...
    tags: ['lesiones', 'charlotte', 'abogado', 'cerca-de-mi'],
  };
