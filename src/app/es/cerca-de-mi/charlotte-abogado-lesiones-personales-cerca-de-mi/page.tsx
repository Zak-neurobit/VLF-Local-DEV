...
export const metadata: Metadata = {
  title:
    'Abogado de Lesiones Personales Cerca De Mí Charlotte NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function CharlotteAbogadolesionespersonalesCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado de Lesiones Personales experimentado en Charlotte, NC. Consulta gratuita disponible 24/7.',
    content: `
