...
export const metadata: Metadata = {
  title: 'Abogado de Compensación Laboral Cerca De Mí Fayetteville NC | Disponible 24/7 | Consulta Gratuita',
  description:
    '¿Busca un abogado de compensación laboral cerca de usted en Fayetteville? ⭐ Calificación 5 Estrellas • 60+ Años de Experiencia • Se Habla Español • Citas el Mismo Día • Llame 1-844-YO-PELEO',
  keywords:
    'abogado de compensacion laboral cerca de mi, abogado de lesiones en el trabajo cerca de mi, workers comp cerca de mi, abogado de compensación laboral fayetteville nc cerca de mi, mejor abogado de compensación laboral cerca de mi, abogado de compensación laboral que habla español cerca de mi, abogado de compensación laboral de emergencia cerca de mi',
  openGraph: {
    title: 'Abogado de Compensación Laboral Cerca De Mí en Fayetteville | Vasquez Law Firm',
    description:
      'Ayuda Legal de Emergencia 24/7 en Fayetteville. Consulta Gratuita. 30,000+ Casos Ganados. Se Habla Español.',
    url: 'https://www.vasquezlawnc.com/es/cerca-de-mi/fayetteville-abogado-compensacion-laboral-cerca-de-mi',
    images: [
      {
        url: '/images/fayetteville-office-hero.jpg',
        width: 1200,
        height: 630,
        alt: 'Vasquez Law Firm Fayetteville - Abogado de Compensación Laboral Cerca de Usted',
      },
    ],
  },
};
...
export default function FayettevilleAbogadocompensacionlaboralCercaDeMiPage() {
  const post = {
    id: 'fayetteville-abogado-compensacion-laboral-cerca-de-mi',
    title: 'Abogado de Compensación Laboral Cerca De Mí en Fayetteville',
    slug: 'fayetteville-abogado-compensacion-laboral-cerca-de-mi',
    excerpt: 'Abogado de Compensación Laboral experimentado en Fayetteville, NC. Consulta gratuita disponible 24/7.',
    content: `
      <div class="prose prose-lg max-w-none">
        <h1>Abogado de Compensación Laboral Cerca De Mí en Fayetteville, NC</h1>
        
        <p>¿Necesita un abogado de compensación laboral cerca de usted en Fayetteville? Vasquez Law Firm es su mejor opción. Con más de 60 años de experiencia combinada, nuestro equipo bilingüe está listo para luchar por sus derechos.</p>

        <h2>💼 Servicios de Abogado de Compensación Laboral en Fayetteville</h2>
        ...
        <h2>📞 Contacte a Su Abogado de Compensación Laboral en Fayetteville Hoy</h2>
    ...
    tags: ['compensacion', 'fayetteville', 'abogado', 'cerca-de-mi'],
  };
