...
export const metadata: Metadata = {
  title:
    'Abogado de Compensación Laboral Cerca De Mí Fayetteville NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function FayettevilleAbogadocompensacionlaboralCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado de Compensación Laboral experimentado en Fayetteville, NC. Consulta gratuita disponible 24/7.',
    content: `
