...
export const metadata: Metadata = {
  title:
    'Abogado de Defensa Criminal Cerca De Mí Fayetteville NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function FayettevilleAbogadodefensacriminalCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado de Defensa Criminal experimentado en Fayetteville, NC. Consulta gratuita disponible 24/7.',
    content: `
