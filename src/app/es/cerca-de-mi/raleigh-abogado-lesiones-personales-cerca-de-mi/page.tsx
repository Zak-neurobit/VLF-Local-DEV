...
export const metadata: Metadata = {
  title:
    'Abogado de Lesiones Personales Cerca De Mí Raleigh NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function RaleighAbogadolesionespersonalesCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado de Lesiones Personales experimentado en Raleigh, NC. Consulta gratuita disponible 24/7.',
    content: `
