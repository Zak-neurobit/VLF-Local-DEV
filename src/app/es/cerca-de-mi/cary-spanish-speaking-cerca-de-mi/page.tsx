...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado que habla español cerca de usted en Cary, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
  keywords: 'abogado que habla español cerca de mi, abogado que habla español Cary, abogado Cary, abogado que habla español NC, abogado español Cary',
  openGraph: {
    title: 'Abogado que Habla Español Cerca de Mi en Cary, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado que habla español cerca de usted en Cary, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
