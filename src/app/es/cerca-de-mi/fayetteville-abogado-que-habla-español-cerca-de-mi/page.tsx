...
export const metadata: Metadata = {
  title:
    'Abogado Que Habla Español Cerca De Mí Fayetteville NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function FayettevilleAbogadoquehablaespañolCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado Que Habla Español experimentado en Fayetteville, NC. Consulta gratuita disponible 24/7.',
    content: `
