...
export const metadata: Metadata = {
  title: 'Abogado de Compensación Laboral Cerca De Mí Greensboro NC | Disponible 24/7 | Consulta Gratuita',
  description:
    '¿Busca un abogado de compensación laboral cerca de usted en Greensboro? ⭐ Calificación 5 Estrellas • 60+ Años de Experiencia • Se Habla Español • Citas el Mismo Día • Llame 1-844-YO-PELEO',
  keywords:
    'abogado de compensacion laboral cerca de mi, abogado de lesiones en el trabajo cerca de mi, workers comp cerca de mi, abogado de compensación laboral greensboro nc cerca de mi, mejor abogado de compensación laboral cerca de mi, abogado de compensación laboral que habla español cerca de mi, abogado de compensación laboral de emergencia cerca de mi',
  openGraph: {
    title: 'Abogado de Compensación Laboral Cerca De Mí en Greensboro | Vasquez Law Firm',
    description:
      'Ayuda Legal de Emergencia 24/7 en Greensboro. Consulta Gratuita. 30,000+ Casos Ganados. Se Habla Español.',
    url: 'https://www.vasquezlawnc.com/es/cerca-de-mi/greensboro-abogado-compensacion-laboral-cerca-de-mi',
    images: [
      {
        url: '/images/greensboro-office-hero.jpg',
        width: 1200,
        height: 630,
        alt: 'Vasquez Law Firm Greensboro - Abogado de Compensación Laboral Cerca de Usted',
      },
    ],
  },
};
...
export default function GreensboroAbogadocompensacionlaboralCercaDeMiPage() {
  const post = {
    id: 'greensboro-abogado-compensacion-laboral-cerca-de-mi',
    title: 'Abogado de Compensación Laboral Cerca De Mí en Greensboro',
    slug: 'greensboro-abogado-compensacion-laboral-cerca-de-mi',
    excerpt: 'Abogado de Compensación Laboral experimentado en Greensboro, NC. Consulta gratuita disponible 24/7.',
    content: `
      <div class="prose prose-lg max-w-none">
        <h1>Abogado de Compensación Laboral Cerca De Mí en Greensboro, NC</h1>
        
        <p>¿Necesita un abogado de compensación laboral cerca de usted en Greensboro? Vasquez Law Firm es su mejor opción. Con más de 60 años de experiencia combinada, nuestro equipo bilingüe está listo para luchar por sus derechos.</p>

        <h2>💼 Servicios de Abogado de Compensación Laboral en Greensboro</h2>
        ...
        <h2>📞 Contacte a Su Abogado de Compensación Laboral en Greensboro Hoy</h2>
    ...
    tags: ['compensacion', 'greensboro', 'abogado', 'cerca-de-mi'],
  };
