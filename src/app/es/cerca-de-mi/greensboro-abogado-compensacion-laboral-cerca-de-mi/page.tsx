...
export const metadata: Metadata = {
  title:
    'Abogado de Compensación Laboral Cerca De Mí Greensboro NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function GreensboroAbogadocompensacionlaboralCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado de Compensación Laboral experimentado en Greensboro, NC. Consulta gratuita disponible 24/7.',
    content: `
