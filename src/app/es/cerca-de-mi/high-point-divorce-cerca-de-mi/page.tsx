...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado de divorcio cerca de usted en High Point, NC. Consultas gratuitas 24/7. Llame (704) 533-7000.',
  keywords: 'abogado de divorcio cerca de mi, abogado de divorcio High Point, abogado High Point, abogado de divorcio NC, abogado español High Point',
  openGraph: {
    title: 'Abogado de Divorcio Cerca de Mi en High Point, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado de divorcio cerca de usted en High Point, NC. Consultas gratuitas 24/7. Llame (704) 533-7000.',
