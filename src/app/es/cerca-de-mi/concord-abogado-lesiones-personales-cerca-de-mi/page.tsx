...
export const metadata: Metadata = {
  title:
    'Abogado de Lesiones Personales Cerca De Mí Concord NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function ConcordAbogadolesionespersonalesCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado de Lesiones Personales experimentado en Concord, NC. Consulta gratuita disponible 24/7.',
    content: `
