...
export default function GreensboroCarAccidentsNearMePage() {
...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado de accidentes de auto cerca de usted en Greensboro, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
  keywords: 'abogado de accidentes de auto cerca de mi, abogado de accidentes de auto Greensboro, abogado Greensboro, abogado de accidentes de auto NC, abogado español Greensboro',
  openGraph: {
    title: 'Abogado de Accidentes de Auto Cerca de Mi en Greensboro, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado de accidentes de auto cerca de usted en Greensboro, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
