...
export const metadata: Metadata = {
  title: 'Abogado Que Habla Español Cerca De Mí Greensboro NC | Disponible 24/7 | Consulta Gratuita',
  description:
    '¿Busca un abogado que habla español cerca de usted en Greensboro? ⭐ Calificación 5 Estrellas • 60+ Años de Experiencia • Se Habla Español • Citas el Mismo Día • Llame 1-844-YO-PELEO',
  keywords:
    'abogado que habla español cerca de mi, abogado bilingue cerca de mi, abogado hispano cerca de mi, abogado que habla español greensboro nc cerca de mi, mejor abogado que habla español cerca de mi, abogado que habla español que habla español cerca de mi, abogado que habla español de emergencia cerca de mi',
  openGraph: {
    title: 'Abogado Que Habla Español Cerca De Mí en Greensboro | Vasquez Law Firm',
    description:
      'Ayuda Legal de Emergencia 24/7 en Greensboro. Consulta Gratuita. 30,000+ Casos Ganados. Se Habla Español.',
    url: 'https://www.vasquezlawnc.com/es/cerca-de-mi/greensboro-abogado-que-habla-español-cerca-de-mi',
    images: [
      {
        url: '/images/greensboro-office-hero.jpg',
        width: 1200,
        height: 630,
        alt: 'Vasquez Law Firm Greensboro - Abogado Que Habla Español Cerca de Usted',
      },
    ],
  },
};
...
export default function GreensboroAbogadoquehablaespañolCercaDeMiPage() {
  const post = {
    id: 'greensboro-abogado-que-habla-español-cerca-de-mi',
    title: 'Abogado Que Habla Español Cerca De Mí en Greensboro',
    slug: 'greensboro-abogado-que-habla-español-cerca-de-mi',
    excerpt: 'Abogado Que Habla Español experimentado en Greensboro, NC. Consulta gratuita disponible 24/7.',
    content: `
      <div class="prose prose-lg max-w-none">
        <h1>Abogado Que Habla Español Cerca De Mí en Greensboro, NC</h1>
        
        <p>¿Necesita un abogado que habla español cerca de usted en Greensboro? Vasquez Law Firm es su mejor opción. Con más de 60 años de experiencia combinada, nuestro equipo bilingüe está listo para luchar por sus derechos.</p>

        <h2>🗣️ Servicios de Abogado Que Habla Español en Greensboro</h2>
        ...
        <h2>📞 Contacte a Su Abogado Que Habla Español en Greensboro Hoy</h2>
    ...
    tags: ['que', 'greensboro', 'abogado', 'cerca-de-mi'],
  };
