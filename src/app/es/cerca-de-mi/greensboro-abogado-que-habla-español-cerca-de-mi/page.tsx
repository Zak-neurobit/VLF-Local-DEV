...
export const metadata: Metadata = {
  title:
    'Abogado Que Habla Español Cerca De Mí Greensboro NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function GreensboroAbogadoquehablaespañolCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado Que Habla Español experimentado en Greensboro, NC. Consulta gratuita disponible 24/7.',
    content: `
