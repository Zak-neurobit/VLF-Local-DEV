import greensuorodivorceNearMeClient from './greensuorodivorceNearMeClient';

export default function greensuorodivorceNearMePage() {
  return <greensuorodivorceNearMeClient />;
}
