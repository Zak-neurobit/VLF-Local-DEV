...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado de divorcio cerca de usted en Greensboro, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
  keywords: 'abogado de divorcio cerca de mi, abogado de divorcio Greensboro, abogado Greensboro, abogado de divorcio NC, abogado español Greensboro',
  openGraph: {
    title: 'Abogado de Divorcio Cerca de Mi en Greensboro, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado de divorcio cerca de usted en Greensboro, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
