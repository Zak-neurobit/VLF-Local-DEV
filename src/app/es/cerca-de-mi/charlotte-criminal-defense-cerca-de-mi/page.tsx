...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado de defensa criminal cerca de usted en Charlotte, NC. Consultas gratuitas 24/7. Llame (704) 533-7000.',
  keywords: 'abogado de defensa criminal cerca de mi, abogado de defensa criminal Charlotte, abogado Charlotte, abogado de defensa criminal NC, abogado español Charlotte',
  openGraph: {
    title: 'Abogado de Defensa Criminal Cerca de Mi en Charlotte, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado de defensa criminal cerca de usted en Charlotte, NC. Consultas gratuitas 24/7. Llame (704) 533-7000.',
