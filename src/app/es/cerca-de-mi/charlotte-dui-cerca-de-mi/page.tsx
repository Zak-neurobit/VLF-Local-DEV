...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado de dui cerca de usted en Charlotte, NC. Consultas gratuitas 24/7. Llame (704) 533-7000.',
  keywords: 'abogado de dui cerca de mi, abogado de dui Charlotte, abogado Charlotte, abogado de dui NC, abogado español Charlotte',
  openGraph: {
    title: 'Abogado de DUI Cerca de Mi en Charlotte, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado de dui cerca de usted en Charlotte, NC. Consultas gratuitas 24/7. Llame (704) 533-7000.',
