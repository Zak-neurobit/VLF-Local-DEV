...
export const metadata: Metadata = {
  title:
    'Abogado de Accidente de Auto Cerca De Mí High Point NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function HighPointAbogadoaccidenteautoCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado de Accidente de Auto experimentado en High Point, NC. Consulta gratuita disponible 24/7.',
    content: `
