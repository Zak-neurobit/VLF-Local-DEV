...
export const metadata: Metadata = {
  title: 'Abogado de Defensa Criminal Cerca De Mí Concord NC | Disponible 24/7 | Consulta Gratuita',
  description:
    '¿Busca un abogado de defensa criminal cerca de usted en Concord? ⭐ Calificación 5 Estrellas • 60+ Años de Experiencia • Se Habla Español • Citas el Mismo Día • Llame 1-844-YO-PELEO',
  keywords:
    'abogado de defensa criminal cerca de mi, abogado criminalista cerca de mi, defensa penal cerca de mi, abogado de defensa criminal concord nc cerca de mi, mejor abogado de defensa criminal cerca de mi, abogado de defensa criminal que habla español cerca de mi, abogado de defensa criminal de emergencia cerca de mi',
  openGraph: {
    title: 'Abogado de Defensa Criminal Cerca De Mí en Concord | Vasquez Law Firm',
    description:
      'Ayuda Legal de Emergencia 24/7 en Concord. Consulta Gratuita. 30,000+ Casos Ganados. Se Habla Español.',
    url: 'https://www.vasquezlawnc.com/es/cerca-de-mi/concord-abogado-defensa-criminal-cerca-de-mi',
    images: [
      {
        url: '/images/concord-office-hero.jpg',
        width: 1200,
        height: 630,
        alt: 'Vasquez Law Firm Concord - Abogado de Defensa Criminal Cerca de Usted',
      },
    ],
  },
};
...
export default function ConcordAbogadodefensacriminalCercaDeMiPage() {
  const post = {
    id: 'concord-abogado-defensa-criminal-cerca-de-mi',
    title: 'Abogado de Defensa Criminal Cerca De Mí en Concord',
    slug: 'concord-abogado-defensa-criminal-cerca-de-mi',
    excerpt: 'Abogado de Defensa Criminal experimentado en Concord, NC. Consulta gratuita disponible 24/7.',
    content: `
      <div class="prose prose-lg max-w-none">
        <h1>Abogado de Defensa Criminal Cerca De Mí en Concord, NC</h1>
        
        <p>¿Necesita un abogado de defensa criminal cerca de usted en Concord? Vasquez Law Firm es su mejor opción. Con más de 60 años de experiencia combinada, nuestro equipo bilingüe está listo para luchar por sus derechos.</p>

        <h2>⚖️ Servicios de Abogado de Defensa Criminal en Concord</h2>
        ...
        <h2>📞 Contacte a Su Abogado de Defensa Criminal en Concord Hoy</h2>
    ...
    tags: ['defensa', 'concord', 'abogado', 'cerca-de-mi'],
  };
