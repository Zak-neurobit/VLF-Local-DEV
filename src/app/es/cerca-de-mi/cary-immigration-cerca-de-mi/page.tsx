...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado de inmigración cerca de usted en Cary, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
  keywords: 'abogado de inmigración cerca de mi, abogado de inmigración Cary, abogado Cary, abogado de inmigración NC, abogado español Cary',
  openGraph: {
    title: 'Abogado de Inmigración Cerca de Mi en Cary, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado de inmigración cerca de usted en Cary, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
