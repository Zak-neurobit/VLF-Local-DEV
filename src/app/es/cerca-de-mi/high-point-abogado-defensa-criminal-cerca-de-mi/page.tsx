...
export const metadata: Metadata = {
  title:
    'Abogado de Defensa Criminal Cerca De Mí High Point NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function HighPointAbogadodefensacriminalCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado de Defensa Criminal experimentado en High Point, NC. Consulta gratuita disponible 24/7.',
    content: `
