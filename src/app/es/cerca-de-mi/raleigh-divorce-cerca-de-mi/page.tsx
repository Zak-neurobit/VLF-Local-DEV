...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado de divorcio cerca de usted en Raleigh, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
  keywords: 'abogado de divorcio cerca de mi, abogado de divorcio Raleigh, abogado Raleigh, abogado de divorcio NC, abogado español Raleigh',
  openGraph: {
    title: 'Abogado de Divorcio Cerca de Mi en Raleigh, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado de divorcio cerca de usted en Raleigh, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
