...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado de lesiones personales cerca de usted en Cary, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
  keywords: 'abogado de lesiones personales cerca de mi, abogado de lesiones personales Cary, abogado Cary, abogado de lesiones personales NC, abogado español Cary',
  openGraph: {
    title: 'Abogado de Lesiones Personales Cerca de Mi en Cary, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado de lesiones personales cerca de usted en Cary, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
