...
export const metadata: Metadata = {
  title: 'Abogado de Inmigración Cerca De Mí Greensboro NC | Disponible 24/7 | Consulta Gratuita',
  description:
    '¿Busca un abogado de inmigración cerca de usted en Greensboro? ⭐ Calificación 5 Estrellas • 60+ Años de Experiencia • Se Habla Español • Citas el Mismo Día • Llame 1-844-YO-PELEO',
  keywords:
    'abogado de inmigracion cerca de mi, abogado de deportacion cerca de mi, abogado de ciudadania cerca de mi, abogado de inmigración greensboro nc cerca de mi, mejor abogado de inmigración cerca de mi, abogado de inmigración que habla español cerca de mi, abogado de inmigración de emergencia cerca de mi',
  openGraph: {
    title: 'Abogado de Inmigración Cerca De Mí en Greensboro | Vasquez Law Firm',
    description:
      'Ayuda Legal de Emergencia 24/7 en Greensboro. Consulta Gratuita. 30,000+ Casos Ganados. Se Habla Español.',
    url: 'https://www.vasquezlawnc.com/es/cerca-de-mi/greensboro-abogado-inmigracion-cerca-de-mi',
    images: [
      {
        url: '/images/greensboro-office-hero.jpg',
        width: 1200,
        height: 630,
        alt: 'Vasquez Law Firm Greensboro - Abogado de Inmigración Cerca de Usted',
      },
    ],
  },
};
...
export default function GreensboroAbogadoinmigracionCercaDeMiPage() {
  const post = {
    id: 'greensboro-abogado-inmigracion-cerca-de-mi',
    title: 'Abogado de Inmigración Cerca De Mí en Greensboro',
    slug: 'greensboro-abogado-inmigracion-cerca-de-mi',
    excerpt: 'Abogado de Inmigración experimentado en Greensboro, NC. Consulta gratuita disponible 24/7.',
    content: `
      <div class="prose prose-lg max-w-none">
        <h1>Abogado de Inmigración Cerca De Mí en Greensboro, NC</h1>
        
        <p>¿Necesita un abogado de inmigración cerca de usted en Greensboro? Vasquez Law Firm es su mejor opción. Con más de 60 años de experiencia combinada, nuestro equipo bilingüe está listo para luchar por sus derechos.</p>

        <h2>🌐 Servicios de Abogado de Inmigración en Greensboro</h2>
        ...
        <h2>📞 Contacte a Su Abogado de Inmigración en Greensboro Hoy</h2>
    ...
    tags: ['inmigracion', 'greensboro', 'abogado', 'cerca-de-mi'],
  };
