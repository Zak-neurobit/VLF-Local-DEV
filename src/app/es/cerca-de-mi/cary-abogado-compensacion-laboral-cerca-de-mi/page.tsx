...
export const metadata: Metadata = {
  title:
    'Abogado de Compensación Laboral Cerca De Mí Cary NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function CaryAbogadocompensacionlaboralCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado de Compensación Laboral experimentado en Cary, NC. Consulta gratuita disponible 24/7.',
    content: `
