...
export const metadata: Metadata = {
  title: 'Abogado de DUI Cerca De Mí Raleigh NC | Disponible 24/7 | Consulta Gratuita',
  description:
    '¿Busca un abogado de DUI cerca de usted en Raleigh? ⭐ Calificación 5 Estrellas • 60+ Años de Experiencia • Se Habla Español • Citas el Mismo Día • Llame 1-844-YO-PELEO',
  keywords:
    'abogado de dui cerca de mi, abogado de dwi cerca de mi, defensa dui cerca de mi, abogado de DUI raleigh nc cerca de mi, mejor abogado de DUI cerca de mi, abogado de DUI que habla español cerca de mi, abogado de DUI de emergencia cerca de mi',
  openGraph: {
    title: 'Abogado de DUI Cerca De Mí en Raleigh | Vasquez Law Firm',
    description:
      'Ayuda Legal de Emergencia 24/7 en Raleigh. Consulta Gratuita. 30,000+ Casos Ganados. Se Habla Español.',
    url: 'https://www.vasquezlawnc.com/es/cerca-de-mi/raleigh-abogado-dui-cerca-de-mi',
    images: [
      {
        url: '/images/raleigh-office-hero.jpg',
        width: 1200,
        height: 630,
        alt: 'Vasquez Law Firm Raleigh - Abogado de DUI Cerca de Usted',
      },
    ],
  },
};
...
export default function RaleighAbogadoduiCercaDeMiPage() {
  const post = {
    id: 'raleigh-abogado-dui-cerca-de-mi',
    title: 'Abogado de DUI Cerca De Mí en Raleigh',
    slug: 'raleigh-abogado-dui-cerca-de-mi',
    excerpt: 'Abogado de DUI experimentado en Raleigh, NC. Consulta gratuita disponible 24/7.',
    content: `
      <div class="prose prose-lg max-w-none">
        <h1>Abogado de DUI Cerca De Mí en Raleigh, NC</h1>
        
        <p>¿Necesita un abogado de DUI cerca de usted en Raleigh? Vasquez Law Firm es su mejor opción. Con más de 60 años de experiencia combinada, nuestro equipo bilingüe está listo para luchar por sus derechos.</p>

        <h2>🚫 Servicios de Abogado de DUI en Raleigh</h2>
        ...
        <h2>📞 Contacte a Su Abogado de DUI en Raleigh Hoy</h2>
    ...
    tags: ['dui', 'raleigh', 'abogado', 'cerca-de-mi'],
  };
