...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado de compensación laboral cerca de usted en Cary, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
  keywords: 'abogado de compensación laboral cerca de mi, abogado de compensación laboral Cary, abogado Cary, abogado de compensación laboral NC, abogado español Cary',
  openGraph: {
    title: 'Abogado de Compensación Laboral Cerca de Mi en Cary, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado de compensación laboral cerca de usted en Cary, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
