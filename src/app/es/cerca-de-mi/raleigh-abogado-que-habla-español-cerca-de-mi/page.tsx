...
export const metadata: Metadata = {
  title: 'Abogado Que Habla Español Cerca De Mí Raleigh NC | Disponible 24/7 | Consulta Gratuita',
  description:
    '¿Busca un abogado que habla español cerca de usted en Raleigh? ⭐ Calificación 5 Estrellas • 60+ Años de Experiencia • Se Habla Español • Citas el Mismo Día • Llame 1-844-YO-PELEO',
  keywords:
    'abogado que habla español cerca de mi, abogado bilingue cerca de mi, abogado hispano cerca de mi, abogado que habla español raleigh nc cerca de mi, mejor abogado que habla español cerca de mi, abogado que habla español que habla español cerca de mi, abogado que habla español de emergencia cerca de mi',
  openGraph: {
    title: 'Abogado Que Habla Español Cerca De Mí en Raleigh | Vasquez Law Firm',
    description:
      'Ayuda Legal de Emergencia 24/7 en Raleigh. Consulta Gratuita. 30,000+ Casos Ganados. Se Habla Español.',
    url: 'https://www.vasquezlawnc.com/es/cerca-de-mi/raleigh-abogado-que-habla-español-cerca-de-mi',
    images: [
      {
        url: '/images/raleigh-office-hero.jpg',
        width: 1200,
        height: 630,
        alt: 'Vasquez Law Firm Raleigh - Abogado Que Habla Español Cerca de Usted',
      },
    ],
  },
};
...
export default function RaleighAbogadoquehablaespañolCercaDeMiPage() {
  const post = {
    id: 'raleigh-abogado-que-habla-español-cerca-de-mi',
    title: 'Abogado Que Habla Español Cerca De Mí en Raleigh',
    slug: 'raleigh-abogado-que-habla-español-cerca-de-mi',
    excerpt: 'Abogado Que Habla Español experimentado en Raleigh, NC. Consulta gratuita disponible 24/7.',
    content: `
      <div class="prose prose-lg max-w-none">
        <h1>Abogado Que Habla Español Cerca De Mí en Raleigh, NC</h1>
        
        <p>¿Necesita un abogado que habla español cerca de usted en Raleigh? Vasquez Law Firm es su mejor opción. Con más de 60 años de experiencia combinada, nuestro equipo bilingüe está listo para luchar por sus derechos.</p>

        <h2>🗣️ Servicios de Abogado Que Habla Español en Raleigh</h2>
        ...
        <h2>📞 Contacte a Su Abogado Que Habla Español en Raleigh Hoy</h2>
    ...
    tags: ['que', 'raleigh', 'abogado', 'cerca-de-mi'],
  };
