...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado de dui cerca de usted en Wilmington, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
  keywords: 'abogado de dui cerca de mi, abogado de dui Wilmington, abogado Wilmington, abogado de dui NC, abogado español Wilmington',
  openGraph: {
    title: 'Abogado de DUI Cerca de Mi en Wilmington, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado de dui cerca de usted en Wilmington, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
