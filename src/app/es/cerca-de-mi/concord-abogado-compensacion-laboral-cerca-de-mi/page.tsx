...
export const metadata: Metadata = {
  title:
    'Abogado de Compensación Laboral Cerca De Mí Concord NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function ConcordAbogadocompensacionlaboralCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado de Compensación Laboral experimentado en Concord, NC. Consulta gratuita disponible 24/7.',
    content: `
