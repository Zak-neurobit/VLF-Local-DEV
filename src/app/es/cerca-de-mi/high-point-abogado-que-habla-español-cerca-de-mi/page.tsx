...
export const metadata: Metadata = {
  title:
    'Abogado Que Habla Español Cerca De Mí High Point NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function HighPointAbogadoquehablaespañolCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado Que Habla Español experimentado en High Point, NC. Consulta gratuita disponible 24/7.',
    content: `
