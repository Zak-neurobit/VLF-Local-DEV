...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado que habla español cerca de usted en Charlotte, NC. Consultas gratuitas 24/7. Llame (704) 533-7000.',
  keywords: 'abogado que habla español cerca de mi, abogado que habla español Charlotte, abogado Charlotte, abogado que habla español NC, abogado español Charlotte',
  openGraph: {
    title: 'Abogado que Habla Español Cerca de Mi en Charlotte, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado que habla español cerca de usted en Charlotte, NC. Consultas gratuitas 24/7. Llame (704) 533-7000.',
