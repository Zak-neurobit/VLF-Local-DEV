...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado de dui cerca de usted en Cary, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
  keywords: 'abogado de dui cerca de mi, abogado de dui Cary, abogado Cary, abogado de dui NC, abogado español Cary',
  openGraph: {
    title: 'Abogado de DUI Cerca de Mi en Cary, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado de dui cerca de usted en Cary, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
