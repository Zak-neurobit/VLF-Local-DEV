...
export const metadata: Metadata = {
  title:
    'Abogado de Compensación Laboral Cerca De Mí Raleigh NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function RaleighAbogadocompensacionlaboralCercaDeMiPage() {
  const post = {
    ...
    excerpt:
      'Abogado de Compensación Laboral experimentado en Raleigh, NC. Consulta gratuita disponible 24/7.',
    content: `
