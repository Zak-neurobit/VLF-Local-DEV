...
export const metadata = {
  ...
  description: 'Encuentre el mejor abogado de dui cerca de usted en Fayetteville, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
  keywords: 'abogado de dui cerca de mi, abogado de dui Fayetteville, abogado Fayetteville, abogado de dui NC, abogado español Fayetteville',
  openGraph: {
    title: 'Abogado de DUI Cerca de Mi en Fayetteville, NC | Vasquez Law Firm',
    description: 'Encuentre el mejor abogado de dui cerca de usted en Fayetteville, NC. Consultas gratuitas 24/7. Llame (919) 533-7000.',
