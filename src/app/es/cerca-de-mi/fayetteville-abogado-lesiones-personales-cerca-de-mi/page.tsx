...
export const metadata: Metadata = {
  title: 'Abogado de Lesiones Personales Cerca De Mí Fayetteville NC | Disponible 24/7 | Consulta Gratuita',
  description:
...
export default function FayettevilleAbogadolesionespersonalesCercaDeMiPage() {
  const post = {
    ...
    excerpt: 'Abogado de Lesiones Personales experimentado en Fayetteville, NC. Consulta gratuita disponible 24/7.',
    content: `
