...
export const metadata = {
  ...
  description:
    'Encuentre el mejor abogado que habla español cerca de usted en High Point, NC. Consultas gratuitas 24/7. Llame (704) 533-7000.',
  keywords:
    'abogado que habla español cerca de mi, abogado que habla español High Point, abogado High Point, abogado que habla español NC, abogado español High Point',
  openGraph: {
    title: 'Abogado que Habla Español Cerca de Mi en High Point, NC | Vasquez Law Firm',
    description:
      'Encuentre el mejor abogado que habla español cerca de usted en High Point, NC. Consultas gratuitas 24/7. Llame (704) 533-7000.',
  ...
  alternates: {
    canonical:
      'https://www.vasquezlawnc.com/es/cerca-de-mi/high-point-spanish-speaking-cerca-de-mi',
    languages: {
