...
export const metadata = {
  ...
  description: 'Servicios legales de defensa dui en Sanford, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'defensa dui Sanford, abogado Sanford, defensa dui FL, abogado español Sanford, servicios legales Sanford',
  openGraph: {
    title: 'Defensa DUI en Sanford, FL | Vasquez Law Firm',
    description: 'Servicios legales de defensa dui en Sanford, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
