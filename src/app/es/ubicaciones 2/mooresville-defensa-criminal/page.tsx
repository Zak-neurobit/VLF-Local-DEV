...
export const metadata = {
  title: 'Defensa Criminal en Mooresville, NC | Vasquez Law Firm',
  description: 'Servicios legales de defensa criminal en Mooresville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'defensa criminal Mooresville, abogado Mooresville, defensa criminal NC, abogado español Mooresville, servicios legales Mooresville',
  openGraph: {
    title: 'Defensa Criminal en Mooresville, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa criminal en Mooresville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Defensa Criminal en Mooresville, NC'
    }]
  },
  alternates: {
