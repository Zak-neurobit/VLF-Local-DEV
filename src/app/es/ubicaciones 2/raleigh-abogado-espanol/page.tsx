...
export const metadata = {
  title: 'Abogado que Habla Español en Raleigh, NC | Vasquez Law Firm',
  description: 'Servicios legales de abogado que habla español en Raleigh, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'abogado que habla español Raleigh, abogado Raleigh, abogado que habla español NC, abogado español Raleigh, servicios legales Raleigh',
  openGraph: {
    title: 'Abogado que Habla Español en Raleigh, NC | Vasquez Law Firm',
    description: 'Servicios legales de abogado que habla español en Raleigh, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Abogado que Habla Español en Raleigh, NC'
    }]
  },
  alternates: {
