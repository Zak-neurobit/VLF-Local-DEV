...
export const metadata = {
  title: 'Defensa Criminal en Concord, NC | Vasquez Law Firm',
  description: 'Servicios legales de defensa criminal en Concord, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'defensa criminal Concord, abogado Concord, defensa criminal NC, abogado español Concord, servicios legales Concord',
  openGraph: {
    title: 'Defensa Criminal en Concord, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa criminal en Concord, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Defensa Criminal en Concord, NC'
    }]
  },
  alternates: {
