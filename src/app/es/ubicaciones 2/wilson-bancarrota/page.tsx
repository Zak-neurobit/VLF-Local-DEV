...
export const metadata = {
  ...
  description: 'Servicios legales de bancarrota en Wilson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'bancarrota Wilson, abogado Wilson, bancarrota NC, abogado español Wilson, servicios legales Wilson',
  openGraph: {
    title: 'Bancarrota en Wilson, NC | Vasquez Law Firm',
    description: 'Servicios legales de bancarrota en Wilson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
