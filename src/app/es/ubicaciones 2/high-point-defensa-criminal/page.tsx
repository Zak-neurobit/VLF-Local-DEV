...
export const metadata = {
  title: 'Defensa Criminal en High Point, NC | Vasquez Law Firm',
  description: 'Servicios legales de defensa criminal en High Point, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'defensa criminal High Point, abogado High Point, defensa criminal NC, abogado español High Point, servicios legales High Point',
  openGraph: {
    title: 'Defensa Criminal en High Point, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa criminal en High Point, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Defensa Criminal en High Point, NC'
    }]
  },
  alternates: {
