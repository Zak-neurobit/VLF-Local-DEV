...
export const metadata = {
  title: 'Abogado que Habla Español en Indian Trail, NC | Vasquez Law Firm',
  description: 'Servicios legales de abogado que habla español en Indian Trail, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'abogado que habla español Indian Trail, abogado Indian Trail, abogado que habla español NC, abogado español Indian Trail, servicios legales Indian Trail',
  openGraph: {
    title: 'Abogado que Habla Español en Indian Trail, NC | Vasquez Law Firm',
    description: 'Servicios legales de abogado que habla español en Indian Trail, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Abogado que Habla Español en Indian Trail, NC'
    }]
  },
  alternates: {
