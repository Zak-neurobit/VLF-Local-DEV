...
export const metadata = {
  ...
  description: 'Servicios legales de bancarrota en Chapel Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'bancarrota Chapel Hill, abogado Chapel Hill, bancarrota NC, abogado español Chapel Hill, servicios legales Chapel Hill',
  openGraph: {
    title: 'Bancarrota en Chapel Hill, NC | Vasquez Law Firm',
    description: 'Servicios legales de bancarrota en Chapel Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
