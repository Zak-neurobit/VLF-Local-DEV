...
export const metadata = {
  title: 'Compensación Laboral en Mint Hill, NC | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Mint Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'compensación laboral Mint Hill, abogado Mint Hill, compensación laboral NC, abogado español Mint Hill, servicios legales Mint Hill',
  openGraph: {
    title: 'Compensación Laboral en Mint Hill, NC | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Mint Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Mint Hill, NC'
    }]
  },
  alternates: {
