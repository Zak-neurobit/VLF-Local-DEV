...
export const metadata = {
  title: 'Lesiones Personales en Orlando, FL | Vasquez Law Firm',
  description: 'Servicios legales de lesiones personales en Orlando, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'lesiones personales Orlando, abogado Orlando, lesiones personales FL, abogado español Orlando, servicios legales Orlando',
  openGraph: {
    title: 'Lesiones Personales en Orlando, FL | Vasquez Law Firm',
    description: 'Servicios legales de lesiones personales en Orlando, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Lesiones Personales en Orlando, FL'
    }]
  },
  alternates: {
