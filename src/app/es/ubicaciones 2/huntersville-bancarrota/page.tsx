...
export const metadata = {
  ...
  description: 'Servicios legales de bancarrota en Huntersville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'bancarrota Huntersville, abogado Huntersville, bancarrota NC, abogado español Huntersville, servicios legales Huntersville',
  openGraph: {
    title: 'Bancarrota en Huntersville, NC | Vasquez Law Firm',
    description: 'Servicios legales de bancarrota en Huntersville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
