...
export const metadata = {
  title: 'Compensación Laboral en Hickory, NC | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Hickory, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'compensación laboral Hickory, abogado Hickory, compensación laboral NC, abogado español Hickory, servicios legales Hickory',
  openGraph: {
    title: 'Compensación Laboral en Hickory, NC | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Hickory, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Hickory, NC'
    }]
  },
  alternates: {
