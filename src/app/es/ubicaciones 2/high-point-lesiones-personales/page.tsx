...
export const metadata = {
  title: 'Lesiones Personales en High Point, NC | Vasquez Law Firm',
  description: 'Servicios legales de lesiones personales en High Point, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'lesiones personales High Point, abogado High Point, lesiones personales NC, abogado español High Point, servicios legales High Point',
  openGraph: {
    title: 'Lesiones Personales en High Point, NC | Vasquez Law Firm',
    description: 'Servicios legales de lesiones personales en High Point, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Lesiones Personales en High Point, NC'
    }]
  },
  alternates: {
