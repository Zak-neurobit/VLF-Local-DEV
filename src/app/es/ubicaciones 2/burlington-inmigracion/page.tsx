...
export const metadata = {
  title: 'Ley de Inmigración en Burlington, NC | Vasquez Law Firm',
  description: 'Servicios legales de ley de inmigración en Burlington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'ley de inmigración Burlington, abogado Burlington, ley de inmigración NC, abogado español Burlington, servicios legales Burlington',
  openGraph: {
    title: 'Ley de Inmigración en Burlington, NC | Vasquez Law Firm',
    description: 'Servicios legales de ley de inmigración en Burlington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Ley de Inmigración en Burlington, NC'
    }]
  },
  alternates: {
