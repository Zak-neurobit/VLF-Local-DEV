...
export const metadata = {
  ...
  description: 'Servicios legales de bancarrota en Orlando, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'bancarrota Orlando, abogado Orlando, bancarrota FL, abogado español Orlando, servicios legales Orlando',
  openGraph: {
    title: 'Bancarrota en Orlando, FL | Vasquez Law Firm',
    description: 'Servicios legales de bancarrota en Orlando, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
