...
export const metadata = {
  title: 'Ley de Inmigración en Indian Trail, NC | Vasquez Law Firm',
  description: 'Servicios legales de ley de inmigración en Indian Trail, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'ley de inmigración Indian Trail, abogado Indian Trail, ley de inmigración NC, abogado español Indian Trail, servicios legales Indian Trail',
  openGraph: {
    title: 'Ley de Inmigración en Indian Trail, NC | Vasquez Law Firm',
    description: 'Servicios legales de ley de inmigración en Indian Trail, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Ley de Inmigración en Indian Trail, NC'
    }]
  },
  alternates: {
