...
export const metadata = {
  ...
  description: 'Servicios legales de defensa dui en Orlando, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'defensa dui Orlando, abogado Orlando, defensa dui FL, abogado español Orlando, servicios legales Orlando',
  openGraph: {
    title: 'Defensa DUI en Orlando, FL | Vasquez Law Firm',
    description: 'Servicios legales de defensa dui en Orlando, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
