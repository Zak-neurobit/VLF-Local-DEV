...
export const metadata = {
  title: 'Ley de Inmigración en Winter Park, FL | Vasquez Law Firm',
  description: 'Servicios legales de ley de inmigración en Winter Park, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'ley de inmigración Winter Park, abogado Winter Park, ley de inmigración FL, abogado español Winter Park, servicios legales Winter Park',
  openGraph: {
    title: 'Ley de Inmigración en Winter Park, FL | Vasquez Law Firm',
    description: 'Servicios legales de ley de inmigración en Winter Park, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Ley de Inmigración en Winter Park, FL'
    }]
  },
  alternates: {
