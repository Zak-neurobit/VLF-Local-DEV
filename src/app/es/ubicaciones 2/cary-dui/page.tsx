...
export const metadata = {
  ...
  description: 'Servicios legales de defensa dui en Cary, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'defensa dui Cary, abogado Cary, defensa dui NC, abogado español Cary, servicios legales Cary',
  openGraph: {
    title: 'Defensa DUI en Cary, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa dui en Cary, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
