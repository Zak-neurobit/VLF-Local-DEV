...
export const metadata = {
  title: 'Compensación Laboral en Winston-Salem, NC | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Winston-Salem, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'compensación laboral Winston-Salem, abogado Winston-Salem, compensación laboral NC, abogado español Winston-Salem, servicios legales Winston-Salem',
  openGraph: {
    title: 'Compensación Laboral en Winston-Salem, NC | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Winston-Salem, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Winston-Salem, NC'
    }]
  },
  alternates: {
