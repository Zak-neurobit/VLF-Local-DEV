...
export const metadata = {
  title: 'Lesiones Personales en Matthews, NC | Vasquez Law Firm',
  description: 'Servicios legales de lesiones personales en Matthews, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'lesiones personales Matthews, abogado Matthews, lesiones personales NC, abogado español Matthews, servicios legales Matthews',
  openGraph: {
    title: 'Lesiones Personales en Matthews, NC | Vasquez Law Firm',
    description: 'Servicios legales de lesiones personales en Matthews, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Lesiones Personales en Matthews, NC'
    }]
  },
  alternates: {
