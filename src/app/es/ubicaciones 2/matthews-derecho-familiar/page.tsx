...
export const metadata = {
  title: 'Derecho Familiar en Matthews, NC | Vasquez Law Firm',
  description: 'Servicios legales de derecho familiar en Matthews, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'derecho familiar Matthews, abogado Matthews, derecho familiar NC, abogado español Matthews, servicios legales Matthews',
  openGraph: {
    title: 'Derecho Familiar en Matthews, NC | Vasquez Law Firm',
    description: 'Servicios legales de derecho familiar en Matthews, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Derecho Familiar en Matthews, NC'
    }]
  },
  alternates: {
