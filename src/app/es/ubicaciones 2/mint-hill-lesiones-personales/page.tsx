...
export const metadata = {
  title: 'Lesiones Personales en Mint Hill, NC | Vasquez Law Firm',
  description: 'Servicios legales de lesiones personales en Mint Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'lesiones personales Mint Hill, abogado Mint Hill, lesiones personales NC, abogado español Mint Hill, servicios legales Mint Hill',
  openGraph: {
    title: 'Lesiones Personales en Mint Hill, NC | Vasquez Law Firm',
    description: 'Servicios legales de lesiones personales en Mint Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Lesiones Personales en Mint Hill, NC'
    }]
  },
  alternates: {
