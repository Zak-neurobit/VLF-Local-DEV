...
export const metadata = {
  title: 'Ley de Inmigración en Huntersville, NC | Vasquez Law Firm',
  description: 'Servicios legales de ley de inmigración en Huntersville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'ley de inmigración Huntersville, abogado Huntersville, ley de inmigración NC, abogado español Huntersville, servicios legales Huntersville',
  openGraph: {
    title: 'Ley de Inmigración en Huntersville, NC | Vasquez Law Firm',
    description: 'Servicios legales de ley de inmigración en Huntersville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Ley de Inmigración en Huntersville, NC'
    }]
  },
  alternates: {
