...
export const metadata = {
  title: 'Abogado que Habla Español en Huntersville, NC | Vasquez Law Firm',
  description: 'Servicios legales de abogado que habla español en Huntersville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'abogado que habla español Huntersville, abogado Huntersville, abogado que habla español NC, abogado español Huntersville, servicios legales Huntersville',
  openGraph: {
    title: 'Abogado que Habla Español en Huntersville, NC | Vasquez Law Firm',
    description: 'Servicios legales de abogado que habla español en Huntersville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Abogado que Habla Español en Huntersville, NC'
    }]
  },
  alternates: {
