...
export const metadata = {
  ...
  description: 'Servicios legales de bancarrota en Winter Park, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'bancarrota Winter Park, abogado Winter Park, bancarrota FL, abogado español Winter Park, servicios legales Winter Park',
  openGraph: {
    title: 'Bancarrota en Winter Park, FL | Vasquez Law Firm',
    description: 'Servicios legales de bancarrota en Winter Park, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
