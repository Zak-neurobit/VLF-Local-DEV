...
export const metadata = {
  title: 'Compensación Laboral en Raleigh, NC | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Raleigh, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'compensación laboral Raleigh, abogado Raleigh, compensación laboral NC, abogado español Raleigh, servicios legales Raleigh',
  openGraph: {
    title: 'Compensación Laboral en Raleigh, NC | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Raleigh, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Raleigh, NC'
    }]
  },
  alternates: {
