...
export const metadata = {
  ...
  description: 'Servicios legales de defensa dui en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'defensa dui Rocky Mount, abogado Rocky Mount, defensa dui NC, abogado español Rocky Mount, servicios legales Rocky Mount',
  openGraph: {
    title: 'Defensa DUI en Rocky Mount, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa dui en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
