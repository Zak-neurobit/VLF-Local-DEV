...
export const metadata = {
  title: 'Abogado que Habla Español en Cary, NC | Vasquez Law Firm',
  description: 'Servicios legales de abogado que habla español en Cary, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'abogado que habla español Cary, abogado Cary, abogado que habla español NC, abogado español Cary, servicios legales Cary',
  openGraph: {
    title: 'Abogado que Habla Español en Cary, NC | Vasquez Law Firm',
    description: 'Servicios legales de abogado que habla español en Cary, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Abogado que Habla Español en Cary, NC'
    }]
  },
  alternates: {
