...
export const metadata = {
  title: 'Derecho Familiar en Davidson, NC | Vasquez Law Firm',
  description: 'Servicios legales de derecho familiar en Davidson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'derecho familiar Davidson, abogado Davidson, derecho familiar NC, abogado español Davidson, servicios legales Davidson',
  openGraph: {
    title: 'Derecho Familiar en Davidson, NC | Vasquez Law Firm',
    description: 'Servicios legales de derecho familiar en Davidson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Derecho Familiar en Davidson, NC'
    }]
  },
  alternates: {
