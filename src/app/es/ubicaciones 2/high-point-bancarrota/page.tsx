...
export const metadata = {
  ...
  description: 'Servicios legales de bancarrota en High Point, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'bancarrota High Point, abogado High Point, bancarrota NC, abogado español High Point, servicios legales High Point',
  openGraph: {
    title: 'Bancarrota en High Point, NC | Vasquez Law Firm',
    description: 'Servicios legales de bancarrota en High Point, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
