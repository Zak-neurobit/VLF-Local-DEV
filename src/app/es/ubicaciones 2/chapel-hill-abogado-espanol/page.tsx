...
export const metadata = {
  title: 'Abogado que Habla Español en Chapel Hill, NC | Vasquez Law Firm',
  description: 'Servicios legales de abogado que habla español en Chapel Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'abogado que habla español Chapel Hill, abogado Chapel Hill, abogado que habla español NC, abogado español Chapel Hill, servicios legales Chapel Hill',
  openGraph: {
    title: 'Abogado que Habla Español en Chapel Hill, NC | Vasquez Law Firm',
    description: 'Servicios legales de abogado que habla español en Chapel Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Abogado que Habla Español en Chapel Hill, NC'
    }]
  },
  alternates: {
