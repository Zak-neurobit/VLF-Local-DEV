...
export const metadata = {
  title: 'Lesiones Personales en Raleigh, NC | Vasquez Law Firm',
  description: 'Servicios legales de lesiones personales en Raleigh, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'lesiones personales Raleigh, abogado Raleigh, lesiones personales NC, abogado español Raleigh, servicios legales Raleigh',
  openGraph: {
    title: 'Lesiones Personales en Raleigh, NC | Vasquez Law Firm',
    description: 'Servicios legales de lesiones personales en Raleigh, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Lesiones Personales en Raleigh, NC'
    }]
  },
  alternates: {
