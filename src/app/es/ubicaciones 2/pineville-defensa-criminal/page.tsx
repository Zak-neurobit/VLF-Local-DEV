...
export const metadata = {
  title: 'Defensa Criminal en Pineville, NC | Vasquez Law Firm',
  description: 'Servicios legales de defensa criminal en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'defensa criminal Pineville, abogado Pineville, defensa criminal NC, abogado español Pineville, servicios legales Pineville',
  openGraph: {
    title: 'Defensa Criminal en Pineville, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa criminal en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Defensa Criminal en Pineville, NC'
    }]
  },
  alternates: {
