...
export const metadata = {
  title: 'Compensación Laboral en Burlington, NC | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Burlington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'compensación laboral Burlington, abogado Burlington, compensación laboral NC, abogado español Burlington, servicios legales Burlington',
  openGraph: {
    title: 'Compensación Laboral en Burlington, NC | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Burlington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Burlington, NC'
    }]
  },
  alternates: {
