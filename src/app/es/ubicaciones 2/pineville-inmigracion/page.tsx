...
export const metadata = {
  title: 'Ley de Inmigración en Pineville, NC | Vasquez Law Firm',
  description: 'Servicios legales de ley de inmigración en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'ley de inmigración Pineville, abogado Pineville, ley de inmigración NC, abogado español Pineville, servicios legales Pineville',
  openGraph: {
    title: 'Ley de Inmigración en Pineville, NC | Vasquez Law Firm',
    description: 'Servicios legales de ley de inmigración en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Ley de Inmigración en Pineville, NC'
    }]
  },
  alternates: {
