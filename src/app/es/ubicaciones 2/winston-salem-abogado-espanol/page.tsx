...
export const metadata = {
  title: 'Abogado que Habla Español en Winston-Salem, NC | Vasquez Law Firm',
  description: 'Servicios legales de abogado que habla español en Winston-Salem, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'abogado que habla español Winston-Salem, abogado Winston-Salem, abogado que habla español NC, abogado español Winston-Salem, servicios legales Winston-Salem',
  openGraph: {
    title: 'Abogado que Habla Español en Winston-Salem, NC | Vasquez Law Firm',
    description: 'Servicios legales de abogado que habla español en Winston-Salem, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Abogado que Habla Español en Winston-Salem, NC'
    }]
  },
  alternates: {
