...
export const metadata = {
  title: 'Abogado que Habla Español en Fayetteville, NC | Vasquez Law Firm',
  description: 'Servicios legales de abogado que habla español en Fayetteville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'abogado que habla español Fayetteville, abogado Fayetteville, abogado que habla español NC, abogado español Fayetteville, servicios legales Fayetteville',
  openGraph: {
    title: 'Abogado que Habla Español en Fayetteville, NC | Vasquez Law Firm',
    description: 'Servicios legales de abogado que habla español en Fayetteville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Abogado que Habla Español en Fayetteville, NC'
    }]
  },
  alternates: {
