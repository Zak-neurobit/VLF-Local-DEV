...
export const metadata = {
  title: 'Defensa Criminal en Fayetteville, NC | Vasquez Law Firm',
  description: 'Servicios legales de defensa criminal en Fayetteville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'defensa criminal Fayetteville, abogado Fayetteville, defensa criminal NC, abogado español Fayetteville, servicios legales Fayetteville',
  openGraph: {
    title: 'Defensa Criminal en Fayetteville, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa criminal en Fayetteville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Defensa Criminal en Fayetteville, NC'
    }]
  },
  alternates: {
