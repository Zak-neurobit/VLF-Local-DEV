...
export const metadata = {
  title: 'Derecho Familiar en Monroe, NC | Vasquez Law Firm',
  description: 'Servicios legales de derecho familiar en Monroe, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'derecho familiar Monroe, abogado Monroe, derecho familiar NC, abogado español Monroe, servicios legales Monroe',
  openGraph: {
    title: 'Derecho Familiar en Monroe, NC | Vasquez Law Firm',
    description: 'Servicios legales de derecho familiar en Monroe, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Derecho Familiar en Monroe, NC'
    }]
  },
  alternates: {
