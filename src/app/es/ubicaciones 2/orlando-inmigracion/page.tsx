...
export const metadata = {
  title: 'Ley de Inmigración en Orlando, FL | Vasquez Law Firm',
  description: 'Servicios legales de ley de inmigración en Orlando, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'ley de inmigración Orlando, abogado Orlando, ley de inmigración FL, abogado español Orlando, servicios legales Orlando',
  openGraph: {
    title: 'Ley de Inmigración en Orlando, FL | Vasquez Law Firm',
    description: 'Servicios legales de ley de inmigración en Orlando, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Ley de Inmigración en Orlando, FL'
    }]
  },
  alternates: {
