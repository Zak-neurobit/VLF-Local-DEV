...
export const metadata = {
  ...
  description: 'Servicios legales de bancarrota en Davidson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'bancarrota Davidson, abogado Davidson, bancarrota NC, abogado español Davidson, servicios legales Davidson',
  openGraph: {
    title: 'Bancarrota en Davidson, NC | Vasquez Law Firm',
    description: 'Servicios legales de bancarrota en Davidson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
