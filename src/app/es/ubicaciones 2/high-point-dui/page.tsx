...
export const metadata = {
  ...
  description: 'Servicios legales de defensa dui en High Point, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'defensa dui High Point, abogado High Point, defensa dui NC, abogado español High Point, servicios legales High Point',
  openGraph: {
    title: 'Defensa DUI en High Point, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa dui en High Point, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
