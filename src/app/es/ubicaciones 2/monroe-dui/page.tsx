...
export const metadata = {
  ...
  description: 'Servicios legales de defensa dui en Monroe, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'defensa dui Monroe, abogado Monroe, defensa dui NC, abogado español Monroe, servicios legales Monroe',
  openGraph: {
    title: 'Defensa DUI en Monroe, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa dui en Monroe, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
