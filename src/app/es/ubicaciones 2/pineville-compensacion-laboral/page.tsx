...
export const metadata = {
  title: 'Compensación Laboral en Pineville, NC | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'compensación laboral Pineville, abogado Pineville, compensación laboral NC, abogado español Pineville, servicios legales Pineville',
  openGraph: {
    title: 'Compensación Laboral en Pineville, NC | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Pineville, NC'
    }]
  },
  alternates: {
