...
export const metadata = {
  title: 'Derecho Familiar en Oviedo, FL | Vasquez Law Firm',
  description: 'Servicios legales de derecho familiar en Oviedo, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'derecho familiar Oviedo, abogado Oviedo, derecho familiar FL, abogado español Oviedo, servicios legales Oviedo',
  openGraph: {
    title: 'Derecho Familiar en Oviedo, FL | Vasquez Law Firm',
    description: 'Servicios legales de derecho familiar en Oviedo, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Derecho Familiar en Oviedo, FL'
    }]
  },
  alternates: {
