...
export const metadata = {
  ...
  description: 'Servicios legales de accidentes de auto en Oviedo, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'accidentes de auto Oviedo, abogado Oviedo, accidentes de auto FL, abogado español Oviedo, servicios legales Oviedo',
  openGraph: {
    title: 'Accidentes de Auto en Oviedo, FL | Vasquez Law Firm',
    description: 'Servicios legales de accidentes de auto en Oviedo, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
