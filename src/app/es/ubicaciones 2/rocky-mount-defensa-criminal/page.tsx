...
export const metadata = {
  title: 'Defensa Criminal en Rocky Mount, NC | Vasquez Law Firm',
  description: 'Servicios legales de defensa criminal en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'defensa criminal Rocky Mount, abogado Rocky Mount, defensa criminal NC, abogado español Rocky Mount, servicios legales Rocky Mount',
  openGraph: {
    title: 'Defensa Criminal en Rocky Mount, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa criminal en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Defensa Criminal en Rocky Mount, NC'
    }]
  },
  alternates: {
