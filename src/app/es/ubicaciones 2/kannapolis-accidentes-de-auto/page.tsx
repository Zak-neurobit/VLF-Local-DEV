...
export const metadata = {
  ...
  description: 'Servicios legales de accidentes de auto en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'accidentes de auto Kannapolis, abogado Kannapolis, accidentes de auto NC, abogado español Kannapolis, servicios legales Kannapolis',
  openGraph: {
    title: 'Accidentes de Auto en Kannapolis, NC | Vasquez Law Firm',
    description: 'Servicios legales de accidentes de auto en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
