...
export const metadata = {
  title: 'Defensa Criminal en Gastonia, NC | Vasquez Law Firm',
  description: 'Servicios legales de defensa criminal en Gastonia, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'defensa criminal Gastonia, abogado Gastonia, defensa criminal NC, abogado español Gastonia, servicios legales Gastonia',
  openGraph: {
    title: 'Defensa Criminal en Gastonia, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa criminal en Gastonia, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Defensa Criminal en Gastonia, NC'
    }]
  },
  alternates: {
