...
export const metadata = {
  title: 'Lesiones Personales en Pineville, NC | Vasquez Law Firm',
  description: 'Servicios legales de lesiones personales en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'lesiones personales Pineville, abogado Pineville, lesiones personales NC, abogado español Pineville, servicios legales Pineville',
  openGraph: {
    title: 'Lesiones Personales en Pineville, NC | Vasquez Law Firm',
    description: 'Servicios legales de lesiones personales en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Lesiones Personales en Pineville, NC'
    }]
  },
  alternates: {
