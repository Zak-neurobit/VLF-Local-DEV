...
export const metadata = {
  title: 'Abogado que Habla Español en Mint Hill, NC | Vasquez Law Firm',
  description: 'Servicios legales de abogado que habla español en Mint Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'abogado que habla español Mint Hill, abogado Mint Hill, abogado que habla español NC, abogado español Mint Hill, servicios legales Mint Hill',
  openGraph: {
    title: 'Abogado que Habla Español en Mint Hill, NC | Vasquez Law Firm',
    description: 'Servicios legales de abogado que habla español en Mint Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Abogado que Habla Español en Mint Hill, NC'
    }]
  },
  alternates: {
