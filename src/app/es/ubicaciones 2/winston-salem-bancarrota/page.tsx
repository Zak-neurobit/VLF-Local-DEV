...
export const metadata = {
  ...
  description: 'Servicios legales de bancarrota en Winston-Salem, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'bancarrota Winston-Salem, abogado Winston-Salem, bancarrota NC, abogado español Winston-Salem, servicios legales Winston-Salem',
  openGraph: {
    title: 'Bancarrota en Winston-Salem, NC | Vasquez Law Firm',
    description: 'Servicios legales de bancarrota en Winston-Salem, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
