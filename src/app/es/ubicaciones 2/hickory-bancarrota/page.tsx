...
export const metadata = {
  ...
  description: 'Servicios legales de bancarrota en Hickory, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'bancarrota Hickory, abogado Hickory, bancarrota NC, abogado español Hickory, servicios legales Hickory',
  openGraph: {
    title: 'Bancarrota en Hickory, NC | Vasquez Law Firm',
    description: 'Servicios legales de bancarrota en Hickory, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
