...
export const metadata = {
  title: 'Compensación Laboral en Indian Trail, NC | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Indian Trail, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'compensación laboral Indian Trail, abogado Indian Trail, compensación laboral NC, abogado español Indian Trail, servicios legales Indian Trail',
  openGraph: {
    title: 'Compensación Laboral en Indian Trail, NC | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Indian Trail, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Indian Trail, NC'
    }]
  },
  alternates: {
