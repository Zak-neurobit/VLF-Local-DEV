...
export const metadata = {
  ...
  description: 'Servicios legales de accidentes de auto en Kissimmee, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'accidentes de auto Kissimmee, abogado Kissimmee, accidentes de auto FL, abogado español Kissimmee, servicios legales Kissimmee',
  openGraph: {
    title: 'Accidentes de Auto en Kissimmee, FL | Vasquez Law Firm',
    description: 'Servicios legales de accidentes de auto en Kissimmee, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
