...
export const metadata = {
  ...
  description: 'Servicios legales de bancarrota en Mint Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'bancarrota Mint Hill, abogado Mint Hill, bancarrota NC, abogado español Mint Hill, servicios legales Mint Hill',
  openGraph: {
    title: 'Bancarrota en Mint Hill, NC | Vasquez Law Firm',
    description: 'Servicios legales de bancarrota en Mint Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
