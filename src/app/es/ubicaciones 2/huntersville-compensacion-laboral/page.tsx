...
export const metadata = {
  title: 'Compensación Laboral en Huntersville, NC | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Huntersville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'compensación laboral Huntersville, abogado Huntersville, compensación laboral NC, abogado español Huntersville, servicios legales Huntersville',
  openGraph: {
    title: 'Compensación Laboral en Huntersville, NC | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Huntersville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Huntersville, NC'
    }]
  },
  alternates: {
