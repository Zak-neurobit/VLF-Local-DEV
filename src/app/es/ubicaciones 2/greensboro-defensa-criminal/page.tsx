...
export const metadata = {
  title: 'Defensa Criminal en Greensboro, NC | Vasquez Law Firm',
  description: 'Servicios legales de defensa criminal en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'defensa criminal Greensboro, abogado Greensboro, defensa criminal NC, abogado español Greensboro, servicios legales Greensboro',
  openGraph: {
    title: 'Defensa Criminal en Greensboro, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa criminal en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Defensa Criminal en Greensboro, NC'
    }]
  },
  alternates: {
