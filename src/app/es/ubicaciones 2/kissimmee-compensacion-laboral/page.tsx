...
export const metadata = {
  title: 'Compensación Laboral en Kissimmee, FL | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Kissimmee, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'compensación laboral Kissimmee, abogado Kissimmee, compensación laboral FL, abogado español Kissimmee, servicios legales Kissimmee',
  openGraph: {
    title: 'Compensación Laboral en Kissimmee, FL | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Kissimmee, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Kissimmee, FL'
    }]
  },
  alternates: {
