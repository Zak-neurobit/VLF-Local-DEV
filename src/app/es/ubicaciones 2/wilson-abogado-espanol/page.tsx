...
export const metadata = {
  title: 'Abogado que Habla Español en Wilson, NC | Vasquez Law Firm',
  description: 'Servicios legales de abogado que habla español en Wilson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'abogado que habla español Wilson, abogado Wilson, abogado que habla español NC, abogado español Wilson, servicios legales Wilson',
  openGraph: {
    title: 'Abogado que Habla Español en Wilson, NC | Vasquez Law Firm',
    description: 'Servicios legales de abogado que habla español en Wilson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Abogado que Habla Español en Wilson, NC'
    }]
  },
  alternates: {
