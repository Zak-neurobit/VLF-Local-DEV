...
export const metadata = {
  ...
  description: 'Servicios legales de accidentes de auto en Mooresville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'accidentes de auto Mooresville, abogado Mooresville, accidentes de auto NC, abogado español Mooresville, servicios legales Mooresville',
  openGraph: {
    title: 'Accidentes de Auto en Mooresville, NC | Vasquez Law Firm',
    description: 'Servicios legales de accidentes de auto en Mooresville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
