...
export const metadata = {
  title: 'Compensación Laboral en High Point, NC | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en High Point, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'compensación laboral High Point, abogado High Point, compensación laboral NC, abogado español High Point, servicios legales High Point',
  openGraph: {
    title: 'Compensación Laboral en High Point, NC | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en High Point, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en High Point, NC'
    }]
  },
  alternates: {
