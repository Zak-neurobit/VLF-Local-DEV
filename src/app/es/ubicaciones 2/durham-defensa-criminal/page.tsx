...
export const metadata = {
  title: 'Defensa Criminal en Durham, NC | Vasquez Law Firm',
  description: 'Servicios legales de defensa criminal en Durham, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'defensa criminal Durham, abogado Durham, defensa criminal NC, abogado español Durham, servicios legales Durham',
  openGraph: {
    title: 'Defensa Criminal en Durham, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa criminal en Durham, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Defensa Criminal en Durham, NC'
    }]
  },
  alternates: {
