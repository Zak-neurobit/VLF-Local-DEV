...
export const metadata = {
  title: 'Compensación Laboral en Mooresville, NC | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Mooresville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'compensación laboral Mooresville, abogado Mooresville, compensación laboral NC, abogado español Mooresville, servicios legales Mooresville',
  openGraph: {
    title: 'Compensación Laboral en Mooresville, NC | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Mooresville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Mooresville, NC'
    }]
  },
  alternates: {
