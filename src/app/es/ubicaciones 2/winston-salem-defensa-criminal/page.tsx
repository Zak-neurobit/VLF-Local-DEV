...
export const metadata = {
  title: 'Defensa Criminal en Winston-Salem, NC | Vasquez Law Firm',
  description: 'Servicios legales de defensa criminal en Winston-Salem, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'defensa criminal Winston-Salem, abogado Winston-Salem, defensa criminal NC, abogado español Winston-Salem, servicios legales Winston-Salem',
  openGraph: {
    title: 'Defensa Criminal en Winston-Salem, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa criminal en Winston-Salem, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Defensa Criminal en Winston-Salem, NC'
    }]
  },
  alternates: {
