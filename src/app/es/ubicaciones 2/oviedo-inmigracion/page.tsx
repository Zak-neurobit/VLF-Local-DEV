...
export const metadata = {
  title: 'Ley de Inmigración en Oviedo, FL | Vasquez Law Firm',
  description: 'Servicios legales de ley de inmigración en Oviedo, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'ley de inmigración Oviedo, abogado Oviedo, ley de inmigración FL, abogado español Oviedo, servicios legales Oviedo',
  openGraph: {
    title: 'Ley de Inmigración en Oviedo, FL | Vasquez Law Firm',
    description: 'Servicios legales de ley de inmigración en Oviedo, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Ley de Inmigración en Oviedo, FL'
    }]
  },
  alternates: {
