...
export const metadata = {
  ...
  description: 'Servicios legales de bancarrota en Gastonia, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'bancarrota Gastonia, abogado Gastonia, bancarrota NC, abogado español Gastonia, servicios legales Gastonia',
  openGraph: {
    title: 'Bancarrota en Gastonia, NC | Vasquez Law Firm',
    description: 'Servicios legales de bancarrota en Gastonia, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
