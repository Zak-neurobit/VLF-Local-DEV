...
export const metadata = {
  ...
  description: 'Servicios legales de accidentes de auto en Monroe, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'accidentes de auto Monroe, abogado Monroe, accidentes de auto NC, abogado español Monroe, servicios legales Monroe',
  openGraph: {
    title: 'Accidentes de Auto en Monroe, NC | Vasquez Law Firm',
    description: 'Servicios legales de accidentes de auto en Monroe, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
