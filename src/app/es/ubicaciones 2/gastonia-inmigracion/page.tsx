...
export const metadata = {
  title: 'Ley de Inmigración en Gastonia, NC | Vasquez Law Firm',
  description: 'Servicios legales de ley de inmigración en Gastonia, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'ley de inmigración Gastonia, abogado Gastonia, ley de inmigración NC, abogado español Gastonia, servicios legales Gastonia',
  openGraph: {
    title: 'Ley de Inmigración en Gastonia, NC | Vasquez Law Firm',
    description: 'Servicios legales de ley de inmigración en Gastonia, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Ley de Inmigración en Gastonia, NC'
    }]
  },
  alternates: {
