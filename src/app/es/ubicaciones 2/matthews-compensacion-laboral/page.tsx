...
export const metadata = {
  title: 'Compensación Laboral en Matthews, NC | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Matthews, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'compensación laboral Matthews, abogado Matthews, compensación laboral NC, abogado español Matthews, servicios legales Matthews',
  openGraph: {
    title: 'Compensación Laboral en Matthews, NC | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Matthews, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Matthews, NC'
    }]
  },
  alternates: {
