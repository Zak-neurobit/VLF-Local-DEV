...
export const metadata = {
  title: 'Compensación Laboral en Rocky Mount, NC | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'compensación laboral Rocky Mount, abogado Rocky Mount, compensación laboral NC, abogado español Rocky Mount, servicios legales Rocky Mount',
  openGraph: {
    title: 'Compensación Laboral en Rocky Mount, NC | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Rocky Mount, NC'
    }]
  },
  alternates: {
