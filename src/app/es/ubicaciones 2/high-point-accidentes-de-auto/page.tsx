...
export const metadata = {
  ...
  description: 'Servicios legales de accidentes de auto en High Point, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'accidentes de auto High Point, abogado High Point, accidentes de auto NC, abogado español High Point, servicios legales High Point',
  openGraph: {
    title: 'Accidentes de Auto en High Point, NC | Vasquez Law Firm',
    description: 'Servicios legales de accidentes de auto en High Point, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
