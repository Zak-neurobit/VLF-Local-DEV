...
export const metadata = {
  title: 'Derecho Familiar en Fayetteville, NC | Vasquez Law Firm',
  description: 'Servicios legales de derecho familiar en Fayetteville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'derecho familiar Fayetteville, abogado Fayetteville, derecho familiar NC, abogado español Fayetteville, servicios legales Fayetteville',
  openGraph: {
    title: 'Derecho Familiar en Fayetteville, NC | Vasquez Law Firm',
    description: 'Servicios legales de derecho familiar en Fayetteville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Derecho Familiar en Fayetteville, NC'
    }]
  },
  alternates: {
