...
export const metadata = {
  title: 'Lesiones Personales en Fayetteville, NC | Vasquez Law Firm',
  description: 'Servicios legales de lesiones personales en Fayetteville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'lesiones personales Fayetteville, abogado Fayetteville, lesiones personales NC, abogado español Fayetteville, servicios legales Fayetteville',
  openGraph: {
    title: 'Lesiones Personales en Fayetteville, NC | Vasquez Law Firm',
    description: 'Servicios legales de lesiones personales en Fayetteville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Lesiones Personales en Fayetteville, NC'
    }]
  },
  alternates: {
