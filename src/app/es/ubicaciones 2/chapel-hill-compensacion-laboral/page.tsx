...
export const metadata = {
  title: 'Compensación Laboral en Chapel Hill, NC | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Chapel Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'compensación laboral Chapel Hill, abogado Chapel Hill, compensación laboral NC, abogado español Chapel Hill, servicios legales Chapel Hill',
  openGraph: {
    title: 'Compensación Laboral en Chapel Hill, NC | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Chapel Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Chapel Hill, NC'
    }]
  },
  alternates: {
