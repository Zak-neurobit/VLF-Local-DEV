...
export const metadata = {
  title: 'Lesiones Personales en Winston-Salem, NC | Vasquez Law Firm',
  description: 'Servicios legales de lesiones personales en Winston-Salem, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'lesiones personales Winston-Salem, abogado Winston-Salem, lesiones personales NC, abogado español Winston-Salem, servicios legales Winston-Salem',
  openGraph: {
    title: 'Lesiones Personales en Winston-Salem, NC | Vasquez Law Firm',
    description: 'Servicios legales de lesiones personales en Winston-Salem, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Lesiones Personales en Winston-Salem, NC'
    }]
  },
  alternates: {
