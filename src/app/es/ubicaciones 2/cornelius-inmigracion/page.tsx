...
export const metadata = {
  title: 'Ley de Inmigración en Cornelius, NC | Vasquez Law Firm',
  description: 'Servicios legales de ley de inmigración en Cornelius, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'ley de inmigración Cornelius, abogado Cornelius, ley de inmigración NC, abogado español Cornelius, servicios legales Cornelius',
  openGraph: {
    title: 'Ley de Inmigración en Cornelius, NC | Vasquez Law Firm',
    description: 'Servicios legales de ley de inmigración en Cornelius, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Ley de Inmigración en Cornelius, NC'
    }]
  },
  alternates: {
