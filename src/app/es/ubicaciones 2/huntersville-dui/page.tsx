...
export const metadata = {
  ...
  description: 'Servicios legales de defensa dui en Huntersville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'defensa dui Huntersville, abogado Huntersville, defensa dui NC, abogado español Huntersville, servicios legales Huntersville',
  openGraph: {
    title: 'Defensa DUI en Huntersville, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa dui en Huntersville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
