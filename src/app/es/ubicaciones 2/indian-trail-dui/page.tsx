...
export const metadata = {
  ...
  description: 'Servicios legales de defensa dui en Indian Trail, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'defensa dui Indian Trail, abogado Indian Trail, defensa dui NC, abogado español Indian Trail, servicios legales Indian Trail',
  openGraph: {
    title: 'Defensa DUI en Indian Trail, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa dui en Indian Trail, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
