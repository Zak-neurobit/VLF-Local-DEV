...
export const metadata = {
  title: 'Lesiones Personales en Hickory, NC | Vasquez Law Firm',
  description: 'Servicios legales de lesiones personales en Hickory, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'lesiones personales Hickory, abogado Hickory, lesiones personales NC, abogado español Hickory, servicios legales Hickory',
  openGraph: {
    title: 'Lesiones Personales en Hickory, NC | Vasquez Law Firm',
    description: 'Servicios legales de lesiones personales en Hickory, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Lesiones Personales en Hickory, NC'
    }]
  },
  alternates: {
