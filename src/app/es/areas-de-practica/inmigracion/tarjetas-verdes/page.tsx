        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Abogados para obtener la tarjeta de residencia en Raleigh NC
            </h1>
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/tarjetas-verdes/',
                  url: 'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/tarjetas-verdes/',
                  name: 'Abogados para obtener la tarjeta de residencia en Raleigh NC - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/tarjetas-verdes/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/tarjetas-verdes/#primaryimage',
                  ...
                  thumbnailUrl:
                    '../../../../wp-content/uploads/2024/04/wake-county-green-card-lawyers-1.jpg',
                  datePublished: '2024-04-05T18:38:38+00:00',
                  dateModified: '2024-04-05T18:38:48+00:00',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/tarjetas-verdes/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'Abogados de Tarjeta Verde del Condado de Wake',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 5,
                      name: 'Abogados para obtener la tarjeta de residencia en Raleigh NC',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  item: 'https://vasquezlawnc.com/es/areas-de-practica/inmigracion/tarjetas-verdes',
                },
              ],
            },
            {
