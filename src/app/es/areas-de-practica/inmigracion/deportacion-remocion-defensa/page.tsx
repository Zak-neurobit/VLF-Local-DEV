        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Abogados Defensores de Deportación en Raleigh, NC
            </h1>
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/deportacion-remocion-defensa/',
                  url: 'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/deportacion-remocion-defensa/',
                  name: 'Abogados Defensores de Deportación en Raleigh, NC - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/deportacion-remocion-defensa/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/deportacion-remocion-defensa/#primaryimage',
                  ...
                  thumbnailUrl:
                    '../../../../wp-content/uploads/2024/04/smithfield-removal-defense-lawyers-1.jpg',
                  datePublished: '2024-04-05T18:42:39+00:00',
                  dateModified: '2024-04-05T18:42:53+00:00',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/deportacion-remocion-defensa/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'Abogados de Defensa de Deportación de Smithfield',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 5,
                      name: 'Abogados Defensores de Deportación en Raleigh, NC',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: 'Deportacion remocion defensa',
                  item: 'https://vasquezlawnc.com/es/areas-de-practica/inmigracion/deportacion-remocion-defensa',
                },
              ],
            },
            {
