      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Abogados de DACA en Raleigh NC</h1>
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/daca-accion-diferida-llegadas-en-la-infancia/',
                  url: 'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/daca-accion-diferida-llegadas-en-la-infancia/',
                  name: 'Abogados de DACA en Raleigh NC - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/daca-accion-diferida-llegadas-en-la-infancia/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/daca-accion-diferida-llegadas-en-la-infancia/#primaryimage',
                  ...
                  thumbnailUrl:
                    '../../../../wp-content/uploads/2024/04/smithfield-daca-relief-lawyers-1-1.jpg',
                  datePublished: '2024-04-05T18:48:14+00:00',
                  dateModified: '2024-04-05T18:48:24+00:00',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/daca-accion-diferida-llegadas-en-la-infancia/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'Abogados de Ayuda en DACA en Smithfield',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 5, name: 'Abogados de DACA en Raleigh NC' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: 'Daca accion diferida llegadas en la infancia',
                  item: 'https://vasquezlawnc.com/es/areas-de-practica/inmigracion/daca-accion-diferida-llegadas-en-la-infancia',
                },
              ],
            },
            {
