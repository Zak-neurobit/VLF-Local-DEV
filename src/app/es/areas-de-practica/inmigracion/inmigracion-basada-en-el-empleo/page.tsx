        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Abogados de Inmigración Basados en el Empleo en Raleigh
            </h1>
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/inmigracion-basada-en-el-empleo/',
                  url: 'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/inmigracion-basada-en-el-empleo/',
                  name: 'Abogados de Inmigración Basados en el Empleo en Raleigh - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/inmigracion-basada-en-el-empleo/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/inmigracion-basada-en-el-empleo/#primaryimage',
                  ...
                  thumbnailUrl:
                    '../../../../wp-content/uploads/2024/04/Employment-Based-Immigration-Lawyers.jpg',
                  datePublished: '2024-04-05T18:51:08+00:00',
                  dateModified: '2024-04-05T18:51:29+00:00',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/inmigracion-basada-en-el-empleo/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'Abogados de Inmigración Basados en el Empleo en Raleigh',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
