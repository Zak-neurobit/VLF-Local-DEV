        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Abogado de Certificación Laboral PERM de Raleigh
            </h1>
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/inmigracion-basada-en-el-empleo/certificacion-laboral-perm/',
                  url: 'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/inmigracion-basada-en-el-empleo/certificacion-laboral-perm/',
                  name: 'Abogado de Certificación Laboral PERM de Raleigh - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/inmigracion-basada-en-el-empleo/certificacion-laboral-perm/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/inmigracion-basada-en-el-empleo/certificacion-laboral-perm/#primaryimage',
                  ...
                  thumbnailUrl:
                    '../../../../../wp-content/uploads/2024/04/Raleigh-PERM-Labor-Certification-Lawyers-1.jpg',
                  datePublished: '2024-04-05T18:53:25+00:00',
                  dateModified: '2025-02-20T11:08:24+00:00',
                  description:
                    '¿Necesita ayuda con la certificación laboral PERM en Raleigh, NC? Nuestro abogado experto en inmigración facilita el proceso. ¡Contáctenos hoy!',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/inmigracion-basada-en-el-empleo/certificacion-laboral-perm/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'Abogado de Certificación Laboral PERM de Raleigh',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 5,
                      name: 'Abogados de Inmigración Basados en el Empleo en Raleigh',
                      item: 'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/inmigracion-basada-en-el-empleo/',
                    },
                    {
                      '@type': 'ListItem',
                      position: 6,
                      name: 'Abogado de Certificación Laboral PERM de Raleigh',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: 'Inmigracion basada en el empleo',
                  item: 'https://vasquezlawnc.com/es/areas-de-practica/inmigracion/inmigracion-basada-en-el-empleo',
                },
                {
                  '@type': 'ListItem',
                  position: 6,
                  name: 'Certificacion laboral perm',
                  item: 'https://vasquezlawnc.com/es/areas-de-practica/inmigracion/inmigracion-basada-en-el-empleo/certificacion-laboral-perm',
                },
              ],
            },
            {
