        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Abogados de inmigración de Raleigh para visas de familiares inmediatas
            </h1>
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/visas-de-pariente-inmediato/',
                  url: 'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/visas-de-pariente-inmediato/',
                  name: 'Abogados de inmigración de Raleigh para visas de familiares inmediatas - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/visas-de-pariente-inmediato/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/visas-de-pariente-inmediato/#primaryimage',
                  ...
                  thumbnailUrl:
                    '../../../../wp-content/uploads/2024/04/north-carolina-immediate-relative-immigration-attorneys-1.jpg',
                  datePublished: '2024-04-05T18:28:59+00:00',
                  dateModified: '2024-04-05T18:29:12+00:00',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/visas-de-pariente-inmediato/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'Abogados de inmigración familiar inmediata de Carolina del Norte',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 5,
                      name: 'Abogados de inmigración de Raleigh para visas de familiares inmediatas',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: 'Visas de pariente inmediato',
                  item: 'https://vasquezlawnc.com/es/areas-de-practica/inmigracion/visas-de-pariente-inmediato',
                },
              ],
            },
            {
