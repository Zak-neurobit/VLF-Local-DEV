...
export const metadata: Metadata = {
  title:
    'Abogados de inmigración de Raleigh, NC para víctimas de crímenes y violencia doméstica - Vasquez Law Firm, PLLC',
  description:
    '¿Es víctima de un crimen o violencia doméstica en Raleigh, NC? Nuestros abogados de inmigración pueden ayudarle a obtener protección legal. ¡Contáctenos hoy!',
  openGraph: {
    title:
      'Abogados de inmigración de Raleigh, NC para víctimas de crímenes y violencia doméstica - Vasquez Law Firm, PLLC',
    description:
    ...
    images: [
      {
        url: '../../../../wp-content/uploads/2024/04/johnston-county-vawa-immigration-lawyers-1.jpg',
      },
    ],
  },
};

export default function VawaUVisaCrimenVictimasPage() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Abogados de inmigración de Raleigh, NC para víctimas de crímenes y violencia doméstica
            </h1>
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/vawa-u-visa-crimen-victimas/',
                  url: 'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/vawa-u-visa-crimen-victimas/',
                  name: 'Abogados de inmigración de Raleigh, NC para víctimas de crímenes y violencia doméstica - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/vawa-u-visa-crimen-victimas/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/vawa-u-visa-crimen-victimas/#primaryimage',
                  ...
                  thumbnailUrl:
                    '../../../../wp-content/uploads/2024/04/johnston-county-vawa-immigration-lawyers-1.jpg',
                  datePublished: '2024-04-05T18:44:00+00:00',
                  dateModified: '2025-02-20T11:17:14+00:00',
                  description:
                    '¿Es víctima de un crimen o violencia doméstica en Raleigh, NC? Nuestros abogados de inmigración pueden ayudarle a obtener protección legal. ¡Contáctenos hoy!',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/vawa-u-visa-crimen-victimas/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'Abogados de Inmigración VAWA del Condado de Johnston',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 5,
                      name: 'Abogados de inmigración de Raleigh, NC para víctimas de crímenes y violencia doméstica',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: 'Vawa u visa crimen victimas',
                  item: 'https://vasquezlawnc.com/es/areas-de-practica/inmigracion/vawa-u-visa-crimen-victimas',
                },
              ],
            },
            {
