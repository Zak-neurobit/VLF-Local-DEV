        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Abogados de Perdones de Inadmisibilidad en Raleigh, NC
            </h1>
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/inadmisibilidad-perdones-inelegible-para-inmigrar/',
                  url: 'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/inadmisibilidad-perdones-inelegible-para-inmigrar/',
                  name: 'Abogados de Perdones de Inadmisibilidad en Raleigh, NC - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/inadmisibilidad-perdones-inelegible-para-inmigrar/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/inadmisibilidad-perdones-inelegible-para-inmigrar/#primaryimage',
                  ...
                  thumbnailUrl:
                    '../../../../wp-content/uploads/2024/04/smithfield-waivers-of-inadmissibility-lawyers-1.jpg',
                  datePublished: '2024-04-05T18:34:23+00:00',
                  dateModified: '2024-04-05T18:34:57+00:00',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/inadmisibilidad-perdones-inelegible-para-inmigrar/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'Abogados de Perdones de Inadmisibilidad de Smithfield',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 5,
                      name: 'Abogados de Perdones de Inadmisibilidad en Raleigh, NC',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: 'Inadmisibilidad perdones inelegible para inmigrar',
                  item: 'https://vasquezlawnc.com/es/areas-de-practica/inmigracion/inadmisibilidad-perdones-inelegible-para-inmigrar',
                },
              ],
            },
            {
