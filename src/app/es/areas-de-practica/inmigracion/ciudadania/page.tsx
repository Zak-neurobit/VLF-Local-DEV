        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Abogados de Ciudadanía y Naturalización de Raleigh, NC
            </h1>
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/ciudadania-naturalizacion/',
                  url: 'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/ciudadania-naturalizacion/',
                  name: 'Abogados de Ciudadanía y Naturalización de Raleigh, NC - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/ciudadania-naturalizacion/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/ciudadania-naturalizacion/#primaryimage',
                  ...
                  thumbnailUrl:
                    '../../../../wp-content/uploads/2024/04/charlotte-nc-citizenship-through-naturalization-lawyers-1.jpg',
                  datePublished: '2024-04-05T18:41:26+00:00',
                  dateModified: '2024-04-05T18:41:35+00:00',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/ciudadania-naturalizacion/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'Abogados de Ciudadanía Mediante Naturalización en Charlotte, NC',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 5,
                      name: 'Abogados de Ciudadanía y Naturalización de Raleigh, NC',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: 'Ciudadania naturalizacion',
                  item: 'https://vasquezlawnc.com/es/areas-de-practica/inmigracion/ciudadania-naturalizacion',
                },
              ],
            },
            {
