        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Abogados de Inmigración de Asilo en Charlotte, NC
            </h1>
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/asilo-refugiado-ayuda-legal/',
                  url: 'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/asilo-refugiado-ayuda-legal/',
                  name: 'Abogados de Inmigración de Asilo en Charlotte, NC - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/asilo-refugiado-ayuda-legal/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/asilo-refugiado-ayuda-legal/#primaryimage',
                  ...
                  thumbnailUrl:
                    '../../../../wp-content/uploads/2024/04/north-carolina-asylum-and-refugees-attorneys-1.jpg',
                  datePublished: '2024-04-05T18:40:04+00:00',
                  dateModified: '2024-04-05T18:40:15+00:00',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/asilo-refugiado-ayuda-legal/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'Abogados de Asilo y Refugiados de Carolina del Norte',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 5,
                      name: 'Abogados de Inmigración de Asilo en Charlotte, NC',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: 'Asilo refugiado ayuda legal',
                  item: 'https://vasquezlawnc.com/es/areas-de-practica/inmigracion/asilo-refugiado-ayuda-legal',
                },
              ],
            },
            {
