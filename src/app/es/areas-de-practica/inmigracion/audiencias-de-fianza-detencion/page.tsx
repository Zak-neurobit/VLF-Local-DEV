        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Abogados de Audiencia de Fianza por Detención en Raleigh, NC
            </h1>
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/audiencias-de-fianza-detencion/',
                  url: 'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/audiencias-de-fianza-detencion/',
                  name: 'Abogados de Audiencia de Fianza por Detención en Raleigh, NC - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/audiencias-de-fianza-detencion/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/audiencias-de-fianza-detencion/#primaryimage',
                  ...
                  thumbnailUrl:
                    '../../../../wp-content/uploads/2024/04/johnston-detention-bond-hearing-attorneys-1.jpg',
                  datePublished: '2024-04-05T18:45:18+00:00',
                  dateModified: '2024-04-05T18:45:29+00:00',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/areas-de-practica/inmigracion/audiencias-de-fianza-detencion/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'Abogados de Audiencias de Fianza de Detención en Johnston',
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 5,
                      name: 'Abogados de Audiencia de Fianza por Detención en Raleigh, NC',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: 'Audiencias de fianza detencion',
                  item: 'https://vasquezlawnc.com/es/areas-de-practica/inmigracion/audiencias-de-fianza-detencion',
                },
              ],
            },
            {
