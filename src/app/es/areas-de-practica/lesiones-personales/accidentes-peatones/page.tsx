...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.vasquezlawnc.com/es/areas-de-practica/lesiones-personales/accidentes-peatones',
    languages: {
      'en-US': 'https://www.vasquezlawnc.com/practice-areas/personal-injury/pedestrian-accidents',
      'es-ES': 'https://www.vasquezlawnc.com/es/areas-de-practica/lesiones-personales/accidentes-peatones',
    },
  },
};
...
const services = [
  {
    ...
    description: 'Representación cuando vehículos golpean peatones en cruces marcados y no marcados.',
    features: [
...
const faqs = [
  {
    ...
    answer: 'Busque atención médica inmediata, incluso si se siente bien. Llame a la policía, obtenga información del conductor y testigos, y contacte a un abogado antes de hablar con seguros.',
  },
];
