...
export const metadata: Metadata = {
  ...
  description:
    'Abogados expertos en compensación laboral de NC con 60+ años de experiencia. Obtenga sus beneficios aprobados rápido. Consulta gratuita. Manejamos reclamos denegados. Se habla español.',
  keywords:
    'abogado compensación laboral NC, abogado compensación trabajadores Carolina del Norte, abogado lesiones trabajo, reclamos compensación laboral denegados, abogado accidentes trabajo NC, abogado comp laboral Raleigh, abogado lesiones trabajo Charlotte, compensación laboral Durham, abogado accidentes trabajo Greensboro, abogado comp Winston Salem',
  openGraph: {
    title: 'Mejores Abogados de Compensación Laboral en Carolina del Norte | YO PELEO POR TI™',
    description:
      'Abogados expertos en compensación laboral de NC con 60+ años de experiencia. Obtenga sus beneficios aprobados rápido. Consulta gratuita. Manejamos reclamos denegados.',
  ...
  twitter: {
    ...
    title: 'Mejores Abogados de Compensación Laboral en Carolina del Norte | YO PELEO POR TI™',
    description:
      'Abogados expertos en compensación laboral de NC con 60+ años de experiencia. Obtenga sus beneficios aprobados rápido. Consulta gratuita.',
  ...
  const services = [
    {
      ...
      description:
        'Manejamos todo su reclamo de compensación laboral de principio a fin, asegurando que se cumplan todos los plazos y se presente la documentación correctamente para obtener los máximos beneficios.',
      features: [
    ...
    },
    {
      ...
      description:
        'No acepte una denegación. Nuestros abogados experimentados saben cómo revertir denegaciones injustas y obtenerle los beneficios que merece.',
      features: [
    ...
    },
    {
      ...
      description:
        'Asegure los beneficios por discapacidad que necesita mientras no puede trabajar. Luchamos por compensación por discapacidad temporal y permanente.',
      features: [
    ...
    },
    {
      ...
      description:
        'Obtenga la atención médica que necesita sin demoras. Obligamos a las compañías de seguros a autorizar tratamientos y cirugías necesarias.',
      features: [
    ...
    },
    {
      ...
      description:
        'Recupere dos tercios de su salario semanal promedio mientras se recupera. Aseguramos cálculos precisos y pagos oportunos.',
      features: [
    ...
    },
    {
      ...
      description:
        'Los trabajadores de construcción enfrentan peligros serios diariamente. Nos especializamos en asegurar beneficios máximos para víctimas de accidentes de construcción.',
      features: [
    ...
    },
    {
      ...
      description:
        'Los movimientos repetitivos causan lesiones reales. Probamos la conexión entre sus deberes laborales y condiciones como túnel carpiano.',
      features: [
    ...
    },
    {
      ...
      description:
        'Las enfermedades relacionadas con el trabajo también merecen compensación. Manejamos reclamos por enfermedades causadas por exposición y condiciones en el lugar de trabajo.',
      features: [
    ...
    },
    {
      ...
      description:
        'Cuando los accidentes laborales cobran vidas, ayudamos a las familias a asegurar beneficios por muerte y garantizar estabilidad financiera durante tiempos difíciles.',
      features: [
  ...
  const faqs = [
    {
      ...
      answer:
        'Trabajamos bajo contingencia - no paga nada por adelantado. Nuestros honorarios vienen de su acuerdo o adjudicación, típicamente 25% o menos según regulado por la ley de NC.',
    },
    {
      question: '¿Puedo ver a mi propio doctor por una lesión de trabajo?',
      answer:
        'Inicialmente, debe ver a los doctores aprobados por el empleador. Sin embargo, puede tener derechos para cambiar doctores u obtener segundas opiniones. Podemos ayudarle a navegar esto.',
    },
    {
      question: '¿Qué pasa si mi reclamo de compensación laboral fue denegado?',
      answer:
        '¡No se rinda! Muchas denegaciones son injustas. Tenemos amplia experiencia revirtiendo denegaciones a través de apelaciones y audiencias. Llámenos inmediatamente.',
    },
    {
      question: '¿Cuánto tiempo tengo para presentar un reclamo de compensación laboral en NC?',
      answer:
        'Debe reportar lesiones dentro de 30 días y presentar el Formulario 18 dentro de 2 años. Sin embargo, actuar rápidamente es crucial para preservar evidencia y testimonio de testigos.',
    },
    {
      question: '¿Me pueden despedir por presentar un reclamo de compensación laboral?',
      answer:
        'Es ilegal que los empleadores tomen represalias contra usted por presentar un reclamo legítimo de compensación laboral. Si esto pasa, puede tener remedios legales adicionales.',
    },
  ];
          ...
          <div className="space-y-12">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">
                Nuestras Especialidades en Compensación Laboral
              </h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                >
                  <h3 className="text-xl font-bold text-primary mb-3 group-hover:text-primary-300">
                    Lesiones en el Lugar de Trabajo
                  </h3>
                  <p className="text-gray-300">
                    Representamos todo tipo de lesiones laborales, desde caídas hasta accidentes con
                    maquinaria.
                  </p>
                </Link>
                ...
                >
                  ...
                  <p className="text-gray-300">
                    Especialistas en hernias discales, fracturas espinales y dolor crónico de
                    espalda.
                  </p>
                </Link>
                ...
                >
                  ...
                  <p className="text-gray-300">
                    Accidentes graves con equipos industriales y maquinaria pesada.
                  </p>
                </Link>
                ...
                >
                  ...
                  <p className="text-gray-300">
                    Enfermedades causadas por exposición química, asbesto y condiciones del trabajo.
                  </p>
                </Link>
                ...
                >
                  ...
                  <p className="text-gray-300">
                    Apelamos denegaciones injustas y luchamos por los beneficios que merece.
                  </p>
                </Link>
                ...
                >
                  <h3 className="text-xl font-bold text-primary mb-3 group-hover:text-primary-300">
                    Audiencias de Compensación
                  </h3>
                  <p className="text-gray-300">
                    Representación experta en audiencias de la Comisión Industrial de NC.
                  </p>
                </Link>
              </div>
            </section>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">
                ¿Por Qué Elegir Bufete de Abogados Vásquez para Compensación Laboral?
              </h2>
              <p className="text-lg mb-6">
                Las compañías de seguros tienen equipos de abogados protegiendo sus ganancias. Usted
                necesita luchadores experimentados de su lado. Nivelamos el campo de juego y le
                conseguimos los beneficios que merece.
              </p>

              <div className="grid md:grid-cols-2 gap-6 mt-8">
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  <h3 className="text-xl font-bold text-primary mb-3">
                    Reclamos Denegados Revertidos
                  </h3>
                  <p className="text-gray-300">
                    Hemos revertido miles de denegaciones injustas. No acepte &ldquo;no&rdquo; como
                    respuesta final.
                  </p>
                </div>
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  ...
                  <p className="text-gray-300">
                    Aseguramos cálculos precisos de salarios y luchamos por cada beneficio al que
                    tiene derecho.
                  </p>
                </div>
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  ...
                  <p className="text-gray-300">
                    Obligamos a las compañías de seguros a aprobar tratamientos, cirugías y
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  ...
                  <p className="text-gray-300">
                    No paga nada a menos que ganemos. Nuestros honorarios están limitados por ley y
                    vienen de su acuerdo.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">
                Estadísticas de Lesiones Laborales en Carolina del Norte
              </h2>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <div className="text-gray-300">
                      Lesiones laborales reportadas anualmente en NC
                    </div>
                  </div>
                  <div className="text-center">
                    <div className="text-4xl font-black text-primary mb-2">35%</div>
                    <div className="text-gray-300">
                      De reclamos inicialmente denegados por aseguradoras
                    </div>
                  </div>
                  <div className="text-center">
                    <div className="text-4xl font-black text-primary mb-2">$890M</div>
                    <div className="text-gray-300">
                      Pagado en beneficios de compensación laboral en NC
                    </div>
                  </div>
                </div>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">
                Lesiones Laborales Comunes Que Manejamos
              </h2>
              <div className="grid md:grid-cols-3 gap-6">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">
                Nuestro Proceso de Compensación Laboral
              </h2>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Evaluamos su reclamo, explicamos sus derechos y desarrollamos una estrategia
                      ganadora - todo sin costo.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2">
                      Presentación y Manejo del Reclamo
                    </h3>
                    <p className="text-gray-300">
                      Manejamos todos los documentos, plazos y comunicaciones con empleadores y
                      aseguradoras.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Luchamos por reemplazo completo de salarios, cobertura médica completa y
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Si es necesario, lo representamos en audiencias de la Comisión Industrial para
            ...
            <section>
              ...
              <p className="text-lg mb-8">
                Todo trabajador merece protección. Representamos trabajadores lesionados en todas
                las industrias a través de Carolina del Norte:
              </p>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              'Servicios legales expertos de compensación laboral en Carolina del Norte incluyendo presentación de reclamos, apelaciones de reclamos denegados, beneficios por discapacidad y representación de lesiones laborales.',
            provider: {
              '@type': 'Attorney',
