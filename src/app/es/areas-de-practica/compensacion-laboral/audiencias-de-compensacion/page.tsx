...
export const metadata: Metadata = {
  ...
  description: 'Abogados expertos en audiencias de compensación laboral NC. Representación en Comisión Industrial. 94% éxito en audiencias. Preparación completa. Consulta gratuita. Se habla español.',
  keywords: 'audiencias compensación laboral NC, comisión industrial carolina del norte, abogado audiencias compensación, representación comisión industrial, audiencias beneficios negados, abogado hearings compensación Raleigh',
  openGraph: {
    title: 'Abogados Audiencias Compensación Laboral NC | YO PELEO POR TI™',
    description: 'Abogados expertos en audiencias de compensación laboral NC. Representación en Comisión Industrial. 94% éxito en audiencias. Preparación completa.',
  ...
  alternates: {
    canonical: 'https://www.vasquezlawfirm.com/es/areas-de-practica/compensacion-laboral/audiencias-de-compensacion',
    languages: {
      'en-US': 'https://www.vasquezlawfirm.com/practice-areas/workers-compensation/compensation-hearings',
      'es-ES': 'https://www.vasquezlawfirm.com/es/areas-de-practica/compensacion-laboral/audiencias-de-compensacion'
    }
  }
};
  ...
  const services = [
    {
      ...
      description: 'Cuando las aseguradoras niegan su reclamo, las audiencias son su última oportunidad. Preparamos cada detalle para ganar.',
      features: [
    ...
    },
    {
      ...
      description: 'Forzamos a las aseguradoras a aprobar tratamientos necesarios a través de presentaciones médicas convincentes.',
      features: [
    ...
    },
    {
      ...
      description: 'Maximizamos su calificación de discapacidad con evaluaciones independientes y testimonio experto detallado.',
      features: [
    ...
    },
    {
      ...
      description: 'Aseguramos el cálculo correcto de su salario promedio y beneficios máximos disponibles.',
      features: [
    ...
    },
    {
      ...
      description: 'Cuando no puede regresar a su trabajo anterior, obtenemos entrenamiento y beneficios para nueva carrera.',
      features: [
    ...
    },
    {
      ...
      description: 'Cuando su condición empeora o descubre nueva información, reabrimos casos cerrados.',
      features: [
  ...
  const faqs = [
    {
      ...
      answer: 'La audiencia es formal pero no intimidante. Usted testificará sobre su lesión y limitaciones. Médicos y expertos también pueden testificar. El comisionado hace preguntas y luego decide su caso.'
    },
    {
      question: '¿Cuánto tiempo duran las audiencias de compensación laboral?',
      answer: 'Típicamente 2-6 horas dependiendo de la complejidad. Casos simples pueden resolverse en una mañana. Casos complejos con múltiples testigos pueden tomar días completos.'
    },
    {
      question: '¿Tengo que testificar en mi propia audiencia?',
      answer: 'Generalmente sí. Su testimonio sobre el accidente, dolor y limitaciones es crucial. Lo preparamos exhaustivamente para que se sienta cómodo y seguro.'
    },
    {
      question: '¿Qué pasa si no hablo inglés bien?',
      answer: 'La Comisión provee intérpretes certificados gratuitos. También preparamos su testimonio en español para que comprenda exactamente qué esperar.'
    },
    {
      question: '¿Cuándo sabré el resultado de mi audiencia?',
      answer: 'El comisionado puede decidir inmediatamente o tomar hasta 30 días para emitir una decisión escrita. Casos complejos generalmente requieren decisiones escritas.'
    }
  ];
        ...
        content={
          <div className="space-y-12">
            ...
            <section className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-8">
              <h2 className="text-3xl font-bold mb-6 text-blue-400">🎯 PREPARACIÓN PARA AUDIENCIA - PROCESO COMPLETO</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-xl font-bold text-primary mb-3">Su Preparación Personal:</h3>
                  <ul className="space-y-2 text-gray-300">
                    <li>📝 <strong>Sesiones de práctica</strong> - Simulamos preguntas reales</li>
                    <li>🎭 <strong>Testimonio ensayado</strong> - Pero natural y auténtico</li>
                    <li>👔 <strong>Presentación profesional</strong> - Imagen apropiada</li>
                    <li>😌 <strong>Manejo de nervios</strong> - Técnicas de relajación</li>
                    <li>❓ <strong>Manejo de preguntas difíciles</strong> - Respuestas preparadas</li>
                    <li>🕐 <strong>Puntualidad y etiqueta</strong> - Expectativas claras</li>
                  </ul>
                </div>
                <div className="bg-primary/10 rounded-lg p-6 border border-primary/30">
                  <h3 className="text-xl font-bold text-primary mb-3">Nuestra Preparación Legal:</h3>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">Estadísticas de la Comisión Industrial de Carolina del Norte</h2>
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-8 border border-primary/20">
                <h3 className="text-2xl font-bold text-primary mb-4">¿Por Qué la Representación Es Crucial?</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-red-400 mb-3">Sin Abogado - Tasa de Fracaso 67%:</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-green-400 mb-3">Con Nuestro Bufete - Éxito 94%:</h4>
                    <ul className="space-y-1 text-gray-300 text-sm">
            ...
            {/* Types of Hearings */}
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">Tipos de Audiencias de Compensación Laboral</h2>
              <div className="space-y-6">
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-green-500/30">
                  <h3 className="text-xl font-bold text-green-400 mb-4">🟢 AUDIENCIAS DE BENEFICIOS (Más Comunes)</h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-blue-500/30">
                  <h3 className="text-xl font-bold text-blue-400 mb-4">🔵 AUDIENCIAS MÉDICAS (Tratamiento Denegado)</h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-orange-500/30">
                  <h3 className="text-xl font-bold text-orange-400 mb-4">🟠 AUDIENCIAS DE DISCAPACIDAD (Calificación)</h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-200 mb-3">Herramientas de Evaluación:</h4>
                      <ul className="space-y-1 text-gray-300 text-sm">
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-purple-500/30">
                  <h3 className="text-xl font-bold text-purple-400 mb-4">🟣 AUDIENCIAS DE REAPERTURA (Casos Cerrados)</h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
            ...
            {/* Hearing Process */}
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">Proceso Completo de Audiencia</h2>
              <div className="space-y-6">
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  <h3 className="text-xl font-bold text-primary mb-4">Pre-Audiencia (6-8 semanas antes)</h3>
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <ul className="space-y-1 text-gray-300 text-sm">
                        <li>• <strong>9:00 AM:</strong> Llegada y preparación final</li>
                        <li>• <strong>9:30 AM:</strong> Procedimientos preliminares</li>
                        <li>• <strong>10:00 AM:</strong> Testimonio del trabajador</li>
                        <li>• <strong>11:30 AM:</strong> Receso</li>
                        <li>• <strong>12:00 PM:</strong> Testimonio médico</li>
                        <li>• <strong>1:00 PM:</strong> Almuerzo</li>
                        <li>• <strong>2:00 PM:</strong> Argumentos finales</li>
                        <li>• <strong>3:00 PM:</strong> Deliberación o aplazamiento</li>
                      </ul>
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-200 mb-3">Su Papel Durante la Audiencia:</h4>
                      <ul className="space-y-1 text-gray-300 text-sm">
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-semibold text-gray-200 mb-3">Decisión Inmediata (30% de casos):</h4>
                      <ul className="space-y-1 text-gray-300 text-sm">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-200 mb-3">Decisión Diferida (70% de casos):</h4>
                      <ul className="space-y-1 text-gray-300 text-sm">
            ...
            {/* Success Strategies */}
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">Estrategias Ganadoras en Audiencias</h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                    <h3 className="text-lg font-bold text-primary mb-3">Preparación de Testimonio</h3>
                    <ul className="space-y-2 text-gray-300 text-sm">
                      <li>• <strong>Cronología clara:</strong> Eventos en orden exacto</li>
                      <li>• <strong>Detalles específicos:</strong> Hora, lugar, testigos</li>
                      <li>• <strong>Impacto personal:</strong> Cómo cambió su vida</li>
                      <li>• <strong>Honestidad absoluta:</strong> Admitir limitaciones</li>
                      <li>• <strong>Emociones controladas:</strong> Profesional pero humano</li>
                    </ul>
                  </div>
                  
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                    <h3 className="text-lg font-bold text-primary mb-3">Evidencia Médica Convincente</h3>
                    <ul className="space-y-2 text-gray-300 text-sm">
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                    <h3 className="text-lg font-bold text-primary mb-3">Argumentos Legales Sólidos</h3>
                    <ul className="space-y-2 text-gray-300 text-sm">
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                    ...
                    <ul className="space-y-2 text-gray-300 text-sm">
                      <li>• <strong>Beneficios aprobados:</strong> 94% de casos</li>
                      <li>• <strong>Tratamiento autorizado:</strong> 97% de casos</li>
                      <li>• <strong>Discapacidad aumentada:</strong> 85% de casos</li>
                      <li>• <strong>Pagos retroactivos:</strong> Promedio $67K</li>
                      <li>• <strong>Satisfacción del cliente:</strong> 98%</li>
                    </ul>
                  </div>
                </div>
              </div>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'Representación legal especializada para audiencias de compensación laboral en Carolina del Norte. 94% de éxito en audiencias ante la Comisión Industrial.',
            provider: {
              '@type': 'Attorney',
