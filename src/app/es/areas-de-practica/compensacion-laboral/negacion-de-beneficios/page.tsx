...
export const metadata: Metadata = {
  ...
  description:
    'Abogados expertos en apelaciones de compensación laboral denegada NC. Revertimos 89% de denegaciones injustas. Forzamos pagos. Consulta gratuita urgente. Se habla español.',
  keywords:
    'compensación laboral denegada NC, apelación reclamo denegado, beneficios negados injustamente, abogado apelaciones compensación, revertir denegación compensación laboral, audiencias comisión industrial NC, forzar pagos compensación',
  openGraph: {
    title: 'Abogados Negación Beneficios Compensación Laboral NC | YO PELEO POR TI™',
    description:
      'Abogados expertos en apelaciones de compensación laboral denegada NC. Revertimos 89% de denegaciones injustas. Forzamos pagos.',
  ...
  alternates: {
    canonical:
      'https://www.vasquezlawfirm.com/es/areas-de-practica/compensacion-laboral/negacion-de-beneficios',
    languages: {
  ...
  const services = [
    {
      ...
      description:
        'Las aseguradoras niegan tratamientos médicos necesarios para ahorrar dinero. Forzamos autorizaciones a través de presión legal agresiva.',
      features: [
    ...
    },
    {
      ...
      description:
        'Cuando las aseguradoras cortan sus pagos semanales sin justificación, actuamos inmediatamente para restaurar sus ingresos.',
      features: [
    ...
    },
    {
      ...
      description:
        'La excusa más común. Utilizamos evidencia médica y testigos expertos para probar que su lesión SÍ está relacionada con el trabajo.',
      features: [
    ...
    },
    {
      ...
      description:
        'Las aseguradoras minimizan deliberadamente su discapacidad. Obtenemos evaluaciones independientes para calificaciones justas.',
      features: [
    ...
    },
    {
      ...
      description:
        'Las aseguradoras demoran deliberadamente esperando que se rinda. Imponemos presión legal y buscamos penalidades por mala fe.',
      features: [
    ...
    },
    {
      ...
      description:
        'Cuando las aseguradoras intentan cerrar permanentemente su caso sin compensación justa, reabrimos y luchamos.',
      features: [
  ...
  const faqs = [
    {
      ...
      answer:
        'NO FIRME NADA. Contacte a un abogado especializado inmediatamente. Tiene plazos estrictos para apelar. Conserve toda documentación y continúe tratamiento médico si es posible.',
    },
    {
      question: '¿Cuánto tiempo tengo para apelar una denegación en NC?',
      answer:
        'Generalmente 30 días desde la notificación de denegación. Sin embargo, algunos plazos pueden ser más cortos. Es crucial actuar inmediatamente para preservar sus derechos.',
    },
    {
      question: '¿Puedo obtener tratamiento médico mientras apelo?',
      answer:
        'Depende. Si tiene seguro de salud, úselo y mantenga facturas para reembolso posterior. En emergencias, busque tratamiento inmediato y luego contacte a un abogado.',
    },
    {
      question: '¿Las aseguradoras deben pagar mis gastos legales si gano la apelación?',
      answer:
        'En algunos casos sí. Si la denegación fue de mala fe o si ganamos en audiencia, la aseguradora puede ser responsable por honorarios de abogado y costos.',
    },
    {
      question: '¿Qué pasa si mi empleador me presiona para no apelar?',
      answer:
        'Eso es retaliación ilegal. Su empleador no puede despedirlo, degradarlo o intimidarlo por ejercer sus derechos de compensación laboral. Podemos demandar por daños adicionales.',
    },
  ];
          ...
          <div className="space-y-12">
            ...
            <section className="bg-red-900/20 border border-red-500/30 rounded-lg p-8">
              <h2 className="text-3xl font-bold mb-6 text-red-400">
                🚨 BENEFICIOS DENEGADOS - ACCIÓN URGENTE REQUERIDA
              </h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-xl font-bold text-primary mb-3">
                    ¡NO FIRME NADA! Primero Llame:
                  </h3>
                  <ul className="space-y-2 text-gray-300">
                    <li>
                      📞 <strong>Abogado especializado</strong> - DENTRO DE 24 HORAS
                    </li>
                    <li>
                      📄 <strong>Conserve TODO</strong> - Cartas, formularios, documentos
                    </li>
                    <li>
                      🏥 <strong>Continue tratamiento</strong> - Use seguro personal si necesario
                    </li>
                    <li>
                      📝 <strong>No hable con aseguradora</strong> - Sin representación legal
                    </li>
                    <li>
                      ⏰ <strong>Plazos estrictos</strong> - 30 días para apelar
                    </li>
                    <li>
                      🚫 <strong>NUNCA acepte</strong> - Primera oferta de acuerdo
                    </li>
                  </ul>
                </div>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">
                La Crisis de Denegaciones en Carolina del Norte
              </h2>
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-8 border border-primary/20">
                <h3 className="text-2xl font-bold text-primary mb-4">
                  ¿Por Qué las Aseguradoras Niegan Tanto?
                </h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">
                Excusas Comunes de Denegación y Cómo las Vencemos
              </h2>
              <div className="space-y-6">
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-red-500/30">
                  <h3 className="text-xl font-bold text-red-400 mb-4">
                    🔴 &ldquo;No Está Relacionado con el Trabajo&rdquo; (67% de denegaciones)
                  </h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-orange-500/30">
                  <h3 className="text-xl font-bold text-orange-400 mb-4">
                    🟠 &ldquo;Tratamiento No Necesario&rdquo; (23% de denegaciones)
                  </h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-semibold text-gray-200 mb-3">
                        Tratamientos Comúnmente Negados:
                      </h4>
                      <ul className="space-y-1 text-gray-300 text-sm">
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-yellow-500/30">
                  <h3 className="text-xl font-bold text-yellow-400 mb-4">
                    🟡 &ldquo;Capaz de Trabajar&rdquo; (18% de denegaciones)
                  </h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">
                Proceso de Apelación Agresivo
              </h2>
              <div className="space-y-6">
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  <h3 className="text-xl font-bold text-primary mb-4">
                    Fase 1: Acción Inmediata (0-30 días)
                  </h3>
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  <h3 className="text-xl font-bold text-primary mb-4">
                    Fase 2: Construcción del Caso (1-6 meses)
                  </h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  <h3 className="text-xl font-bold text-primary mb-4">
                    Fase 3: Audiencia y Resolución (6-18 meses)
                  </h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-semibold text-gray-200 mb-3">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">
                Resultados Recientes en Apelaciones
              </h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                    <h3 className="text-lg font-bold text-primary mb-3">
                      Casos de Alto Valor Revertidos
                    </h3>
                    <ul className="space-y-2 text-gray-300 text-sm">
                      <li>
                        • <strong>$450K:</strong> Cirugía de espalda denegada - Revertida
                      </li>
                      <li>
                        • <strong>$380K:</strong> Tratamiento de cáncer ocupacional
                      </li>
                      <li>
                        • <strong>$290K:</strong> Beneficios por discapacidad permanente
                      </li>
                      <li>
                        • <strong>$180K:</strong> Medicamentos de dolor crónico
                      </li>
                      <li>
                        • <strong>$165K:</strong> Terapia física extendida
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                    ...
                    <ul className="space-y-2 text-gray-300 text-sm">
                      <li>
                        • <strong>Casos médicos simples:</strong> 2-4 meses
                      </li>
                      <li>
                        • <strong>Disputas de causalidad:</strong> 4-8 meses
                      </li>
                      <li>
                        • <strong>Casos complejos:</strong> 8-18 meses
                      </li>
                      <li>
                        • <strong>Apelaciones múltiples:</strong> 12-24 meses
                      </li>
                      <li>
                        • <strong>Pagos de emergencia:</strong> 1-4 semanas
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                    ...
                    <ul className="space-y-2 text-gray-300 text-sm">
                      <li>
                        • <strong>Experiencia especializada:</strong> 60+ años combinados
                      </li>
                      <li>
                        • <strong>Red médica experta:</strong> Mejores especialistas
                      </li>
                      <li>
                        • <strong>Recursos ilimitados:</strong> Sin escatimar en evidencia
                      </li>
                      <li>
                        • <strong>Reputación temida:</strong> Aseguradoras nos conocen
                      </li>
                      <li>
                        • <strong>Compromiso total:</strong> Nunca nos rendimos
                      </li>
                    </ul>
                  </div>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">
                Por Qué Somos Temidos por las Aseguradoras
              </h2>
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-8 border border-primary/20">
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="text-center">
                    ...
                    <p className="text-gray-300 text-sm">
                      Revertimos 9 de cada 10 denegaciones que tomamos
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="text-4xl font-black text-primary mb-4">$23M</div>
                    <h3 className="text-lg font-bold text-gray-200 mb-2">
                      Recuperado en Apelaciones
                    </h3>
                    <p className="text-gray-300 text-sm">
                      Solo en los últimos 3 años para clientes
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="text-4xl font-black text-primary mb-4">24/7</div>
                    <h3 className="text-lg font-bold text-gray-200 mb-2">
                      Disponibilidad de Emergencia
                    </h3>
                    <p className="text-gray-300 text-sm">
                      Cuando le niegan, necesita acción inmediata
                    </p>
                  </div>
                </div>
              </div>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              'Representación legal especializada para apelaciones de compensación laboral denegada en Carolina del Norte. 89% de éxito en revertir denegaciones injustas.',
            provider: {
              '@type': 'Attorney',
