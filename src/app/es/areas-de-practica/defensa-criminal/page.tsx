...
export const metadata: Metadata = {
  title: 'Defensa Criminal - Bufete de Abogados Vasquez',
  description:
    'Servicios legales de defensa criminal. Abogados experimentados listos para ayudarte. Consulta gratuita disponible.',
};
    ...
    <div className="min-h-screen bg-white">
      <section className="relative bg-gradient-to-br from-[#6B1F2E] to-[#8B2635] text-white py-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Defensa Criminal</h1>
          <p className="text-xl max-w-3xl">
            Abogados experimentados en defensa criminal listos para luchar por tus derechos.
          </p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <p>
              Nuestro equipo de abogados especializados en defensa criminal está comprometido a
      ...
      <section className="py-16 bg-[#C9974D]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            ¿Necesitas Ayuda con Defensa Criminal?
          </h2>
