...
export const metadata: Metadata = {
  title: 'Abogados de Defensa por Violencia Doméstica NC | Protección Legal 24/7 | YO PELEO POR TI™',
  description:
  ...
  alternates: {
    canonical: 'https://www.vasquezlawnc.com/es/areas-de-practica/defensa-criminal/violencia-domestica',
    languages: {
      'en-US': 'https://www.vasquezlawnc.com/practice-areas/criminal-defense/domestic-violence',
      'es-ES': 'https://www.vasquezlawnc.com/es/areas-de-practica/defensa-criminal/violencia-domestica',
    },
  },
};
...
const faqs = [
  {
    ...
    answer: 'Los cargos de violencia doméstica pueden impactar severamente la custodia. Trabajamos para proteger tanto su caso criminal como sus derechos parentales.',
  },
];
