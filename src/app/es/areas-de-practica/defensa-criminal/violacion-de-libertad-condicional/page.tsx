        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
            ...
            },
            {
              ...
              availableLanguage: ['English', 'Spanish'],
              url: 'https://vasquezlawnc.com/es/areas-de-practica/defensa-criminal/violacion-de-libertad-condicional',
            },
            {
              '@context': 'https://schema.org',
              '@type': 'BreadcrumbList',
              itemListElement: [
                ...
                },
                {
                  ...
                  item: 'https://vasquezlawnc.com/es/areas-de-practica/defensa-criminal',
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: 'Violacion de libertad condicional',
                  item: 'https://vasquezlawnc.com/es/areas-de-practica/defensa-criminal/violacion-de-libertad-condicional',
                },
              ],
            },
            {
