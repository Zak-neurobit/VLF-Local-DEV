      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Mapa e indicaciones – Charlotte</h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/es/contacto/ubicacion-oficina-charlotte-nc/',
                  url: 'https://www.vasquezlawnc.com/es/contacto/ubicacion-oficina-charlotte-nc/',
                  name: 'Ubicacion Oficina Charlotte, NC - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-09-13T15:15:44+00:00',
                  dateModified: '2024-09-13T15:17:41+00:00',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/contacto/ubicacion-oficina-charlotte-nc/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: [
                        'https://www.vasquezlawnc.com/es/contacto/ubicacion-oficina-charlotte-nc/',
                      ],
                    },
                  ],
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 4, name: 'Ubicacion Oficina Charlotte, NC' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 4,
                  name: 'Ubicacion oficina charlotte nc',
                  item: 'https://vasquezlawnc.com/es/contacto/ubicacion-oficina-charlotte-nc',
                },
              ],
            },
            {
