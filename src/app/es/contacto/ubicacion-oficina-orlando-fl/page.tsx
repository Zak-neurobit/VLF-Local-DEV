      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Mapa e indicaciones – Orlando</h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/es/contacto/ubicacion-oficina-orlando-fl/',
                  url: 'https://www.vasquezlawnc.com/es/contacto/ubicacion-oficina-orlando-fl/',
                  name: 'Ubicacion Oficina Orlando, FL - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-09-13T15:19:41+00:00',
                  dateModified: '2024-09-13T15:21:15+00:00',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/contacto/ubicacion-oficina-orlando-fl/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: [
                        'https://www.vasquezlawnc.com/es/contacto/ubicacion-oficina-orlando-fl/',
                      ],
                    },
                  ],
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 4, name: 'Ubicacion Oficina Orlando, FL' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 4,
                  name: 'Ubicacion oficina orlando fl',
                  item: 'https://vasquezlawnc.com/es/contacto/ubicacion-oficina-orlando-fl',
                },
              ],
            },
            {
