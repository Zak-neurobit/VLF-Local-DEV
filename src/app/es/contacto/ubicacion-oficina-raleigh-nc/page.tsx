      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Mapa e indicaciones – Raleigh</h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/es/contacto/ubicacion-oficina-raleigh-nc/',
                  url: 'https://www.vasquezlawnc.com/es/contacto/ubicacion-oficina-raleigh-nc/',
                  name: 'Ubicacion Oficina Raleigh, NC - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-09-13T15:13:12+00:00',
                  dateModified: '2025-02-20T11:13:28+00:00',
                  description:
                    'Encuentre la mejor ruta a nuestra oficina en Raleigh, NC. Obtenga mapas e indicaciones precisas para visitarnos. ¡Contáctenos para más información!',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/es/contacto/ubicacion-oficina-raleigh-nc/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: [
                        'https://www.vasquezlawnc.com/es/contacto/ubicacion-oficina-raleigh-nc/',
                      ],
                    },
                  ],
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 4, name: 'Ubicacion Oficina Raleigh, NC' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 4,
                  name: 'Ubicacion oficina raleigh nc',
                  item: 'https://vasquezlawnc.com/es/contacto/ubicacion-oficina-raleigh-nc',
                },
              ],
            },
            {
