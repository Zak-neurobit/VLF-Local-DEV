...
export default function UbicacionOficinaSmithfieldPage() {
  // TODO: Extract content from original file and format properly
  const post = {
    id: 'ubicacion-oficina-smithfield',
    title: 'Mapa e indicaciones – Smithfield',
    slug: 'ubicacion-oficina-smithfield',
