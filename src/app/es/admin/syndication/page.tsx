...
export default function SyndicationManagementPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      console.error('Failed to fetch syndication data:', error);
    } finally {
      setIsLoading(false);
    }
  };
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                >
                  ...
                  <SelectOption value="blog-1">Latest Inmigración Guide</SelectOption>
                  <SelectOption value="blog-2">Defensa Criminal Tips</SelectOption>
                  <SelectOption value="news-1">Legal Update: New Inmigración Policy</SelectOption>
                </Select>
              </div>
