      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-gray-100 p-6 rounded-lg mb-8">
          ...
          <ul className="space-y-2">
            <li><strong>Ruta Actual:</strong> {pathname}</li>
            <li><strong>Idioma Detectado:</strong> {currentLang}</li>
          </ul>
        </div>
        ...
        <div className="mt-8 p-6 bg-blue-50 rounded-lg">
          ...
          <ul className="space-y-2">
            <li><a href="/" className="text-blue-600 hover:underline">Página Principal en Inglés</a></li>
            <li><a href="/es" className="text-blue-600 hover:underline">Página Principal en Español</a></li>
            <li><a href="/blog" className="text-blue-600 hover:underline">Blog en Inglés</a></li>
            <li><a href="/es/blog" className="text-blue-600 hover:underline">Blog en Español</a></li>
            <li><a href="/contact" className="text-blue-600 hover:underline">Contacto en Inglés</a></li>
            <li><a href="/es/contacto" className="text-blue-600 hover:underline">Contacto en Español</a></li>
          </ul>
        </div>
      </div>
    </div>
