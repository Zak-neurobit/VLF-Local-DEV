...
export const metadata = {
  ...
  description:
    'Servicios legales de ley de inmigración en Davidson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'ley de inmigración Davidson, abogado Davidson, ley de inmigración NC, abogado español Davidson, servicios legales Davidson',
  openGraph: {
    title: 'Ley de Inmigración en Davidson, NC | Vasquez Law Firm',
    description:
      'Servicios legales de ley de inmigración en Davidson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
