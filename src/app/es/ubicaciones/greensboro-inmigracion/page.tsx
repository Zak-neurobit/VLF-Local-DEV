...
export const metadata = {
  ...
  description:
    'Servicios legales de ley de inmigración en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'ley de inmigración Greensboro, abogado Greensboro, ley de inmigración NC, abogado español Greensboro, servicios legales Greensboro',
  openGraph: {
    title: 'Ley de Inmigración en Greensboro, NC | Vasquez Law Firm',
    description:
      'Servicios legales de ley de inmigración en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
