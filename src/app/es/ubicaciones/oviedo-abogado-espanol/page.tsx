...
export const metadata = {
  ...
  description:
    'Servicios legales de abogado que habla español en Oviedo, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    'abogado que habla español Oviedo, abogado Oviedo, abogado que habla español FL, abogado español Oviedo, servicios legales Oviedo',
  openGraph: {
    title: 'Abogado que Habla Español en Oviedo, FL | Vasquez Law Firm',
    description:
      'Servicios legales de abogado que habla español en Oviedo, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
