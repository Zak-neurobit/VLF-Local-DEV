...
export const metadata = {
  ...
  description: 'Servicios legales de bancarrota en Durham, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'bancarrota Durham, abogado Durham, bancarrota NC, abogado español Durham, servicios legales Durham',
  openGraph: {
    title: 'Bancarrota en Durham, NC | Vasquez Law Firm',
    description: 'Servicios legales de bancarrota en Durham, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
