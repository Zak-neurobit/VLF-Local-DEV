...
export const metadata = {
  title: 'Abogado que Habla Español en Matthews, NC | Vasquez Law Firm',
  description: 'Servicios legales de abogado que habla español en Matthews, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'abogado que habla español Matthews, abogado Matthews, abogado que habla español NC, abogado español Matthews, servicios legales Matthews',
  openGraph: {
    title: 'Abogado que Habla Español en Matthews, NC | Vasquez Law Firm',
    description: 'Servicios legales de abogado que habla español en Matthews, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Abogado que Habla Español en Matthews, NC'
    }]
  },
  alternates: {
