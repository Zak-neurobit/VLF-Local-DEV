...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa criminal en Hickory, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'defensa criminal Hickory, abogado Hickory, defensa criminal NC, abogado español Hickory, servicios legales Hickory',
  openGraph: {
    title: 'Defensa Criminal en Hickory, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa criminal en Hickory, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
