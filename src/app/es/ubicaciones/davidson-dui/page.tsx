...
export const metadata = {
  ...
  description: 'Servicios legales de defensa dui en Davidson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'defensa dui Davidson, abogado Davidson, defensa dui NC, abogado español Davidson, servicios legales Davidson',
  openGraph: {
    title: 'Defensa DUI en Davidson, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa dui en Davidson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
