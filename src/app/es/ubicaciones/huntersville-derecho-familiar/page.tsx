...
export const metadata = {
  ...
  description:
    'Servicios legales de derecho familiar en Huntersville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'derecho familiar Huntersville, abogado Huntersville, derecho familiar NC, abogado español Huntersville, servicios legales Huntersville',
  openGraph: {
    title: 'Derecho Familiar en Huntersville, NC | Vasquez Law Firm',
    description:
      'Servicios legales de derecho familiar en Huntersville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
