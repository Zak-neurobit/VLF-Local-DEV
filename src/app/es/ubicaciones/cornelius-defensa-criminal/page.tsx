...
export const metadata = {
  title: 'Defensa Criminal en Cornelius, NC | Vasquez Law Firm',
  description: 'Servicios legales de defensa criminal en Cornelius, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'defensa criminal Cornelius, abogado Cornelius, defensa criminal NC, abogado español Cornelius, servicios legales Cornelius',
  openGraph: {
    title: 'Defensa Criminal en Cornelius, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa criminal en Cornelius, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Defensa Criminal en Cornelius, NC'
    }]
  },
  alternates: {
