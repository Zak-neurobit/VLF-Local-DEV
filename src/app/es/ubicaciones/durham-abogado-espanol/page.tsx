...
export const metadata = {
  ...
  description:
    'Servicios legales de abogado que habla español en Durham, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'abogado que habla español Durham, abogado Durham, abogado que habla español NC, abogado español Durham, servicios legales Durham',
  openGraph: {
    title: 'Abogado que Habla Español en Durham, NC | Vasquez Law Firm',
    description:
      'Servicios legales de abogado que habla español en Durham, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
