...
export const metadata = {
  title: 'Ley de Inmigración en Wilmington, NC | Vasquez Law Firm',
  description: 'Servicios legales de ley de inmigración en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'ley de inmigración Wilmington, abogado Wilmington, ley de inmigración NC, abogado español Wilmington, servicios legales Wilmington',
  openGraph: {
    title: 'Ley de Inmigración en Wilmington, NC | Vasquez Law Firm',
    description: 'Servicios legales de ley de inmigración en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Ley de Inmigración en Wilmington, NC'
    }]
  },
  alternates: {
