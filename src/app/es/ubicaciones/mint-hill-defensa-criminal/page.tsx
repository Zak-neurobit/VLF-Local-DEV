...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa criminal en Mint Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'defensa criminal Mint Hill, abogado Mint Hill, defensa criminal NC, abogado español Mint Hill, servicios legales Mint Hill',
  openGraph: {
    title: 'Defensa Criminal en Mint Hill, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa criminal en Mint Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
