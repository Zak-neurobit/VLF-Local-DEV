...
export const metadata = {
  ...
  description:
    'Servicios legales de bancarrota en Concord, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'bancarrota Concord, abogado Concord, bancarrota NC, abogado español Concord, servicios legales Concord',
  openGraph: {
    title: 'Bancarrota en Concord, NC | Vasquez Law Firm',
    description:
      'Servicios legales de bancarrota en Concord, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
