...
export const metadata = {
  ...
  description:
    'Servicios legales de compensación laboral en Wilson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'compensación laboral Wilson, abogado Wilson, compensación laboral NC, abogado español Wilson, servicios legales Wilson',
  openGraph: {
    title: 'Compensación Laboral en Wilson, NC | Vasquez Law Firm',
    description:
      'Servicios legales de compensación laboral en Wilson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
