...
export const metadata = {
  title: 'Ley de Inmigración en Charlotte, NC | Vasquez Law Firm',
  description: 'Servicios legales de ley de inmigración en Charlotte, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'ley de inmigración Charlotte, abogado Charlotte, ley de inmigración NC, abogado español Charlotte, servicios legales Charlotte',
  openGraph: {
    title: 'Ley de Inmigración en Charlotte, NC | Vasquez Law Firm',
    description: 'Servicios legales de ley de inmigración en Charlotte, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Ley de Inmigración en Charlotte, NC'
    }]
  },
  alternates: {
