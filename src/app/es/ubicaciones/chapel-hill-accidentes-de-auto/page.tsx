...
export const metadata = {
  ...
  description:
    'Servicios legales de accidentes de auto en Chapel Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'accidentes de auto Chapel Hill, abogado Chapel Hill, accidentes de auto NC, abogado español Chapel Hill, servicios legales Chapel Hill',
  openGraph: {
    title: 'Accidentes de Auto en Chapel Hill, NC | Vasquez Law Firm',
    description:
      'Servicios legales de accidentes de auto en Chapel Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
