...
export const metadata = {
  ...
  description:
    'Servicios legales de accidentes de auto en Winston-Salem, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'accidentes de auto Winston-Salem, abogado Winston-Salem, accidentes de auto NC, abogado español Winston-Salem, servicios legales Winston-Salem',
  openGraph: {
    title: 'Accidentes de Auto en Winston-Salem, NC | Vasquez Law Firm',
    description:
      'Servicios legales de accidentes de auto en Winston-Salem, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
