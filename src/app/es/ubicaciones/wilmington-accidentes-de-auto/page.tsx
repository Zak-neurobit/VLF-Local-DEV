...
export const metadata = {
  ...
  description:
    'Servicios legales de accidentes de auto en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'accidentes de auto Wilmington, abogado Wilmington, accidentes de auto NC, abogado español Wilmington, servicios legales Wilmington',
  openGraph: {
    title: 'Accidentes de Auto en Wilmington, NC | Vasquez Law Firm',
    description:
      'Servicios legales de accidentes de auto en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
