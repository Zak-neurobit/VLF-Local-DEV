...
export const metadata = {
  ...
  description:
    'Servicios legales de accidentes de auto en Matthews, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'accidentes de auto Matthews, abogado Matthews, accidentes de auto NC, abogado español Matthews, servicios legales Matthews',
  openGraph: {
    title: 'Accidentes de Auto en Matthews, NC | Vasquez Law Firm',
    description:
      'Servicios legales de accidentes de auto en Matthews, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
