...
export const metadata = {
  ...
  description:
    'Servicios legales de accidentes de auto en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'accidentes de auto Greensboro, abogado Greensboro, accidentes de auto NC, abogado español Greensboro, servicios legales Greensboro',
  openGraph: {
    title: 'Accidentes de Auto en Greensboro, NC | Vasquez Law Firm',
    description:
      'Servicios legales de accidentes de auto en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
