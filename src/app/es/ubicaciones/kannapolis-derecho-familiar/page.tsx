...
export const metadata = {
  ...
  description:
    'Servicios legales de derecho familiar en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'derecho familiar Kannapolis, abogado Kannapolis, derecho familiar NC, abogado español Kannapolis, servicios legales Kannapolis',
  openGraph: {
    title: 'Derecho Familiar en Kannapolis, NC | Vasquez Law Firm',
    description:
      'Servicios legales de derecho familiar en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
