...
export const metadata = {
  ...
  description:
    'Servicios legales de compensación laboral en Gastonia, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'compensación laboral Gastonia, abogado Gastonia, compensación laboral NC, abogado español Gastonia, servicios legales Gastonia',
  openGraph: {
    title: 'Compensación Laboral en Gastonia, NC | Vasquez Law Firm',
    description:
      'Servicios legales de compensación laboral en Gastonia, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
