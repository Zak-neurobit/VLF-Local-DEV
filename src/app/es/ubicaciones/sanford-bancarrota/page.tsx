...
export const metadata = {
  ...
  description:
    'Servicios legales de bancarrota en Sanford, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    'bancarrota Sanford, abogado Sanford, bancarrota FL, abogado español Sanford, servicios legales Sanford',
  openGraph: {
    title: 'Bancarrota en Sanford, FL | Vasquez Law Firm',
    description:
      'Servicios legales de bancarrota en Sanford, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
