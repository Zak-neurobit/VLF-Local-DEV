...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa criminal en Indian Trail, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'defensa criminal Indian Trail, abogado Indian Trail, defensa criminal NC, abogado español Indian Trail, servicios legales Indian Trail',
  openGraph: {
    title: 'Defensa Criminal en Indian Trail, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa criminal en Indian Trail, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
