...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa criminal en Huntersville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'defensa criminal Huntersville, abogado Huntersville, defensa criminal NC, abogado español Huntersville, servicios legales Huntersville',
  openGraph: {
    title: 'Defensa Criminal en Huntersville, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa criminal en Huntersville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
