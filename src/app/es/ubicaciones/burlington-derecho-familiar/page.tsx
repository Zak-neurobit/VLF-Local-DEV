...
export const metadata = {
  ...
  description:
    'Servicios legales de derecho familiar en Burlington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'derecho familiar Burlington, abogado Burlington, derecho familiar NC, abogado español Burlington, servicios legales Burlington',
  openGraph: {
    title: 'Derecho Familiar en Burlington, NC | Vasquez Law Firm',
    description:
      'Servicios legales de derecho familiar en Burlington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
