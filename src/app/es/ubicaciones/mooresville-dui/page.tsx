...
export const metadata = {
  ...
  description: 'Servicios legales de defensa dui en Mooresville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'defensa dui Mooresville, abogado Mooresville, defensa dui NC, abogado español Mooresville, servicios legales Mooresville',
  openGraph: {
    title: 'Defensa DUI en Mooresville, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa dui en Mooresville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
