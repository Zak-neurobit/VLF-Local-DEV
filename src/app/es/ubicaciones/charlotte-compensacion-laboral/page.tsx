...
export const metadata = {
  ...
  description:
    'Servicios legales de compensación laboral en Charlotte, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'compensación laboral Charlotte, abogado Charlotte, compensación laboral NC, abogado español Charlotte, servicios legales Charlotte',
  openGraph: {
    title: 'Compensación Laboral en Charlotte, NC | Vasquez Law Firm',
    description:
      'Servicios legales de compensación laboral en Charlotte, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
