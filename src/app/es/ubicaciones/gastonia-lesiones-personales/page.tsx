...
export const metadata = {
  ...
  description:
    'Servicios legales de lesiones personales en Gastonia, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'lesiones personales Gastonia, abogado Gastonia, lesiones personales NC, abogado español Gastonia, servicios legales Gastonia',
  openGraph: {
    title: 'Lesiones Personales en Gastonia, NC | Vasquez Law Firm',
    description:
      'Servicios legales de lesiones personales en Gastonia, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
