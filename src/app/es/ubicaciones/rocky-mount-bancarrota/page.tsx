...
export const metadata = {
  ...
  description:
    'Servicios legales de bancarrota en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'bancarrota Rocky Mount, abogado Rocky Mount, bancarrota NC, abogado español Rocky Mount, servicios legales Rocky Mount',
  openGraph: {
    title: 'Bancarrota en Rocky Mount, NC | Vasquez Law Firm',
    description:
      'Servicios legales de bancarrota en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
