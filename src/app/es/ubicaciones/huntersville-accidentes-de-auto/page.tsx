...
export const metadata = {
  ...
  description: 'Servicios legales de accidentes de auto en Huntersville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'accidentes de auto Huntersville, abogado Huntersville, accidentes de auto NC, abogado español Huntersville, servicios legales Huntersville',
  openGraph: {
    title: 'Accidentes de Auto en Huntersville, NC | Vasquez Law Firm',
    description: 'Servicios legales de accidentes de auto en Huntersville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
