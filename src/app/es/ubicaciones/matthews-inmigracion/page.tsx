...
export const metadata = {
  ...
  description:
    'Servicios legales de ley de inmigración en Matthews, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'ley de inmigración Matthews, abogado Matthews, ley de inmigración NC, abogado español Matthews, servicios legales Matthews',
  openGraph: {
    title: 'Ley de Inmigración en Matthews, NC | Vasquez Law Firm',
    description:
      'Servicios legales de ley de inmigración en Matthews, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
