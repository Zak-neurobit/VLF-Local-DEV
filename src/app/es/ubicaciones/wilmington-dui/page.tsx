...
export const metadata = {
  ...
  description: 'Servicios legales de defensa dui en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'defensa dui Wilmington, abogado Wilmington, defensa dui NC, abogado español Wilmington, servicios legales Wilmington',
  openGraph: {
    title: 'Defensa DUI en Wilmington, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa dui en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
