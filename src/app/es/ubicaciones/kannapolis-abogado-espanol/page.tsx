...
export const metadata = {
  ...
  description:
    'Servicios legales de abogado que habla español en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'abogado que habla español Kannapolis, abogado Kannapolis, abogado que habla español NC, abogado español Kannapolis, servicios legales Kannapolis',
  openGraph: {
    title: 'Abogado que Habla Español en Kannapolis, NC | Vasquez Law Firm',
    description:
      'Servicios legales de abogado que habla español en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
