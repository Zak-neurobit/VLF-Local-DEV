...
export const metadata = {
  ...
  description:
    'Servicios legales de bancarrota en Matthews, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'bancarrota Matthews, abogado Matthews, bancarrota NC, abogado español Matthews, servicios legales Matthews',
  openGraph: {
    title: 'Bancarrota en Matthews, NC | Vasquez Law Firm',
    description:
      'Servicios legales de bancarrota en Matthews, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
