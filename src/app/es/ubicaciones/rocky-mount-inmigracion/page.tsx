...
export const metadata = {
  title: 'Ley de Inmigración en Rocky Mount, NC | Vasquez Law Firm',
  description: 'Servicios legales de ley de inmigración en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'ley de inmigración Rocky Mount, abogado Rocky Mount, ley de inmigración NC, abogado español Rocky Mount, servicios legales Rocky Mount',
  openGraph: {
    title: 'Ley de Inmigración en Rocky Mount, NC | Vasquez Law Firm',
    description: 'Servicios legales de ley de inmigración en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Ley de Inmigración en Rocky Mount, NC'
    }]
  },
  alternates: {
