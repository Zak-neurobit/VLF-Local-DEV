...
export const metadata = {
  title: 'Compensación Laboral en Sanford, FL | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Sanford, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'compensación laboral Sanford, abogado Sanford, compensación laboral FL, abogado español Sanford, servicios legales Sanford',
  openGraph: {
    title: 'Compensación Laboral en Sanford, FL | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Sanford, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Sanford, FL'
    }]
  },
  alternates: {
