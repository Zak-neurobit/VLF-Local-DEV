...
export const metadata = {
  ...
  description:
    'Servicios legales de lesiones personales en Charlotte, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'lesiones personales Charlotte, abogado Charlotte, lesiones personales NC, abogado español Charlotte, servicios legales Charlotte',
  openGraph: {
    title: 'Lesiones Personales en Charlotte, NC | Vasquez Law Firm',
    description:
      'Servicios legales de lesiones personales en Charlotte, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
