...
export const metadata = {
  ...
  description:
    'Servicios legales de bancarrota en Cornelius, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'bancarrota Cornelius, abogado Cornelius, bancarrota NC, abogado español Cornelius, servicios legales Cornelius',
  openGraph: {
    title: 'Bancarrota en Cornelius, NC | Vasquez Law Firm',
    description:
      'Servicios legales de bancarrota en Cornelius, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
