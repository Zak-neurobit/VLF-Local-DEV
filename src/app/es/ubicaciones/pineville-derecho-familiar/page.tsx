...
export const metadata = {
  ...
  description:
    'Servicios legales de derecho familiar en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'derecho familiar Pineville, abogado Pineville, derecho familiar NC, abogado español Pineville, servicios legales Pineville',
  openGraph: {
    title: 'Derecho Familiar en Pineville, NC | Vasquez Law Firm',
    description:
      'Servicios legales de derecho familiar en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
