...
export const metadata = {
  ...
  description:
    'Servicios legales de abogado que habla español en Charlotte, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'abogado que habla español Charlotte, abogado Charlotte, abogado que habla español NC, abogado español Charlotte, servicios legales Charlotte',
  openGraph: {
    title: 'Abogado que Habla Español en Charlotte, NC | Vasquez Law Firm',
    description:
      'Servicios legales de abogado que habla español en Charlotte, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
