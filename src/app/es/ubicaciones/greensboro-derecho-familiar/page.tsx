...
export const metadata = {
  ...
  description:
    'Servicios legales de derecho familiar en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'derecho familiar Greensboro, abogado Greensboro, derecho familiar NC, abogado español Greensboro, servicios legales Greensboro',
  openGraph: {
    title: 'Derecho Familiar en Greensboro, NC | Vasquez Law Firm',
    description:
      'Servicios legales de derecho familiar en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
