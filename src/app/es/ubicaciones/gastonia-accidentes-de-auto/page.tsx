...
export const metadata = {
  ...
  description:
    'Servicios legales de accidentes de auto en Gastonia, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'accidentes de auto Gastonia, abogado Gastonia, accidentes de auto NC, abogado español Gastonia, servicios legales Gastonia',
  openGraph: {
    title: 'Accidentes de Auto en Gastonia, NC | Vasquez Law Firm',
    description:
      'Servicios legales de accidentes de auto en Gastonia, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
