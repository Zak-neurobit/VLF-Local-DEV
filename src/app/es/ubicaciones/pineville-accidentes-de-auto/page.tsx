...
export const metadata = {
  ...
  description: 'Servicios legales de accidentes de auto en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'accidentes de auto Pineville, abogado Pineville, accidentes de auto NC, abogado español Pineville, servicios legales Pineville',
  openGraph: {
    title: 'Accidentes de Auto en Pineville, NC | Vasquez Law Firm',
    description: 'Servicios legales de accidentes de auto en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
