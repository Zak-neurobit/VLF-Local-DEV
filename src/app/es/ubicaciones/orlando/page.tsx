...
export const metadata: Metadata = {
  ...
  description: 'Bufete de abogados en Orlando, FL especializado en inmigración, lesiones personales, defensa criminal y derecho familiar. Consulta gratuita en español.',
  keywords: 'abogado Orlando, bufete abogados Orlando FL, inmigración Orlando, lesiones personales Orlando, defensa criminal Orlando',
  openGraph: {
    title: 'Abogado en Orlando, FL | Bufete de Abogados Vasquez',
    description: 'Servicios legales profesionales en el corazón de Florida. Hablamos español. Consulta gratuita.',
...
const orlandoOfficeSchema = generateLocalBusinessSchema({
  ...
  phone: '(407) 555-0123',
  description: 'Bufete de abogados en Orlando, FL especializado en inmigración, lesiones personales, defensa criminal y derecho familiar.',
  languages: ['es', 'en'],
  servicesOffered: [
    'Inmigración',
    'Lesiones Personales',
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Abogado en Orlando, FL
              </h1>
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
                Servicios legales profesionales en el corazón de Florida central. 
                Defendemos sus derechos con pasión y experiencia.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <div className="space-y-4">
                  <p className="text-gray-600">
                    Orlando ofrece acceso estratégico a:
                  </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Servimos a la diversa comunidad hispana de Florida central con servicios legales especializados.
              </p>
            </div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="bg-white p-6 rounded-lg shadow">
                    <p className="text-gray-600 mb-4">
                      "Como puertorriqueño, necesitaba ayuda con documentos de ciudadanía para mi esposa. 
                      Su experiencia con casos del Caribe fue invaluable."
                    </p>
                  ...
                  <div className="bg-white p-6 rounded-lg shadow">
                    <p className="text-gray-600 mb-4">
                      "Después de mi accidente en I-4, lograron una compensación excelente. 
                      Conocen bien los hospitales y médicos de Orlando."
                    </p>
