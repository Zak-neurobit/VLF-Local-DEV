...
export const metadata = {
  ...
  description:
    'Servicios legales de abogado que habla español en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'abogado que habla español Pineville, abogado Pineville, abogado que habla español NC, abogado español Pineville, servicios legales Pineville',
  openGraph: {
    title: 'Abogado que Habla Español en Pineville, NC | Vasquez Law Firm',
    description:
      'Servicios legales de abogado que habla español en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
