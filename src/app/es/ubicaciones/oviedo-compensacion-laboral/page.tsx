...
export const metadata = {
  title: 'Compensación Laboral en Oviedo, FL | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Oviedo, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'compensación laboral Oviedo, abogado Oviedo, compensación laboral FL, abogado español Oviedo, servicios legales Oviedo',
  openGraph: {
    title: 'Compensación Laboral en Oviedo, FL | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Oviedo, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Oviedo, FL'
    }]
  },
  alternates: {
