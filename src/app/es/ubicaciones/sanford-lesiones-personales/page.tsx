...
export const metadata = {
  ...
  description:
    'Servicios legales de lesiones personales en Sanford, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    'lesiones personales Sanford, abogado Sanford, lesiones personales FL, abogado español Sanford, servicios legales Sanford',
  openGraph: {
    title: 'Lesiones Personales en Sanford, FL | Vasquez Law Firm',
    description:
      'Servicios legales de lesiones personales en Sanford, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
