...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa dui en Charlotte, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'defensa dui Charlotte, abogado Charlotte, defensa dui NC, abogado español Charlotte, servicios legales Charlotte',
  openGraph: {
    title: 'Defensa DUI en Charlotte, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa dui en Charlotte, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
