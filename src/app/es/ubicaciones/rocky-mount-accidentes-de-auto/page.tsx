...
export const metadata = {
  ...
  description: 'Servicios legales de accidentes de auto en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'accidentes de auto Rocky Mount, abogado Rocky Mount, accidentes de auto NC, abogado español Rocky Mount, servicios legales Rocky Mount',
  openGraph: {
    title: 'Accidentes de Auto en Rocky Mount, NC | Vasquez Law Firm',
    description: 'Servicios legales de accidentes de auto en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
