...
export const metadata = {
  ...
  description:
    'Servicios legales de bancarrota en Fayetteville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'bancarrota Fayetteville, abogado Fayetteville, bancarrota NC, abogado español Fayetteville, servicios legales Fayetteville',
  openGraph: {
    title: 'Bancarrota en Fayetteville, NC | Vasquez Law Firm',
    description:
      'Servicios legales de bancarrota en Fayetteville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
