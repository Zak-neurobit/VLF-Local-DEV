...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa dui en Chapel Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'defensa dui Chapel Hill, abogado Chapel Hill, defensa dui NC, abogado español Chapel Hill, servicios legales Chapel Hill',
  openGraph: {
    title: 'Defensa DUI en Chapel Hill, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa dui en Chapel Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
