...
export const metadata = {
  ...
  description: 'Servicios legales de accidentes de auto en Concord, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'accidentes de auto Concord, abogado Concord, accidentes de auto NC, abogado español Concord, servicios legales Concord',
  openGraph: {
    title: 'Accidentes de Auto en Concord, NC | Vasquez Law Firm',
    description: 'Servicios legales de accidentes de auto en Concord, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
