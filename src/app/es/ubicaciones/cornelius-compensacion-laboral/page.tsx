...
export const metadata = {
  ...
  description:
    'Servicios legales de compensación laboral en Cornelius, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'compensación laboral Cornelius, abogado Cornelius, compensación laboral NC, abogado español Cornelius, servicios legales Cornelius',
  openGraph: {
    title: 'Compensación Laboral en Cornelius, NC | Vasquez Law Firm',
    description:
      'Servicios legales de compensación laboral en Cornelius, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
