...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa dui en Cornelius, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'defensa dui Cornelius, abogado Cornelius, defensa dui NC, abogado español Cornelius, servicios legales Cornelius',
  openGraph: {
    title: 'Defensa DUI en Cornelius, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa dui en Cornelius, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
