...
export const metadata = {
  ...
  description:
    'Servicios legales de compensación laboral en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'compensación laboral Wilmington, abogado Wilmington, compensación laboral NC, abogado español Wilmington, servicios legales Wilmington',
  openGraph: {
    title: 'Compensación Laboral en Wilmington, NC | Vasquez Law Firm',
    description:
      'Servicios legales de compensación laboral en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
