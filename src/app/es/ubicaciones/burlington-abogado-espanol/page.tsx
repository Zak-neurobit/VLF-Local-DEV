...
export const metadata = {
  ...
  description:
    'Servicios legales de abogado que habla español en Burlington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'abogado que habla español Burlington, abogado Burlington, abogado que habla español NC, abogado español Burlington, servicios legales Burlington',
  openGraph: {
    title: 'Abogado que Habla Español en Burlington, NC | Vasquez Law Firm',
    description:
      'Servicios legales de abogado que habla español en Burlington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
