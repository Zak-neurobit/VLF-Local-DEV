...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa criminal en Orlando, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    'defensa criminal Orlando, abogado Orlando, defensa criminal FL, abogado español Orlando, servicios legales Orlando',
  openGraph: {
    title: 'Defensa Criminal en Orlando, FL | Vasquez Law Firm',
    description:
      'Servicios legales de defensa criminal en Orlando, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
