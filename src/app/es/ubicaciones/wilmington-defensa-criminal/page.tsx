...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa criminal en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'defensa criminal Wilmington, abogado Wilmington, defensa criminal NC, abogado español Wilmington, servicios legales Wilmington',
  openGraph: {
    title: 'Defensa Criminal en Wilmington, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa criminal en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
