...
export const metadata = {
  title: 'Defensa Criminal en Raleigh, NC | Vasquez Law Firm',
  description: 'Servicios legales de defensa criminal en Raleigh, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'defensa criminal Raleigh, abogado Raleigh, defensa criminal NC, abogado español Raleigh, servicios legales Raleigh',
  openGraph: {
    title: 'Defensa Criminal en Raleigh, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa criminal en Raleigh, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Defensa Criminal en Raleigh, NC'
    }]
  },
  alternates: {
