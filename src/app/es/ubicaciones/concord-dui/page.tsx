...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa dui en Concord, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'defensa dui Concord, abogado Concord, defensa dui NC, abogado español Concord, servicios legales Concord',
  openGraph: {
    title: 'Defensa DUI en Concord, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa dui en Concord, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
