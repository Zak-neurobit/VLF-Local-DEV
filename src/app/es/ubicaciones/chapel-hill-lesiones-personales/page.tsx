...
export const metadata = {
  title: 'Lesiones Personales en Chapel Hill, NC | Vasquez Law Firm',
  description: 'Servicios legales de lesiones personales en Chapel Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'lesiones personales Chapel Hill, abogado Chapel Hill, lesiones personales NC, abogado español Chapel Hill, servicios legales Chapel Hill',
  openGraph: {
    title: 'Lesiones Personales en Chapel Hill, NC | Vasquez Law Firm',
    description: 'Servicios legales de lesiones personales en Chapel Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Lesiones Personales en Chapel Hill, NC'
    }]
  },
  alternates: {
