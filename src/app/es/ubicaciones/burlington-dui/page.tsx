...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa dui en Burlington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'defensa dui Burlington, abogado Burlington, defensa dui NC, abogado español Burlington, servicios legales Burlington',
  openGraph: {
    title: 'Defensa DUI en Burlington, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa dui en Burlington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
