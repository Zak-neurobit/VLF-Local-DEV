...
export const metadata = {
  ...
  description:
    'Servicios legales de abogado que habla español en Davidson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'abogado que habla español Davidson, abogado Davidson, abogado que habla español NC, abogado español Davidson, servicios legales Davidson',
  openGraph: {
    title: 'Abogado que Habla Español en Davidson, NC | Vasquez Law Firm',
    description:
      'Servicios legales de abogado que habla español en Davidson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
