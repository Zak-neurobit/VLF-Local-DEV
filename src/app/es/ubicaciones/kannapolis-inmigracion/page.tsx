...
export const metadata = {
  ...
  description:
    'Servicios legales de ley de inmigración en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'ley de inmigración Kannapolis, abogado Kannapolis, ley de inmigración NC, abogado español Kannapolis, servicios legales Kannapolis',
  openGraph: {
    title: 'Ley de Inmigración en Kannapolis, NC | Vasquez Law Firm',
    description:
      'Servicios legales de ley de inmigración en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
