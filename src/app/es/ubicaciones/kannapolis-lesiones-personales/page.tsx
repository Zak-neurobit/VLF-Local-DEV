...
export const metadata = {
  ...
  description:
    'Servicios legales de lesiones personales en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'lesiones personales Kannapolis, abogado Kannapolis, lesiones personales NC, abogado español Kannapolis, servicios legales Kannapolis',
  openGraph: {
    title: 'Lesiones Personales en Kannapolis, NC | Vasquez Law Firm',
    description:
      'Servicios legales de lesiones personales en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
