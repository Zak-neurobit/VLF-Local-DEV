...
export const metadata = {
  ...
  description:
    'Servicios legales de compensación laboral en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'compensación laboral Kannapolis, abogado Kannapolis, compensación laboral NC, abogado español Kannapolis, servicios legales Kannapolis',
  openGraph: {
    title: 'Compensación Laboral en Kannapolis, NC | Vasquez Law Firm',
    description:
      'Servicios legales de compensación laboral en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
