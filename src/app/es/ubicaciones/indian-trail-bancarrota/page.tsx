...
export const metadata = {
  ...
  description:
    'Servicios legales de bancarrota en Indian Trail, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'bancarrota Indian Trail, abogado Indian Trail, bancarrota NC, abogado español Indian Trail, servicios legales Indian Trail',
  openGraph: {
    title: 'Bancarrota en Indian Trail, NC | Vasquez Law Firm',
    description:
      'Servicios legales de bancarrota en Indian Trail, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
