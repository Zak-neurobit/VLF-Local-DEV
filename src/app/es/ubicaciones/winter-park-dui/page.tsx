...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa dui en Winter Park, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    'defensa dui Winter Park, abogado Winter Park, defensa dui FL, abogado español Winter Park, servicios legales Winter Park',
  openGraph: {
    title: 'Defensa DUI en Winter Park, FL | Vasquez Law Firm',
    description:
      'Servicios legales de defensa dui en Winter Park, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
