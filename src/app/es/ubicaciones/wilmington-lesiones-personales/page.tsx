...
export const metadata = {
  ...
  description:
    'Servicios legales de lesiones personales en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'lesiones personales Wilmington, abogado Wilmington, lesiones personales NC, abogado español Wilmington, servicios legales Wilmington',
  openGraph: {
    title: 'Lesiones Personales en Wilmington, NC | Vasquez Law Firm',
    description:
      'Servicios legales de lesiones personales en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
