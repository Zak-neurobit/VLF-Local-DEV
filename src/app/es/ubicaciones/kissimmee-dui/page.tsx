...
export const metadata = {
  ...
  description: 'Servicios legales de defensa dui en Kissimmee, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'defensa dui Kissimmee, abogado Kissimmee, defensa dui FL, abogado español Kissimmee, servicios legales Kissimmee',
  openGraph: {
    title: 'Defensa DUI en Kissimmee, FL | Vasquez Law Firm',
    description: 'Servicios legales de defensa dui en Kissimmee, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
