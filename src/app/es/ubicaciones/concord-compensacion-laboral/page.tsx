...
export const metadata = {
  ...
  description:
    'Servicios legales de compensación laboral en Concord, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'compensación laboral Concord, abogado Concord, compensación laboral NC, abogado español Concord, servicios legales Concord',
  openGraph: {
    title: 'Compensación Laboral en Concord, NC | Vasquez Law Firm',
    description:
      'Servicios legales de compensación laboral en Concord, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
