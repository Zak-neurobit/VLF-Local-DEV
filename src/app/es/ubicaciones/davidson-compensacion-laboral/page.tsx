...
export const metadata = {
  ...
  description:
    'Servicios legales de compensación laboral en Davidson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'compensación laboral Davidson, abogado Davidson, compensación laboral NC, abogado español Davidson, servicios legales Davidson',
  openGraph: {
    title: 'Compensación Laboral en Davidson, NC | Vasquez Law Firm',
    description:
      'Servicios legales de compensación laboral en Davidson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
