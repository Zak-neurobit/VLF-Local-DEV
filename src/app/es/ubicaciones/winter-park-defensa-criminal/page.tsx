...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa criminal en Winter Park, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    'defensa criminal Winter Park, abogado Winter Park, defensa criminal FL, abogado español Winter Park, servicios legales Winter Park',
  openGraph: {
    title: 'Defensa Criminal en Winter Park, FL | Vasquez Law Firm',
    description:
      'Servicios legales de defensa criminal en Winter Park, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
