...
export const metadata = {
  ...
  description:
    'Servicios legales de derecho familiar en Chapel Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'derecho familiar Chapel Hill, abogado Chapel Hill, derecho familiar NC, abogado español Chapel Hill, servicios legales Chapel Hill',
  openGraph: {
    title: 'Derecho Familiar en Chapel Hill, NC | Vasquez Law Firm',
    description:
      'Servicios legales de derecho familiar en Chapel Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
