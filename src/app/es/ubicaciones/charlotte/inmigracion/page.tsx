...
export const metadata: Metadata = {
  ...
  description: 'Abogados de inmigración especializados en Charlotte, NC. Residencia permanente, ciudadanía, DACA, visas familiares y defensa contra deportación. Consulta gratuita.',
  keywords: 'abogado inmigración Charlotte, residencia permanente Charlotte, ciudadanía Charlotte, DACA Charlotte, visas familiares Charlotte',
  openGraph: {
    title: 'Abogado de Inmigración en Charlotte, NC | Bufete Vasquez',
    description: 'Especialistas en inmigración en Charlotte, NC. Ayudamos con residencia permanente, ciudadanía, DACA y más. Hablamos español.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Expertos en leyes de inmigración que luchan por sus derechos y el futuro de su familia en Estados Unidos.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ofrecemos una gama completa de servicios de inmigración para ayudarle a navegar el complejo sistema legal estadounidense.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Tarjetas Verdes (Residencia Permanente)</h3>
              <p className="text-gray-600 mb-4">
                Ayudamos con peticiones familiares, basadas en empleo, inversión y otras vías para obtener la residencia permanente.
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                Le guiamos a través del proceso de naturalización para convertirse en ciudadano estadounidense.
              </p>
              <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                Defendemos agresivamente contra procedimientos de remoción en el Tribunal de Inmigración de Charlotte.
              </p>
              <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                Ayudamos a profesionales y trabajadores a obtener autorización para trabajar en Estados Unidos.
              </p>
              <ul className="text-sm text-gray-600 space-y-1">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                <p className="text-gray-600 mb-4">
                  Tenemos amplia experiencia representando clientes en el Tribunal de Inmigración de Charlotte, ubicado en:
                </p>
                <div className="space-y-2 text-gray-600">
                  <p><strong>Dirección:</strong> 6130 Tyvola Centre Dr, Charlotte, NC 28217</p>
                  <p><strong>Jueces:</strong> Conocemos las preferencias y procedimientos de todos los jueces locales</p>
                  <p><strong>Casos:</strong> Manejamos audiencias maestras, individuales y de fianza</p>
                </div>
              </div>
              ...
              <div className="mt-6 bg-blue-50 p-6 rounded-lg">
                ...
                <p className="text-blue-800">
                  Charlotte tiene una de las poblaciones hispanas de más rápido crecimiento en Carolina del Norte. 
                  Entendemos los desafíos únicos que enfrenta nuestra comunidad y estamos aquí para ayudar.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow">
                  ...
                  <p className="text-gray-600 text-sm">
                    "Estaba en procedimientos de remoción y pensé que perdería todo. Lograron la cancelación 
                    de mi deportación y ahora tengo mi tarjeta verde."
                  </p>
                ...
                <div className="bg-white p-6 rounded-lg shadow">
                  ...
                  <p className="text-gray-600 text-sm">
                    "Me ayudaron a prepararme para el examen de ciudadanía. Ahora soy ciudadano americano 
                    y puedo votar por primera vez."
                  </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Más de 15 años de experiencia en el Tribunal de Inmigración de Charlotte y conocimiento profundo de las leyes locales.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Todo nuestro equipo habla español fluidamente. Entendemos su cultura y sus necesidades específicas.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Emergencias de inmigración requieren acción inmediata. Estamos disponibles 24/7 para casos urgentes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">
              Consulta Gratuita de Inmigración
            </h2>
            <p className="text-xl">
              Su futuro en Estados Unidos es demasiado importante para dejarlo al azar. 
