...
export const metadata: Metadata = {
  ...
  description:
    'Abogados de compensación laboral en Charlotte, NC. Lesiones en el trabajo, beneficios negados, reclamaciones laborales. Luchamos por sus derechos.',
  keywords:
    'abogado compensación laboral Charlotte, lesiones trabajo Charlotte, workers comp Charlotte, beneficios laborales Charlotte',
  openGraph: {
    title: 'Abogado de Compensación Laboral en Charlotte, NC | Bufete Vasquez',
    description:
      'Especialistas en compensación laboral en Charlotte, NC. Protegemos a trabajadores lesionados. Consulta gratuita.',
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Si se lesionó en el trabajo, tiene derechos. Luchamos para que reciba todos los
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Representamos trabajadores en todas las industrias de Charlotte, desde construcción
              hasta hospitales.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                Charlotte está en constante crecimiento. Protegemos a trabajadores de construcción
                lesionados en proyectos locales.
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                Representamos trabajadores en plantas manufactureras y almacenes de distribución en
                Charlotte.
              </p>
              <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                Incluso los trabajos de oficina pueden causar lesiones que requieren compensación
                laboral.
              </p>
              <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                Representamos conductores comerciales, trabajadores de UPS, FedEx y otras compañías
                de entrega.
              </p>
              <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                Trabajadores de tiendas, supermercados y centros comerciales también tienen derecho
                a compensación.
              </p>
              <ul className="text-sm text-gray-600 space-y-1">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Beneficios que Usted Merece</h2>
            <p className="text-xl text-gray-600">
              La compensación laboral de Carolina del Norte debe cubrir todos sus gastos y pérdidas
              relacionadas con su lesión.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm">
                    Bank of America, Wells Fargo, Credit Suisse - Lesiones ergonómicas y estrés
                    laboral
                  </p>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm">
                    Carolinas HealthCare, Presbyterian Healthcare - Lesiones de levantamiento y
                    exposición
                  </p>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm">
                    Honeywell, Siemens - Lesiones industriales y con maquinaria
                  </p>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm">
                    UPS, FedEx, Aeropuerto de Charlotte - Lesiones de carga y accidentes
                  </p>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm">
                    Proyectos del centro de Charlotte - Caídas y lesiones con equipos
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-lg shadow border-l-4 border-orange-500">
                  <h4 className="font-semibold text-gray-900 mb-2">
                    Trabajador de Construcción - $350K
                  </h4>
                  <p className="text-gray-600 text-sm">
                    Caída desde andamio en proyecto del centro de Charlotte resultó en compensación
                    total por discapacidad permanente.
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow border-l-4 border-orange-500">
                  ...
                  <p className="text-gray-600 text-sm">
                    Lesión de espalda por levantar paciente en Carolinas Medical Center, todos los
                ...
                <div className="bg-white p-6 rounded-lg shadow border-l-4 border-orange-500">
                  ...
                  <p className="text-gray-600 text-sm">
                    Lesión de rodilla por paquete pesado, cirugía cubierta y compensación por
                ...
                <div className="bg-white p-6 rounded-lg shadow border-l-4 border-orange-500">
                  <h4 className="font-semibold text-gray-900 mb-2">
                    Trabajador de Almacén - $120K
                  </h4>
                  <p className="text-gray-600 text-sm">
                    Síndrome del túnel carpiano por trabajo repetitivo, cirugía y reentrenamiento
                    vocacional.
                  </p>
                </div>
              </div>
      ...
      <section className="py-16 bg-orange-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Proceso de Reclamación de Workers' Comp</h2>
            <p className="text-xl">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p>Coordinamos con médicos aprobados para obtener el tratamiento que necesita.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p>Presentamos su reclamación ante la Comisión Industrial de Carolina del Norte.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p>Luchamos hasta obtener todos los beneficios médicos y de salarios que merece.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              No deje que su empleador o su aseguradora le nieguen los beneficios que merece. Actúe
              ahora.
            </p>
          </div>
          <ContactForm />
