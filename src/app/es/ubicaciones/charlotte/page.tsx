...
export const metadata: Metadata = {
  ...
  description: 'Bufete de abogados en Charlotte, NC especializado en inmigración, lesiones personales, defensa criminal y derecho familiar. Consulta gratuita en español.',
  keywords: 'abogado Charlotte, bufete abogados Charlotte NC, inmigración Charlotte, lesiones personales Charlotte, defensa criminal Charlotte',
  openGraph: {
    title: 'Abogado en Charlotte, NC | Bufete de Abogados Vasquez',
    description: 'Servicios legales profesionales en Charlotte, NC. Hablamos español. Consulta gratuita.',
...
const charlotteOfficeSchema = generateLocalBusinessSchema({
  ...
  phone: '(704) 555-0123',
  description: 'Bufete de abogados en Charlotte, NC especializado en inmigración, lesiones personales, defensa criminal y derecho familiar.',
  languages: ['es', 'en'],
  servicesOffered: [
    'Inmigración',
    'Lesiones Personales',
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Abogado en Charlotte, NC
              </h1>
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
                Servicios legales profesionales en el corazón de Carolina del Norte. 
                Defendemos sus derechos con experiencia y dedicación.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Ofrecemos servicios legales especializados para la comunidad hispana en Charlotte y sus alrededores.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
                ...
                <p className="text-gray-600 mb-4">
                  Residencia permanente, ciudadanía, visas familiares, DACA, y defensa contra deportación.
                </p>
                <Link
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="bg-white p-6 rounded-lg shadow">
                    <p className="text-gray-600 mb-4">
                      "El equipo del Bufete Vasquez me ayudó con mi caso de inmigración de manera profesional y en español. Obtuve mi residencia permanente gracias a su experiencia."
                    </p>
                  ...
                  <div className="bg-white p-6 rounded-lg shadow">
                    <p className="text-gray-600 mb-4">
                      "Después de mi accidente automovilístico en I-77, recibí la compensación que merecía. Recomiendo sus servicios a toda la comunidad latina."
                    </p>
