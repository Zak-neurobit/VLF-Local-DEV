...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa criminal en Cary, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'defensa criminal Cary, abogado Cary, defensa criminal NC, abogado español Cary, servicios legales Cary',
  openGraph: {
    title: 'Defensa Criminal en Cary, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa criminal en Cary, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
