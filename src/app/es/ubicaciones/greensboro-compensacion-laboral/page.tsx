...
export const metadata = {
  ...
  description:
    'Servicios legales de compensación laboral en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'compensación laboral Greensboro, abogado Greensboro, compensación laboral NC, abogado español Greensboro, servicios legales Greensboro',
  openGraph: {
    title: 'Compensación Laboral en Greensboro, NC | Vasquez Law Firm',
    description:
      'Servicios legales de compensación laboral en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
