...
export const metadata = {
  ...
  description:
    'Servicios legales de accidentes de auto en Sanford, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    'accidentes de auto Sanford, abogado Sanford, accidentes de auto FL, abogado español Sanford, servicios legales Sanford',
  openGraph: {
    title: 'Accidentes de Auto en Sanford, FL | Vasquez Law Firm',
    description:
      'Servicios legales de accidentes de auto en Sanford, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
