...
export const metadata = {
  ...
  description:
    'Servicios legales de lesiones personales en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'lesiones personales Greensboro, abogado Greensboro, lesiones personales NC, abogado español Greensboro, servicios legales Greensboro',
  openGraph: {
    title: 'Lesiones Personales en Greensboro, NC | Vasquez Law Firm',
    description:
      'Servicios legales de lesiones personales en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
