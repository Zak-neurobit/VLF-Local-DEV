...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa dui en Raleigh, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'defensa dui Raleigh, abogado Raleigh, defensa dui NC, abogado español Raleigh, servicios legales Raleigh',
  openGraph: {
    title: 'Defensa DUI en Raleigh, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa dui en Raleigh, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
