...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa dui en Winston-Salem, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'defensa dui Winston-Salem, abogado Winston-Salem, defensa dui NC, abogado español Winston-Salem, servicios legales Winston-Salem',
  openGraph: {
    title: 'Defensa DUI en Winston-Salem, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa dui en Winston-Salem, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
