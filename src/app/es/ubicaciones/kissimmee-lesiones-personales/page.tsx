...
export const metadata = {
  ...
  description:
    'Servicios legales de lesiones personales en Kissimmee, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    'lesiones personales Kissimmee, abogado Kissimmee, lesiones personales FL, abogado español Kissimmee, servicios legales Kissimmee',
  openGraph: {
    title: 'Lesiones Personales en Kissimmee, FL | Vasquez Law Firm',
    description:
      'Servicios legales de lesiones personales en Kissimmee, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
