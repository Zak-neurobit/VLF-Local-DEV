...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa dui en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'defensa dui Kannapolis, abogado Kannapolis, defensa dui NC, abogado español Kannapolis, servicios legales Kannapolis',
  openGraph: {
    title: 'Defensa DUI en Kannapolis, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa dui en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
