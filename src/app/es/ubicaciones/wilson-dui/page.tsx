...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa dui en Wilson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'defensa dui Wilson, abogado Wilson, defensa dui NC, abogado español Wilson, servicios legales Wilson',
  openGraph: {
    title: 'Defensa DUI en Wilson, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa dui en Wilson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
