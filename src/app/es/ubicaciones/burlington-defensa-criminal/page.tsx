...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa criminal en Burlington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'defensa criminal Burlington, abogado Burlington, defensa criminal NC, abogado español Burlington, servicios legales Burlington',
  openGraph: {
    title: 'Defensa Criminal en Burlington, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa criminal en Burlington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
