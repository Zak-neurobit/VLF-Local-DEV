...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa dui en Mint Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'defensa dui Mint Hill, abogado Mint Hill, defensa dui NC, abogado español Mint Hill, servicios legales Mint Hill',
  openGraph: {
    title: 'Defensa DUI en Mint Hill, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa dui en Mint Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
