...
export const metadata = {
  ...
  description:
    'Servicios legales de abogado que habla español en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'abogado que habla español Greensboro, abogado Greensboro, abogado que habla español NC, abogado español Greensboro, servicios legales Greensboro',
  openGraph: {
    title: 'Abogado que Habla Español en Greensboro, NC | Vasquez Law Firm',
    description:
      'Servicios legales de abogado que habla español en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
