...
export const metadata = {
  ...
  description:
    'Servicios legales de bancarrota en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'bancarrota Wilmington, abogado Wilmington, bancarrota NC, abogado español Wilmington, servicios legales Wilmington',
  openGraph: {
    title: 'Bancarrota en Wilmington, NC | Vasquez Law Firm',
    description:
      'Servicios legales de bancarrota en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
