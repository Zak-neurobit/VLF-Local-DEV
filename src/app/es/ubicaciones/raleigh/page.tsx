...
export const metadata: Metadata = {
  ...
  description:
    'Bufete de abogados en Raleigh, NC especializado en inmigración, lesiones personales, defensa criminal y derecho familiar. Consulta gratuita en español.',
  keywords:
    'abogado Raleigh, bufete abogados Raleigh NC, inmigración Raleigh, lesiones personales Raleigh, defensa criminal Raleigh',
  openGraph: {
    title: 'Abogado en Raleigh, NC | Bufete de Abogados Vasquez',
    description:
      'Servicios legales profesionales en la capital de Carolina del Norte. Hablamos español. Consulta gratuita.',
        ...
        <section className="bg-gradient-to-r from-green-900 to-green-700 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">Abogado en Raleigh, NC</h1>
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
                Servicios legales profesionales en la capital de Carolina del Norte. Defendemos sus
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Ventajas de Raleigh</h3>
                <div className="space-y-4">
                  <p className="text-gray-600">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Servimos a la comunidad hispana de Raleigh y el Triángulo con servicios legales
                integrales.
              </p>
            </div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="bg-white p-6 rounded-lg shadow">
                    <p className="text-gray-600 mb-4">
                      "Su oficina en Raleigh me ayudó con mi caso de USCIS de manera eficiente. El
                      acceso directo a las oficinas gubernamentales hizo la diferencia."
                    </p>
                  ...
                  <div className="bg-white p-6 rounded-lg shadow">
                    <p className="text-gray-600 mb-4">
                      "Después de mi accidente en I-440, recibí compensación completa. Su
                      conocimiento de los hospitales locales fue clave."
                    </p>
                  ...
                  <div className="bg-white p-6 rounded-lg shadow">
                    <p className="text-gray-600 mb-4">
                      "Como trabajador de Research Triangle Park, obtuve todos mis beneficios de
                      compensación laboral. Excelente servicio en español."
                    </p>
