...
export const metadata = {
  ...
  description:
    'Servicios legales de bancarrota en Kissimmee, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    'bancarrota Kissimmee, abogado Kissimmee, bancarrota FL, abogado español Kissimmee, servicios legales Kissimmee',
  openGraph: {
    title: 'Bancarrota en Kissimmee, FL | Vasquez Law Firm',
    description:
      'Servicios legales de bancarrota en Kissimmee, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
