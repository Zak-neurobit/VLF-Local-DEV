...
export const metadata = {
  ...
  description:
    'Servicios legales de lesiones personales en Oviedo, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    'lesiones personales Oviedo, abogado Oviedo, lesiones personales FL, abogado español Oviedo, servicios legales Oviedo',
  openGraph: {
    title: 'Lesiones Personales en Oviedo, FL | Vasquez Law Firm',
    description:
      'Servicios legales de lesiones personales en Oviedo, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
