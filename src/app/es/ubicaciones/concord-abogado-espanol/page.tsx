...
export const metadata = {
  ...
  description:
    'Servicios legales de abogado que habla español en Concord, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'abogado que habla español Concord, abogado Concord, abogado que habla español NC, abogado español Concord, servicios legales Concord',
  openGraph: {
    title: 'Abogado que Habla Español en Concord, NC | Vasquez Law Firm',
    description:
      'Servicios legales de abogado que habla español en Concord, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
