...
export const metadata = {
  ...
  description:
    'Servicios legales de ley de inmigración en Cary, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'ley de inmigración Cary, abogado Cary, ley de inmigración NC, abogado español Cary, servicios legales Cary',
  openGraph: {
    title: 'Ley de Inmigración en Cary, NC | Vasquez Law Firm',
    description:
      'Servicios legales de ley de inmigración en Cary, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
