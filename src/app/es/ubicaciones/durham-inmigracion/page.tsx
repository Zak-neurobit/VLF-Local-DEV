...
export const metadata = {
  ...
  description:
    'Servicios legales de ley de inmigración en Durham, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'ley de inmigración Durham, abogado Durham, ley de inmigración NC, abogado español Durham, servicios legales Durham',
  openGraph: {
    title: 'Ley de Inmigración en Durham, NC | Vasquez Law Firm',
    description:
      'Servicios legales de ley de inmigración en Durham, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
