...
export const metadata = {
  title: 'Abogado que Habla Español en Mooresville, NC | Vasquez Law Firm',
  description: 'Servicios legales de abogado que habla español en Mooresville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'abogado que habla español Mooresville, abogado Mooresville, abogado que habla español NC, abogado español Mooresville, servicios legales Mooresville',
  openGraph: {
    title: 'Abogado que Habla Español en Mooresville, NC | Vasquez Law Firm',
    description: 'Servicios legales de abogado que habla español en Mooresville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Abogado que Habla Español en Mooresville, NC'
    }]
  },
  alternates: {
