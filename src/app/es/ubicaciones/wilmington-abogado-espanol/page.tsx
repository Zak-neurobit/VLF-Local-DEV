...
export const metadata = {
  ...
  description:
    'Servicios legales de abogado que habla español en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'abogado que habla español Wilmington, abogado Wilmington, abogado que habla español NC, abogado español Wilmington, servicios legales Wilmington',
  openGraph: {
    title: 'Abogado que Habla Español en Wilmington, NC | Vasquez Law Firm',
    description:
      'Servicios legales de abogado que habla español en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
