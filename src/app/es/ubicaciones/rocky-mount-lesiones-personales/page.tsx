...
export const metadata = {
  ...
  description:
    'Servicios legales de lesiones personales en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'lesiones personales Rocky Mount, abogado Rocky Mount, lesiones personales NC, abogado español Rocky Mount, servicios legales Rocky Mount',
  openGraph: {
    title: 'Lesiones Personales en Rocky Mount, NC | Vasquez Law Firm',
    description:
      'Servicios legales de lesiones personales en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
