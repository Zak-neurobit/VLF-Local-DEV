...
export const metadata = {
  ...
  description:
    'Servicios legales de bancarrota en Charlotte, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'bancarrota Charlotte, abogado Charlotte, bancarrota NC, abogado español Charlotte, servicios legales Charlotte',
  openGraph: {
    title: 'Bancarrota en Charlotte, NC | Vasquez Law Firm',
    description:
      'Servicios legales de bancarrota en Charlotte, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
