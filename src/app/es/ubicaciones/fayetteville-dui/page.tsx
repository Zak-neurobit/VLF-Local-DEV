...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa dui en Fayetteville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'defensa dui Fayetteville, abogado Fayetteville, defensa dui NC, abogado español Fayetteville, servicios legales Fayetteville',
  openGraph: {
    title: 'Defensa DUI en Fayetteville, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa dui en Fayetteville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
