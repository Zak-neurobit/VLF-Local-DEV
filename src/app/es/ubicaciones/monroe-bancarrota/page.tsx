...
export const metadata = {
  ...
  description:
    'Servicios legales de bancarrota en Monroe, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'bancarrota Monroe, abogado Monroe, bancarrota NC, abogado español Monroe, servicios legales Monroe',
  openGraph: {
    title: 'Bancarrota en Monroe, NC | Vasquez Law Firm',
    description:
      'Servicios legales de bancarrota en Monroe, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
