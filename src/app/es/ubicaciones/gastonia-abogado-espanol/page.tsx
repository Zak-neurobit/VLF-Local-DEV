...
export const metadata = {
  ...
  description:
    'Servicios legales de abogado que habla español en Gastonia, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'abogado que habla español Gastonia, abogado Gastonia, abogado que habla español NC, abogado español Gastonia, servicios legales Gastonia',
  openGraph: {
    title: 'Abogado que Habla Español en Gastonia, NC | Vasquez Law Firm',
    description:
      'Servicios legales de abogado que habla español en Gastonia, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
