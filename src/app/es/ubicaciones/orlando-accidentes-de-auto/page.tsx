...
export const metadata = {
  ...
  description: 'Servicios legales de accidentes de auto en Orlando, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'accidentes de auto Orlando, abogado Orlando, accidentes de auto FL, abogado español Orlando, servicios legales Orlando',
  openGraph: {
    title: 'Accidentes de Auto en Orlando, FL | Vasquez Law Firm',
    description: 'Servicios legales de accidentes de auto en Orlando, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
