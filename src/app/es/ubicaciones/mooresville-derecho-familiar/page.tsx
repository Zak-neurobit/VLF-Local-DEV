...
export const metadata = {
  ...
  description:
    'Servicios legales de derecho familiar en Mooresville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'derecho familiar Mooresville, abogado Mooresville, derecho familiar NC, abogado español Mooresville, servicios legales Mooresville',
  openGraph: {
    title: 'Derecho Familiar en Mooresville, NC | Vasquez Law Firm',
    description:
      'Servicios legales de derecho familiar en Mooresville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
