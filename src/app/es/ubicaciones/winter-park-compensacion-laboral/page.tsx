...
export const metadata = {
  ...
  description:
    'Servicios legales de compensación laboral en Winter Park, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    'compensación laboral Winter Park, abogado Winter Park, compensación laboral FL, abogado español Winter Park, servicios legales Winter Park',
  openGraph: {
    title: 'Compensación Laboral en Winter Park, FL | Vasquez Law Firm',
    description:
      'Servicios legales de compensación laboral en Winter Park, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
