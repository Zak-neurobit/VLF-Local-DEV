...
export const metadata = {
  ...
  description:
    'Servicios legales de abogado que habla español en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'abogado que habla español Rocky Mount, abogado Rocky Mount, abogado que habla español NC, abogado español Rocky Mount, servicios legales Rocky Mount',
  openGraph: {
    title: 'Abogado que Habla Español en Rocky Mount, NC | Vasquez Law Firm',
    description:
      'Servicios legales de abogado que habla español en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
