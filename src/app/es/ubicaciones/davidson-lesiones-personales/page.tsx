...
export const metadata = {
  ...
  description:
    'Servicios legales de lesiones personales en Davidson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'lesiones personales Davidson, abogado Davidson, lesiones personales NC, abogado español Davidson, servicios legales Davidson',
  openGraph: {
    title: 'Lesiones Personales en Davidson, NC | Vasquez Law Firm',
    description:
      'Servicios legales de lesiones personales en Davidson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
