...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa criminal en Charlotte, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'defensa criminal Charlotte, abogado Charlotte, defensa criminal NC, abogado español Charlotte, servicios legales Charlotte',
  openGraph: {
    title: 'Defensa Criminal en Charlotte, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa criminal en Charlotte, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
