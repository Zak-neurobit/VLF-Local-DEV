...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa dui en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'defensa dui Greensboro, abogado Greensboro, defensa dui NC, abogado español Greensboro, servicios legales Greensboro',
  openGraph: {
    title: 'Defensa DUI en Greensboro, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa dui en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
