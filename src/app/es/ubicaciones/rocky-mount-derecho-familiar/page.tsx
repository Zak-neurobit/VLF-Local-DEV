...
export const metadata = {
  ...
  description:
    'Servicios legales de derecho familiar en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'derecho familiar Rocky Mount, abogado Rocky Mount, derecho familiar NC, abogado español Rocky Mount, servicios legales Rocky Mount',
  openGraph: {
    title: 'Derecho Familiar en Rocky Mount, NC | Vasquez Law Firm',
    description:
      'Servicios legales de derecho familiar en Rocky Mount, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
