...
export const metadata = {
  ...
  description:
    'Servicios legales de derecho familiar en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'derecho familiar Wilmington, abogado Wilmington, derecho familiar NC, abogado español Wilmington, servicios legales Wilmington',
  openGraph: {
    title: 'Derecho Familiar en Wilmington, NC | Vasquez Law Firm',
    description:
      'Servicios legales de derecho familiar en Wilmington, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
