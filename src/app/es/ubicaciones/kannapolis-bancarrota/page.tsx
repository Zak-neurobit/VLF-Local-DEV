...
export const metadata = {
  ...
  description: 'Servicios legales de bancarrota en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'bancarrota Kannapolis, abogado Kannapolis, bancarrota NC, abogado español Kannapolis, servicios legales Kannapolis',
  openGraph: {
    title: 'Bancarrota en Kannapolis, NC | Vasquez Law Firm',
    description: 'Servicios legales de bancarrota en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
