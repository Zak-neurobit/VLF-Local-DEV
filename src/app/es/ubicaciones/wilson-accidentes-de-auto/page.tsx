...
export const metadata = {
  ...
  description:
    'Servicios legales de accidentes de auto en Wilson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'accidentes de auto Wilson, abogado Wilson, accidentes de auto NC, abogado español Wilson, servicios legales Wilson',
  openGraph: {
    title: 'Accidentes de Auto en Wilson, NC | Vasquez Law Firm',
    description:
      'Servicios legales de accidentes de auto en Wilson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
