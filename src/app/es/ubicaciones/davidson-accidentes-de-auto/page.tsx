...
export const metadata = {
  ...
  description:
    'Servicios legales de accidentes de auto en Davidson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'accidentes de auto Davidson, abogado Davidson, accidentes de auto NC, abogado español Davidson, servicios legales Davidson',
  openGraph: {
    title: 'Accidentes de Auto en Davidson, NC | Vasquez Law Firm',
    description:
      'Servicios legales de accidentes de auto en Davidson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
