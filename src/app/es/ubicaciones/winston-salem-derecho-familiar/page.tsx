...
export const metadata = {
  ...
  description:
    'Servicios legales de derecho familiar en Winston-Salem, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'derecho familiar Winston-Salem, abogado Winston-Salem, derecho familiar NC, abogado español Winston-Salem, servicios legales Winston-Salem',
  openGraph: {
    title: 'Derecho Familiar en Winston-Salem, NC | Vasquez Law Firm',
    description:
      'Servicios legales de derecho familiar en Winston-Salem, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
