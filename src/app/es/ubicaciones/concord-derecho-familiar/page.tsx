...
export const metadata = {
  ...
  description:
    'Servicios legales de derecho familiar en Concord, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'derecho familiar Concord, abogado Concord, derecho familiar NC, abogado español Concord, servicios legales Concord',
  openGraph: {
    title: 'Derecho Familiar en Concord, NC | Vasquez Law Firm',
    description:
      'Servicios legales de derecho familiar en Concord, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
