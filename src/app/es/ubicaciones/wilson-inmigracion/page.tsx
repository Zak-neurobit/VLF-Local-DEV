...
export const metadata = {
  ...
  description:
    'Servicios legales de ley de inmigración en Wilson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'ley de inmigración Wilson, abogado Wilson, ley de inmigración NC, abogado español Wilson, servicios legales Wilson',
  openGraph: {
    title: 'Ley de Inmigración en Wilson, NC | Vasquez Law Firm',
    description:
      'Servicios legales de ley de inmigración en Wilson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
