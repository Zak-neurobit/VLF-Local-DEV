...
export const metadata = {
  title: 'Defensa Criminal en Sanford, FL | Vasquez Law Firm',
  description: 'Servicios legales de defensa criminal en Sanford, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'defensa criminal Sanford, abogado Sanford, defensa criminal FL, abogado español Sanford, servicios legales Sanford',
  openGraph: {
    title: 'Defensa Criminal en Sanford, FL | Vasquez Law Firm',
    description: 'Servicios legales de defensa criminal en Sanford, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Defensa Criminal en Sanford, FL'
    }]
  },
  alternates: {
