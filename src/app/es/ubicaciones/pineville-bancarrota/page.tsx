...
export const metadata = {
  ...
  description:
    'Servicios legales de bancarrota en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'bancarrota Pineville, abogado Pineville, bancarrota NC, abogado español Pineville, servicios legales Pineville',
  openGraph: {
    title: 'Bancarrota en Pineville, NC | Vasquez Law Firm',
    description:
      'Servicios legales de bancarrota en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
