...
export const metadata = {
  title: 'Compensación Laboral en Cary, NC | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Cary, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords: 'compensación laboral Cary, abogado Cary, compensación laboral NC, abogado español Cary, servicios legales Cary',
  openGraph: {
    title: 'Compensación Laboral en Cary, NC | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Cary, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Cary, NC'
    }]
  },
  alternates: {
