...
export const metadata = {
  title: 'Compensación Laboral en Monroe, NC | Vasquez Law Firm',
  description: 'Servicios legales de compensación laboral en Monroe, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'compensación laboral Monroe, abogado Monroe, compensación laboral NC, abogado español Monroe, servicios legales Monroe',
  openGraph: {
    title: 'Compensación Laboral en Monroe, NC | Vasquez Law Firm',
    description: 'Servicios legales de compensación laboral en Monroe, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Compensación Laboral en Monroe, NC'
    }]
  },
  alternates: {
