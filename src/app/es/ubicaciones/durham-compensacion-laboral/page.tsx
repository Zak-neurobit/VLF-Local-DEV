...
export const metadata = {
  ...
  description:
    'Servicios legales de compensación laboral en Durham, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'compensación laboral Durham, abogado Durham, compensación laboral NC, abogado español Durham, servicios legales Durham',
  openGraph: {
    title: 'Compensación Laboral en Durham, NC | Vasquez Law Firm',
    description:
      'Servicios legales de compensación laboral en Durham, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
