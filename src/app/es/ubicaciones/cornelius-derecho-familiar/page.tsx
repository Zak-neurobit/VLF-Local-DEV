...
export const metadata = {
  ...
  description:
    'Servicios legales de derecho familiar en Cornelius, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'derecho familiar Cornelius, abogado Cornelius, derecho familiar NC, abogado español Cornelius, servicios legales Cornelius',
  openGraph: {
    title: 'Derecho Familiar en Cornelius, NC | Vasquez Law Firm',
    description:
      'Servicios legales de derecho familiar en Cornelius, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
