...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa criminal en Chapel Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'defensa criminal Chapel Hill, abogado Chapel Hill, defensa criminal NC, abogado español Chapel Hill, servicios legales Chapel Hill',
  openGraph: {
    title: 'Defensa Criminal en Chapel Hill, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa criminal en Chapel Hill, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
