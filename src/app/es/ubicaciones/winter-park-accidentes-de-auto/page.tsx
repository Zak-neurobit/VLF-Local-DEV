...
export const metadata = {
  ...
  description:
    'Servicios legales de accidentes de auto en Winter Park, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    'accidentes de auto Winter Park, abogado Winter Park, accidentes de auto FL, abogado español Winter Park, servicios legales Winter Park',
  openGraph: {
    title: 'Accidentes de Auto en Winter Park, FL | Vasquez Law Firm',
    description:
      'Servicios legales de accidentes de auto en Winter Park, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
