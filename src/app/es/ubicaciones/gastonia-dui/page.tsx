...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa dui en Gastonia, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'defensa dui Gastonia, abogado Gastonia, defensa dui NC, abogado español Gastonia, servicios legales Gastonia',
  openGraph: {
    title: 'Defensa DUI en Gastonia, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa dui en Gastonia, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
