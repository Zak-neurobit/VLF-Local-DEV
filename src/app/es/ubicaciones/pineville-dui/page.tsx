...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa dui en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'defensa dui Pineville, abogado Pineville, defensa dui NC, abogado español Pineville, servicios legales Pineville',
  openGraph: {
    title: 'Defensa DUI en Pineville, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa dui en Pineville, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
