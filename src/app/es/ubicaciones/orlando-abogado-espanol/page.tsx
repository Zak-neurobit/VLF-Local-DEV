...
export const metadata = {
  title: 'Abogado que Habla Español en Orlando, FL | Vasquez Law Firm',
  description: 'Servicios legales de abogado que habla español en Orlando, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords: 'abogado que habla español Orlando, abogado Orlando, abogado que habla español FL, abogado español Orlando, servicios legales Orlando',
  openGraph: {
    title: 'Abogado que Habla Español en Orlando, FL | Vasquez Law Firm',
    description: 'Servicios legales de abogado que habla español en Orlando, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Abogado que Habla Español en Orlando, FL'
    }]
  },
  alternates: {
