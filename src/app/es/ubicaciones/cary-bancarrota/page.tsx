...
export const metadata = {
  ...
  description:
    'Servicios legales de bancarrota en Cary, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'bancarrota Cary, abogado Cary, bancarrota NC, abogado español Cary, servicios legales Cary',
  openGraph: {
    title: 'Bancarrota en Cary, NC | Vasquez Law Firm',
    description:
      'Servicios legales de bancarrota en Cary, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
