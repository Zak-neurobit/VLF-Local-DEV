...
export const metadata = {
  ...
  description:
    'Servicios legales de bancarrota en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'bancarrota Greensboro, abogado Greensboro, bancarrota NC, abogado español Greensboro, servicios legales Greensboro',
  openGraph: {
    title: 'Bancarrota en Greensboro, NC | Vasquez Law Firm',
    description:
      'Servicios legales de bancarrota en Greensboro, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
