...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa criminal en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'defensa criminal Kannapolis, abogado Kannapolis, defensa criminal NC, abogado español Kannapolis, servicios legales Kannapolis',
  openGraph: {
    title: 'Defensa Criminal en Kannapolis, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa criminal en Kannapolis, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
