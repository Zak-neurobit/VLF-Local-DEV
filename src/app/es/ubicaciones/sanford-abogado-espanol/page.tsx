...
export const metadata = {
  ...
  description:
    'Servicios legales de abogado que habla español en Sanford, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    'abogado que habla español Sanford, abogado Sanford, abogado que habla español FL, abogado español Sanford, servicios legales Sanford',
  openGraph: {
    title: 'Abogado que Habla Español en Sanford, FL | Vasquez Law Firm',
    description:
      'Servicios legales de abogado que habla español en Sanford, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
