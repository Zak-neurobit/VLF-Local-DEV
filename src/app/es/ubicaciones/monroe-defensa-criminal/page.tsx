...
export const metadata = {
  title: 'Defensa Criminal en Monroe, NC | Vasquez Law Firm',
  description: 'Servicios legales de defensa criminal en Monroe, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'defensa criminal Monroe, abogado Monroe, defensa criminal NC, abogado español Monroe, servicios legales Monroe',
  openGraph: {
    title: 'Defensa Criminal en Monroe, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa criminal en Monroe, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Defensa Criminal en Monroe, NC'
    }]
  },
  alternates: {
