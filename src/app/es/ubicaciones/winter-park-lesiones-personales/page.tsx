...
export const metadata = {
  ...
  description:
    'Servicios legales de lesiones personales en Winter Park, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    'lesiones personales Winter Park, abogado Winter Park, lesiones personales FL, abogado español Winter Park, servicios legales Winter Park',
  openGraph: {
    title: 'Lesiones Personales en Winter Park, FL | Vasquez Law Firm',
    description:
      'Servicios legales de lesiones personales en Winter Park, FL. Abogados locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
