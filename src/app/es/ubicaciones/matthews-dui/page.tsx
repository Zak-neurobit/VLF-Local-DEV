...
export const metadata = {
  ...
  description: 'Servicios legales de defensa dui en Matthews, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords: 'defensa dui Matthews, abogado Matthews, defensa dui NC, abogado español Matthews, servicios legales Matthews',
  openGraph: {
    title: 'Defensa DUI en Matthews, NC | Vasquez Law Firm',
    description: 'Servicios legales de defensa dui en Matthews, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
