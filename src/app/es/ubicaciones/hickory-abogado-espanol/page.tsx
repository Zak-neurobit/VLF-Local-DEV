...
export const metadata = {
  ...
  description:
    'Servicios legales de abogado que habla español en Hickory, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'abogado que habla español Hickory, abogado Hickory, abogado que habla español NC, abogado español Hickory, servicios legales Hickory',
  openGraph: {
    title: 'Abogado que Habla Español en Hickory, NC | Vasquez Law Firm',
    description:
      'Servicios legales de abogado que habla español en Hickory, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
