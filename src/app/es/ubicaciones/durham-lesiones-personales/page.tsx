...
export const metadata = {
  ...
  description:
    'Servicios legales de lesiones personales en Durham, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'lesiones personales Durham, abogado Durham, lesiones personales NC, abogado español Durham, servicios legales Durham',
  openGraph: {
    title: 'Lesiones Personales en Durham, NC | Vasquez Law Firm',
    description:
      'Servicios legales de lesiones personales en Durham, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
