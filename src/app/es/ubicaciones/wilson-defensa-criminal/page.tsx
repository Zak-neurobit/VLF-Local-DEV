...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa criminal en Wilson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    'defensa criminal Wilson, abogado Wilson, defensa criminal NC, abogado español Wilson, servicios legales Wilson',
  openGraph: {
    title: 'Defensa Criminal en Wilson, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa criminal en Wilson, NC. Abogados locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
