...
export const metadata = {
  ...
  description:
    'Servicios legales de defensa dui en Hickory, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    'defensa dui Hickory, abogado Hickory, defensa dui NC, abogado español Hickory, servicios legales Hickory',
  openGraph: {
    title: 'Defensa DUI en Hickory, NC | Vasquez Law Firm',
    description:
      'Servicios legales de defensa dui en Hickory, NC. Abogados locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
