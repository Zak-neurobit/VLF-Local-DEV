    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Lesiones Personales Services in North Carolina',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  return (
    <>
      <ModernPracticeAreaTemplate
        title="North Carolina's Premier Lesiones Personales Law Firm"
          ...
          <div className="space-y-12">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">
                Why Vasquez Law Firm for Lesiones Personales?
              </h2>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LegalService',
            name: 'Lesiones Personales Law Services - Vasquez Law Firm',
            description:
            ...
            serviceType: 'Lesiones Personales Law',
            offers: {
              '@type': 'Offer',
