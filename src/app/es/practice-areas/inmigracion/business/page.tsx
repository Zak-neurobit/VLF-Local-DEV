...
import { Briefcase, Globe, FaChartLine, FaUserTie, FaHandshake, Building,  } from 'lucide-react';
...
const employerServices = [
  {
    ...
    features: ['I-9 compliance', 'E-Verify guidance', 'LCA compliance', 'Inmigración policies'],
  },
  {
    title: 'Strategic Inmigración Planning',
...
export default function BusinessInmigraciónPage() {
  return (
      ...
      <section className="relative bg-gradient-to-r from-blue-900 to-blue-700 text-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Business Inmigración Services</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Comprehensive Business Inmigración Solutions
            </h2>
