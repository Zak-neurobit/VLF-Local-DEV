...
export const metadata: Metadata = {
  ...
  description:
    'URGENT: Inmigración detention and bond hearing attorneys with 24/7 emergency response. Former ICE attorneys on staff. Get immediate help for detained family members. Call 1-844-YO-PELEO',
  keywords:
  ...
  openGraph: {
    title: 'EMERGENCY Inmigración Detention & Bond Abogados | 24/7 Response - Vasquez Law Firm',
    description:
...
export default function DetentionBondHearingsPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'Inmigración bonds typically range from $1,500 to $25,000 depending on the case. We file bond reduction motions to lower unreasonably high bonds and can connect families with bond payment assistance programs.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'We can appeal bond denials to the Board of Inmigración Appeals (BIA) and file habeas corpus petitions in federal court. We also explore parole in place applications and alternative detention programs.',
    },
    {
  ...
  const content = {
    ...
    process: [
      ...
      },
      {
        ...
        description:
          'Abogado visit to detention facility for client consultation and document gathering',
      },
      {
        step: '3',
  ...
  return (
    <StandardizedPracticeAreaTemplate
      title="EMERGENCY Inmigración Detention & Bond Abogados"
      ...
      additionalContent={
        <div className="space-y-12">
          ...
          {/* Bond Process */}
          <section>
            <h2 className="text-3xl font-bold text-primary mb-8">Inmigración Bond Process</h2>
