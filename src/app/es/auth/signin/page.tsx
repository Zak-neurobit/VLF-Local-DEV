...
export const metadata: Metadata = {
  title: 'Iniciar Sesión - Bufete de Abogados Vásquez',
  description: 'Acceda a su cuenta del portal de clientes del Bufete de Abogados Vásquez',
  alternates: {
    canonical: 'https://www.vasquezlawnc.com/es/auth/signin',
    languages: {
      'en-US': 'https://www.vasquezlawnc.com/auth/signin',
      'es-ES': 'https://www.vasquezlawnc.com/es/auth/signin',
    },
  },
};
          ...
          <form className="mt-8 space-y-6" action="#" method="POST">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href="/es/auth/forgot-password" className="font-medium text-secondary hover:text-secondary-dark">
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-gray-50 text-gray-500">O continúe con</span>
                </div>
              </div>
