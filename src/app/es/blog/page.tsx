...
export const metadata: Metadata = {
  ...
  description:
    'Artículos legales, noticias y actualizaciones sobre inmigración, lesiones personales, compensación laboral y más.',
};
...
const blogPosts = [
  {
    ...
    excerpt:
      'Conozca los últimos cambios en las políticas de inmigración y cómo pueden afectar su caso.',
  ...
  },
  {
    ...
    excerpt:
      'Pasos importantes a seguir inmediatamente después de verse involucrado en un accidente vehicular.',
...
const categories = [
  ...
  { id: 'inmigracion', name: 'Inmigración', slug: 'inmigracion' },
  { id: 'lesiones-personales', name: 'Lesiones Personales', slug: 'lesiones-personales' },
  { id: 'compensacion-laboral', name: 'Compensación Laboral', slug: 'compensacion-laboral' },
  { id: 'defensa-criminal', name: 'Defensa Criminal', slug: 'defensa-criminal' },
  { id: 'derecho-familiar', name: 'Derecho Familiar', slug: 'derecho-familiar' },
];
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {blogPosts.map(post => (
          ...
          >
            ...
            <div className="p-6">
              <div className="text-sm text-[#C9974D] font-semibold mb-2">{post.category}</div>
              <h2 className="text-xl font-bold text-gray-900 mb-3">
                <Link
                  href={`/es/blog/${post.slug}`}
                  className="hover:text-[#6B1F2E] transition-colors"
                >
                  {post.title}
                </Link>
              </h2>
      ...
      <div className="flex justify-center gap-2 mt-12">
        ...
        <button className="px-4 py-2 bg-[#6B1F2E] text-white rounded-lg">1</button>
        <button className="px-4 py-2 bg-gray-200 text-gray-600 rounded-lg hover:bg-gray-300 transition-colors">
          2
        </button>
        <button className="px-4 py-2 bg-gray-200 text-gray-600 rounded-lg hover:bg-gray-300 transition-colors">
