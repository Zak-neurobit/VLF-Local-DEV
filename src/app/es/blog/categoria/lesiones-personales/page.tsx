...
export const metadata: Metadata = {
  title: `Lesiones Personales - Blog Legal | Bufete de Abogados Vasquez`,
  description: `Artículos y noticias sobre lesiones personales de nuestros abogados expertos.`,
};
    ...
    <div className="space-y-8">
      <header className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Todos los artículos relacionados con lesiones personales
        </p>
      </header>
