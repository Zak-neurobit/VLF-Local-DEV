...
export const metadata: Metadata = {
  ...
  description: `Artículos y noticias sobre compensación laboral de nuestros abogados expertos.`,
};
    ...
    <div className="space-y-8">
      <header className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">
          Categoría: Compensación Laboral
        </h1>
        <p className="text-lg text-gray-600">
          Todos los artículos relacionados con compensación laboral
        </p>
      </header>
