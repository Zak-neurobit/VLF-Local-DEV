...
export const metadata: Metadata = {
  title: `Derecho Familiar - Blog Legal | Bufete de Abogados Vasquez`,
  description: `Artículos y noticias sobre derecho familiar de nuestros abogados expertos.`,
};
    ...
    <div className="space-y-8">
      <header className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Todos los artículos relacionados con derecho familiar
        </p>
      </header>
