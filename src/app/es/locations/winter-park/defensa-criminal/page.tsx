...
export const metadata: Metadata = {
  title: `Defensa Criminal - Winter Park | Vasquez Law Firm`,
  description: `Defensa Criminal services in Winter Park. Experienced attorneys serving the local community.`,
};

export default function WinterParkCriminalDefensePage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Defensa Criminal in Winter Park</h1>
