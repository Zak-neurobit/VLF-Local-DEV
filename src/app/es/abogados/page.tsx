...
export const metadata: Metadata = {
  title: 'Abogados - Vasquez Law Firm, PLLC',
  description: '',
  openGraph: {
    title: 'Abogados - Vasquez Law Firm, PLLC',
    description: '',
      ...
      <section className="bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Conoce Nuestros Abogados</h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/es/abogados/',
                  url: 'https://www.vasquezlawnc.com/es/abogados/',
                  name: 'Abogados - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-09-13T13:51:03+00:00',
                  dateModified: '2025-04-22T15:25:45+00:00',
                  breadcrumb: { '@id': 'https://www.vasquezlawnc.com/es/abogados/#breadcrumb' },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/es/abogados/'],
                    },
                  ],
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id': 'https://www.vasquezlawnc.com/es/abogados/#breadcrumb',
                  itemListElement: [
                    {
                      '@type': 'ListItem',
                      position: 1,
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: 'Abogados',
                  item: 'https://vasquezlawnc.com/es/abogados',
                },
              ],
            },
            {
