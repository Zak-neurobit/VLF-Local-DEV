      ...
      <section className="relative bg-gradient-to-r from-burgundy-700 to-burgundy-900 text-white py-20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">William Vasquez - Abogado</h1>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="mb-8">
                ...
                <p className="text-gray-700">
                  ...
                  años de experiencia, ha dedicado su carrera a luchar por los derechos de
                  inmigrantes, víctimas de accidentes y aquellos que enfrentan cargos criminales. Un
                  veterano de la Fuerza Aérea de EE.UU., el Sr. Vasquez aporta disciplina,
                  integridad y pensamiento estratégico a cada caso.
                </p>
              </div>
