...
export const metadata: Metadata = {
  title: 'Jillian Baucom - Abogado - Vasquez Law Firm, PLLC',
  description: '',
};
      ...
      <section className="relative bg-gradient-to-r from-burgundy-700 to-burgundy-900 text-white py-20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Jillian Baucom - Abogado</h1>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="mb-8">
                ...
                <p className="text-gray-700">
                  ...
                  complejo sistema de inmigración.
                </p>
              </div>
