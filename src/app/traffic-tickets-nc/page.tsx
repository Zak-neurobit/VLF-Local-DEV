...
export const metadata: Metadata = {
  title: 'Traffic Tickets, NC - Vasquez Law Firm, PLLC',
  description: '',
  openGraph: {
    title: 'Traffic Tickets, NC - Vasquez Law Firm, PLLC',
    description: '',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Traffic Tickets, NC - Vasquez Law Firm, PLLC
            </h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/traffic-tickets-nc/',
                  url: 'https://www.vasquezlawnc.com/traffic-tickets-nc/',
                  name: 'Traffic Tickets, NC - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2025-02-14T15:02:28+00:00',
                  dateModified: '2025-02-18T09:32:59+00:00',
                  breadcrumb: {
                    '@id': 'https://www.vasquezlawnc.com/traffic-tickets-nc/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/traffic-tickets-nc/'],
                    },
                  ],
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Traffic Tickets, NC' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 2,
                  name: 'Traffic tickets nc',
                  item: 'https://vasquezlawnc.com/traffic-tickets-nc',
                },
              ],
            },
            {
