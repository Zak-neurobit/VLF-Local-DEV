...
export const metadata: Metadata = {
  title: 'Smithfield, NC Auto Accident Lawyers | Vasquez Law Firm, PLLC',
  description:
    'Experienced auto accident lawyers in Smithfield, providing legal assistance for injury claims, compensation, and navigating the aftermath of a car accident.',
  openGraph: {
    title: 'Smithfield, NC Auto Accident Lawyers | Vasquez Law Firm, PLLC',
    description:
      'Experienced auto accident lawyers in Smithfield, providing legal assistance for injury claims, compensation, and navigating the aftermath of a car accident.',
              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Smithfield, NC Auto Accident Lawyers | Vasquez Law Firm, PLLC
                  </h2>
                  <p className="text-gray-700">
                    Smithfield, NC Auto Accident Lawyers brings extensive legal experience to every
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-700">
                    Smithfield, NC Auto Accident Lawyers focuses on immigration, personal injury,
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/smithfield-nc-auto-accident-lawyers/',
                  url: 'https://www.vasquezlawnc.com/smithfield-nc-auto-accident-lawyers/',
                  name: 'Smithfield, NC Auto Accident Lawyers | Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-10-30T18:11:49+00:00',
                  dateModified: '2024-10-30T18:14:08+00:00',
                  description:
                    'Experienced auto accident lawyers in Smithfield, providing legal assistance for injury claims, compensation, and navigating the aftermath of a car accident.',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/smithfield-nc-auto-accident-lawyers/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/smithfield-nc-auto-accident-lawyers/'],
                    },
                  ],
                },
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'Smithfield, NC Auto Accident Lawyers',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              url: 'https://vasquezlawnc.com/smithfield-nc-auto-accident-lawyers/index',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Smithfield nc auto accident lawyers',
                  item: 'https://vasquezlawnc.com/smithfield-nc-auto-accident-lawyers',
                },
              ],
            },
            {
