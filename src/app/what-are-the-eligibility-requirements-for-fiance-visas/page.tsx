        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              What Are the Eligibility Requirements for Fiancé Visas? - Vasquez Law Firm, PLLC
            </h1>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/what-are-the-eligibility-requirements-for-fiance-visas/',
                  url: 'https://www.vasquezlawnc.com/what-are-the-eligibility-requirements-for-fiance-visas/',
                  name: 'What Are the Eligibility Requirements for Fiancé Visas? - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/what-are-the-eligibility-requirements-for-fiance-visas/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/what-are-the-eligibility-requirements-for-fiance-visas/#primaryimage',
                  ...
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/09/shutterstock_1577155054.jpg',
                  datePublished: '2023-03-13T16:34:03+00:00',
                  dateModified: '2024-09-18T16:34:28+00:00',
                  author: {
                    '@id':
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/what-are-the-eligibility-requirements-for-fiance-visas/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'What Are the Eligibility Requirements for Fiancé Visas?',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              availableLanguage: ['English', 'Spanish'],
              url: 'https://vasquezlawnc.com/what-are-the-eligibility-requirements-for-fiance-visas/index',
            },
            {
              '@context': 'https://schema.org',
              '@type': 'BreadcrumbList',
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 2,
                  name: 'What are the eligibility requirements for fiance visas',
                  item: 'https://vasquezlawnc.com/what-are-the-eligibility-requirements-for-fiance-visas',
                },
              ],
            },
            {
