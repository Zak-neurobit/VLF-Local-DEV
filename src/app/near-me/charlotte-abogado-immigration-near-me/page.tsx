...
export default function CharlotteAbogadoimmigrationPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Abogado immigration Near Me in Charlotte</h1>
      <p className="text-lg mb-6">
        Looking for a abogado immigration near you in Charlotte? Vasquez Law Firm provides experienced legal representation right in your neighborhood.
      </p>
