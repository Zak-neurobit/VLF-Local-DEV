...
export default function WinstonSalemWorkersCompensationLawyerNearMePage() {
  ...
  const post = {
    id: 'winston-salem-workers-compensation-lawyer-near-me',
    title: 'Winston Salem Workers Compensation Lawyer Near Me',
    slug: 'winston-salem-workers-compensation-lawyer-near-me',
