...
export default function ConcordDuiPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Dui Near Me in Concord</h1>
      <p className="text-lg mb-6">
        Looking for a dui near you in Concord? Vasquez Law Firm provides experienced legal representation right in your neighborhood.
      </p>
