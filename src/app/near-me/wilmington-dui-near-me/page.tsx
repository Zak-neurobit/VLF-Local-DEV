...
export const metadata: Metadata = {
  title: `Dui Near Me in Wilmington | Vasquez Law Firm`,
  description: `Find the best dui near you in Wilmington. Experienced legal representation.`,
};

export default function WilmingtonDuiPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Dui Near Me in Wilmington</h1>
      <p className="text-lg mb-6">
        Looking for a dui near you in Wilmington? Vasquez Law Firm provides experienced legal representation right in your neighborhood.
      </p>
