...
export const metadata: Metadata = {
  title: `Personal injury Near Me in Durham | Vasquez Law Firm`,
  description: `Find the best personal injury near you in Durham. Experienced legal representation.`,
};

export default function DurhamPersonalinjuryPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Personal injury Near Me in Durham</h1>
      <p className="text-lg mb-6">
        Looking for a personal injury near you in Durham? Vasquez Law Firm provides experienced legal representation right in your neighborhood.
      </p>
