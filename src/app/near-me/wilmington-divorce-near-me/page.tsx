...
export default function WilmingtonDivorcePage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Divorce Near Me in Wilmington</h1>
      <p className="text-lg mb-6">
        Looking for a divorce near you in Wilmington? Vasquez Law Firm provides experienced legal representation right in your neighborhood.
      </p>
