...
export default function WilmingtonWorkersCompensationLawyerNearMePage() {
  ...
  const post = {
    id: 'wilmington-workers-compensation-lawyer-near-me',
    title: 'Wilmington Workers Compensation Lawyer Near Me',
    slug: 'wilmington-workers-compensation-lawyer-near-me',
