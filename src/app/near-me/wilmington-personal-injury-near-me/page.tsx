...
export const metadata: Metadata = {
  title: `Personal injury Near Me in Wilmington | Vasquez Law Firm`,
  description: `Find the best personal injury near you in Wilmington. Experienced legal representation.`,
};

export default function WilmingtonPersonalinjuryPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Personal injury Near Me in Wilmington</h1>
      <p className="text-lg mb-6">
        Looking for a personal injury near you in Wilmington? Vasquez Law Firm provides experienced legal representation right in your neighborhood.
      </p>
