...
export const metadata: Metadata = {
  title: `Dui Near Me in Greensboro | Vasquez Law Firm`,
  description: `Find the best dui near you in Greensboro. Experienced legal representation.`,
};

export default function GreensboroDuiPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Dui Near Me in Greensboro</h1>
      <p className="text-lg mb-6">
        Looking for a dui near you in Greensboro? Vasquez Law Firm provides experienced legal representation right in your neighborhood.
      </p>
