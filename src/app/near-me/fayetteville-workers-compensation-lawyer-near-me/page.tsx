...
export default function FayettevilleWorkersCompensationLawyerNearMePage() {
  ...
  const post = {
    id: 'fayetteville-workers-compensation-lawyer-near-me',
    title: 'Fayetteville Workers Compensation Lawyer Near Me',
    slug: 'fayetteville-workers-compensation-lawyer-near-me',
