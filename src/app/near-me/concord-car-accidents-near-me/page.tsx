...
export const metadata: Metadata = {
  title: `Car accidents Near Me in Concord | Vasquez Law Firm`,
  description: `Find the best car accidents near you in Concord. Experienced legal representation.`,
};

export default function ConcordCaraccidentsPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Car accidents Near Me in Concord</h1>
      <p className="text-lg mb-6">
        Looking for a car accidents near you in Concord? Vasquez Law Firm provides experienced legal representation right in your neighborhood.
      </p>
