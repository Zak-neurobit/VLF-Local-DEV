...
export const metadata: Metadata = {
  title: `Spanish speaking Near Me in Wilmington | Vasquez Law Firm`,
  description: `Find the best spanish speaking near you in Wilmington. Experienced legal representation.`,
};

export default function WilmingtonSpanishspeakingPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Spanish speaking Near Me in Wilmington</h1>
      <p className="text-lg mb-6">
        Looking for a spanish speaking near you in Wilmington? Vasquez Law Firm provides experienced legal representation right in your neighborhood.
      </p>
