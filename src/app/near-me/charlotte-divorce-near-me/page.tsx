...
export const metadata: Metadata = {
  title: `Divorce Near Me in Charlotte | Vasquez Law Firm`,
  description: `Find the best divorce near you in Charlotte. Experienced legal representation.`,
};

export default function CharlotteDivorcePage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Divorce Near Me in Charlotte</h1>
      <p className="text-lg mb-6">
        Looking for a divorce near you in Charlotte? Vasquez Law Firm provides experienced legal representation right in your neighborhood.
      </p>
