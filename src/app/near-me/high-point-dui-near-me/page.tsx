...
export default function HighPointduiPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Point dui Near Me in High</h1>
      <p className="text-lg mb-6">
        Looking for a point dui near you in High? Vasquez Law Firm provides experienced legal representation right in your neighborhood.
      </p>
