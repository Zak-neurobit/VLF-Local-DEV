...
export default function RaleighSpanishspeakingPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Spanish speaking Near Me in Raleigh</h1>
      <p className="text-lg mb-6">
        Looking for a spanish speaking near you in Raleigh? Vasquez Law Firm provides experienced legal representation right in your neighborhood.
      </p>
