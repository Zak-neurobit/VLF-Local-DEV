...
export const metadata: Metadata = {
  title: `Immigration Near Me in Raleigh | Vasquez Law Firm`,
...
export default function RaleighImmigrationPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Immigration Near Me in Raleigh</h1>
      <p className="text-lg mb-6">
        Looking for a immigration near you in Raleigh? Vasquez Law Firm provides experienced legal representation right in your neighborhood.
      </p>
