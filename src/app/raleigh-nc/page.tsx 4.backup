...
export const metadata: Metadata = {
  title: 'Raleigh, NC - Vasquez Law Firm, PLLC',
  description:
      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Raleigh, NC</h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/raleigh-nc/',
                  url: 'https://www.vasquezlawnc.com/raleigh-nc/',
                  name: 'Raleigh, NC - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-06-03T19:18:41+00:00',
                  dateModified: '2025-02-20T10:57:09+00:00',
                  description:
                    'Need a trusted workers’ comp lawyer in Raleigh, NC? Get expert legal help to secure the benefits you deserve. Contact us today for a free consultation!',
                  breadcrumb: { '@id': 'https://www.vasquezlawnc.com/raleigh-nc/#breadcrumb' },
                  inLanguage: 'en-US',
                  potentialAction: [
                    { '@type': 'ReadAction', target: ['https://www.vasquezlawnc.com/raleigh-nc/'] },
                  ],
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id': 'https://www.vasquezlawnc.com/raleigh-nc/#breadcrumb',
                  itemListElement: [
                    {
                      '@type': 'ListItem',
                      position: 1,
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Raleigh, NC' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Raleigh nc',
                  item: 'https://vasquezlawnc.com/raleigh-nc',
                },
              ],
            },
            {
