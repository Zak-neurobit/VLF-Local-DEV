...
export const metadata: Metadata = {
  ...
  description: 'Make secure online payments for legal services. PCI compliant, encrypted, and protected payment processing.',
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>Contact us if you need a payment plan or have questions</span>
                </li>
              </ul>
            </div>
          </div>
