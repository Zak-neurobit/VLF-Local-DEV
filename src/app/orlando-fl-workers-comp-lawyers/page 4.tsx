              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Orlando, FL Workers&apos; Comp Lawyers | Vasquez Law Firm, PLLC
                  </h2>
                  <p className="text-gray-700">
                    Orlando, FL Workers&apos; Comp Lawyers brings extensive legal experience to
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-700">
                    Orlando, FL Workers&apos; Comp Lawyers focuses on immigration, personal injury,
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
              ...
              '@graph': [
                {
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/orlando-fl-workers-comp-lawyers/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/orlando-fl-workers-comp-lawyers/'],
                    },
                  ],
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id': 'https://www.vasquezlawnc.com/orlando-fl-workers-comp-lawyers/#breadcrumb',
                  itemListElement: [
                    {
                      '@type': 'ListItem',
                      position: 1,
            ...
            },
            {
              ...
              url: 'https://vasquezlawnc.com/orlando-fl-workers-comp-lawyers/index',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Orlando fl workers comp lawyers',
                  item: 'https://vasquezlawnc.com/orlando-fl-workers-comp-lawyers',
                },
              ],
            },
            {
