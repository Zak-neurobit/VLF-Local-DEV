        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Criminal Defense Archives - Vasquez Law Firm, PLLC
            </h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'CollectionPage',
                  '@id': 'https://www.vasquezlawnc.com/category/criminal-defense/',
                  url: 'https://www.vasquezlawnc.com/category/criminal-defense/',
                  name: 'Criminal Defense Archives - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id': 'https://www.vasquezlawnc.com/category/criminal-defense/#primaryimage',
                  },
                  image: {
                    '@id': 'https://www.vasquezlawnc.com/category/criminal-defense/#primaryimage',
                  },
                  ...
                  breadcrumb: {
                    '@id': 'https://www.vasquezlawnc.com/category/criminal-defense/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                },
                {
                ...
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Criminal Defense' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              availableLanguage: ['English', 'Spanish'],
              url: 'https://vasquezlawnc.com/category/criminal-defense/index',
            },
            {
              '@context': 'https://schema.org',
              '@type': 'BreadcrumbList',
              itemListElement: [
                ...
                },
                {
                  ...
                  item: 'https://vasquezlawnc.com/category/criminal-defense',
                },
              ],
            },
            {
