        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Workers&apos; Compensation Archives - Page 2 of 2 - Vasquez Law Firm, PLLC
            </h1>
              ...
              '@graph': [
                {
                  ...
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/category/workers-compensation/page/2/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/category/workers-compensation/page/2/#primaryimage',
                  ...
                  thumbnailUrl:
                    '../../../../wp-content/uploads/2024/09/shutterstock_1303104493-min.jpg',
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/category/workers-compensation/page/2/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                },
                {
                  ...
                  '@id':
                    'https://www.vasquezlawnc.com/category/workers-compensation/page/2/#primaryimage',
                  url: '../../../../wp-content/uploads/2024/09/shutterstock_1303104493-min.jpg',
                  contentUrl:
                    '../../../../wp-content/uploads/2024/09/shutterstock_1303104493-min.jpg',
                  width: 500,
                  height: 334,
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  item: 'https://vasquezlawnc.com/category/workers-compensation',
                },
                {
                  '@type': 'ListItem',
                  position: 4,
                  name: 'Page',
                  item: 'https://vasquezlawnc.com/category/workers-compensation/page',
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: '2',
                  item: 'https://vasquezlawnc.com/category/workers-compensation/page/2',
                },
              ],
            },
            {
