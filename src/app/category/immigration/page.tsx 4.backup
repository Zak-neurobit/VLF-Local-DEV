        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Immigration Archives - Page 5 of 5 - Vasquez Law Firm, PLLC
            </h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'CollectionPage',
                  '@id': 'https://www.vasquezlawnc.com/category/immigration/',
                  url: 'https://www.vasquezlawnc.com/category/immigration/page/5/',
                  name: 'Immigration Archives - Page 5 of 5 - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id': 'https://www.vasquezlawnc.com/category/immigration/page/5/#primaryimage',
                  },
                  image: {
                    '@id': 'https://www.vasquezlawnc.com/category/immigration/page/5/#primaryimage',
                  },
                  ...
                  breadcrumb: {
                    '@id': 'https://www.vasquezlawnc.com/category/immigration/page/5/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                },
                {
                ...
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Immigration' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              availableLanguage: ['English', 'Spanish'],
              url: 'https://vasquezlawnc.com/category/immigration/page/5/index',
            },
            {
              '@context': 'https://schema.org',
              '@type': 'BreadcrumbList',
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 4,
                  name: 'Page',
                  item: 'https://vasquezlawnc.com/category/immigration/page',
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: '5',
                  item: 'https://vasquezlawnc.com/category/immigration/page/5',
                },
              ],
            },
            {
