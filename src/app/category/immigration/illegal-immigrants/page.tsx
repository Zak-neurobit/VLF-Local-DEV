...
export const metadata: Metadata = {
  title: 'illegal immigrants Archives - Vasquez Law Firm, PLLC',
  description:
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              illegal immigrants Archives - Vasquez Law Firm, PLLC
            </h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'CollectionPage',
                  '@id': 'https://www.vasquezlawnc.com/category/immigration/illegal-immigrants/',
                  url: 'https://www.vasquezlawnc.com/category/immigration/illegal-immigrants/',
                  name: 'illegal immigrants Archives - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/category/immigration/illegal-immigrants/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/category/immigration/illegal-immigrants/#primaryimage',
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/category/immigration/illegal-immigrants/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                },
                {
                ...
                },
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      ...
                      position: 2,
                      name: 'Immigration',
                      item: 'https://www.vasquezlawnc.com/category/immigration/',
                    },
                    { '@type': 'ListItem', position: 3, name: 'illegal immigrants' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              availableLanguage: ['English', 'Spanish'],
              url: 'https://vasquezlawnc.com/category/immigration/illegal-immigrants/index',
            },
            {
              '@context': 'https://schema.org',
              '@type': 'BreadcrumbList',
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: 'Immigration',
                  item: 'https://vasquezlawnc.com/category/immigration',
                },
                {
                  '@type': 'ListItem',
                  position: 4,
                  name: 'Illegal immigrants',
                  item: 'https://vasquezlawnc.com/category/immigration/illegal-immigrants',
                },
              ],
            },
            {
