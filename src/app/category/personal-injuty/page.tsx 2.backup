        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Personal Injuty Archives - Vasquez Law Firm, PLLC
            </h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'CollectionPage',
                  '@id': 'https://www.vasquezlawnc.com/category/personal-injuty/',
                  url: 'https://www.vasquezlawnc.com/category/personal-injuty/',
                  name: 'Personal Injuty Archives - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id': 'https://www.vasquezlawnc.com/category/personal-injuty/#primaryimage',
                  },
                  image: {
                    '@id': 'https://www.vasquezlawnc.com/category/personal-injuty/#primaryimage',
                  },
                  ...
                  breadcrumb: {
                    '@id': 'https://www.vasquezlawnc.com/category/personal-injuty/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                },
                {
                ...
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Personal Injuty' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 3,
                  name: 'Personal injuty',
                  item: 'https://vasquezlawnc.com/category/personal-injuty',
                },
              ],
            },
            {
