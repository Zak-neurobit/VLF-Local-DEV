        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Car Accidents Archives - Vasquez Law Firm, PLLC
            </h1>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'CollectionPage',
                  '@id': 'https://www.vasquezlawnc.com/category/car-accidents/',
                  url: 'https://www.vasquezlawnc.com/category/car-accidents/',
                  name: 'Car Accidents Archives - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id': 'https://www.vasquezlawnc.com/category/car-accidents/#primaryimage',
                  },
                  image: {
                    '@id': 'https://www.vasquezlawnc.com/category/car-accidents/#primaryimage',
                  },
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/09/vasquez-blog-sept2024.webp',
                  breadcrumb: {
                    '@id': 'https://www.vasquezlawnc.com/category/car-accidents/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                },
                {
                  ...
                  inLanguage: 'en-US',
                  '@id': 'https://www.vasquezlawnc.com/category/car-accidents/#primaryimage',
                  url: 'https://www.vasquezlawnc.com/wp-content/uploads/2024/09/vasquez-blog-sept2024.webp',
                  contentUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/09/vasquez-blog-sept2024.webp',
                  width: 1000,
                  height: 400,
                },
                {
                  ...
                  itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Car Accidents' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: 'Car accidents',
                  item: 'https://vasquezlawnc.com/category/car-accidents',
                },
              ],
            },
            {
