...
export const metadata: Metadata = {
  title: 'Best Workers Compensation Quote: Save More Today - Vasquez Law Firm, PLLC',
  description:
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              How to Get the Best Workers Compensation Quote for Maximum Benefits
            </h1>
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/best-workers-compensation-quote-save-more-today/',
                  url: 'https://www.vasquezlawnc.com/best-workers-compensation-quote-save-more-today/',
                  name: 'Best Workers Compensation Quote: Save More Today - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/best-workers-compensation-quote-save-more-today/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/best-workers-compensation-quote-save-more-today/#primaryimage',
                  ...
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2025/03/How-to-Get-the-Best-Workers-Compensation-Quote-for-Maximum-Benefits.jpg',
                  datePublished: '2025-03-05T11:53:13+00:00',
                  dateModified: '2025-03-18T11:48:31+00:00',
                  author: {
                    '@id':
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/best-workers-compensation-quote-save-more-today/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'Best Workers Compensation Quote: Save More Today',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Best workers compensation quote save more today',
                  item: 'https://vasquezlawnc.com/best-workers-compensation-quote-save-more-today',
                },
              ],
            },
            {
