...
export const metadata: Metadata = {
  title: 'Raleigh Family Law Attorneys - Vasquez Law Firm, PLLC',
  description:
      ...
      <section className="relative bg-gradient-to-r from-burgundy-900 to-burgundy-700 text-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Raleigh Family Law Attorneys</h1>
              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Raleigh Family Law Attorneys - Vasquez Law Firm, PLLC
                  </h2>
                  <p className="text-gray-700">
                    Raleigh Family Law Attorneys brings extensive legal experience to every case.
                    Licensed to practice in North Carolina and Florida, they has successfully
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-700">
                    Raleigh Family Law Attorneys focuses on immigration, personal injury, and
                    criminal defense, providing dedicated representation to clients throughout North
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/family-law/',
                  url: 'https://www.vasquezlawnc.com/family-law/',
                  name: 'Raleigh Family Law Attorneys - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id': 'https://www.vasquezlawnc.com/family-law/#primaryimage',
                  },
                  image: { '@id': 'https://www.vasquezlawnc.com/family-law/#primaryimage' },
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/04/north-carolina-family-lawyers.jpg',
                  datePublished: '2024-02-19T21:04:52+00:00',
                  dateModified: '2025-02-20T10:29:06+00:00',
                  description:
                    "Experienced Raleigh family law attorneys providing compassionate legal support for divorce, child custody, and more. Protect your family's future today.",
                  inLanguage: 'en-US',
                  potentialAction: [
                    { '@type': 'ReadAction', target: ['https://www.vasquezlawnc.com/family-law/'] },
                  ],
                },
                {
                  '@type': 'ImageObject',
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'North Carolina Family Lawyers',
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              '@context': 'https://schema.org',
              '@type': 'Attorney',
              name: 'Raleigh Family Law Attorneys',
              image: '',
              jobTitle: 'Attorney',
              worksFor: {
                '@type': 'LegalService',
              ...
              url: 'https://vasquezlawnc.com/family-law/page/9/index﹖et_blog',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Family law',
                  item: 'https://vasquezlawnc.com/family-law',
                },
                {
                  '@type': 'ListItem',
                  position: 3,
                  name: 'Page',
                  item: 'https://vasquezlawnc.com/family-law/page',
                },
                {
                  '@type': 'ListItem',
                  position: 4,
                  name: '9',
                  item: 'https://vasquezlawnc.com/family-law/page/9',
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: 'Index﹖et_blog',
                  item: 'https://vasquezlawnc.com/family-law/page/9/index﹖et_blog',
                },
              ],
            },
            {
