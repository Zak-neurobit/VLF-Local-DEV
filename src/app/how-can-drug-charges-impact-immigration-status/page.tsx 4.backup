        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              How Can Drug Charges Impact Immigration Status? - Vasquez Law Firm, PLLC
            </h1>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/how-can-drug-charges-impact-immigration-status/',
                  url: 'https://www.vasquezlawnc.com/how-can-drug-charges-impact-immigration-status/',
                  name: 'How Can Drug Charges Impact Immigration Status? - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/how-can-drug-charges-impact-immigration-status/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/how-can-drug-charges-impact-immigration-status/#primaryimage',
                  ...
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/09/blog_20240726144700.jpg',
                  datePublished: '2024-07-26T16:08:49+00:00',
                  dateModified: '2024-09-18T16:10:05+00:00',
                  author: {
                    '@id':
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/how-can-drug-charges-impact-immigration-status/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'How Can Drug Charges Impact Immigration Status?',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              availableLanguage: ['English', 'Spanish'],
              url: 'https://vasquezlawnc.com/how-can-drug-charges-impact-immigration-status/index',
            },
            {
              '@context': 'https://schema.org',
              '@type': 'BreadcrumbList',
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'How can drug charges impact immigration status',
                  item: 'https://vasquezlawnc.com/how-can-drug-charges-impact-immigration-status',
                },
              ],
            },
            {
