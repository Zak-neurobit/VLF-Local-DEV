...
export const metadata: Metadata = {
  title: 'Locations - Bufete de Attorneys Vasquez | Servicios Legales en NC y FL',
  description:
  ...
  keywords:
    'Locations Bufete de Attorneys Vasquez, oficinas legales NC, oficinas legales FL, oficinas abogado de inmigración, ubicaciones abogado de lesiones personales, bufete bilingüe',
  openGraph: {
    title: 'Locations - Bufete de Attorneys Vasquez | Servicios Legales en NC y FL',
    description:
