              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Charlotte, NC Workers&apos; Comp Lawyers - Vasquez Law Firm, PLLC
                  </h2>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
              ...
              '@graph': [
                {
                  ...
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/charlotte-nc-workers-comp-lawyers/'],
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              url: 'https://vasquezlawnc.com/charlotte-nc-workers-comp-lawyers/index',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Charlotte nc workers comp lawyers',
                  item: 'https://vasquezlawnc.com/charlotte-nc-workers-comp-lawyers',
                },
              ],
            },
            {
