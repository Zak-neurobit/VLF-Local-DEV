...
export default function CharlotteNcWorkersCompLawyersPage() {
  // TODO: Extract content from original file and format properly
  const post = {
    id: 'charlotte-nc-workers-comp-lawyers',
    title: 'Charlotte, NC Workers&apos; Comp Lawyers',
    slug: 'charlotte-nc-workers-comp-lawyers',
