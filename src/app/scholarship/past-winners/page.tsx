          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/scholarship/past-winners/',
                  url: 'https://www.vasquezlawnc.com/scholarship/past-winners/',
                  name: 'Past Winners - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-09-13T15:40:49+00:00',
                  dateModified: '2024-10-10T11:54:17+00:00',
                  description:
                    'Vasquez Law Firm has proudly awarded as the Fall 2023 recipient of our DACA Dreamer Scholarship. Ahiram is completing her undergraduate studies at Arizona State University.',
                  breadcrumb: {
                    '@id': 'https://www.vasquezlawnc.com/scholarship/past-winners/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/scholarship/past-winners/'],
                    },
                  ],
                },
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      ...
                      position: 2,
                      name: 'Scholarship',
                      item: 'https://www.vasquezlawnc.com/scholarship/',
                    },
                    { '@type': 'ListItem', position: 3, name: 'Past Winners' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Scholarship',
                  item: 'https://vasquezlawnc.com/scholarship',
                },
                {
                  '@type': 'ListItem',
                  position: 3,
                  name: 'Past winners',
                  item: 'https://vasquezlawnc.com/scholarship/past-winners',
                },
              ],
            },
            {
