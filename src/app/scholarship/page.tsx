...
export const metadata: Metadata = {
  title: 'Scholarship - Vasquez Law Firm, PLLC',
  description:
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/scholarship/',
                  url: 'https://www.vasquezlawnc.com/scholarship/',
                  name: 'Scholarship - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2024-02-26T20:31:59+00:00',
                  dateModified: '2025-02-20T10:38:58+00:00',
                  description:
                    'Vasquez Law Firm supports Dreamers with DACA legal services and the Dreamer Scholarship. Get trusted legal help and apply for funding today!',
                  breadcrumb: { '@id': 'https://www.vasquezlawnc.com/scholarship/#breadcrumb' },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/scholarship/'],
                    },
                  ],
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id': 'https://www.vasquezlawnc.com/scholarship/#breadcrumb',
                  itemListElement: [
                    {
                      '@type': 'ListItem',
                      position: 1,
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Scholarship' },
                  ],
                },
                {
                  '@type': 'WebSite',
