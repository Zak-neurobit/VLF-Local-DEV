            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <p className="text-lg mb-8 max-w-3xl mx-auto text-gray-300">
                  Meet the dedicated professionals who make our firm exceptional. Their passion,
                  expertise, and commitment to our clients drive our success every day.
                </p>
              </motion.div>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  desc: 'We treat clients and team as family',
                },
                {
                  icon: <Award className="w-8 h-8" />,
                  title: 'HONESTY',
                  desc: 'Straightforward and transparent always',
                },
                {
                  icon: <Star className="w-8 h-8" />,
                  title: 'DEDICATION',
                  desc: "Committed to everyone's growth",
                },
                {
                  icon: <Users className="w-8 h-8" />,
                  title: 'QUALITY EXPERIENCE',
                  desc: 'Creating a productive workspace',
                },
                {
                  icon: <Award className="w-8 h-8" />,
                  title: 'I FIGHT - YO PELEO',
                  desc: 'Fighting with passion for all',
                },
              ].map((value, index) => (
                <motion.div
                  key={index}
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8">
                ...
                others and our commitment to excellence. If you want to be part of a team that makes
                a real difference in people&apos;s lives, we&apos;d love to hear from you.
              </p>
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                'Meet the dedicated professionals at Vasquez Law Firm who make our firm exceptional.',
