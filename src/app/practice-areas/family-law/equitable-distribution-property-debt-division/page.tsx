...
export default function PracticeAreasFamilyLawEquitableDistributionPropertyDebtDivisionPage() {
  return (
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            serviceType: 'Family Law Equitable Distribution Property Debt Division Legal Services',
            provider: {
              '@type': 'LegalService',
            ...
            url: 'https://www.vasquezlawfirm.com/practice-areas/family-law/equitable-distribution-property-debt-division/page',
            description:
              'Family Law Equitable Distribution Property Debt Division legal services in North Carolina. Free consultation. Se habla español.',
          }),
        }}
      />
    </div>
