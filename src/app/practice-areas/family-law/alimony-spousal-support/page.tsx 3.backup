...
export default function PracticeAreasFamilyLawAlimonySpousalSupportPage() {
  return (
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            serviceType: 'Family Law Alimony Spousal Support Legal Services',
            provider: {
              '@type': 'LegalService',
            ...
            url: 'https://www.vasquezlawfirm.com/practice-areas/family-law/alimony-spousal-support/page',
            description:
              'Family Law Alimony Spousal Support legal services in North Carolina. Free consultation. Se habla español.',
          }),
        }}
      />
    </div>
