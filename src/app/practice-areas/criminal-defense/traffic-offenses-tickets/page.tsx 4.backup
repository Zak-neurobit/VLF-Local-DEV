...
export default function PracticeAreasCriminalDefenseTrafficOffensesTicketsPage() {
  return (
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            serviceType: 'Criminal Defense Traffic Offenses Tickets Legal Services',
            provider: {
              '@type': 'LegalService',
            ...
            url: 'https://www.vasquezlawfirm.com/practice-areas/criminal-defense/traffic-offenses-tickets/page',
            description:
              'Criminal Defense Traffic Offenses Tickets legal services in North Carolina. Free consultation. Se habla español.',
          }),
        }}
      />
    </div>
