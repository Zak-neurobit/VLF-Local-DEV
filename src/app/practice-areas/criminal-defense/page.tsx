...
export default function CriminalDefensePage() {
  const services = [
    {
      ...
      description: 'Aggressive defense against drunk driving charges. Our experienced attorneys use proven strategies to protect your license, freedom, and future.',
      features: [
    ...
    },
    {
      ...
      description: 'Expert defense for all drug charges from simple possession to trafficking. We focus on dismissals, reduced charges, and alternative sentencing options.',
      features: [
        'Possession charges',
    ...
    },
    {
      ...
      description: 'Strategic defense for assault, battery, and violent crime charges. We build strong defenses focusing on self-defense, witness credibility, and evidence challenges.',
      features: [
    ...
    },
    {
      ...
      description: 'Sensitive and strategic handling of domestic violence cases. We protect your rights, reputation, and relationships while navigating these complex charges.',
      features: [
    ...
    },
    {
      ...
      description: 'Experienced federal criminal defense with former federal prosecutors on our team. We handle complex federal cases with sophisticated defense strategies.',
      features: [
        'Federal drug conspiracies',
        'Wire and mail fraud',
    ...
    },
    {
      ...
      description: 'Sophisticated defense for financial and business crimes. Our attorneys understand complex financial matters and build strong defenses to protect your career and freedom.',
      features: [
    ...
    },
    {
      ...
      description: 'Discreet and aggressive defense for sex crime allegations. We protect your reputation while fighting for your freedom and future.',
      features: [
    ...
    },
    {
      ...
      description: 'Comprehensive defense for theft and property crime charges. We work to minimize consequences and protect your record.',
      features: [
    ...
    },
    {
      ...
      description: 'Protecting young futures with compassionate juvenile defense. We focus on rehabilitation and keeping cases out of adult court.',
      features: [
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Exercise your right to remain silent, ask for an attorney immediately, and call us at 1-844-YO-PELEO. Do not discuss your case with anyone except your lawyer.'
    },
    {
      question: 'Can you help with expungements?',
      answer: 'Yes! We help clients clear their criminal records through expungements when eligible, giving you a fresh start for employment and housing opportunities.'
    }
  ];
  ...
  return (
    <>
      <ModernPracticeAreaTemplate
        title="NC's Most Aggressive Criminal Defense Team"
          ...
          <div className="space-y-12">
            ...
            <section>
              ...
              <p className="text-lg mb-6">
                When your freedom is at stake, you need attorneys who understand both sides of the courtroom. Our team includes former prosecutors and judges who know exactly how the state builds cases - and how to defeat them.
              </p>
              
              <div className="grid md:grid-cols-2 gap-6 mt-8">
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  <h3 className="text-xl font-bold text-primary mb-3">Former Prosecutors</h3>
                  <p className="text-gray-300">Our attorneys have prosecuted thousands of cases. Now we use that insider knowledge to defend you.</p>
                </div>
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  ...
                  <p className="text-gray-300">While we negotiate aggressively, we prepare every case for trial. Prosecutors know we fight.</p>
                </div>
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  <h3 className="text-xl font-bold text-primary mb-3">Immigration-Safe Strategies</h3>
                  <p className="text-gray-300">Criminal charges can affect immigration status. We protect both your freedom and your future in America.</p>
                </div>
              </div>
            </section>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">We respond to your call 24/7 and can meet you at jail, court, or our office immediately.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">We investigate every detail, interview witnesses, and challenge evidence to build your defense.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Using our prosecutorial experience, we identify weaknesses and develop winning strategies.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Whether negotiating dismissals or fighting at trial, we never stop protecting your rights.</p>
                  </div>
                </div>
              </div>
            </section>
