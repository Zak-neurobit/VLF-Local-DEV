...
export default function PracticeAreasCriminalDefenseDrugCrimeCasesPage() {
  return (
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            serviceType: 'Criminal Defense Drug Crime Cases Legal Services',
            provider: {
              '@type': 'LegalService',
            ...
            url: 'https://www.vasquezlawfirm.com/practice-areas/criminal-defense/drug-crime-cases/page',
            description:
              'Criminal Defense Drug Crime Cases legal services in North Carolina. Free consultation. Se habla español.',
          }),
        }}
      />
    </div>
