...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Federal Criminal Defense Lawyer NC | When Stakes Are Highest',
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Federal Criminal Defense Services',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  return (
    <>
      <ModernPracticeAreaTemplate
        title="Federal Criminal Defense Attorneys"
                ...
                <table className="w-full bg-white/5 backdrop-blur-sm rounded-lg overflow-hidden">
                  ...
                  <tbody className="divide-y divide-gray-700">
                    ...
                    <tr>
                      ...
                      <td className="px-4 py-3 text-gray-300">US Attorneys (DOJ)</td>
                    </tr>
                    <tr>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LegalService',
            name: 'Federal Criminal Defense Services - Vasquez Law Firm',
            description:
            ...
            serviceType: 'Federal Criminal Defense',
          }),
        }}
      />
    </>
