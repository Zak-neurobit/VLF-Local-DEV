...
export default function PracticeAreasCriminalDefenseExpungementExpunctionPage() {
  return (
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            serviceType: 'Criminal Defense Expungement Expunction Legal Services',
            provider: {
              '@type': 'LegalService',
            ...
            url: 'https://www.vasquezlawfirm.com/practice-areas/criminal-defense/expungement-expunction/page',
            description:
              'Criminal Defense Expungement Expunction legal services in North Carolina. Free consultation. Se habla español.',
          }),
        }}
      />
    </div>
