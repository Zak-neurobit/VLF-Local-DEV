...
export default function PracticeAreasCriminalDefenseDomesticViolenceAbusePage() {
  return (
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            serviceType: 'Criminal Defense Domestic Violence Abuse Legal Services',
            provider: {
              '@type': 'LegalService',
            ...
            url: 'https://www.vasquezlawfirm.com/practice-areas/criminal-defense/domestic-violence-abuse/page',
            description:
              'Criminal Defense Domestic Violence Abuse legal services in North Carolina. Free consultation. Se habla español.',
          }),
        }}
      />
    </div>
