...
export default function PracticeAreasPage({ searchParams }: PracticeAreasPageProps) {
  // Get language from URL params or default to 'en'
  const language: 'en' | 'es' = (searchParams?.lang as 'en' | 'es') || 'en';
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: 'https://www.vasquezlawfirm.com/practice-areas/page',
