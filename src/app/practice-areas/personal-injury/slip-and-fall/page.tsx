        ...
        content={
          <div className="space-y-12">
            ...
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  <div className="text-3xl font-black text-primary mb-2">$850,000</div>
                  <p className="text-gray-300">
                    Grocery store fall resulting in hip replacement surgery for 68-year-old client
                  </p>
                </div>
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  <div className="text-3xl font-black text-primary mb-2">$425,000</div>
                  <p className="text-gray-300">
                    Restaurant slip on unmarked wet floor causing back surgery for server
                  </p>
                </div>
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  <div className="text-3xl font-black text-primary mb-2">$275,000</div>
                  <p className="text-gray-300">
                    Apartment complex stairway fall due to broken handrail
                  </p>
                </div>
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  <div className="text-3xl font-black text-primary mb-2">$190,000</div>
                  <p className="text-gray-300">
