  ...
  const services = [
    {
      ...
      description: 'Serious accidents demand serious representation. We fight insurance companies to get you maximum compensation for medical bills, lost wages, and pain and suffering.',
      features: [
        'Car accident claims',
    ...
    },
    {
      ...
      description: 'Property owners must keep you safe. When they fail, we hold them accountable for your injuries, medical expenses, and other damages.',
      features: [
    ...
    },
    {
      ...
      description: 'When healthcare providers fail to meet the standard of care, patients suffer. Our experienced attorneys hold negligent medical professionals accountable.',
      features: [
        'Surgical errors',
        'Misdiagnosis cases',
        'Birth injuries',
    ...
    },
    {
      ...
      description: 'Losing a loved one due to someone else\'s negligence is devastating. We help families seek justice and compensation for their profound loss.',
      features: [
        'Fatal car accidents',
    ...
    },
    {
      ...
      description: 'Injured on the job? You have rights beyond workers\' compensation. We explore all avenues to maximize your recovery.',
      features: [
    ...
    },
    {
      ...
      description: 'Dangerous and defective products cause serious injuries. We hold manufacturers and sellers responsible for the harm their products cause.',
      features: [
    ...
    },
    {
      ...
      description: 'Vulnerable road users deserve protection. When drivers fail to share the road safely, we fight for injured pedestrians and cyclists.',
      features: [
        'Crosswalk accidents',
        'Sidewalk injuries',
    ...
    },
    {
      ...
      description: 'Life-changing injuries require life-long care. We secure compensation that accounts for your future medical needs and quality of life.',
      features: [
    ...
    },
    {
      ...
      description: 'Our elderly deserve dignity and proper care. When nursing homes fail in their duty, we fight to protect vulnerable residents and their families.',
      features: [
  ...
  const faqs = [
    {
      ...
      answer: 'We work on a contingency fee basis - you pay nothing unless we win your case. Our fee comes from the settlement or verdict we secure for you. Free consultations always.'
    },
    {
      question: 'How long do I have to file a personal injury claim in NC?',
      answer: 'North Carolina generally allows 3 years from the date of injury to file a lawsuit. However, some cases have shorter deadlines. Contact us immediately to protect your rights.'
    },
    {
      question: 'What is my personal injury case worth?',
      answer: 'Every case is unique. Value depends on medical expenses, lost wages, pain and suffering, and other factors. We provide honest case evaluations during your free consultation.'
    },
    {
      question: 'Do I have to go to court?',
      answer: 'Most personal injury cases settle without trial. However, we prepare every case as if it will go to court, ensuring insurance companies take your claim seriously.'
    },
    {
      question: 'What if I was partially at fault?',
      answer: 'North Carolina follows contributory negligence rules, which can be harsh. Even 1% fault can bar recovery. That\'s why you need experienced attorneys who know how to protect your claim.'
    }
  ];
            ...
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-8">
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  ...
                  <p className="text-gray-300">You pay nothing upfront. We only get paid when we win your case. No hidden costs, no surprises.</p>
                </div>
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  ...
                  <p className="text-gray-300">Full legal services in English and Spanish. We ensure nothing gets lost in translation.</p>
                </div>
              </div>
            </section>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">We review your case at no cost and explain your rights and options clearly.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">We gather evidence, interview witnesses, and work with experts to build your strongest case.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">We fight insurance companies who try to lowball you, demanding maximum compensation.</p>
                  </div>
                </div>
                <div className="flex items-start">
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'Comprehensive personal injury legal services in North Carolina including car accidents, slip and falls, medical malpractice, and wrongful death claims.',
            provider: {
              '@type': 'Attorney',
