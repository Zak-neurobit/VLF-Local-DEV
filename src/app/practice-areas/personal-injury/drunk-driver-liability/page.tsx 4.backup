...
export default function PracticeAreasPersonalInjuryDrunkDriverLiabilityPage() {
  return (
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            serviceType: 'Personal Injury Drunk Driver Liability Legal Services',
            provider: {
              '@type': 'LegalService',
            ...
            url: 'https://www.vasquezlawfirm.com/practice-areas/personal-injury/drunk-driver-liability/page',
            description:
              'Personal Injury Drunk Driver Liability legal services in North Carolina. Free consultation. Se habla español.',
          }),
        }}
      />
    </div>
