...
export default function PracticeAreasWorkersCompensationThirdPartyInjuryClaimsPage() {
  return (
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            serviceType: 'Workers Compensation Third Party Injury Claims Legal Services',
            provider: {
              '@type': 'LegalService',
            ...
            url: 'https://www.vasquezlawfirm.com/practice-areas/workers-compensation/third-party-injury-claims/page',
            description:
              'Workers Compensation Third Party Injury Claims legal services in North Carolina. Free consultation. Se habla español.',
          }),
        }}
      />
    </div>
