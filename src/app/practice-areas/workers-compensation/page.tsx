  ...
  const services = [
    {
      ...
      description: 'We handle your entire workers\' compensation claim from start to finish, ensuring all deadlines are met and paperwork is properly filed for maximum benefits.',
      features: [
    ...
    },
    {
      ...
      description: 'Don\'t accept a denial. Our experienced attorneys know how to overturn wrongful denials and get you the benefits you deserve.',
      features: [
    ...
    },
    {
      ...
      description: 'Secure the disability benefits you need while unable to work. We fight for temporary and permanent disability compensation.',
      features: [
    ...
    },
    {
      ...
      description: 'Get the medical care you need without delays. We force insurance companies to authorize necessary treatments and surgeries.',
      features: [
    ...
    },
    {
      ...
      description: 'Recover two-thirds of your average weekly wage while you heal. We ensure accurate calculations and timely payments.',
      features: [
    ...
    },
    {
      ...
      description: 'Construction workers face serious hazards daily. We specialize in securing maximum benefits for construction accident victims.',
      features: [
    ...
    },
    {
      ...
      description: 'Repetitive motions cause real injuries. We prove the connection between your work duties and conditions like carpal tunnel.',
      features: [
    ...
    },
    {
      ...
      description: 'Work-related illnesses deserve compensation too. We handle claims for diseases caused by workplace exposure and conditions.',
      features: [
        'Asbestos exposure',
        'Chemical poisoning',
        'Hearing loss claims',
    ...
    },
    {
      ...
      description: 'When workplace accidents claim lives, we help families secure death benefits and ensure financial stability during difficult times.',
      features: [
        'Dependency benefits',
        'Burial expenses',
  ...
  const faqs = [
    {
      ...
      answer: 'We work on contingency - you pay nothing upfront. Our fee comes from your settlement or award, typically 25% or less as regulated by NC law.'
    },
    {
      question: 'Can I see my own doctor for a work injury?',
      answer: 'Initially, you must see the employer\'s approved doctors. However, you may have rights to change doctors or get second opinions. We can help navigate this.'
    },
    {
      question: 'What if my workers\' comp claim was denied?',
      answer: 'Don\'t give up! Many denials are wrongful. We have extensive experience overturning denials through appeals and hearings. Call us immediately.'
    },
    {
      question: 'How long do I have to file a workers\' comp claim in NC?',
      answer: 'You must report injuries within 30 days and file Form 18 within 2 years. However, acting quickly is crucial for preserving evidence and witness testimony.'
    },
    {
      question: 'Can I be fired for filing a workers\' comp claim?',
      answer: 'It\'s illegal for employers to retaliate against you for filing a legitimate workers\' comp claim. If this happens, you may have additional legal remedies.'
    }
  ];
      ...
      <ModernPracticeAreaTemplate
        ...
        content={
          <div className="space-y-12">
            ...
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-8">
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  ...
                  <p className="text-gray-300">We force insurance companies to approve necessary treatments, surgeries, and medications.</p>
                </div>
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                  <h3 className="text-xl font-bold text-primary mb-3">No Upfront Costs</h3>
                  <p className="text-gray-300">You pay nothing unless we win. Our fees are capped by law and come from your settlement.</p>
                </div>
              </div>
            </section>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">Common Workplace Injuries We Handle</h2>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">We evaluate your claim, explain your rights, and develop a winning strategy - all at no cost.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">We handle all paperwork, deadlines, and communications with employers and insurers.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">We fight for full wage replacement, complete medical coverage, and disability ratings.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">If needed, we represent you at Industrial Commission hearings to secure your benefits.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-lg mb-8">
                Every worker deserves protection. We represent injured workers across all industries throughout North Carolina:
              </p>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'Expert workers\' compensation legal services in North Carolina including claim filing, denied claim appeals, disability benefits, and workplace injury representation.',
            provider: {
              '@type': 'Attorney',
