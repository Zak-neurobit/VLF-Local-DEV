...
export default function PracticeAreasWorkersCompensationRepetitiveStressCarpalTunnelPage() {
  return (
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            serviceType: 'Workers Compensation Repetitive Stress Carpal Tunnel Legal Services',
            provider: {
              '@type': 'LegalService',
            ...
            url: 'https://www.vasquezlawfirm.com/practice-areas/workers-compensation/repetitive-stress-carpal-tunnel/page',
            description:
              'Workers Compensation Repetitive Stress Carpal Tunnel legal services in North Carolina. Free consultation. Se habla español.',
          }),
        }}
      />
    </div>
