        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
              NC Equipment & Machinery Accident Lawyer
            </h1>
            <p className="text-2xl md:text-3xl font-semibold text-[#FF6B6B] mb-6">
              YO PELEO POR TI™
            </p>
            <p className="text-xl mb-8 text-gray-100">
              Injured by workplace equipment or machinery? You deserve maximum workers compensation
              benefits. We fight equipment manufacturers, insurance companies, and negligent
              employers.
            </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
            Common Equipment Accidents We Handle
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-3 text-[#001845]">Forklift Accidents</h3>
              <p className="text-gray-700">
                Tip-overs, struck-by incidents, falls from forks, and crushing injuries. Often
                involving inadequate training or equipment defects.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-3 text-[#001845]">Crane Accidents</h3>
              <p className="text-gray-700">
                Load drops, boom strikes, electrocution, and rigging failures. Complex cases often
                involving multiple liable parties.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-3 text-[#001845]">Manufacturing Equipment</h3>
              <p className="text-gray-700">
                Presses, saws, conveyors, and automated machinery. Missing guards and inadequate
                safety protocols are common causes.
              </p>
            </div>
          </div>
        </div>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            serviceType: 'Workers Compensation Equipment Accidents Legal Services',
            provider: {
              '@type': 'LegalService',
            ...
            url: 'https://www.vasquezlawfirm.com/practice-areas/workers-compensation/equipment-accidents/page',
            description:
              'Workers Compensation Equipment Accidents legal services in North Carolina. Free consultation. Se habla español.',
          }),
        }}
      />
    </div>
