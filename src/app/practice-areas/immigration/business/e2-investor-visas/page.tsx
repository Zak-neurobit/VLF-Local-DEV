...
import { FaChartLine, Globe, FaHandshake, FaDollarSign, FaClipboardCheck, FaUserTie,  } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <FaClipboardCheck className="text-3xl text-blue-600 mx-auto mb-3" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gray-50 rounded-lg p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="border-l-4 border-blue-600 pl-4">
                  <h4 className="font-semibold text-gray-900">Large Investments ($500K+)</h4>
