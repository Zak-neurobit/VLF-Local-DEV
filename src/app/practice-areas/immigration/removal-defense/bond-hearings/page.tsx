...
export default function BondHearingsPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'Immigration bonds range from $1,500 to $50,000+, but we fight for the LOWEST possible amount. We also help connect families with bond companies that offer payment plans.',
    },
    {
            ...
            <section className="bg-gradient-to-r from-primary/20 to-primary-dark/20 rounded-lg p-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                ...
                <div>
                  ...
                  <div className="text-gray-300">Average Bond</div>
                </div>
                <div>
