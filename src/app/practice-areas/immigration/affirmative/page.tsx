    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Affirmative Immigration Services - Building Your American Dream',
      },
    ],
    locale: 'en_US',
    type: 'website',
...
export default function AffirmativeImmigrationPage() {
  const currentPage = {
  ...
  return (
    <>
      ...
      <ModernPracticeAreaTemplate
        title="Affirmative Immigration Services"
          ...
          <div className="space-y-12">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-8 text-primary">
                Comprehensive Affirmative Immigration Services
              </h2>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">
                Why Choose Vasquez Law Firm for Affirmative Immigration?
              </h2>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-primary">
                Our Affirmative Immigration Process
              </h2>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LegalService',
            name: 'Affirmative Immigration Services - Vasquez Law Firm',
            description:
            ...
            serviceType: 'Affirmative Immigration Services',
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              ...
              itemListElement: [
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Family-Based Immigration Petitions',
