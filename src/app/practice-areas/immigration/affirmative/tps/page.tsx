...
export const metadata: Metadata = {
  ...
  description: 'Expert TPS attorneys helping nationals from designated countries. Initial TPS registration, re-registration, travel documents, and paths to permanent status.',
  keywords: 'TPS lawyer, temporary protected status, TPS countries, TPS renewal, TPS attorney, immigration protection',
};
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12">Currently Designated TPS Countries</h2>
            <div className="bg-yellow-50 p-4 rounded-lg mb-8 text-center">
              <p className="text-sm text-yellow-800">
                ⚠️ TPS designations change. This list is current as of 2024. Contact us for the latest information.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              <p className="text-center text-blue-800 font-semibold">
                Each country has specific dates for physical presence and continuous residence requirements
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">For first-time TPS applicants during open registration period</p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-gray-600 mb-3">TPS holders may apply for travel authorization for:</p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12">Paths to Permanent Status from TPS</h2>
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-lg font-bold mb-3 text-blue-800">Family-Based Petitions</h3>
                <p className="text-gray-600">
                  TPS holders with U.S. citizen or permanent resident family members may have paths to green cards, 
                  especially with advance parole travel.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-lg font-bold mb-3 text-blue-800">Employment-Based Options</h3>
                <p className="text-gray-600">
                  Long-term TPS holders with employer sponsors may qualify for employment-based green cards.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-lg font-bold mb-3 text-blue-800">Adjustment Through Travel</h3>
                <p className="text-gray-600">
                  Strategic use of advance parole may cure unlawful entry and open adjustment of status options.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-lg font-bold mb-3 text-blue-800">Legislative Solutions</h3>
                <p className="text-gray-600">
                  Proposed legislation may provide paths to permanent residence for long-term TPS holders.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-sm text-gray-600">
                  • Continuous residence: March 9, 2001<br />
                  • Physical presence: March 9, 2001<br />
                  • One of the largest TPS populations
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="font-bold mb-3 text-blue-800">Venezuela</h3>
                <p className="text-sm text-gray-600">
                  • Continuous residence: March 8, 2021<br />
                  • Physical presence: March 8, 2021<br />
                  • Recent designation
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-sm text-gray-600">
                  • Multiple registration periods<br />
                  • Check specific requirements<br />
                  • Extended due to conditions
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="font-bold mb-3 text-blue-800">Ukraine</h3>
                <p className="text-sm text-gray-600">
                  • Continuous residence: April 11, 2022<br />
                  • Physical presence: April 11, 2022<br />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-red-50 p-8 rounded-lg shadow-lg">
              <h3 className="text-xl font-bold mb-4 text-red-800 text-center">TPS Deadlines Are Strict!</h3>
              <div className="space-y-4">
                <p className="text-gray-700">
                  <strong>Initial Registration:</strong> You must apply during the designated registration period for your country. 
                  Missing this window may permanently bar you from TPS.
                </p>
                <p className="text-gray-700">
                  <strong>Re-Registration:</strong> Current TPS holders must re-register during each designated period. 
                  Failure to re-register will result in loss of TPS status.
                </p>
                <p className="text-gray-700">
                  <strong>Late Filing:</strong> Very limited exceptions exist for late initial registration. 
                  Don't risk your eligibility - file on time!
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-blue-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Whether you need initial registration, re-registration, or exploring paths beyond TPS, our experienced attorneys can help.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
