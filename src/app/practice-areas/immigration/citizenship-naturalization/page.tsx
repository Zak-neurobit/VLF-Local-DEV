...
export const metadata: Metadata = {
  title: 'Citizenship & Naturalization Lawyers NC & FL | Become US Citizen | Vasquez Law Firm',
  description:
  ...
  openGraph: {
    title: 'Citizenship & Naturalization Lawyers | Become US Citizen - Vasquez Law Firm',
    description:
...
export default function CitizenshipNaturalizationPage() {
  const services = [
    ...
    },
    {
      ...
      features: [
        ...
        'Attorney accompaniment available',
      ],
    },
    {
  ...
  return (
    <ModernPracticeAreaTemplate
      title="Citizenship & Naturalization Lawyers"
