...
export const metadata: Metadata = {
  title:
    'Immediate Relative Visas Lawyers NC & FL | Spouses, Parents, Children | No Wait Times | Vasquez Law Firm',
  description:
  ...
  openGraph: {
    title: 'Immediate Relative Visas Lawyers | Fastest Family Immigration - Vasquez Law Firm',
    description:
...
export default function ImmediateRelativeVisasPage() {
  ...
  return (
    <ModernPracticeAreaTemplate
      title="Immediate Relative Visas Lawyers"
      subtitle="Fastest Family Immigration - No Wait Times"
