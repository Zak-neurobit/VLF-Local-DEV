...
export const metadata: Metadata = {
  title: 'Family Immigration Lawyer NC | Reunite Families Fast | Vasquez Law Firm',
  description:
  ...
  openGraph: {
    title: 'Family Immigration Lawyers | Reuniting Families - Vasquez Law Firm',
    description:
...
export default function FamilyBasedImmigrationPage() {
  ...
  const content = {
    ...
    processTitle: 'Our Family Immigration Process',
    process: [
      {
        step: '1',
    ...
    whyChooseTitle: 'Why Choose Our Family Immigration Team?',
    whyChoosePoints: [
    ...
    categoriesTitle: 'Family-Based Immigration Categories',
    categories: [
      {
  ...
  return (
    <ModernPracticeAreaTemplate
      title="Family-Based Immigration Lawyers"
