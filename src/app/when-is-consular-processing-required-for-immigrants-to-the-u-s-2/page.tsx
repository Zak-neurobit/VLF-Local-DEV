        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              When Is Consular Processing Required for Immigrants to the U.S.? - Vasquez Law Firm,
              PLLC
            </h1>
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/when-is-consular-processing-required-for-immigrants-to-the-u-s-2/',
                  url: 'https://www.vasquezlawnc.com/when-is-consular-processing-required-for-immigrants-to-the-u-s-2/',
                  name: 'When Is Consular Processing Required for Immigrants to the U.S.? - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/when-is-consular-processing-required-for-immigrants-to-the-u-s-2/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/when-is-consular-processing-required-for-immigrants-to-the-u-s-2/#primaryimage',
                  ...
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/09/shutterstock-1812113506-1-2.jpg',
                  datePublished: '2024-01-26T16:17:09+00:00',
                  dateModified: '2024-09-18T16:17:31+00:00',
                  author: {
                    '@id':
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/when-is-consular-processing-required-for-immigrants-to-the-u-s-2/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'When Is Consular Processing Required for Immigrants to the U.S.?',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  '@type': 'ListItem',
                  position: 2,
                  name: 'When is consular processing required for immigrants to the u s 2',
                  item: 'https://vasquezlawnc.com/when-is-consular-processing-required-for-immigrants-to-the-u-s-2',
                },
              ],
            },
            {
