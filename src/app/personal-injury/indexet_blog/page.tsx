              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                    Raleigh, NC Personal Injury Attorneys - Vasquez Law Firm, PLLC
                  </h2>
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/personal-injury/',
                  url: 'https://www.vasquezlawnc.com/personal-injury/',
                  name: 'Raleigh, NC Personal Injury Attorneys - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id': 'https://www.vasquezlawnc.com/personal-injury/#primaryimage',
                  },
                  image: { '@id': 'https://www.vasquezlawnc.com/personal-injury/#primaryimage' },
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/04/mecklenburg-county-personal-injury-accident-lawyers.jpg',
                  datePublished: '2024-02-19T21:03:47+00:00',
                  dateModified: '2025-02-19T12:31:38+00:00',
                  description:
                    'Injured due to negligence? Raleigh, NC personal injury attorneys fight for your rights and maximum compensation. Get a free consultation today.',
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/personal-injury/'],
                    },
                  ],
                },
                {
                  ...
                  width: 1000,
                  height: 400,
                  caption: 'Mecklenburg County Personal Injury Accident Lawyers',
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              url: 'https://vasquezlawnc.com/personal-injury/page/9/index﹖et_blog',
              sameAs: [],
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: 'Page',
                  item: 'https://vasquezlawnc.com/personal-injury/page',
                },
                {
                  '@type': 'ListItem',
                  position: 4,
                  name: '9',
                  item: 'https://vasquezlawnc.com/personal-injury/page/9',
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: 'Index﹖et_blog',
                  item: 'https://vasquezlawnc.com/personal-injury/page/9/index﹖et_blog',
                },
              ],
            },
            {
