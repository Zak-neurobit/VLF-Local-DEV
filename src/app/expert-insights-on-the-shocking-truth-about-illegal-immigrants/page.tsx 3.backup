...
export const metadata: Metadata = {
  title: 'Expert Insights on the Shocking Truth About Illegal Immigrants - Vasquez Law Firm, PLLC',
  description:
  ...
  openGraph: {
    title:
      'Expert Insights on the Shocking Truth About Illegal Immigrants - Vasquez Law Firm, PLLC',
    description:
      'Discover the shocking truth about illegal immigrants, their impact, and what needs to change. Gain expert insights and understand the complexities of this issue.',
    images: [
      {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              The Shocking Truth About Illegal Immigration You Can’t Afford to Miss
            </h1>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                  Expert Insights on the Shocking Truth About Illegal Immigrants - Vasquez Law Firm,
                  PLLC
                </h2>
                <div className="text-gray-700">
                  Our experienced attorneys provide comprehensive legal services for The Shocking
                  Truth About Illegal Immigration You Can’t Afford to Miss cases. With over 35 years
                  of combined experience, we understand the complexities of The Shocking Truth About
                  Illegal Immigration You Can’t Afford to Miss law and fight tirelessly for our
                  clients&apos; rights.
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="text-gray-700">
                  When you choose Vasquez Law Firm for your The Shocking Truth About Illegal
                  Immigration You Can’t Afford to Miss case, you get: • Bilingual attorneys who
              ...
              <div className="mb-8">
                ...
                <div className="text-gray-700">
                  Common questions about The Shocking Truth About Illegal Immigration You Can’t
                  Afford to Miss cases in North Carolina and Florida. Our attorneys are here to
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/expert-insights-on-the-shocking-truth-about-illegal-immigrants/',
                  url: 'https://www.vasquezlawnc.com/expert-insights-on-the-shocking-truth-about-illegal-immigrants/',
                  name: 'Expert Insights on the Shocking Truth About Illegal Immigrants - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/expert-insights-on-the-shocking-truth-about-illegal-immigrants/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/expert-insights-on-the-shocking-truth-about-illegal-immigrants/#primaryimage',
                  ...
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2025/01/The-Shocking-Truth-About-Illegal-Immigration-You-Cant-Afford-to-Miss.jpg',
                  datePublished: '2025-01-25T15:09:22+00:00',
                  dateModified: '2025-01-28T13:44:27+00:00',
                  author: {
                    '@id':
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/expert-insights-on-the-shocking-truth-about-illegal-immigrants/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  height: 400,
                  caption:
                    "Impactful article headline, 'The Shocking Truth About Illegal Immigration You Can't Afford to Miss,' highlighting key facts and insights.",
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id':
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'Expert Insights on the Shocking Truth About Illegal Immigrants',
                    },
                  ],
                },
                {
            ...
            },
            {
              '@context': 'https://schema.org',
              '@type': 'LegalService',
              name: 'The Shocking Truth About Illegal Immigration You Can’t Afford to Miss',
              description:
                'Discover the shocking truth about illegal immigrants, their impact, and what needs to change. Gain expert insights and understand the complexities of this issue.',
              provider: {
                '@type': 'LegalService',
              ...
              availableLanguage: ['English', 'Spanish'],
              url: 'https://vasquezlawnc.com/expert-insights-on-the-shocking-truth-about-illegal-immigrants/index',
            },
            {
              '@context': 'https://schema.org',
              '@type': 'BreadcrumbList',
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Expert insights on the shocking truth about illegal immigrants',
                  item: 'https://vasquezlawnc.com/expert-insights-on-the-shocking-truth-about-illegal-immigrants',
                },
              ],
            },
            {
