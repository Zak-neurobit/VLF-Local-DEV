...
export const metadata: Metadata = {
  title: 'Judith Parkes - Vasquez Law Firm, PLLC',
  description:
          ...
          __html: JSON.stringify([
            {
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id': 'https://www.vasquezlawnc.com/judith-parkes/',
                  url: 'https://www.vasquezlawnc.com/judith-parkes/',
                  name: 'Judith Parkes - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  datePublished: '2025-02-28T06:24:35+00:00',
                  dateModified: '2025-02-28T06:52:03+00:00',
                  breadcrumb: { '@id': 'https://www.vasquezlawnc.com/judith-parkes/#breadcrumb' },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                      '@type': 'ReadAction',
                      target: ['https://www.vasquezlawnc.com/judith-parkes/'],
                    },
                  ],
                },
                {
                  '@type': 'BreadcrumbList',
                  '@id': 'https://www.vasquezlawnc.com/judith-parkes/#breadcrumb',
                  itemListElement: [
                    {
                      '@type': 'ListItem',
                      position: 1,
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Judith Parkes' },
                  ],
                },
                {
                  '@type': 'WebSite',
            ...
            },
            {
              ...
              url: 'https://vasquezlawnc.com/judith-parkes/index',
              sameAs: [],
              knowsLanguage: ['English', 'Spanish'],
              alumniOf: {
                '@type': 'CollegeOrUniversity',
                name: 'Judith received her Juris Doctorate from the University of Puerto Rico School of Law',
              },
            },
            {
              '@context': 'https://schema.org',
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Judith parkes',
                  item: 'https://vasquezlawnc.com/judith-parkes',
                },
              ],
            },
            {
