        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              What Should I Do if I Am Arrested for DWI Over the Holidays? - Vasquez Law Firm, PLLC
            </h1>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-burgundy-900 mb-4">
                  What Should I Do if I Am Arrested for DWI Over the Holidays? - Vasquez Law Firm,
                  PLLC
                </h2>
                <div className="text-gray-700">
                  Our experienced attorneys provide comprehensive legal services for criminalDefense
                  cases. With over 35 years of combined experience, we understand the complexities
                  of criminalDefense law and fight tirelessly for our clients&apos; rights.
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="text-gray-700">
                  When you choose Vasquez Law Firm for your criminalDefense case, you get: •
              ...
              <div className="mb-8">
                ...
                <div className="text-gray-700">
                  Get a free evaluation of your criminalDefense case. During your consultation,
              ...
              <div className="mb-8">
                ...
                <div className="text-gray-700">
                  Common questions about criminalDefense cases in North Carolina and Florida. Our
          ...
          __html: JSON.stringify([
              ...
              '@graph': [
                {
                  '@type': 'WebPage',
                  '@id':
                    'https://www.vasquezlawnc.com/what-should-i-do-if-i-am-arrested-for-dwi-over-the-holidays/',
                  url: 'https://www.vasquezlawnc.com/what-should-i-do-if-i-am-arrested-for-dwi-over-the-holidays/',
                  name: 'What Should I Do if I Am Arrested for DWI Over the Holidays? - Vasquez Law Firm, PLLC',
                  isPartOf: { '@id': 'https://www.vasquezlawnc.com/#website' },
                  primaryImageOfPage: {
                    '@id':
                      'https://www.vasquezlawnc.com/what-should-i-do-if-i-am-arrested-for-dwi-over-the-holidays/#primaryimage',
                  },
                  image: {
                    '@id':
                      'https://www.vasquezlawnc.com/what-should-i-do-if-i-am-arrested-for-dwi-over-the-holidays/#primaryimage',
                  ...
                  thumbnailUrl:
                    'https://www.vasquezlawnc.com/wp-content/uploads/2024/02/arrested-for-dwi-over-holidays.jpg',
                  datePublished: '2023-12-14T15:31:16+00:00',
                  dateModified: '2024-09-18T16:18:11+00:00',
                  author: {
                    '@id':
                  ...
                  breadcrumb: {
                    '@id':
                      'https://www.vasquezlawnc.com/what-should-i-do-if-i-am-arrested-for-dwi-over-the-holidays/#breadcrumb',
                  },
                  inLanguage: 'en-US',
                  potentialAction: [
                    {
                ...
                },
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      '@type': 'ListItem',
                      position: 2,
                      name: 'What Should I Do if I Am Arrested for DWI Over the Holidays?',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              mainEntity: [
                {
                  '@type': 'Question',
                  name: 'How much does a criminalDefense lawyer cost?',
                  acceptedAnswer: {
                    '@type': 'Answer',
                ...
                {
                  '@type': 'Question',
                  name: 'How long does a criminalDefense case take?',
                  acceptedAnswer: {
                    '@type': 'Answer',
            ...
            },
            {
              ...
              availableLanguage: ['English', 'Spanish'],
              url: 'https://vasquezlawnc.com/what-should-i-do-if-i-am-arrested-for-dwi-over-the-holidays/index',
            },
            {
              '@context': 'https://schema.org',
              '@type': 'BreadcrumbList',
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'What should i do if i am arrested for dwi over the holidays',
                  item: 'https://vasquezlawnc.com/what-should-i-do-if-i-am-arrested-for-dwi-over-the-holidays',
                },
              ],
            },
            {
