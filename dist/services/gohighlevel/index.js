...
class GoHighLevelService {
  constructor() {
    ...
    const isConfigured = env_config_1.envConfig.checkService(
      env_config_1.SERVICE_CONFIGS.GOHIGHLEVEL
    );
  ...
  async syncContactToDatabase(ghlContact) {
    try {
      ...
      logger_1.logger.info('Contact sync placeholder', {
        ghlContactId: ghlContact?.id || 'unknown',
      });
