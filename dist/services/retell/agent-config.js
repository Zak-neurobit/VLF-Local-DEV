...
exports.VOICE_AGENTS = exports.RETELL_CONFIG = void 0;
exports.selectVoiceAgent = selectVoiceAgent;
exports.createRetellAgentConfig = createRetellAgentConfig;
exports.initializeRetellAgents = initializeRetellAgents;
const logger_1 = require('@/lib/logger');
// Retell API Configuration
exports.RETELL_CONFIG = {
...
// Agent routing logic
function selectVoiceAgent(context) {
  // Emergency routing
...
function createRetellAgentConfig(agentType) {
  const agent = exports.VOICE_AGENTS[agentType];
  return {
...
async function initializeRetellAgents() {
  try {
    const agentConfigs = [];
    for (const [key, agent] of Object.entries(exports.VOICE_AGENTS)) {
      const config = createRetellAgentConfig(key);
      agentConfigs.push({
        key,
        config,
      });
    }
    logger_1.logger.info('Retell voice agents configured', {
