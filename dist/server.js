...
var ChatSocketServer = /** @class */ (function () {
    ...
    ChatSocketServer.prototype.setupMiddleware = function () {
        ...
        this.io.use(function (socket, next) { return __awaiter(_this, void 0, void 0, function () {
            var sessionId, language, token, reconnectionToken, userId, userRole, authenticated, decoded, sessionData, previousSession;
    ...
    ChatSocketServer.prototype.setupEventHandlers = function () {
        ...
        this.io.on('connection', function (socket) {
            ...
            socket.on('chat:init', function (data) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, prisma_1.getPrismaClient)().conversation.create({
                                    data: {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.joinRoom(socket, socketData.roomId, RoomType.CONVERSATION)];
                        case 2:
                            // Join conversation room
                            _a.sent();
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, prisma_1.getPrismaClient)().message.create({
                                    data: {
                        ...
                        case 5:
                            ...
                            if (!((_a = response.metadata) === null || _a === void 0 ? void 0 : _a.escalate)) return [3 /*break*/, 7];
                            return [4 /*yield*/, this.handleEscalation(socket, response.metadata.escalationType)];
                        case 6:
                            _b.sent();
                            _b.label = 7;
            ...
            socket.on('user:message', function (data) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2: return [4 /*yield*/, this.processMessage(text, __assign(__assign({}, socketData), { language: language }))];
                        case 3:
                            response = _a.sent();
                            if (!socketData.conversationId) return [3 /*break*/, 5];
                            return [4 /*yield*/, (0, prisma_1.getPrismaClient)().message.create({
                                    data: {
                                        ...
                                        role: 'assistant',
                                        content: response.content,
                                        metadata: __assign(__assign({}, response.metadata), { source: 'virtual_assistant' }),
                                    },
                                })];
                        case 4:
                            _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, (0, prisma_1.getPrismaClient)().conversation.update({
    ...
    ChatSocketServer.prototype.setupRoomHandlers = function () {
        ...
        this.io.on('connection', function (socket) {
            ...
            socket.on('room:join', function (data) { return __awaiter(_this, void 0, void 0, function () {
                var error_5;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            // Leave a room
            socket.on('room:leave', function (data) { return __awaiter(_this, void 0, void 0, function () {
                var error_6;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            socket.on('room:message', function (data) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    try {
    ...
    ChatSocketServer.prototype.setupNotificationHandlers = function () {
        ...
        this.io.on('connection', function (socket) {
            ...
            socket.on('notifications:subscribe', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, prisma_1.getPrismaClient)().notification.findMany({
                                    where: {
                                        userId: socketData.userId,
                                        read: false,
                                    },
            ...
            socket.on('notifications:mark-read', function (data) { return __awaiter(_this, void 0, void 0, function () {
                var error_8;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, prisma_1.getPrismaClient)().notification.update({
                                    where: {
    ...
    ChatSocketServer.prototype.setupCaseHandlers = function () {
        ...
        this.io.on('connection', function (socket) {
            ...
            socket.on('case:subscribe', function (data) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, prisma_1.getPrismaClient)().case.findFirst({
                                    where: {
                                        id: data.caseId,
            ...
            socket.on('case:unsubscribe', function (data) { return __awaiter(_this, void 0, void 0, function () {
    ...
    ChatSocketServer.prototype.setupReconnectionHandlers = function () {
        ...
        this.io.on('connection', function (socket) {
            var socketData = socket.data;
            // Handle reconnection
            socket.on('reconnect:attempt', function (data) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, prisma_1.getPrismaClient)().conversation.findUnique({
    ...
    ChatSocketServer.prototype.getWelcomeMessage = function (language) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (language === 'es') {
                    return [2 /*return*/, '¡Hola! Soy el asistente virtual de Vasquez Law Firm. ¿Cómo puedo ayudarte hoy?'];
                }
                return [2 /*return*/, "Hello! I'm the Vasquez Law Firm virtual assistant. How can I help you today?"];
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = escalationType;
                        switch (_a) {
                            case 'voice': return [3 /*break*/, 1];
                            case 'human': return [3 /*break*/, 2];
                        }
                        return [3 /*break*/, 5];
                    case 1:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, prisma_1.getPrismaClient)().supportTicket.create({
                                data: {
                                    userId: socketData.userId,
                                    subject: 'Human Agent Requested',
                                    description: "User requested to speak with a human agent during conversation ".concat(socketData.conversationId),
    ...
    ChatSocketServer.prototype.joinRoom = function (socket, roomId, roomType) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                logger_1.wsLogger.info(socket.id, "Joined room: ".concat(roomId, " (").concat(roomType, ")"));
                return [2 /*return*/];
            });
        });
    };
    ...
    ChatSocketServer.prototype.checkRateLimit = function (clientId) {
        ...
        var validTimestamps = timestamps.filter(function (t) { return now - t < _this.RATE_LIMIT_WINDOW; });
    ...
    ChatSocketServer.prototype.generateReconnectionToken = function (socketData) {
        var _this = this;
        var token = "reconnect_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9));
    ...
    ChatSocketServer.prototype.getRoomParticipantCount = function (roomId) {
        var _a;
        return ((_a = this.roomParticipants.get(roomId)) === null || _a === void 0 ? void 0 : _a.size) || 0;
    };
    ...
    ChatSocketServer.prototype.broadcastToUser = function (userId, event, data) {
        for (var _i = 0, _a = this.activeSessions; _i < _a.length; _i++) {
            var _b = _a[_i], socketId = _b[0], session = _b[1];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.io.to(notificationRoom).emit('notification', __assign(__assign({}, notification), { timestamp: new Date().toISOString() }));
                        // Also store in database
                        return [4 /*yield*/, (0, prisma_1.getPrismaClient)().notification.create({
                                data: {
                                    userId: userId,
                                    type: 'SYSTEM',
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.io.to(caseRoom).emit('case:update', __assign(__assign({}, update), { timestamp: new Date().toISOString() }));
                        return [4 /*yield*/, (0, prisma_1.getPrismaClient)().case.findUnique({
                                where: { id: caseId },
                                select: {
                                    clientId: true,
                                    attorneyId: true,
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.sendNotification(caseData.clientId, {
                                type: 'info',
                                title: 'Case Update',
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3:
                        if (!(caseData.attorneyId && caseData.attorneyId !== update.data.updatedBy)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.sendNotification(caseData.attorneyId, {
                                type: 'info',
                                title: 'Case Update',
                                message: notificationMessage,
                                metadata: { caseId: caseId, updateType: update.updateType },
